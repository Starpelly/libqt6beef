#pragma once
#ifndef SRCC_LIBQRECT_H
#define SRCC_LIBQRECT_H
...
QRect* QRect_new(QRect* other);
QRect* QRect_new2(QRect* other);
QRect* QRect_new3();
QRect* QRect_new4(QPoint* topleft, QPoint* bottomright);
QRect* QRect_new5(QPoint* topleft, QSize* size);
QRect* QRect_new6(int left, int top, int width, int height);
QRect* QRect_new7(QRect* param1);
...
QRectF* QRectF_new(QRectF* other);
QRectF* QRectF_new2(QRectF* other);
QRectF* QRectF_new3();
QRectF* QRectF_new4(QPointF* topleft, QSizeF* size);
QRectF* QRectF_new5(QPointF* topleft, QPointF* bottomRight);
QRectF* QRectF_new6(double left, double top, double width, double height);
QRectF* QRectF_new7(QRect* rect);
QRectF* QRectF_new8(QRectF* param1);
