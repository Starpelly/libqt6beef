...
libqt_string QShortcut_TrUtf8(const char* s);
...
libqt_string QShortcut_TrUtf82(const char* s, const char* c);
libqt_string QShortcut_TrUtf83(const char* s, const char* c, int n);
