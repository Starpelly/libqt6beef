...
public struct QWhatsThis
{
	...
	public static extern void* QWhatsThis_new(QWhatsThis other);
	[LinkName("QWhatsThis_new2")]
	public static extern void* QWhatsThis_new2(QWhatsThis other);
	...
	public static extern void QWhatsThis_ShowText(QPoint pos, char8[] text);
	...
	public static extern void QWhatsThis_ShowText3(QPoint pos, char8[] text, QWidget w);
