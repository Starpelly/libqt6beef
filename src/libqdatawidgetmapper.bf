...
public struct QDataWidgetMapper
{
	[LinkName("QDataWidgetMapper_new")]
	public static extern void* QDataWidgetMapper_new();
	[LinkName("QDataWidgetMapper_new2")]
	public static extern void* QDataWidgetMapper_new2(QObject parent);
	[LinkName("QDataWidgetMapper_MetaObject")]
	public static extern QMetaObject QDataWidgetMapper_MetaObject(void* c_this);
	...
	public static extern char8[] QDataWidgetMapper_Tr(char8[] s);
	[LinkName("QDataWidgetMapper_SetModel")]
	public static extern void QDataWidgetMapper_SetModel(void* c_this, QAbstractItemModel model);
	[LinkName("QDataWidgetMapper_Model")]
	public static extern QAbstractItemModel QDataWidgetMapper_Model(void* c_this);
	[LinkName("QDataWidgetMapper_SetItemDelegate")]
	public static extern void QDataWidgetMapper_SetItemDelegate(void* c_this, QAbstractItemDelegate _delegate);
	[LinkName("QDataWidgetMapper_ItemDelegate")]
	public static extern QAbstractItemDelegate QDataWidgetMapper_ItemDelegate(void* c_this);
	[LinkName("QDataWidgetMapper_SetRootIndex")]
	public static extern void QDataWidgetMapper_SetRootIndex(void* c_this, QModelIndex index);
	[LinkName("QDataWidgetMapper_RootIndex")]
	public static extern QModelIndex QDataWidgetMapper_RootIndex(void* c_this);
	...
	public static extern void QDataWidgetMapper_AddMapping(void* c_this, QWidget widget, int32 section);
	[LinkName("QDataWidgetMapper_AddMapping2")]
	public static extern void QDataWidgetMapper_AddMapping2(void* c_this, QWidget widget, int32 section, uint8[] propertyName);
	[LinkName("QDataWidgetMapper_RemoveMapping")]
	public static extern void QDataWidgetMapper_RemoveMapping(void* c_this, QWidget widget);
	[LinkName("QDataWidgetMapper_MappedSection")]
	public static extern int32 QDataWidgetMapper_MappedSection(void* c_this, QWidget widget);
	[LinkName("QDataWidgetMapper_MappedPropertyName")]
	public static extern uint8[] QDataWidgetMapper_MappedPropertyName(void* c_this, QWidget widget);
	[LinkName("QDataWidgetMapper_MappedWidgetAt")]
	public static extern QWidget QDataWidgetMapper_MappedWidgetAt(void* c_this, int32 section);
	...
	public static extern void QDataWidgetMapper_SetCurrentModelIndex(void* c_this, QModelIndex index);
	[LinkName("QDataWidgetMapper_CurrentIndexChanged")]
	public static extern void QDataWidgetMapper_CurrentIndexChanged(void* c_this, int32 index);
	[LinkName("QDataWidgetMapper_Tr2")]
	public static extern char8[] QDataWidgetMapper_Tr2(char8[] s, char8[] c);
	[LinkName("QDataWidgetMapper_Tr3")]
	public static extern char8[] QDataWidgetMapper_Tr3(char8[] s, char8[] c, int32 n);
}