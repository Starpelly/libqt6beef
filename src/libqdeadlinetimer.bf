...
public struct QDeadlineTimer
{
	...
	public static extern void* QDeadlineTimer_new(QDeadlineTimer other);
	[LinkName("QDeadlineTimer_new2")]
	public static extern void* QDeadlineTimer_new2(QDeadlineTimer other);
	...
	public static extern void* QDeadlineTimer_new6(QDeadlineTimer param1);
	...
	public static extern void QDeadlineTimer_Swap(void* c_this, QDeadlineTimer other);
	...
	public static extern QDeadlineTimer QDeadlineTimer_OperatorPlusAssign(void* c_this, int64 msecs);
	[LinkName("QDeadlineTimer_OperatorMinusAssign")]
	public static extern QDeadlineTimer QDeadlineTimer_OperatorMinusAssign(void* c_this, int64 msecs);
	[LinkName("QDeadlineTimer_OperatorAssign")]
	public static extern void QDeadlineTimer_OperatorAssign(void* c_this, QDeadlineTimer param1);
