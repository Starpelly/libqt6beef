...
public struct QPaintDevice
{
	...
	public static extern QPaintEngine QPaintDevice_PaintEngine(void* c_this);
	...
	public static extern void QPaintDevice_InitPainter(void* c_this, QPainter painter);
	[LinkName("QPaintDevice_Redirected")]
	public static extern QPaintDevice QPaintDevice_Redirected(void* c_this, QPoint offset);
	[LinkName("QPaintDevice_SharedPainter")]
	public static extern QPainter QPaintDevice_SharedPainter(void* c_this);
}