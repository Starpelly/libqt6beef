...
public struct QGestureRecognizer
{
	...
	public static extern QGesture QGestureRecognizer_Create(void* c_this, QObject target);
	[LinkName("QGestureRecognizer_Recognize")]
	public static extern int64 QGestureRecognizer_Recognize(void* c_this, QGesture state, QObject watched, QEvent event);
	[LinkName("QGestureRecognizer_Reset")]
	public static extern void QGestureRecognizer_Reset(void* c_this, QGesture state);
	...
	public static extern void QGestureRecognizer_OperatorAssign(void* c_this, QGestureRecognizer param1);
}