...
public struct QStyle
{
	[LinkName("QStyle_new")]
	public static extern void* QStyle_new();
	[LinkName("QStyle_MetaObject")]
	public static extern QMetaObject QStyle_MetaObject(void* c_this);
	...
	[LinkName("QStyle_Tr")]
	public static extern char8[] QStyle_Tr(char8[] s);
	[LinkName("QStyle_Name")]
	public static extern char8[] QStyle_Name(void* c_this);
	[LinkName("QStyle_Polish")]
	public static extern void QStyle_Polish(void* c_this, QWidget widget);
	[LinkName("QStyle_Unpolish")]
	public static extern void QStyle_Unpolish(void* c_this, QWidget widget);
	[LinkName("QStyle_PolishWithApplication")]
	public static extern void QStyle_PolishWithApplication(void* c_this, QApplication application);
	[LinkName("QStyle_UnpolishWithApplication")]
	public static extern void QStyle_UnpolishWithApplication(void* c_this, QApplication application);
	[LinkName("QStyle_PolishWithPalette")]
	public static extern void QStyle_PolishWithPalette(void* c_this, QPalette palette);
	[LinkName("QStyle_ItemTextRect")]
	public static extern QRect QStyle_ItemTextRect(void* c_this, QFontMetrics fm, QRect r, int32 flags, bool enabled, char8[] text);
	[LinkName("QStyle_ItemPixmapRect")]
	public static extern QRect QStyle_ItemPixmapRect(void* c_this, QRect r, int32 flags, QPixmap pixmap);
	[LinkName("QStyle_DrawItemText")]
	public static extern void QStyle_DrawItemText(void* c_this, QPainter painter, QRect rect, int32 flags, QPalette pal, bool enabled, char8[] text, int64 textRole);
	[LinkName("QStyle_DrawItemPixmap")]
	public static extern void QStyle_DrawItemPixmap(void* c_this, QPainter painter, QRect rect, int32 alignment, QPixmap pixmap);
	[LinkName("QStyle_StandardPalette")]
	public static extern QPalette QStyle_StandardPalette(void* c_this);
	[LinkName("QStyle_DrawPrimitive")]
	public static extern void QStyle_DrawPrimitive(void* c_this, int64 pe, QStyleOption opt, QPainter p, QWidget w);
	[LinkName("QStyle_DrawControl")]
	public static extern void QStyle_DrawControl(void* c_this, int64 element, QStyleOption opt, QPainter p, QWidget w);
	[LinkName("QStyle_SubElementRect")]
	public static extern QRect QStyle_SubElementRect(void* c_this, int64 subElement, QStyleOption option, QWidget widget);
	[LinkName("QStyle_DrawComplexControl")]
	public static extern void QStyle_DrawComplexControl(void* c_this, int64 cc, QStyleOptionComplex opt, QPainter p, QWidget widget);
	[LinkName("QStyle_HitTestComplexControl")]
	public static extern int64 QStyle_HitTestComplexControl(void* c_this, int64 cc, QStyleOptionComplex opt, QPoint pt, QWidget widget);
	[LinkName("QStyle_SubControlRect")]
	public static extern QRect QStyle_SubControlRect(void* c_this, int64 cc, QStyleOptionComplex opt, int64 sc, QWidget widget);
	[LinkName("QStyle_PixelMetric")]
	public static extern int32 QStyle_PixelMetric(void* c_this, int64 metric, QStyleOption option, QWidget widget);
	[LinkName("QStyle_SizeFromContents")]
	public static extern QSize QStyle_SizeFromContents(void* c_this, int64 ct, QStyleOption opt, QSize contentsSize, QWidget w);
	[LinkName("QStyle_StyleHint")]
	public static extern int32 QStyle_StyleHint(void* c_this, int64 stylehint, QStyleOption opt, QWidget widget, QStyleHintReturn returnData);
	[LinkName("QStyle_StandardPixmap")]
	public static extern QPixmap QStyle_StandardPixmap(void* c_this, int64 standardPixmap, QStyleOption opt, QWidget widget);
	[LinkName("QStyle_StandardIcon")]
	public static extern QIcon QStyle_StandardIcon(void* c_this, int64 standardIcon, QStyleOption option, QWidget widget);
	[LinkName("QStyle_GeneratedIconPixmap")]
	public static extern QPixmap QStyle_GeneratedIconPixmap(void* c_this, int64 iconMode, QPixmap pixmap, QStyleOption opt);
	...
	public static extern int32 QStyle_LayoutSpacing(void* c_this, int64 control1, int64 control2, int64 orientation, QStyleOption option, QWidget widget);
	...
	public static extern QStyle QStyle_Proxy(void* c_this);
	[LinkName("QStyle_Tr2")]
	public static extern char8[] QStyle_Tr2(char8[] s, char8[] c);
	[LinkName("QStyle_Tr3")]
	public static extern char8[] QStyle_Tr3(char8[] s, char8[] c, int32 n);
	...
	public static extern int32 QStyle_CombinedLayoutSpacing4(void* c_this, int64 controls1, int64 controls2, int64 orientation, QStyleOption option);
	[LinkName("QStyle_CombinedLayoutSpacing5")]
	public static extern int32 QStyle_CombinedLayoutSpacing5(void* c_this, int64 controls1, int64 controls2, int64 orientation, QStyleOption option, QWidget widget);
}