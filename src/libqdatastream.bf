...
public struct QDataStream
{
	[LinkName("QDataStream_new")]
	public static extern void* QDataStream_new();
	[LinkName("QDataStream_new2")]
	public static extern void* QDataStream_new2(QIODevice param1);
	[LinkName("QDataStream_new3")]
	public static extern void* QDataStream_new3(uint8[] param1);
	[LinkName("QDataStream_Device")]
	public static extern QIODevice QDataStream_Device(void* c_this);
	[LinkName("QDataStream_SetDevice")]
	public static extern void QDataStream_SetDevice(void* c_this, QIODevice device);
	...
	public static extern QDataStream QDataStream_ReadBytes(void* c_this, char8[] param1, uint32 lenVal);
