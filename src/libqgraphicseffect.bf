...
public struct QGraphicsEffect
{
	[LinkName("QGraphicsEffect_new")]
	public static extern void* QGraphicsEffect_new();
	[LinkName("QGraphicsEffect_new2")]
	public static extern void* QGraphicsEffect_new2(QObject parent);
	[LinkName("QGraphicsEffect_MetaObject")]
	public static extern QMetaObject QGraphicsEffect_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsEffect_Tr(char8[] s);
	[LinkName("QGraphicsEffect_BoundingRectFor")]
	public static extern QRectF QGraphicsEffect_BoundingRectFor(void* c_this, QRectF sourceRect);
	[LinkName("QGraphicsEffect_BoundingRect")]
	public static extern QRectF QGraphicsEffect_BoundingRect(void* c_this);
	...
	public static extern void QGraphicsEffect_EnabledChanged(void* c_this, bool enabled);
	[LinkName("QGraphicsEffect_Draw")]
	public static extern void QGraphicsEffect_Draw(void* c_this, QPainter painter);
	...
	public static extern QRectF QGraphicsEffect_SourceBoundingRect(void* c_this);
	[LinkName("QGraphicsEffect_DrawSource")]
	public static extern void QGraphicsEffect_DrawSource(void* c_this, QPainter painter);
	[LinkName("QGraphicsEffect_SourcePixmap")]
	public static extern QPixmap QGraphicsEffect_SourcePixmap(void* c_this);
	[LinkName("QGraphicsEffect_Tr2")]
	public static extern char8[] QGraphicsEffect_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsEffect_Tr3")]
	public static extern char8[] QGraphicsEffect_Tr3(char8[] s, char8[] c, int32 n);
	[LinkName("QGraphicsEffect_SourceBoundingRect1")]
	public static extern QRectF QGraphicsEffect_SourceBoundingRect1(void* c_this, int64 system);
	[LinkName("QGraphicsEffect_SourcePixmap1")]
	public static extern QPixmap QGraphicsEffect_SourcePixmap1(void* c_this, int64 system);
	[LinkName("QGraphicsEffect_SourcePixmap2")]
	public static extern QPixmap QGraphicsEffect_SourcePixmap2(void* c_this, int64 system, QPoint offset);
	[LinkName("QGraphicsEffect_SourcePixmap3")]
	public static extern QPixmap QGraphicsEffect_SourcePixmap3(void* c_this, int64 system, QPoint offset, int64 mode);
}
public struct QGraphicsColorizeEffect
{
	...
	public static extern void* QGraphicsColorizeEffect_new2(QObject parent);
	[LinkName("QGraphicsColorizeEffect_MetaObject")]
	public static extern QMetaObject QGraphicsColorizeEffect_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsColorizeEffect_Tr(char8[] s);
	[LinkName("QGraphicsColorizeEffect_Color")]
	public static extern QColor QGraphicsColorizeEffect_Color(void* c_this);
	...
	public static extern void QGraphicsColorizeEffect_SetColor(void* c_this, QColor c);
	...
	public static extern void QGraphicsColorizeEffect_ColorChanged(void* c_this, QColor color);
	[LinkName("QGraphicsColorizeEffect_StrengthChanged")]
	public static extern void QGraphicsColorizeEffect_StrengthChanged(void* c_this, double strength);
	[LinkName("QGraphicsColorizeEffect_Draw")]
	public static extern void QGraphicsColorizeEffect_Draw(void* c_this, QPainter painter);
	[LinkName("QGraphicsColorizeEffect_Tr2")]
	public static extern char8[] QGraphicsColorizeEffect_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsColorizeEffect_Tr3")]
	public static extern char8[] QGraphicsColorizeEffect_Tr3(char8[] s, char8[] c, int32 n);
}
public struct QGraphicsBlurEffect
{
	[LinkName("QGraphicsBlurEffect_new")]
	public static extern void* QGraphicsBlurEffect_new();
	[LinkName("QGraphicsBlurEffect_new2")]
	public static extern void* QGraphicsBlurEffect_new2(QObject parent);
	[LinkName("QGraphicsBlurEffect_MetaObject")]
	public static extern QMetaObject QGraphicsBlurEffect_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsBlurEffect_Tr(char8[] s);
	[LinkName("QGraphicsBlurEffect_BoundingRectFor")]
	public static extern QRectF QGraphicsBlurEffect_BoundingRectFor(void* c_this, QRectF rect);
	...
	public static extern void QGraphicsBlurEffect_BlurRadiusChanged(void* c_this, double blurRadius);
	[LinkName("QGraphicsBlurEffect_BlurHintsChanged")]
	public static extern void QGraphicsBlurEffect_BlurHintsChanged(void* c_this, int64 hints);
	[LinkName("QGraphicsBlurEffect_Draw")]
	public static extern void QGraphicsBlurEffect_Draw(void* c_this, QPainter painter);
	[LinkName("QGraphicsBlurEffect_Tr2")]
	public static extern char8[] QGraphicsBlurEffect_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsBlurEffect_Tr3")]
	public static extern char8[] QGraphicsBlurEffect_Tr3(char8[] s, char8[] c, int32 n);
}
public struct QGraphicsDropShadowEffect
{
	...
	public static extern void* QGraphicsDropShadowEffect_new2(QObject parent);
	[LinkName("QGraphicsDropShadowEffect_MetaObject")]
	public static extern QMetaObject QGraphicsDropShadowEffect_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsDropShadowEffect_Tr(char8[] s);
	[LinkName("QGraphicsDropShadowEffect_BoundingRectFor")]
	public static extern QRectF QGraphicsDropShadowEffect_BoundingRectFor(void* c_this, QRectF rect);
	[LinkName("QGraphicsDropShadowEffect_Offset")]
	public static extern QPointF QGraphicsDropShadowEffect_Offset(void* c_this);
	...
	public static extern QColor QGraphicsDropShadowEffect_Color(void* c_this);
	[LinkName("QGraphicsDropShadowEffect_SetOffset")]
	public static extern void QGraphicsDropShadowEffect_SetOffset(void* c_this, QPointF ofs);
	...
	public static extern void QGraphicsDropShadowEffect_SetColor(void* c_this, QColor color);
	[LinkName("QGraphicsDropShadowEffect_OffsetChanged")]
	public static extern void QGraphicsDropShadowEffect_OffsetChanged(void* c_this, QPointF offset);
	[LinkName("QGraphicsDropShadowEffect_BlurRadiusChanged")]
	public static extern void QGraphicsDropShadowEffect_BlurRadiusChanged(void* c_this, double blurRadius);
	[LinkName("QGraphicsDropShadowEffect_ColorChanged")]
	public static extern void QGraphicsDropShadowEffect_ColorChanged(void* c_this, QColor color);
	[LinkName("QGraphicsDropShadowEffect_Draw")]
	public static extern void QGraphicsDropShadowEffect_Draw(void* c_this, QPainter painter);
	[LinkName("QGraphicsDropShadowEffect_Tr2")]
	public static extern char8[] QGraphicsDropShadowEffect_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsDropShadowEffect_Tr3")]
	public static extern char8[] QGraphicsDropShadowEffect_Tr3(char8[] s, char8[] c, int32 n);
}
public struct QGraphicsOpacityEffect
{
	...
	public static extern void* QGraphicsOpacityEffect_new2(QObject parent);
	[LinkName("QGraphicsOpacityEffect_MetaObject")]
	public static extern QMetaObject QGraphicsOpacityEffect_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsOpacityEffect_Tr(char8[] s);
	...
	public static extern QBrush QGraphicsOpacityEffect_OpacityMask(void* c_this);
	...
	public static extern void QGraphicsOpacityEffect_SetOpacityMask(void* c_this, QBrush mask);
	[LinkName("QGraphicsOpacityEffect_OpacityChanged")]
	public static extern void QGraphicsOpacityEffect_OpacityChanged(void* c_this, double opacity);
	[LinkName("QGraphicsOpacityEffect_OpacityMaskChanged")]
	public static extern void QGraphicsOpacityEffect_OpacityMaskChanged(void* c_this, QBrush mask);
	[LinkName("QGraphicsOpacityEffect_Draw")]
	public static extern void QGraphicsOpacityEffect_Draw(void* c_this, QPainter painter);
	[LinkName("QGraphicsOpacityEffect_Tr2")]
	public static extern char8[] QGraphicsOpacityEffect_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsOpacityEffect_Tr3")]
	public static extern char8[] QGraphicsOpacityEffect_Tr3(char8[] s, char8[] c, int32 n);
}