#pragma once
#ifndef SRC_MULTIMEDIAC_LIBQMEDIACONTENT_H
#define SRC_MULTIMEDIAC_LIBQMEDIACONTENT_H
...
QMediaContent* QMediaContent_new5(libqt_list /* of QMediaResource* */ resources);
...
libqt_list /* of QMediaResource* */ QMediaContent_Resources(const QMediaContent* self);
