...
public struct QKeySequence
{
	...
	public static extern void* QKeySequence_new2(char8[] key);
	[LinkName("QKeySequence_new3")]
	public static extern void* QKeySequence_new3(int32 k1);
	[LinkName("QKeySequence_new4")]
	public static extern void* QKeySequence_new4(QKeyCombination k1);
	[LinkName("QKeySequence_new5")]
	public static extern void* QKeySequence_new5(QKeySequence ks);
	[LinkName("QKeySequence_new6")]
	public static extern void* QKeySequence_new6(int64 key);
	[LinkName("QKeySequence_new7")]
	public static extern void* QKeySequence_new7(char8[] key, int64 format);
	...
	public static extern void* QKeySequence_new11(QKeyCombination k1, QKeyCombination k2);
	[LinkName("QKeySequence_new12")]
	public static extern void* QKeySequence_new12(QKeyCombination k1, QKeyCombination k2, QKeyCombination k3);
	[LinkName("QKeySequence_new13")]
	public static extern void* QKeySequence_new13(QKeyCombination k1, QKeyCombination k2, QKeyCombination k3, QKeyCombination k4);
	...
	public static extern char8[] QKeySequence_ToString(void* c_this);
	[LinkName("QKeySequence_FromString")]
	public static extern QKeySequence QKeySequence_FromString(char8[] str);
	[LinkName("QKeySequence_ListFromString")]
	public static extern QKeySequence[] QKeySequence_ListFromString(char8[] str);
	[LinkName("QKeySequence_ListToString")]
	public static extern char8[] QKeySequence_ListToString(QKeySequence[] list);
	[LinkName("QKeySequence_Matches")]
	public static extern int64 QKeySequence_Matches(void* c_this, QKeySequence seq);
	[LinkName("QKeySequence_Mnemonic")]
	public static extern QKeySequence QKeySequence_Mnemonic(char8[] text);
	...
	public static extern QVariant QKeySequence_ToQVariant(void* c_this);
	[LinkName("QKeySequence_OperatorSubscript")]
	public static extern QKeyCombination QKeySequence_OperatorSubscript(void* c_this, uint32 i);
	[LinkName("QKeySequence_OperatorAssign")]
	public static extern void QKeySequence_OperatorAssign(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_Swap")]
	public static extern void QKeySequence_Swap(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_OperatorEqual")]
	public static extern bool QKeySequence_OperatorEqual(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_OperatorNotEqual")]
	public static extern bool QKeySequence_OperatorNotEqual(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_OperatorLesser")]
	public static extern bool QKeySequence_OperatorLesser(void* c_this, QKeySequence ks);
	[LinkName("QKeySequence_OperatorGreater")]
	public static extern bool QKeySequence_OperatorGreater(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_OperatorLesserOrEqual")]
	public static extern bool QKeySequence_OperatorLesserOrEqual(void* c_this, QKeySequence other);
	[LinkName("QKeySequence_OperatorGreaterOrEqual")]
	public static extern bool QKeySequence_OperatorGreaterOrEqual(void* c_this, QKeySequence other);
	...
	public static extern char8[] QKeySequence_ToString1(void* c_this, int64 format);
	[LinkName("QKeySequence_FromString2")]
	public static extern QKeySequence QKeySequence_FromString2(char8[] str, int64 format);
	[LinkName("QKeySequence_ListFromString2")]
	public static extern QKeySequence[] QKeySequence_ListFromString2(char8[] str, int64 format);
	[LinkName("QKeySequence_ListToString2")]
	public static extern char8[] QKeySequence_ListToString2(QKeySequence[] list, int64 format);
}