...
public struct QGuiApplication
{
	...
	public static extern QMetaObject QGuiApplication_MetaObject(void* c_this);
	...
	public static extern char8[] QGuiApplication_Tr(char8[] s);
	[LinkName("QGuiApplication_SetApplicationDisplayName")]
	public static extern void QGuiApplication_SetApplicationDisplayName(char8[] name);
	[LinkName("QGuiApplication_ApplicationDisplayName")]
	public static extern char8[] QGuiApplication_ApplicationDisplayName();
	[LinkName("QGuiApplication_SetDesktopFileName")]
	public static extern void QGuiApplication_SetDesktopFileName(char8[] name);
	[LinkName("QGuiApplication_DesktopFileName")]
	public static extern char8[] QGuiApplication_DesktopFileName();
	...
	public static extern char8[] QGuiApplication_PlatformName();
	...
	public static extern bool QGuiApplication_Notify(void* c_this, QObject param1, QEvent param2);
	...
	public static extern char8[] QGuiApplication_SessionId(void* c_this);
	[LinkName("QGuiApplication_SessionKey")]
	public static extern char8[] QGuiApplication_SessionKey(void* c_this);
	...
	public static extern void QGuiApplication_FontDatabaseChanged(void* c_this);
	[LinkName("QGuiApplication_ScreenAdded")]
	public static extern void QGuiApplication_ScreenAdded(void* c_this, QScreen screen);
	[LinkName("QGuiApplication_ScreenRemoved")]
	public static extern void QGuiApplication_ScreenRemoved(void* c_this, QScreen screen);
	[LinkName("QGuiApplication_PrimaryScreenChanged")]
	public static extern void QGuiApplication_PrimaryScreenChanged(void* c_this, QScreen screen);
	[LinkName("QGuiApplication_LastWindowClosed")]
	public static extern void QGuiApplication_LastWindowClosed(void* c_this);
	[LinkName("QGuiApplication_FocusObjectChanged")]
	public static extern void QGuiApplication_FocusObjectChanged(void* c_this, QObject focusObject);
	[LinkName("QGuiApplication_FocusWindowChanged")]
	public static extern void QGuiApplication_FocusWindowChanged(void* c_this, QWindow focusWindow);
	[LinkName("QGuiApplication_ApplicationStateChanged")]
	public static extern void QGuiApplication_ApplicationStateChanged(void* c_this, int64 state);
	[LinkName("QGuiApplication_LayoutDirectionChanged")]
	public static extern void QGuiApplication_LayoutDirectionChanged(void* c_this, int64 direction);
	[LinkName("QGuiApplication_CommitDataRequest")]
	public static extern void QGuiApplication_CommitDataRequest(void* c_this, QSessionManager sessionManager);
	[LinkName("QGuiApplication_SaveStateRequest")]
	public static extern void QGuiApplication_SaveStateRequest(void* c_this, QSessionManager sessionManager);
	[LinkName("QGuiApplication_ApplicationDisplayNameChanged")]
	public static extern void QGuiApplication_ApplicationDisplayNameChanged(void* c_this);
	[LinkName("QGuiApplication_PaletteChanged")]
	public static extern void QGuiApplication_PaletteChanged(void* c_this, QPalette pal);
	[LinkName("QGuiApplication_FontChanged")]
	public static extern void QGuiApplication_FontChanged(void* c_this, QFont font);
	[LinkName("QGuiApplication_Event")]
	public static extern bool QGuiApplication_Event(void* c_this, QEvent param1);
	[LinkName("QGuiApplication_Tr2")]
	public static extern char8[] QGuiApplication_Tr2(char8[] s, char8[] c);
	[LinkName("QGuiApplication_Tr3")]
	public static extern char8[] QGuiApplication_Tr3(char8[] s, char8[] c, int32 n);
}