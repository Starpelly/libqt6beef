...
public struct QGraphicsAnchor
{
	[LinkName("QGraphicsAnchor_MetaObject")]
	public static extern QMetaObject QGraphicsAnchor_MetaObject(void* c_this);
	...
	public static extern char8[] QGraphicsAnchor_Tr(char8[] s);
	...
	public static extern char8[] QGraphicsAnchor_Tr2(char8[] s, char8[] c);
	[LinkName("QGraphicsAnchor_Tr3")]
	public static extern char8[] QGraphicsAnchor_Tr3(char8[] s, char8[] c, int32 n);
}
public struct QGraphicsAnchorLayout
{
	[LinkName("QGraphicsAnchorLayout_new")]
	public static extern void* QGraphicsAnchorLayout_new();
	[LinkName("QGraphicsAnchorLayout_new2")]
	public static extern void* QGraphicsAnchorLayout_new2(QGraphicsLayoutItem parent);
	[LinkName("QGraphicsAnchorLayout_AddAnchor")]
	public static extern QGraphicsAnchor QGraphicsAnchorLayout_AddAnchor(void* c_this, QGraphicsLayoutItem firstItem, int64 firstEdge, QGraphicsLayoutItem secondItem, int64 secondEdge);
	[LinkName("QGraphicsAnchorLayout_Anchor")]
	public static extern QGraphicsAnchor QGraphicsAnchorLayout_Anchor(void* c_this, QGraphicsLayoutItem firstItem, int64 firstEdge, QGraphicsLayoutItem secondItem, int64 secondEdge);
	[LinkName("QGraphicsAnchorLayout_AddCornerAnchors")]
	public static extern void QGraphicsAnchorLayout_AddCornerAnchors(void* c_this, QGraphicsLayoutItem firstItem, int64 firstCorner, QGraphicsLayoutItem secondItem, int64 secondCorner);
	[LinkName("QGraphicsAnchorLayout_AddAnchors")]
	public static extern void QGraphicsAnchorLayout_AddAnchors(void* c_this, QGraphicsLayoutItem firstItem, QGraphicsLayoutItem secondItem);
	...
	public static extern void QGraphicsAnchorLayout_SetGeometry(void* c_this, QRectF rect);
	...
	public static extern QGraphicsLayoutItem QGraphicsAnchorLayout_ItemAt(void* c_this, int32 index);
	...
	public static extern QSizeF QGraphicsAnchorLayout_SizeHint(void* c_this, int64 which, QSizeF constraint);
	[LinkName("QGraphicsAnchorLayout_AddAnchors3")]
	public static extern void QGraphicsAnchorLayout_AddAnchors3(void* c_this, QGraphicsLayoutItem firstItem, QGraphicsLayoutItem secondItem, int64 orientations);
}