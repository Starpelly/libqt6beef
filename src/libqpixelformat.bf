...
public struct QPixelFormat
{
	...
	public static extern void* QPixelFormat_new(QPixelFormat other);
	[LinkName("QPixelFormat_new2")]
	public static extern void* QPixelFormat_new2(QPixelFormat other);
	...
	public static extern void* QPixelFormat_new5(QPixelFormat param1);
