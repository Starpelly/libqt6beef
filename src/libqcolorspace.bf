...
public struct QColorSpace
{
	...
	public static extern void* QColorSpace_new6(QPointF whitePoint, QPointF redPoint, QPointF greenPoint, QPointF bluePoint, int64 transferFunction);
	[LinkName("QColorSpace_new7")]
	public static extern void* QColorSpace_new7(QPointF whitePoint, QPointF redPoint, QPointF greenPoint, QPointF bluePoint, uint16[] transferFunctionTable);
	[LinkName("QColorSpace_new8")]
	public static extern void* QColorSpace_new8(QPointF whitePoint, QPointF redPoint, QPointF greenPoint, QPointF bluePoint, uint16[] redTransferFunctionTable, uint16[] greenTransferFunctionTable, uint16[] blueTransferFunctionTable);
	[LinkName("QColorSpace_new9")]
	public static extern void* QColorSpace_new9(QColorSpace colorSpace);
	...
	public static extern void* QColorSpace_new11(QPointF whitePoint, QPointF redPoint, QPointF greenPoint, QPointF bluePoint, int64 transferFunction, float gamma);
	[LinkName("QColorSpace_OperatorAssign")]
	public static extern void QColorSpace_OperatorAssign(void* c_this, QColorSpace colorSpace);
	[LinkName("QColorSpace_Swap")]
	public static extern void QColorSpace_Swap(void* c_this, QColorSpace colorSpace);
	...
	public static extern char8[] QColorSpace_Description(void* c_this);
	[LinkName("QColorSpace_SetDescription")]
	public static extern void QColorSpace_SetDescription(void* c_this, char8[] description);
	...
	public static extern QColorSpace QColorSpace_WithTransferFunction(void* c_this, int64 transferFunction);
	[LinkName("QColorSpace_WithTransferFunctionWithTransferFunctionTable")]
	public static extern QColorSpace QColorSpace_WithTransferFunctionWithTransferFunctionTable(void* c_this, uint16[] transferFunctionTable);
	[LinkName("QColorSpace_WithTransferFunctions")]
	public static extern QColorSpace QColorSpace_WithTransferFunctions(void* c_this, uint16[] redTransferFunctionTable, uint16[] greenTransferFunctionTable, uint16[] blueTransferFunctionTable);
	...
	public static extern void QColorSpace_SetPrimaries2(void* c_this, QPointF whitePoint, QPointF redPoint, QPointF greenPoint, QPointF bluePoint);
	...
	public static extern QColorSpace QColorSpace_FromIccProfile(uint8[] iccProfile);
	[LinkName("QColorSpace_IccProfile")]
	public static extern uint8[] QColorSpace_IccProfile(void* c_this);
	[LinkName("QColorSpace_TransformationToColorSpace")]
	public static extern QColorTransform QColorSpace_TransformationToColorSpace(void* c_this, QColorSpace colorspace);
	[LinkName("QColorSpace_ToQVariant")]
	public static extern QVariant QColorSpace_ToQVariant(void* c_this);
	...
	public static extern QColorSpace QColorSpace_WithTransferFunction2(void* c_this, int64 transferFunction, float gamma);
}