...
public struct QLibraryInfo
{
	...
	public static extern void* QLibraryInfo_new(QLibraryInfo other);
	[LinkName("QLibraryInfo_new2")]
	public static extern void* QLibraryInfo_new2(QLibraryInfo other);
	...
	public static extern char8[] QLibraryInfo_Path(int64 p);
	[LinkName("QLibraryInfo_Location")]
	public static extern char8[] QLibraryInfo_Location(int64 location);
	[LinkName("QLibraryInfo_PlatformPluginArguments")]
	public static extern char8[][] QLibraryInfo_PlatformPluginArguments(char8[] platformName);
}