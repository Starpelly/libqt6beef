...
public struct QCursor
{
	...
	public static extern void* QCursor_new3(QBitmap bitmap, QBitmap mask);
	[LinkName("QCursor_new4")]
	public static extern void* QCursor_new4(QPixmap pixmap);
	[LinkName("QCursor_new5")]
	public static extern void* QCursor_new5(QCursor cursor);
	[LinkName("QCursor_new6")]
	public static extern void* QCursor_new6(QBitmap bitmap, QBitmap mask, int32 hotX);
	[LinkName("QCursor_new7")]
	public static extern void* QCursor_new7(QBitmap bitmap, QBitmap mask, int32 hotX, int32 hotY);
	[LinkName("QCursor_new8")]
	public static extern void* QCursor_new8(QPixmap pixmap, int32 hotX);
	[LinkName("QCursor_new9")]
	public static extern void* QCursor_new9(QPixmap pixmap, int32 hotX, int32 hotY);
	[LinkName("QCursor_OperatorAssign")]
	public static extern void QCursor_OperatorAssign(void* c_this, QCursor cursor);
	[LinkName("QCursor_Swap")]
	public static extern void QCursor_Swap(void* c_this, QCursor other);
	[LinkName("QCursor_ToQVariant")]
	public static extern QVariant QCursor_ToQVariant(void* c_this);
	...
	public static extern QBitmap QCursor_Bitmap(void* c_this, int64 param1);
	[LinkName("QCursor_Mask")]
	public static extern QBitmap QCursor_Mask(void* c_this, int64 param1);
	[LinkName("QCursor_Bitmap2")]
	public static extern QBitmap QCursor_Bitmap2(void* c_this);
	[LinkName("QCursor_Mask2")]
	public static extern QBitmap QCursor_Mask2(void* c_this);
	[LinkName("QCursor_Pixmap")]
	public static extern QPixmap QCursor_Pixmap(void* c_this);
	[LinkName("QCursor_HotSpot")]
	public static extern QPoint QCursor_HotSpot(void* c_this);
