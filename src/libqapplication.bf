...
public struct QApplication
{
	...
	public static extern QMetaObject QApplication_MetaObject(void* c_this);
	...
	public static extern char8[] QApplication_Tr(char8[] s);
	...
	public static extern QStyle QApplication_SetStyleWithStyle(char8[] style);
	...
	public static extern bool QApplication_Notify(void* c_this, QObject param1, QEvent param2);
	...
	public static extern void QApplication_FocusChanged(void* c_this, QWidget old, QWidget now);
	[LinkName("QApplication_StyleSheet")]
	public static extern char8[] QApplication_StyleSheet(void* c_this);
	[LinkName("QApplication_SetStyleSheet")]
	public static extern void QApplication_SetStyleSheet(void* c_this, char8[] sheet);
	...
	public static extern bool QApplication_Event(void* c_this, QEvent param1);
	[LinkName("QApplication_Tr2")]
	public static extern char8[] QApplication_Tr2(char8[] s, char8[] c);
	[LinkName("QApplication_Tr3")]
	public static extern char8[] QApplication_Tr3(char8[] s, char8[] c, int32 n);
