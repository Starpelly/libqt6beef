...
public struct QCryptographicHash
{
	...
	public static extern bool QCryptographicHash_AddDataWithDevice(void* c_this, QIODevice device);
	[LinkName("QCryptographicHash_Result")]
	public static extern uint8[] QCryptographicHash_Result(void* c_this);
	...
	public static extern uint8[] QCryptographicHash_Hash(char8[] data, int64 method);
