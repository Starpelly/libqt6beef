...
public struct QStringDecoder
{
	...
	public static extern QChar QStringDecoder_AppendToBuffer(void* c_this, QChar _out, char8[] ba);
	[LinkName("QStringDecoder_DecoderForHtml")]
	public static extern QStringDecoder QStringDecoder_DecoderForHtml(char8[] data);
}