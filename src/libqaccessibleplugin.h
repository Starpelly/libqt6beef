...
libqt_string QAccessiblePlugin_TrUtf8(const char* s);
...
libqt_string QAccessiblePlugin_TrUtf82(const char* s, const char* c);
libqt_string QAccessiblePlugin_TrUtf83(const char* s, const char* c, int n);
