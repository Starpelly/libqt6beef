...
libqt_string QStandardItemModel_TrUtf8(const char* s) {
...
libqt_string QStandardItemModel_TrUtf82(const char* s, const char* c) {
...
libqt_string QStandardItemModel_TrUtf83(const char* s, const char* c, int n) {
