...
public struct QPropertyAnimationPtr : IQPropertyAnimation, IDisposable, IQVariantAnimation
{
	...
	{
		return .(CQt.QPropertyAnimation_new());
	}
	...
	{
		return CQt.QPropertyAnimation_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QPropertyAnimation_SetTargetObject(this.nativePtr, (target == default || target.NativePtr == default) ? default : target.NativePtr);
	}
	...
	{
		return CQt.QPropertyAnimation_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void UpdateCurrentValue(IQVariant value)
	{
		CQt.QPropertyAnimation_UpdateCurrentValue(this.nativePtr, (value == default || value.NativePtr == default) ? default : value.NativePtr);
	}
	
	public void UpdateState(int64 newState, int64 oldState)
	{
		CQt.QPropertyAnimation_UpdateState(this.nativePtr, (int64)newState, (int64)oldState);
	}
...
{
	public QPropertyAnimationPtr handle;
	
	public static implicit operator QPropertyAnimationPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QPropertyAnimationPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QPropertyAnimationPtr.Tr(s);
	}
	
	public void* TargetObject()
	{
		return this.handle.TargetObject();
	}
	
	public void SetTargetObject(IQObject target)
	{
		this.handle.SetTargetObject(target);
	}
	...
	public void SetPropertyName(String propertyName)
	{
		this.handle.SetPropertyName(propertyName);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QPropertyAnimationPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QPropertyAnimationPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QPropertyAnimationPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QPropertyAnimationPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QPropertyAnimationPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QPropertyAnimationPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
