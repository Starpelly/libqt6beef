...
public interface IQCheckBox
{
	void* NativePtr { get; }
}
public struct QCheckBoxPtr : IQCheckBox, IDisposable, IQAbstractButton
{
	...
	{
		return .(CQt.QCheckBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QCheckBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QCheckBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QCheckBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QCheckBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QCheckBox_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QCheckBox_MinimumSizeHint(this.nativePtr);
	}
	
	public void SetTristate()
	{
		CQt.QCheckBox_SetTristate(this.nativePtr);
	}
	
	public bool IsTristate()
	{
		return CQt.QCheckBox_IsTristate(this.nativePtr);
	}
	
	public int64 CheckState()
	{
		return CQt.QCheckBox_CheckState(this.nativePtr);
	}
	
	public void SetCheckState(int64 state)
	{
		CQt.QCheckBox_SetCheckState(this.nativePtr, (int64)state);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QCheckBox_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public bool HitButton(IQPoint pos)
	{
		return CQt.QCheckBox_HitButton(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void CheckStateSet()
	{
		CQt.QCheckBox_CheckStateSet(this.nativePtr);
	}
	
	public void NextCheckState()
	{
		CQt.QCheckBox_NextCheckState(this.nativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QCheckBox_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QCheckBox_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionButton option)
	{
		CQt.QCheckBox_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	...
	{
		CQt.QCheckBox_SetTristate1(this.nativePtr, y);
	}
...
{
	public QCheckBoxPtr handle;
	
	public static implicit operator QCheckBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QCheckBoxPtr.New(parent);
	}
	...
	public void SetTristate()
	{
		this.handle.SetTristate();
	}
	
	public bool IsTristate()
	{
		return this.handle.IsTristate();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QCheckBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QCheckBoxPtr.Tr3(s, c, n);
	}
	
	public void SetTristate1(bool y)
	{
		this.handle.SetTristate1(y);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QCheckBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QCheckBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QCheckBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QCheckBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QCheckBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QCheckBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QCheckBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QCheckBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QCheckBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QCheckBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QCheckBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QCheckBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QCheckBox_new(void* parent);
	[LinkName("QCheckBox_new2")]
	public static extern void* QCheckBox_new2();
	[LinkName("QCheckBox_new3")]
	public static extern void* QCheckBox_new3(libqt_string text);
	[LinkName("QCheckBox_new4")]
	public static extern void* QCheckBox_new4(libqt_string text, void* parent);
	[LinkName("QCheckBox_MetaObject")]
	public static extern void* QCheckBox_MetaObject(void* c_this);
	...
	public static extern void QCheckBox_SizeHint(void* c_this);
	[LinkName("QCheckBox_MinimumSizeHint")]
	public static extern void QCheckBox_MinimumSizeHint(void* c_this);
	...
	public static extern void QCheckBox_Connect_StateChanged(void* c_this, c_intptr slot);
	[LinkName("QCheckBox_Event")]
	public static extern bool QCheckBox_Event(void* c_this, void* e);
	[LinkName("QCheckBox_HitButton")]
	public static extern bool QCheckBox_HitButton(void* c_this, void* pos);
	...
	public static extern void QCheckBox_PaintEvent(void* c_this, void* param1);
	[LinkName("QCheckBox_MouseMoveEvent")]
	public static extern void QCheckBox_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QCheckBox_InitStyleOption")]
	public static extern void QCheckBox_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QCheckBox_Delete(void* self);
}