...
public class QCheckBox : IQCheckBox, IQAbstractButton
{
	...
	{
		this.nativePtr = CQt.QCheckBox_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QCheckBox_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QCheckBox_SetCheckState(this.nativePtr, state);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QCheckBox_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual bool HitButton(IQPoint pos)
	{
		return CQt.QCheckBox_HitButton(this.nativePtr, (pos == default) ? default : (void*)pos.NativePtr);
	}
	...
	{
		CQt.QCheckBox_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QCheckBox_MouseMoveEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionButton option)
	{
		CQt.QCheckBox_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
