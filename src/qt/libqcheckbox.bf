...
public class QCheckBox
{
	...
	{
		this.nativePtr = CQt.QCheckBox_new(parent);
	}
	...
	{
		return CQt.QCheckBox_Event(this.nativePtr, e);
	}
	
	public virtual bool HitButton(void* pos)
	{
		return CQt.QCheckBox_HitButton(this.nativePtr, pos);
	}
	...
	{
		CQt.QCheckBox_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QCheckBox_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QCheckBox_InitStyleOption(this.nativePtr, option);
	}
