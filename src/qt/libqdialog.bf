...
public interface IQDialog
{
	void* NativePtr { get; }
}
public struct QDialogPtr : IQDialog, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QDialog_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QDialog_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QDialog_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QDialog_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QDialog_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QDialog_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void CloseEvent(IQCloseEvent param1)
	{
		CQt.QDialog_CloseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QDialog_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QDialog_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent param1)
	{
		CQt.QDialog_ContextMenuEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QDialog_EventFilter(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr, (param2 == default || param2.NativePtr == default) ? default : param2.NativePtr);
	}
	
	public void AdjustPosition(IQWidget param1)
	{
		CQt.QDialog_AdjustPosition(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
...
{
	public QDialogPtr handle;
	
	public static implicit operator QDialogPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QDialogPtr.New(parent);
	}
	...
	public void AdjustPosition(IQWidget param1)
	{
		this.handle.AdjustPosition(param1);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QDialogPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QDialogPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QDialogPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QDialogPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QDialogPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QDialogPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QDialogPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QDialogPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QDialogPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QDialogPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QDialogPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QDialogPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QDialogPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QDialog_new(void* parent);
	[LinkName("QDialog_new2")]
	public static extern void* QDialog_new2();
	[LinkName("QDialog_new3")]
	public static extern void* QDialog_new3(void* parent, int64 f);
	[LinkName("QDialog_MetaObject")]
	public static extern void* QDialog_MetaObject(void* c_this);
	...
	public static extern void QDialog_SizeHint(void* c_this);
	[LinkName("QDialog_MinimumSizeHint")]
	public static extern void QDialog_MinimumSizeHint(void* c_this);
	...
	public static extern void QDialog_Connect_Finished(void* c_this, c_intptr slot);
	[LinkName("QDialog_Connect_Accepted")]
	public static extern void QDialog_Connect_Accepted(void* c_this, c_intptr slot);
	[LinkName("QDialog_Connect_Rejected")]
	public static extern void QDialog_Connect_Rejected(void* c_this, c_intptr slot);
	...
	public static extern void QDialog_KeyPressEvent(void* c_this, void* param1);
	[LinkName("QDialog_CloseEvent")]
	public static extern void QDialog_CloseEvent(void* c_this, void* param1);
	[LinkName("QDialog_ShowEvent")]
	public static extern void QDialog_ShowEvent(void* c_this, void* param1);
	[LinkName("QDialog_ResizeEvent")]
	public static extern void QDialog_ResizeEvent(void* c_this, void* param1);
	[LinkName("QDialog_ContextMenuEvent")]
	public static extern void QDialog_ContextMenuEvent(void* c_this, void* param1);
	[LinkName("QDialog_EventFilter")]
	public static extern bool QDialog_EventFilter(void* c_this, void* param1, void* param2);
	[LinkName("QDialog_AdjustPosition")]
	public static extern void QDialog_AdjustPosition(void* c_this, void* param1);
	...
	public static extern void QDialog_Delete(void* self);
}