...
public class QDialog
{
	...
	{
		this.nativePtr = CQt.QDialog_new(parent);
	}
	...
	{
		CQt.QDialog_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void CloseEvent(void* param1)
	{
		CQt.QDialog_CloseEvent(this.nativePtr, param1);
	}
	
	public virtual void ShowEvent(void* param1)
	{
		CQt.QDialog_ShowEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QDialog_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void ContextMenuEvent(void* param1)
	{
		CQt.QDialog_ContextMenuEvent(this.nativePtr, param1);
	}
	
	public virtual bool EventFilter(void* param1, void* param2)
	{
		return CQt.QDialog_EventFilter(this.nativePtr, param1, param2);
	}
	
	public void AdjustPosition(void* param1)
	{
		CQt.QDialog_AdjustPosition(this.nativePtr, param1);
	}
