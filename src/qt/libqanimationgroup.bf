...
public struct QAnimationGroupPtr : IQAnimationGroup, IDisposable, IQAbstractAnimation
{
	...
	{
		return .(CQt.QAnimationGroup_new());
	}
	...
	{
		return CQt.QAnimationGroup_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QAnimationGroup_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
...
{
	public QAnimationGroupPtr handle;
	
	public static implicit operator QAnimationGroupPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QAnimationGroupPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAnimationGroupPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAnimationGroupPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAnimationGroupPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAnimationGroupPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAnimationGroupPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAnimationGroupPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAnimationGroupPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
