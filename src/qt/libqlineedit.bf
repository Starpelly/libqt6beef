...
public class QLineEdit
{
	...
	{
		this.nativePtr = CQt.QLineEdit_new(parent);
	}
	...
	{
		CQt.QLineEdit_SetPlaceholderText(this.nativePtr, placeholderText);
	}
	...
	public void SetValidator(void* validator)
	{
		CQt.QLineEdit_SetValidator(this.nativePtr, validator);
	}
	...
	public void SetCompleter(void* completer)
	{
		CQt.QLineEdit_SetCompleter(this.nativePtr, completer);
	}
	...
	public int32 CursorPositionAt(void* pos)
	{
		return CQt.QLineEdit_CursorPositionAt(this.nativePtr, pos);
	}
	...
	{
		CQt.QLineEdit_SetInputMask(this.nativePtr, inputMask);
	}
	...
	public void SetTextMarginsWithMargins(void* margins)
	{
		CQt.QLineEdit_SetTextMarginsWithMargins(this.nativePtr, margins);
	}
	...
	public void AddAction(void* action, int64 position)
	{
		CQt.QLineEdit_AddAction(this.nativePtr, action, position);
	}
	
	public void* AddAction2(void* icon, int64 position)
	{
		return CQt.QLineEdit_AddAction2(this.nativePtr, icon, position);
	}
	
	public void SetText(libqt_string text)
	{
		CQt.QLineEdit_SetText(this.nativePtr, text);
	}
	...
	{
		CQt.QLineEdit_Insert(this.nativePtr, param1);
	}
	...
	{
		CQt.QLineEdit_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QLineEdit_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QLineEdit_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseDoubleClickEvent(void* param1)
	{
		CQt.QLineEdit_MouseDoubleClickEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QLineEdit_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyReleaseEvent(void* param1)
	{
		CQt.QLineEdit_KeyReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusInEvent(void* param1)
	{
		CQt.QLineEdit_FocusInEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusOutEvent(void* param1)
	{
		CQt.QLineEdit_FocusOutEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QLineEdit_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void DragEnterEvent(void* param1)
	{
		CQt.QLineEdit_DragEnterEvent(this.nativePtr, param1);
	}
	
	public virtual void DragMoveEvent(void* e)
	{
		CQt.QLineEdit_DragMoveEvent(this.nativePtr, e);
	}
	
	public virtual void DragLeaveEvent(void* e)
	{
		CQt.QLineEdit_DragLeaveEvent(this.nativePtr, e);
	}
	
	public virtual void DropEvent(void* param1)
	{
		CQt.QLineEdit_DropEvent(this.nativePtr, param1);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QLineEdit_ChangeEvent(this.nativePtr, param1);
	}
	
	public virtual void ContextMenuEvent(void* param1)
	{
		CQt.QLineEdit_ContextMenuEvent(this.nativePtr, param1);
	}
	
	public virtual void InputMethodEvent(void* param1)
	{
		CQt.QLineEdit_InputMethodEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QLineEdit_InitStyleOption(this.nativePtr, option);
	}
	...
	public void InputMethodQuery2(int64 property, void argument)
	{
		CQt.QLineEdit_InputMethodQuery2(this.nativePtr, property, argument);
	}
	
	public virtual void TimerEvent(void* param1)
	{
		CQt.QLineEdit_TimerEvent(this.nativePtr, param1);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QLineEdit_Event(this.nativePtr, param1);
	}
