...
public struct QTableWidgetSelectionRangePtr : IQTableWidgetSelectionRange, IDisposable
{
	...
	public static Self New(IQTableWidgetSelectionRange other)
	{
		return .(CQt.QTableWidgetSelectionRange_new((other == default || other.NativePtr == default) ? default : other.NativePtr));
	}
...
{
	public QTableWidgetSelectionRangePtr handle;
	
	public static implicit operator QTableWidgetSelectionRangePtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QTableWidgetSelectionRangePtr.New(other);
	}
	...
	public int32 TopRow()
	{
		return this.handle.TopRow();
	}
	
	public int32 BottomRow()
	{
		return this.handle.BottomRow();
	}
	
	public int32 LeftColumn()
	{
		return this.handle.LeftColumn();
	}
	
	public int32 RightColumn()
	{
		return this.handle.RightColumn();
	}
...
public struct QTableWidgetItemPtr : IQTableWidgetItem, IDisposable
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		return .(CQt.QTableWidgetItem_new());
	}
	...
	{
		CQt.QTableWidgetItem_SetIcon(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	...
	{
		CQt.QTableWidgetItem_SetFont(this.nativePtr, (font == default || font.NativePtr == default) ? default : font.NativePtr);
	}
	...
	{
		CQt.QTableWidgetItem_SetTextAlignmentWithAlignment(this.nativePtr, (int64)alignment);
	}
	...
	{
		CQt.QTableWidgetItem_SetBackground(this.nativePtr, (brush == default || brush.NativePtr == default) ? default : brush.NativePtr);
	}
	...
	{
		CQt.QTableWidgetItem_SetForeground(this.nativePtr, (brush == default || brush.NativePtr == default) ? default : brush.NativePtr);
	}
	...
	{
		CQt.QTableWidgetItem_SetCheckState(this.nativePtr, (int64)state);
	}
	...
	{
		CQt.QTableWidgetItem_SetSizeHint(this.nativePtr, (size == default || size.NativePtr == default) ? default : size.NativePtr);
	}
	...
	{
		CQt.QTableWidgetItem_SetData(this.nativePtr, role, (value == default || value.NativePtr == default) ? default : value.NativePtr);
	}
	
	public bool OperatorLesser(IQTableWidgetItem other)
	{
		return CQt.QTableWidgetItem_OperatorLesser(this.nativePtr, (other == default || other.NativePtr == default) ? default : other.NativePtr);
	}
	
	public void Read(IQDataStream _in)
	{
		CQt.QTableWidgetItem_Read(this.nativePtr, (_in == default || _in.NativePtr == default) ? default : _in.NativePtr);
	}
	
	public void Write(IQDataStream _out)
	{
		CQt.QTableWidgetItem_Write(this.nativePtr, (_out == default || _out.NativePtr == default) ? default : _out.NativePtr);
	}
	
	public void OperatorAssign(IQTableWidgetItem other)
	{
		CQt.QTableWidgetItem_OperatorAssign(this.nativePtr, (other == default || other.NativePtr == default) ? default : other.NativePtr);
	}
...
{
	public QTableWidgetItemPtr handle;
	
	public static implicit operator QTableWidgetItemPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QTableWidgetItemPtr.New();
	}
	...
	public void* TableWidget()
	{
		return this.handle.TableWidget();
	}
...
public struct QTableWidgetPtr : IQTableWidget, IDisposable, IQTableView
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		return .(CQt.QTableWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QTableWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QTableWidget_Row(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public int32 Column(IQTableWidgetItem item)
	{
		return CQt.QTableWidget_Column(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetItem(this.nativePtr, row, column, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		return CQt.QTableWidget_Items(this.nativePtr, (data == default || data.NativePtr == default) ? default : data.NativePtr);
	}
	
	public void IndexFromItem(IQTableWidgetItem item)
	{
		CQt.QTableWidget_IndexFromItem(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public void* ItemFromIndex(IQModelIndex index)
	{
		return CQt.QTableWidget_ItemFromIndex(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetVerticalHeaderItem(this.nativePtr, row, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetHorizontalHeaderItem(this.nativePtr, column, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetCurrentItem(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public void SetCurrentItem2(IQTableWidgetItem item, int64 command)
	{
		CQt.QTableWidget_SetCurrentItem2(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr, command);
	}
	...
	{
		CQt.QTableWidget_EditItem(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public void OpenPersistentEditor(IQTableWidgetItem item)
	{
		CQt.QTableWidget_OpenPersistentEditor(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public void ClosePersistentEditor(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ClosePersistentEditor(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public bool IsPersistentEditorOpen(IQTableWidgetItem item)
	{
		return CQt.QTableWidget_IsPersistentEditorOpen(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetCellWidget(this.nativePtr, row, column, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetRangeSelected(this.nativePtr, (range == default || range.NativePtr == default) ? default : range.NativePtr, selectVal);
	}
	...
	{
		return CQt.QTableWidget_ItemAt(this.nativePtr, (p == default || p.NativePtr == default) ? default : p.NativePtr);
	}
	...
	{
		CQt.QTableWidget_VisualItemRect(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SetItemPrototype(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	
	public void ScrollToItem(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ScrollToItem(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr);
	}
	...
	{
		return CQt.QTableWidget_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	...
	public void* MimeData(IQTableWidgetItem[] items)
	{
		return CQt.QTableWidget_MimeData(this.nativePtr, null);
	}
	
	public bool DropMimeData(int32 row, int32 column, IQMimeData data, int64 action)
	{
		return CQt.QTableWidget_DropMimeData(this.nativePtr, row, column, (data == default || data.NativePtr == default) ? default : data.NativePtr, (int64)action);
	}
	...
	{
		CQt.QTableWidget_DropEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	{
		CQt.QTableWidget_SortItems2(this.nativePtr, column, (int64)order);
	}
	
	public void ScrollToItem2(IQTableWidgetItem item, int64 hint)
	{
		CQt.QTableWidget_ScrollToItem2(this.nativePtr, (item == default || item.NativePtr == default) ? default : item.NativePtr, (int64)hint);
	}
...
{
	public QTableWidgetPtr handle;
	
	public static implicit operator QTableWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QTableWidgetPtr.New(parent);
	}
	...
	public int32 Column(IQTableWidgetItem item)
	{
		return this.handle.Column(item);
	}
	
	public void* Item(int32 row, int32 column)
	{
		return this.handle.Item(row, column);
	}
	...
	public void* TakeItem(int32 row, int32 column)
	{
		return this.handle.TakeItem(row, column);
	}
	...
	public void SetCurrentCell(int32 row, int32 column)
	{
		this.handle.SetCurrentCell(row, column);
	}
	
	public void SetCurrentCell2(int32 row, int32 column, int64 command)
	{
		this.handle.SetCurrentCell2(row, column, command);
	}
	
	public void SortItems(int32 column)
	{
		this.handle.SortItems(column);
	}
	...
	public void* CellWidget(int32 row, int32 column)
	{
		return this.handle.CellWidget(row, column);
	}
	
	public void SetCellWidget(int32 row, int32 column, IQWidget widget)
	{
		this.handle.SetCellWidget(row, column, widget);
	}
	
	public void RemoveCellWidget(int32 row, int32 column)
	{
		this.handle.RemoveCellWidget(row, column);
	}
	
	public void SetRangeSelected(IQTableWidgetSelectionRange range, bool selectVal)
	{
		this.handle.SetRangeSelected(range, selectVal);
	}
	
	public void[] SelectedRanges()
	{
		return this.handle.SelectedRanges();
	}
	...
	public int32 VisualRow(int32 logicalRow)
	{
		return this.handle.VisualRow(logicalRow);
	}
	
	public int32 VisualColumn(int32 logicalColumn)
	{
		return this.handle.VisualColumn(logicalColumn);
	}
	...
	public void InsertRow(int32 row)
	{
		this.handle.InsertRow(row);
	}
	
	public void InsertColumn(int32 column)
	{
		this.handle.InsertColumn(column);
	}
	...
	{
		return this.handle.DropMimeData(row, column, data, action);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QTableWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QTableWidgetPtr.Tr3(s, c, n);
	}
	
	public void SortItems2(int32 column, int64 order)
	{
		this.handle.SortItems2(column, order);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QTableWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QTableWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QTableWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QTableWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QTableWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QTableWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QTableWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QTableWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QTableWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QTableWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QTableWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QTableWidgetPtr.DevicePixelRatioFScale();
	}
