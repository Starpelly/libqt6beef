...
public interface IQToolButton
{
	void* NativePtr { get; }
}
public struct QToolButtonPtr : IQToolButton, IDisposable, IQAbstractButton
{
	...
	{
		return .(CQt.QToolButton_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QToolButton_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QToolButton_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QToolButton_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QToolButton_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QToolButton_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QToolButton_MinimumSizeHint(this.nativePtr);
	}
	
	public int64 ToolButtonStyle()
	{
		return CQt.QToolButton_ToolButtonStyle(this.nativePtr);
	}
	
	public int64 ArrowType()
	{
		return CQt.QToolButton_ArrowType(this.nativePtr);
	}
	
	public void SetArrowType(int64 typeVal)
	{
		CQt.QToolButton_SetArrowType(this.nativePtr, (int64)typeVal);
	}
	
	public void SetMenu(IQMenu menu)
	{
		CQt.QToolButton_SetMenu(this.nativePtr, (menu == default || menu.NativePtr == default) ? default : menu.NativePtr);
	}
	
	public void* Menu()
	{
		return CQt.QToolButton_Menu(this.nativePtr);
	}
	
	public void SetPopupMode(int64 mode)
	{
		CQt.QToolButton_SetPopupMode(this.nativePtr, (int64)mode);
	}
	
	public int64 PopupMode()
	{
		return CQt.QToolButton_PopupMode(this.nativePtr);
	}
	
	public void* DefaultAction()
	{
		return CQt.QToolButton_DefaultAction(this.nativePtr);
	}
	
	public void SetAutoRaise(bool enable)
	{
		CQt.QToolButton_SetAutoRaise(this.nativePtr, enable);
	}
	
	public bool AutoRaise()
	{
		return CQt.QToolButton_AutoRaise(this.nativePtr);
	}
	
	public void ShowMenu()
	{
		CQt.QToolButton_ShowMenu(this.nativePtr);
	}
	
	public void SetToolButtonStyle(int64 style)
	{
		CQt.QToolButton_SetToolButtonStyle(this.nativePtr, (int64)style);
	}
	
	public void SetDefaultAction(IQAction defaultAction)
	{
		CQt.QToolButton_SetDefaultAction(this.nativePtr, (defaultAction == default || defaultAction.NativePtr == default) ? default : defaultAction.NativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QToolButton_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QToolButton_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QToolButton_MouseReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QToolButton_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ActionEvent(IQActionEvent param1)
	{
		CQt.QToolButton_ActionEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void EnterEvent(IQEnterEvent param1)
	{
		CQt.QToolButton_EnterEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void LeaveEvent(IQEvent param1)
	{
		CQt.QToolButton_LeaveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QToolButton_TimerEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QToolButton_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool HitButton(IQPoint pos)
	{
		return CQt.QToolButton_HitButton(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void CheckStateSet()
	{
		CQt.QToolButton_CheckStateSet(this.nativePtr);
	}
	
	public void NextCheckState()
	{
		CQt.QToolButton_NextCheckState(this.nativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionToolButton option)
	{
		CQt.QToolButton_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	...
	{
		CQt.QAbstractButton_SetText(this.nativePtr, libqt_string(text));
	}
	
	public libqt_string Text()
	{
		return CQt.QAbstractButton_Text(this.nativePtr);
	}
	
	public void SetIcon(IQIcon icon)
	{
		CQt.QAbstractButton_SetIcon(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	
	public void Icon()
	{
		CQt.QAbstractButton_Icon(this.nativePtr);
	}
	
	public void IconSize()
	{
		CQt.QAbstractButton_IconSize(this.nativePtr);
	}
	
	public void SetShortcut(IQKeySequence key)
	{
		CQt.QAbstractButton_SetShortcut(this.nativePtr, (key == default || key.NativePtr == default) ? default : key.NativePtr);
	}
	
	public void Shortcut()
	{
		CQt.QAbstractButton_Shortcut(this.nativePtr);
	}
	
	public void SetCheckable(bool checkable)
	{
		CQt.QAbstractButton_SetCheckable(this.nativePtr, checkable);
	}
	
	public bool IsCheckable()
	{
		return CQt.QAbstractButton_IsCheckable(this.nativePtr);
	}
	
	public bool IsChecked()
	{
		return CQt.QAbstractButton_IsChecked(this.nativePtr);
	}
	
	public void SetDown(bool down)
	{
		CQt.QAbstractButton_SetDown(this.nativePtr, down);
	}
	
	public bool IsDown()
	{
		return CQt.QAbstractButton_IsDown(this.nativePtr);
	}
	
	public void SetAutoRepeat(bool autoRepeat)
	{
		CQt.QAbstractButton_SetAutoRepeat(this.nativePtr, autoRepeat);
	}
	
	public bool AutoRepeat()
	{
		return CQt.QAbstractButton_AutoRepeat(this.nativePtr);
	}
	
	public void SetAutoRepeatDelay(int32 autoRepeatDelay)
	{
		CQt.QAbstractButton_SetAutoRepeatDelay(this.nativePtr, autoRepeatDelay);
	}
	
	public int32 AutoRepeatDelay()
	{
		return CQt.QAbstractButton_AutoRepeatDelay(this.nativePtr);
	}
	
	public void SetAutoRepeatInterval(int32 autoRepeatInterval)
	{
		CQt.QAbstractButton_SetAutoRepeatInterval(this.nativePtr, autoRepeatInterval);
	}
	
	public int32 AutoRepeatInterval()
	{
		return CQt.QAbstractButton_AutoRepeatInterval(this.nativePtr);
	}
	
	public void SetAutoExclusive(bool autoExclusive)
	{
		CQt.QAbstractButton_SetAutoExclusive(this.nativePtr, autoExclusive);
	}
	
	public bool AutoExclusive()
	{
		return CQt.QAbstractButton_AutoExclusive(this.nativePtr);
	}
	
	public void* Group()
	{
		return CQt.QAbstractButton_Group(this.nativePtr);
	}
	
	public void SetIconSize(IQSize size)
	{
		CQt.QAbstractButton_SetIconSize(this.nativePtr, (size == default || size.NativePtr == default) ? default : size.NativePtr);
	}
	
	public void AnimateClick()
	{
		CQt.QAbstractButton_AnimateClick(this.nativePtr);
	}
	
	public void Click()
	{
		CQt.QAbstractButton_Click(this.nativePtr);
	}
	
	public void Toggle()
	{
		CQt.QAbstractButton_Toggle(this.nativePtr);
	}
	
	public void SetChecked(bool _checked)
	{
		CQt.QAbstractButton_SetChecked(this.nativePtr, _checked);
	}
...
{
	public QToolButtonPtr handle;
	
	public static implicit operator QToolButtonPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QToolButtonPtr.New(parent);
	}
	...
	public int64 ArrowType()
	{
		return this.handle.ArrowType();
	}
	
	public void SetArrowType(int64 typeVal)
	{
		this.handle.SetArrowType(typeVal);
	}
	
	public void SetMenu(IQMenu menu)
	{
		this.handle.SetMenu(menu);
	}
	...
	public void SetPopupMode(int64 mode)
	{
		this.handle.SetPopupMode(mode);
	}
	
	public int64 PopupMode()
	{
		return this.handle.PopupMode();
	}
	...
	public void SetAutoRaise(bool enable)
	{
		this.handle.SetAutoRaise(enable);
	}
	
	public bool AutoRaise()
	{
		return this.handle.AutoRaise();
	}
	
	public void ShowMenu()
	{
		this.handle.ShowMenu();
	}
	
	public void SetToolButtonStyle(int64 style)
	{
		this.handle.SetToolButtonStyle(style);
	}
	...
	public virtual bool HitButton(IQPoint pos)
	{
		return this.handle.HitButton(pos);
	}
	
	public virtual void CheckStateSet()
	{
		this.handle.CheckStateSet();
	}
	
	public virtual void NextCheckState()
	{
		this.handle.NextCheckState();
	}
	
	public virtual void InitStyleOption(IQStyleOptionToolButton option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QToolButtonPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QToolButtonPtr.Tr3(s, c, n);
	}
	...
	public void SetDown(bool down)
	{
		this.handle.SetDown(down);
	}
	
	public bool IsDown()
	{
		return this.handle.IsDown();
	}
	...
	public void SetAutoRepeatDelay(int32 autoRepeatDelay)
	{
		this.handle.SetAutoRepeatDelay(autoRepeatDelay);
	}
	
	public int32 AutoRepeatDelay()
	{
		return this.handle.AutoRepeatDelay();
	}
	
	public void SetAutoRepeatInterval(int32 autoRepeatInterval)
	{
		this.handle.SetAutoRepeatInterval(autoRepeatInterval);
	}
	
	public int32 AutoRepeatInterval()
	{
		return this.handle.AutoRepeatInterval();
	}
	
	public void SetAutoExclusive(bool autoExclusive)
	{
		this.handle.SetAutoExclusive(autoExclusive);
	}
	
	public bool AutoExclusive()
	{
		return this.handle.AutoExclusive();
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QToolButtonPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QToolButtonPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QToolButtonPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QToolButtonPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QToolButtonPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QToolButtonPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QToolButtonPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QToolButtonPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QToolButtonPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QToolButtonPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QToolButtonPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QToolButtonPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QToolButton_new(void* parent);
	[LinkName("QToolButton_new2")]
	public static extern void* QToolButton_new2();
	[LinkName("QToolButton_MetaObject")]
	public static extern void* QToolButton_MetaObject(void* c_this);
	...
	public static extern void QToolButton_SizeHint(void* c_this);
	[LinkName("QToolButton_MinimumSizeHint")]
	public static extern void QToolButton_MinimumSizeHint(void* c_this);
	...
	public static extern void QToolButton_SetMenu(void* c_this, void* menu);
	[LinkName("QToolButton_Menu")]
	public static extern void* QToolButton_Menu(void* c_this);
	...
	public static extern void* QToolButton_DefaultAction(void* c_this);
	...
	public static extern void QToolButton_SetDefaultAction(void* c_this, void* defaultAction);
	[LinkName("QToolButton_Connect_Triggered")]
	public static extern void QToolButton_Connect_Triggered(void* c_this, c_intptr slot);
	[LinkName("QToolButton_Event")]
	public static extern bool QToolButton_Event(void* c_this, void* e);
	[LinkName("QToolButton_MousePressEvent")]
	public static extern void QToolButton_MousePressEvent(void* c_this, void* param1);
	[LinkName("QToolButton_MouseReleaseEvent")]
	public static extern void QToolButton_MouseReleaseEvent(void* c_this, void* param1);
	[LinkName("QToolButton_PaintEvent")]
	public static extern void QToolButton_PaintEvent(void* c_this, void* param1);
	[LinkName("QToolButton_ActionEvent")]
	public static extern void QToolButton_ActionEvent(void* c_this, void* param1);
	[LinkName("QToolButton_EnterEvent")]
	public static extern void QToolButton_EnterEvent(void* c_this, void* param1);
	[LinkName("QToolButton_LeaveEvent")]
	public static extern void QToolButton_LeaveEvent(void* c_this, void* param1);
	[LinkName("QToolButton_TimerEvent")]
	public static extern void QToolButton_TimerEvent(void* c_this, void* param1);
	[LinkName("QToolButton_ChangeEvent")]
	public static extern void QToolButton_ChangeEvent(void* c_this, void* param1);
	[LinkName("QToolButton_HitButton")]
	public static extern bool QToolButton_HitButton(void* c_this, void* pos);
	...
	public static extern void QToolButton_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QToolButton_Delete(void* self);
}