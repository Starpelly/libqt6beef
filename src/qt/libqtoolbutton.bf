...
public class QToolButton
{
	...
	{
		this.nativePtr = CQt.QToolButton_new(parent);
	}
	...
	public void SetMenu(void* menu)
	{
		CQt.QToolButton_SetMenu(this.nativePtr, menu);
	}
	...
	{
		CQt.QToolButton_SetDefaultAction(this.nativePtr, defaultAction);
	}
	
	public virtual bool Event(void* e)
	{
		return CQt.QToolButton_Event(this.nativePtr, e);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QToolButton_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QToolButton_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QToolButton_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void ActionEvent(void* param1)
	{
		CQt.QToolButton_ActionEvent(this.nativePtr, param1);
	}
	
	public virtual void EnterEvent(void* param1)
	{
		CQt.QToolButton_EnterEvent(this.nativePtr, param1);
	}
	
	public virtual void LeaveEvent(void* param1)
	{
		CQt.QToolButton_LeaveEvent(this.nativePtr, param1);
	}
	
	public virtual void TimerEvent(void* param1)
	{
		CQt.QToolButton_TimerEvent(this.nativePtr, param1);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QToolButton_ChangeEvent(this.nativePtr, param1);
	}
	
	public virtual bool HitButton(void* pos)
	{
		return CQt.QToolButton_HitButton(this.nativePtr, pos);
	}
	...
	{
		CQt.QToolButton_InitStyleOption(this.nativePtr, option);
	}
	...
	{
		CQt.QAbstractButton_SetText(this.nativePtr, text);
	}
	...
	{
		CQt.QAbstractButton_SetIcon(this.nativePtr, icon);
	}
	...
	public void SetShortcut(void* key)
	{
		CQt.QAbstractButton_SetShortcut(this.nativePtr, key);
	}
	...
	{
		CQt.QAbstractButton_SetIconSize(this.nativePtr, size);
	}
