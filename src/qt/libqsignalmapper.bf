...
public struct QSignalMapperPtr : IQSignalMapper, IDisposable, IQObject
{
	...
	{
		return CQt.QSignalMapper_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QSignalMapper_SetMapping(this.nativePtr, (sender == default || sender.NativePtr == default) ? default : sender.NativePtr, id);
	}
	
	public void SetMapping2(IQObject sender, String text)
	{
		CQt.QSignalMapper_SetMapping2(this.nativePtr, (sender == default || sender.NativePtr == default) ? default : sender.NativePtr, libqt_string(text));
	}
	
	public void SetMapping3(IQObject sender, IQObject object)
	{
		CQt.QSignalMapper_SetMapping3(this.nativePtr, (sender == default || sender.NativePtr == default) ? default : sender.NativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr);
	}
	
	public void RemoveMappings(IQObject sender)
	{
		CQt.QSignalMapper_RemoveMappings(this.nativePtr, (sender == default || sender.NativePtr == default) ? default : sender.NativePtr);
	}
	...
	{
		return CQt.QSignalMapper_MappingWithObject(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr);
	}
	...
	{
		CQt.QSignalMapper_MapWithSender(this.nativePtr, (sender == default || sender.NativePtr == default) ? default : sender.NativePtr);
	}
...
{
	public QSignalMapperPtr handle;
	
	public static implicit operator QSignalMapperPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QSignalMapperPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QSignalMapperPtr.Tr(s);
	}
	
	public void SetMapping(IQObject sender, int32 id)
	{
		this.handle.SetMapping(sender, id);
	}
	
	public void SetMapping2(IQObject sender, String text)
	{
		this.handle.SetMapping2(sender, text);
	}
	
	public void SetMapping3(IQObject sender, IQObject object)
	{
		this.handle.SetMapping3(sender, object);
	}
	
	public void RemoveMappings(IQObject sender)
	{
		this.handle.RemoveMappings(sender);
	}
	
	public void* Mapping(int32 id)
	{
		return this.handle.Mapping(id);
	}
	
	public void* MappingWithText(String text)
	{
		return this.handle.MappingWithText(text);
	}
	
	public void* MappingWithObject(IQObject object)
	{
		return this.handle.MappingWithObject(object);
	}
	...
	public void MapWithSender(IQObject sender)
	{
		this.handle.MapWithSender(sender);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSignalMapperPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSignalMapperPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSignalMapperPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSignalMapperPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSignalMapperPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSignalMapperPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
