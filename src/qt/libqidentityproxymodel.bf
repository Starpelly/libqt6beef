...
public struct QIdentityProxyModelPtr : IQIdentityProxyModel, IDisposable, IQAbstractProxyModel
{
	...
	{
		return .(CQt.QIdentityProxyModel_new());
	}
	...
	{
		return CQt.QIdentityProxyModel_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QIdentityProxyModel_ColumnCount(this.nativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public void Index(int32 row, int32 column, IQModelIndex parent)
	{
		CQt.QIdentityProxyModel_Index(this.nativePtr, row, column, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public void MapFromSource(IQModelIndex sourceIndex)
	{
		CQt.QIdentityProxyModel_MapFromSource(this.nativePtr, (sourceIndex == default || sourceIndex.NativePtr == default) ? default : sourceIndex.NativePtr);
	}
	
	public void MapToSource(IQModelIndex proxyIndex)
	{
		CQt.QIdentityProxyModel_MapToSource(this.nativePtr, (proxyIndex == default || proxyIndex.NativePtr == default) ? default : proxyIndex.NativePtr);
	}
	
	public void Parent(IQModelIndex child)
	{
		CQt.QIdentityProxyModel_Parent(this.nativePtr, (child == default || child.NativePtr == default) ? default : child.NativePtr);
	}
	
	public int32 RowCount(IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_RowCount(this.nativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public void HeaderData(int32 section, int64 orientation, int32 role)
	{
		CQt.QIdentityProxyModel_HeaderData(this.nativePtr, section, (int64)orientation, role);
	}
	
	public bool DropMimeData(IQMimeData data, int64 action, int32 row, int32 column, IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_DropMimeData(this.nativePtr, (data == default || data.NativePtr == default) ? default : data.NativePtr, (int64)action, row, column, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public void Sibling(int32 row, int32 column, IQModelIndex idx)
	{
		CQt.QIdentityProxyModel_Sibling(this.nativePtr, row, column, (idx == default || idx.NativePtr == default) ? default : idx.NativePtr);
	}
	
	public void MapSelectionFromSource(IQItemSelection selection)
	{
		CQt.QIdentityProxyModel_MapSelectionFromSource(this.nativePtr, (selection == default || selection.NativePtr == default) ? default : selection.NativePtr);
	}
	
	public void MapSelectionToSource(IQItemSelection selection)
	{
		CQt.QIdentityProxyModel_MapSelectionToSource(this.nativePtr, (selection == default || selection.NativePtr == default) ? default : selection.NativePtr);
	}
	
	public void[] Match(IQModelIndex start, int32 role, IQVariant value, int32 hits, int64 flags)
	{
		return CQt.QIdentityProxyModel_Match(this.nativePtr, (start == default || start.NativePtr == default) ? default : start.NativePtr, role, (value == default || value.NativePtr == default) ? default : value.NativePtr, hits, flags);
	}
	
	public void SetSourceModel(IQAbstractItemModel sourceModel)
	{
		CQt.QIdentityProxyModel_SetSourceModel(this.nativePtr, (sourceModel == default || sourceModel.NativePtr == default) ? default : sourceModel.NativePtr);
	}
	
	public bool InsertColumns(int32 column, int32 count, IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_InsertColumns(this.nativePtr, column, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public bool InsertRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_InsertRows(this.nativePtr, row, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public bool RemoveColumns(int32 column, int32 count, IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_RemoveColumns(this.nativePtr, column, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public bool RemoveRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QIdentityProxyModel_RemoveRows(this.nativePtr, row, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	...
	{
		return CQt.QIdentityProxyModel_MoveRows(this.nativePtr, (sourceParent == default || sourceParent.NativePtr == default) ? default : sourceParent.NativePtr, sourceRow, count, (destinationParent == default || destinationParent.NativePtr == default) ? default : destinationParent.NativePtr, destinationChild);
	}
	...
	{
		return CQt.QIdentityProxyModel_MoveColumns(this.nativePtr, (sourceParent == default || sourceParent.NativePtr == default) ? default : sourceParent.NativePtr, sourceColumn, count, (destinationParent == default || destinationParent.NativePtr == default) ? default : destinationParent.NativePtr, destinationChild);
	}
	...
	{
		return CQt.QAbstractProxyModel_SetHeaderData(this.nativePtr, section, (int64)orientation, (value == default || value.NativePtr == default) ? default : value.NativePtr, role);
	}
	...
	{
		CQt.QAbstractProxyModel_Sort(this.nativePtr, column, (int64)order);
	}
	
	public void Span(IQModelIndex index)
	{
		CQt.QAbstractProxyModel_Span(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
...
{
	public QIdentityProxyModelPtr handle;
	
	public static implicit operator QIdentityProxyModelPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QIdentityProxyModelPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QIdentityProxyModelPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QIdentityProxyModelPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QIdentityProxyModelPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QIdentityProxyModelPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QIdentityProxyModelPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QIdentityProxyModelPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QIdentityProxyModelPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
