...
public class QToolBox
{
	...
	{
		this.nativePtr = CQt.QToolBox_new(parent);
	}
	...
	public int32 AddItem(void* widget, libqt_string text)
	{
		return CQt.QToolBox_AddItem(this.nativePtr, widget, text);
	}
	
	public int32 AddItem2(void* widget, void* icon, libqt_string text)
	{
		return CQt.QToolBox_AddItem2(this.nativePtr, widget, icon, text);
	}
	
	public int32 InsertItem(int32 index, void* widget, libqt_string text)
	{
		return CQt.QToolBox_InsertItem(this.nativePtr, index, widget, text);
	}
	
	public int32 InsertItem2(int32 index, void* widget, void* icon, libqt_string text)
	{
		return CQt.QToolBox_InsertItem2(this.nativePtr, index, widget, icon, text);
	}
	...
	{
		CQt.QToolBox_SetItemText(this.nativePtr, index, text);
	}
	...
	{
		CQt.QToolBox_SetItemIcon(this.nativePtr, index, icon);
	}
	...
	public void SetItemToolTip(int32 index, libqt_string toolTip)
	{
		CQt.QToolBox_SetItemToolTip(this.nativePtr, index, toolTip);
	}
	...
	{
		return CQt.QToolBox_IndexOf(this.nativePtr, widget);
	}
	...
	{
		CQt.QToolBox_SetCurrentWidget(this.nativePtr, widget);
	}
	
	public virtual bool Event(void* e)
	{
		return CQt.QToolBox_Event(this.nativePtr, e);
	}
	...
	{
		CQt.QToolBox_ShowEvent(this.nativePtr, e);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QToolBox_ChangeEvent(this.nativePtr, param1);
	}
