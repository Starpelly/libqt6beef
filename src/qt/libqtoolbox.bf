...
public class QToolBox : IQToolBox, IQFrame
{
	...
	{
		this.nativePtr = CQt.QToolBox_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QToolBox_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QToolBox_AddItem(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, libqt_string(text));
	}
	
	public int32 AddItem2(IQWidget widget, IQIcon icon, String text)
	{
		return CQt.QToolBox_AddItem2(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, (icon == default) ? default : (void*)icon.NativePtr, libqt_string(text));
	}
	
	public int32 InsertItem(int32 index, IQWidget widget, String text)
	{
		return CQt.QToolBox_InsertItem(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, libqt_string(text));
	}
	
	public int32 InsertItem2(int32 index, IQWidget widget, IQIcon icon, String text)
	{
		return CQt.QToolBox_InsertItem2(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, (icon == default) ? default : (void*)icon.NativePtr, libqt_string(text));
	}
	...
	{
		CQt.QToolBox_SetItemIcon(this.nativePtr, index, (icon == default) ? default : (void*)icon.NativePtr);
	}
	...
	{
		return CQt.QToolBox_IndexOf(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QToolBox_SetCurrentWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QToolBox_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	...
	{
		CQt.QToolBox_ShowEvent(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QToolBox_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
