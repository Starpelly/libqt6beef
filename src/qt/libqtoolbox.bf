...
public interface IQToolBox
{
	void* NativePtr { get; }
}
public struct QToolBoxPtr : IQToolBox, IDisposable, IQFrame
{
	...
	{
		return .(CQt.QToolBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QToolBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QToolBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QToolBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QToolBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public int32 AddItem(IQWidget widget, String text)
	{
		return CQt.QToolBox_AddItem(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, libqt_string(text));
	}
	
	public int32 AddItem2(IQWidget widget, IQIcon icon, String text)
	{
		return CQt.QToolBox_AddItem2(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	
	public int32 InsertItem(int32 index, IQWidget widget, String text)
	{
		return CQt.QToolBox_InsertItem(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, libqt_string(text));
	}
	
	public int32 InsertItem2(int32 index, IQWidget widget, IQIcon icon, String text)
	{
		return CQt.QToolBox_InsertItem2(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	
	public void RemoveItem(int32 index)
	{
		CQt.QToolBox_RemoveItem(this.nativePtr, index);
	}
	
	public void SetItemEnabled(int32 index, bool enabled)
	{
		CQt.QToolBox_SetItemEnabled(this.nativePtr, index, enabled);
	}
	
	public bool IsItemEnabled(int32 index)
	{
		return CQt.QToolBox_IsItemEnabled(this.nativePtr, index);
	}
	
	public void SetItemText(int32 index, String text)
	{
		CQt.QToolBox_SetItemText(this.nativePtr, index, libqt_string(text));
	}
	
	public libqt_string ItemText(int32 index)
	{
		return CQt.QToolBox_ItemText(this.nativePtr, index);
	}
	
	public void SetItemIcon(int32 index, IQIcon icon)
	{
		CQt.QToolBox_SetItemIcon(this.nativePtr, index, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	
	public void ItemIcon(int32 index)
	{
		CQt.QToolBox_ItemIcon(this.nativePtr, index);
	}
	
	public void SetItemToolTip(int32 index, String toolTip)
	{
		CQt.QToolBox_SetItemToolTip(this.nativePtr, index, libqt_string(toolTip));
	}
	
	public libqt_string ItemToolTip(int32 index)
	{
		return CQt.QToolBox_ItemToolTip(this.nativePtr, index);
	}
	
	public int32 CurrentIndex()
	{
		return CQt.QToolBox_CurrentIndex(this.nativePtr);
	}
	
	public void* CurrentWidget()
	{
		return CQt.QToolBox_CurrentWidget(this.nativePtr);
	}
	
	public void* Widget(int32 index)
	{
		return CQt.QToolBox_Widget(this.nativePtr, index);
	}
	
	public int32 IndexOf(IQWidget widget)
	{
		return CQt.QToolBox_IndexOf(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public int32 Count()
	{
		return CQt.QToolBox_Count(this.nativePtr);
	}
	
	public void SetCurrentIndex(int32 index)
	{
		CQt.QToolBox_SetCurrentIndex(this.nativePtr, index);
	}
	
	public void SetCurrentWidget(IQWidget widget)
	{
		CQt.QToolBox_SetCurrentWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QToolBox_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ItemInserted(int32 index)
	{
		CQt.QToolBox_ItemInserted(this.nativePtr, index);
	}
	
	public void ItemRemoved(int32 index)
	{
		CQt.QToolBox_ItemRemoved(this.nativePtr, index);
	}
	
	public void ShowEvent(IQShowEvent e)
	{
		CQt.QToolBox_ShowEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QToolBox_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	...
	{
		CQt.QFrame_SizeHint(this.nativePtr);
	}
...
{
	public QToolBoxPtr handle;
	
	public static implicit operator QToolBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QToolBoxPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QToolBoxPtr.Tr(s);
	}
	
	public int32 AddItem(IQWidget widget, String text)
	{
		return this.handle.AddItem(widget, text);
	}
	
	public int32 AddItem2(IQWidget widget, IQIcon icon, String text)
	{
		return this.handle.AddItem2(widget, icon, text);
	}
	
	public int32 InsertItem(int32 index, IQWidget widget, String text)
	{
		return this.handle.InsertItem(index, widget, text);
	}
	
	public int32 InsertItem2(int32 index, IQWidget widget, IQIcon icon, String text)
	{
		return this.handle.InsertItem2(index, widget, icon, text);
	}
	...
	public void SetItemEnabled(int32 index, bool enabled)
	{
		this.handle.SetItemEnabled(index, enabled);
	}
	
	public bool IsItemEnabled(int32 index)
	{
		return this.handle.IsItemEnabled(index);
	}
	...
	public void SetItemToolTip(int32 index, String toolTip)
	{
		this.handle.SetItemToolTip(index, toolTip);
	}
	
	public libqt_string ItemToolTip(int32 index)
	{
		return this.handle.ItemToolTip(index);
	}
	...
	public virtual void ItemInserted(int32 index)
	{
		this.handle.ItemInserted(index);
	}
	
	public virtual void ItemRemoved(int32 index)
	{
		this.handle.ItemRemoved(index);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QToolBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QToolBoxPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QToolBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QToolBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QToolBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QToolBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QToolBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QToolBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QToolBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QToolBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QToolBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QToolBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QToolBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QToolBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QToolBox_new(void* parent);
	[LinkName("QToolBox_new2")]
	public static extern void* QToolBox_new2();
	[LinkName("QToolBox_new3")]
	public static extern void* QToolBox_new3(void* parent, int64 f);
	[LinkName("QToolBox_MetaObject")]
	public static extern void* QToolBox_MetaObject(void* c_this);
	...
	public static extern int32 QToolBox_AddItem(void* c_this, void* widget, libqt_string text);
	[LinkName("QToolBox_AddItem2")]
	public static extern int32 QToolBox_AddItem2(void* c_this, void* widget, void* icon, libqt_string text);
	[LinkName("QToolBox_InsertItem")]
	public static extern int32 QToolBox_InsertItem(void* c_this, int32 index, void* widget, libqt_string text);
	[LinkName("QToolBox_InsertItem2")]
	public static extern int32 QToolBox_InsertItem2(void* c_this, int32 index, void* widget, void* icon, libqt_string text);
	...
	public static extern void QToolBox_SetItemText(void* c_this, int32 index, libqt_string text);
	[LinkName("QToolBox_ItemText")]
	public static extern libqt_string QToolBox_ItemText(void* c_this, int32 index);
	[LinkName("QToolBox_SetItemIcon")]
	public static extern void QToolBox_SetItemIcon(void* c_this, int32 index, void* icon);
	[LinkName("QToolBox_ItemIcon")]
	public static extern void QToolBox_ItemIcon(void* c_this, int32 index);
	[LinkName("QToolBox_SetItemToolTip")]
	public static extern void QToolBox_SetItemToolTip(void* c_this, int32 index, libqt_string toolTip);
	[LinkName("QToolBox_ItemToolTip")]
	public static extern libqt_string QToolBox_ItemToolTip(void* c_this, int32 index);
	...
	public static extern void* QToolBox_CurrentWidget(void* c_this);
	[LinkName("QToolBox_Widget")]
	public static extern void* QToolBox_Widget(void* c_this, int32 index);
	[LinkName("QToolBox_IndexOf")]
	public static extern int32 QToolBox_IndexOf(void* c_this, void* widget);
	...
	public static extern void QToolBox_SetCurrentWidget(void* c_this, void* widget);
	[LinkName("QToolBox_Connect_CurrentChanged")]
	public static extern void QToolBox_Connect_CurrentChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBox_Event")]
	public static extern bool QToolBox_Event(void* c_this, void* e);
	...
	public static extern void QToolBox_ShowEvent(void* c_this, void* e);
	[LinkName("QToolBox_ChangeEvent")]
	public static extern void QToolBox_ChangeEvent(void* c_this, void* param1);
	...
	public static extern void QToolBox_Delete(void* self);
}