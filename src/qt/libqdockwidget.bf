...
public interface IQDockWidget
{
	void* NativePtr { get; }
}
public struct QDockWidgetPtr : IQDockWidget, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QDockWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QDockWidget_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QDockWidget_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QDockWidget_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QDockWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public void* Widget()
	{
		return CQt.QDockWidget_Widget(this.nativePtr);
	}
	
	public void SetWidget(IQWidget widget)
	{
		CQt.QDockWidget_SetWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void SetFeatures(int64 features)
	{
		CQt.QDockWidget_SetFeatures(this.nativePtr, features);
	}
	
	public int64 Features()
	{
		return CQt.QDockWidget_Features(this.nativePtr);
	}
	
	public void SetFloating(bool floating)
	{
		CQt.QDockWidget_SetFloating(this.nativePtr, floating);
	}
	
	public bool IsFloating()
	{
		return CQt.QDockWidget_IsFloating(this.nativePtr);
	}
	
	public void SetAllowedAreas(int64 areas)
	{
		CQt.QDockWidget_SetAllowedAreas(this.nativePtr, areas);
	}
	
	public int64 AllowedAreas()
	{
		return CQt.QDockWidget_AllowedAreas(this.nativePtr);
	}
	
	public void SetTitleBarWidget(IQWidget widget)
	{
		CQt.QDockWidget_SetTitleBarWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* TitleBarWidget()
	{
		return CQt.QDockWidget_TitleBarWidget(this.nativePtr);
	}
	
	public bool IsAreaAllowed(int64 area)
	{
		return CQt.QDockWidget_IsAreaAllowed(this.nativePtr, (int64)area);
	}
	
	public void* ToggleViewAction()
	{
		return CQt.QDockWidget_ToggleViewAction(this.nativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QDockWidget_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QDockWidget_CloseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QDockWidget_PaintEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QDockWidget_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionDockWidget option)
	{
		CQt.QDockWidget_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QDockWidgetPtr handle;
	
	public static implicit operator QDockWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QDockWidgetPtr.New(parent);
	}
	...
	public void SetFeatures(int64 features)
	{
		this.handle.SetFeatures(features);
	}
	...
	public void SetFloating(bool floating)
	{
		this.handle.SetFloating(floating);
	}
	...
	public void SetTitleBarWidget(IQWidget widget)
	{
		this.handle.SetTitleBarWidget(widget);
	}
	
	public void* TitleBarWidget()
	{
		return this.handle.TitleBarWidget();
	}
	...
	public virtual void InitStyleOption(IQStyleOptionDockWidget option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QDockWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QDockWidgetPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QDockWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QDockWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QDockWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QDockWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QDockWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QDockWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QDockWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QDockWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QDockWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QDockWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QDockWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QDockWidgetPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QDockWidget_new(void* parent);
	[LinkName("QDockWidget_new2")]
	public static extern void* QDockWidget_new2(libqt_string title);
	[LinkName("QDockWidget_new3")]
	public static extern void* QDockWidget_new3();
	[LinkName("QDockWidget_new4")]
	public static extern void* QDockWidget_new4(libqt_string title, void* parent);
	[LinkName("QDockWidget_new5")]
	public static extern void* QDockWidget_new5(libqt_string title, void* parent, int64 flags);
	[LinkName("QDockWidget_new6")]
	public static extern void* QDockWidget_new6(void* parent, int64 flags);
	[LinkName("QDockWidget_MetaObject")]
	public static extern void* QDockWidget_MetaObject(void* c_this);
	...
	public static extern void* QDockWidget_Widget(void* c_this);
	[LinkName("QDockWidget_SetWidget")]
	public static extern void QDockWidget_SetWidget(void* c_this, void* widget);
	...
	public static extern void QDockWidget_SetTitleBarWidget(void* c_this, void* widget);
	[LinkName("QDockWidget_TitleBarWidget")]
	public static extern void* QDockWidget_TitleBarWidget(void* c_this);
	...
	public static extern void* QDockWidget_ToggleViewAction(void* c_this);
	[LinkName("QDockWidget_Connect_FeaturesChanged")]
	public static extern void QDockWidget_Connect_FeaturesChanged(void* c_this, c_intptr slot);
	[LinkName("QDockWidget_Connect_TopLevelChanged")]
	public static extern void QDockWidget_Connect_TopLevelChanged(void* c_this, c_intptr slot);
	[LinkName("QDockWidget_Connect_AllowedAreasChanged")]
	public static extern void QDockWidget_Connect_AllowedAreasChanged(void* c_this, c_intptr slot);
	[LinkName("QDockWidget_Connect_VisibilityChanged")]
	public static extern void QDockWidget_Connect_VisibilityChanged(void* c_this, c_intptr slot);
	[LinkName("QDockWidget_Connect_DockLocationChanged")]
	public static extern void QDockWidget_Connect_DockLocationChanged(void* c_this, c_intptr slot);
	[LinkName("QDockWidget_ChangeEvent")]
	public static extern void QDockWidget_ChangeEvent(void* c_this, void* event);
	[LinkName("QDockWidget_CloseEvent")]
	public static extern void QDockWidget_CloseEvent(void* c_this, void* event);
	[LinkName("QDockWidget_PaintEvent")]
	public static extern void QDockWidget_PaintEvent(void* c_this, void* event);
	[LinkName("QDockWidget_Event")]
	public static extern bool QDockWidget_Event(void* c_this, void* event);
	[LinkName("QDockWidget_InitStyleOption")]
	public static extern void QDockWidget_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QDockWidget_Delete(void* self);
}