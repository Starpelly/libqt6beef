...
public class QDockWidget
{
	...
	{
		this.nativePtr = CQt.QDockWidget_new(parent);
	}
	...
	{
		CQt.QDockWidget_SetWidget(this.nativePtr, widget);
	}
	...
	public void SetTitleBarWidget(void* widget)
	{
		CQt.QDockWidget_SetTitleBarWidget(this.nativePtr, widget);
	}
	...
	{
		CQt.QDockWidget_ChangeEvent(this.nativePtr, event);
	}
	
	public virtual void CloseEvent(void* event)
	{
		CQt.QDockWidget_CloseEvent(this.nativePtr, event);
	}
	
	public virtual void PaintEvent(void* event)
	{
		CQt.QDockWidget_PaintEvent(this.nativePtr, event);
	}
	
	public virtual bool Event(void* event)
	{
		return CQt.QDockWidget_Event(this.nativePtr, event);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QDockWidget_InitStyleOption(this.nativePtr, option);
	}
