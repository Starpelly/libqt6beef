...
public class QDockWidget : IQDockWidget, IQWidget
{
	...
	{
		this.nativePtr = CQt.QDockWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QDockWidget_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QDockWidget_SetWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QDockWidget_SetTitleBarWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		return CQt.QDockWidget_IsAreaAllowed(this.nativePtr, area);
	}
	...
	{
		CQt.QDockWidget_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void CloseEvent(IQCloseEvent event)
	{
		CQt.QDockWidget_CloseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent event)
	{
		CQt.QDockWidget_PaintEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual bool Event(IQEvent event)
	{
		return CQt.QDockWidget_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionDockWidget option)
	{
		CQt.QDockWidget_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
