...
public interface IQStackedWidget
{
	void* NativePtr { get; }
}
public struct QStackedWidgetPtr : IQStackedWidget, IDisposable, IQFrame
{
	...
	{
		return .(CQt.QStackedWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QStackedWidget_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QStackedWidget_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QStackedWidget_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QStackedWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QStackedWidget_AddWidget(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public int32 InsertWidget(int32 index, IQWidget w)
	{
		return CQt.QStackedWidget_InsertWidget(this.nativePtr, index, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public void RemoveWidget(IQWidget w)
	{
		CQt.QStackedWidget_RemoveWidget(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public void* CurrentWidget()
	{
		return CQt.QStackedWidget_CurrentWidget(this.nativePtr);
	}
	
	public int32 CurrentIndex()
	{
		return CQt.QStackedWidget_CurrentIndex(this.nativePtr);
	}
	
	public int32 IndexOf(IQWidget param1)
	{
		return CQt.QStackedWidget_IndexOf(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void* Widget(int32 param1)
	{
		return CQt.QStackedWidget_Widget(this.nativePtr, param1);
	}
	
	public int32 Count()
	{
		return CQt.QStackedWidget_Count(this.nativePtr);
	}
	
	public void SetCurrentIndex(int32 index)
	{
		CQt.QStackedWidget_SetCurrentIndex(this.nativePtr, index);
	}
	
	public void SetCurrentWidget(IQWidget w)
	{
		CQt.QStackedWidget_SetCurrentWidget(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QStackedWidget_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
...
{
	public QStackedWidgetPtr handle;
	
	public static implicit operator QStackedWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QStackedWidgetPtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QStackedWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QStackedWidgetPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QStackedWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QStackedWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QStackedWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QStackedWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QStackedWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QStackedWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QStackedWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QStackedWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QStackedWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QStackedWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QStackedWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QStackedWidgetPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QStackedWidget_new(void* parent);
	[LinkName("QStackedWidget_new2")]
	public static extern void* QStackedWidget_new2();
	[LinkName("QStackedWidget_MetaObject")]
	public static extern void* QStackedWidget_MetaObject(void* c_this);
	[LinkName("QStackedWidget_Metacast")]
	public static extern void* QStackedWidget_Metacast(void* c_this, char8* param1);
	[LinkName("QStackedWidget_Metacall")]
	public static extern int32 QStackedWidget_Metacall(void* c_this, int64 param1, int32 param2, void* param3);
	[LinkName("QStackedWidget_Tr")]
	public static extern libqt_string QStackedWidget_Tr(char8* s);
	[LinkName("QStackedWidget_AddWidget")]
	public static extern int32 QStackedWidget_AddWidget(void* c_this, void* w);
	[LinkName("QStackedWidget_InsertWidget")]
	public static extern int32 QStackedWidget_InsertWidget(void* c_this, int32 index, void* w);
	[LinkName("QStackedWidget_RemoveWidget")]
	public static extern void QStackedWidget_RemoveWidget(void* c_this, void* w);
	[LinkName("QStackedWidget_CurrentWidget")]
	public static extern void* QStackedWidget_CurrentWidget(void* c_this);
	[LinkName("QStackedWidget_CurrentIndex")]
	public static extern int32 QStackedWidget_CurrentIndex(void* c_this);
	[LinkName("QStackedWidget_IndexOf")]
	public static extern int32 QStackedWidget_IndexOf(void* c_this, void* param1);
	[LinkName("QStackedWidget_Widget")]
	public static extern void* QStackedWidget_Widget(void* c_this, int32 param1);
	[LinkName("QStackedWidget_Count")]
	public static extern int32 QStackedWidget_Count(void* c_this);
	[LinkName("QStackedWidget_SetCurrentIndex")]
	public static extern void QStackedWidget_SetCurrentIndex(void* c_this, int32 index);
	[LinkName("QStackedWidget_SetCurrentWidget")]
	public static extern void QStackedWidget_SetCurrentWidget(void* c_this, void* w);
	[LinkName("QStackedWidget_Connect_CurrentChanged")]
	public static extern void QStackedWidget_Connect_CurrentChanged(void* c_this, c_intptr slot);
	[LinkName("QStackedWidget_Connect_WidgetRemoved")]
	public static extern void QStackedWidget_Connect_WidgetRemoved(void* c_this, c_intptr slot);
	[LinkName("QStackedWidget_Event")]
	public static extern bool QStackedWidget_Event(void* c_this, void* e);
	...
	public static extern void QStackedWidget_Delete(void* self);
}