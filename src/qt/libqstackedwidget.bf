...
public class QStackedWidget
{
	...
	{
		this.nativePtr = CQt.QStackedWidget_new(parent);
	}
	...
	{
		return CQt.QStackedWidget_AddWidget(this.nativePtr, w);
	}
	
	public int32 InsertWidget(int32 index, void* w)
	{
		return CQt.QStackedWidget_InsertWidget(this.nativePtr, index, w);
	}
	
	public void RemoveWidget(void* w)
	{
		CQt.QStackedWidget_RemoveWidget(this.nativePtr, w);
	}
	...
	public int32 IndexOf(void* param1)
	{
		return CQt.QStackedWidget_IndexOf(this.nativePtr, param1);
	}
	...
	{
		CQt.QStackedWidget_SetCurrentWidget(this.nativePtr, w);
	}
	
	public virtual bool Event(void* e)
	{
		return CQt.QStackedWidget_Event(this.nativePtr, e);
	}
