...
public class QStackedWidget : IQStackedWidget, IQFrame
{
	...
	{
		this.nativePtr = CQt.QStackedWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QStackedWidget_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QStackedWidget_AddWidget(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	
	public int32 InsertWidget(int32 index, IQWidget w)
	{
		return CQt.QStackedWidget_InsertWidget(this.nativePtr, index, (w == null) ? null : (void*)w.NativePtr);
	}
	
	public void RemoveWidget(IQWidget w)
	{
		CQt.QStackedWidget_RemoveWidget(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	...
	{
		return CQt.QStackedWidget_IndexOf(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	...
	{
		CQt.QStackedWidget_SetCurrentWidget(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QStackedWidget_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
