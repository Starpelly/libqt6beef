...
public interface IQGroupBox
{
	void* NativePtr { get; }
}
public struct QGroupBoxPtr : IQGroupBox, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QGroupBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QGroupBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QGroupBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QGroupBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QGroupBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QGroupBox_Title(this.nativePtr);
	}
	
	public void SetTitle(String title)
	{
		CQt.QGroupBox_SetTitle(this.nativePtr, libqt_string(title));
	}
	
	public int64 Alignment()
	{
		return CQt.QGroupBox_Alignment(this.nativePtr);
	}
	
	public void SetAlignment(int32 alignment)
	{
		CQt.QGroupBox_SetAlignment(this.nativePtr, alignment);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QGroupBox_MinimumSizeHint(this.nativePtr);
	}
	
	public bool IsFlat()
	{
		return CQt.QGroupBox_IsFlat(this.nativePtr);
	}
	
	public void SetFlat(bool flat)
	{
		CQt.QGroupBox_SetFlat(this.nativePtr, flat);
	}
	
	public bool IsCheckable()
	{
		return CQt.QGroupBox_IsCheckable(this.nativePtr);
	}
	
	public void SetCheckable(bool checkable)
	{
		CQt.QGroupBox_SetCheckable(this.nativePtr, checkable);
	}
	
	public bool IsChecked()
	{
		return CQt.QGroupBox_IsChecked(this.nativePtr);
	}
	
	public void SetChecked(bool _checked)
	{
		CQt.QGroupBox_SetChecked(this.nativePtr, _checked);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QGroupBox_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QGroupBox_ChildEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QGroupBox_ResizeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QGroupBox_PaintEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QGroupBox_FocusInEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QGroupBox_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MousePressEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseMoveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseReleaseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionGroupBox option)
	{
		CQt.QGroupBox_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QGroupBoxPtr handle;
	
	public static implicit operator QGroupBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QGroupBoxPtr.New(parent);
	}
	...
	public virtual void InitStyleOption(IQStyleOptionGroupBox option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QGroupBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QGroupBoxPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QGroupBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QGroupBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QGroupBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QGroupBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QGroupBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QGroupBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QGroupBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QGroupBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QGroupBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QGroupBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QGroupBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QGroupBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QGroupBox_new(void* parent);
	[LinkName("QGroupBox_new2")]
	public static extern void* QGroupBox_new2();
	[LinkName("QGroupBox_new3")]
	public static extern void* QGroupBox_new3(libqt_string title);
	[LinkName("QGroupBox_new4")]
	public static extern void* QGroupBox_new4(libqt_string title, void* parent);
	[LinkName("QGroupBox_MetaObject")]
	public static extern void* QGroupBox_MetaObject(void* c_this);
	...
	public static extern libqt_string QGroupBox_Title(void* c_this);
	[LinkName("QGroupBox_SetTitle")]
	public static extern void QGroupBox_SetTitle(void* c_this, libqt_string title);
	...
	public static extern void QGroupBox_MinimumSizeHint(void* c_this);
	...
	public static extern void QGroupBox_Connect_Clicked(void* c_this, c_intptr slot);
	[LinkName("QGroupBox_Connect_Toggled")]
	public static extern void QGroupBox_Connect_Toggled(void* c_this, c_intptr slot);
	[LinkName("QGroupBox_Event")]
	public static extern bool QGroupBox_Event(void* c_this, void* event);
	[LinkName("QGroupBox_ChildEvent")]
	public static extern void QGroupBox_ChildEvent(void* c_this, void* event);
	[LinkName("QGroupBox_ResizeEvent")]
	public static extern void QGroupBox_ResizeEvent(void* c_this, void* event);
	[LinkName("QGroupBox_PaintEvent")]
	public static extern void QGroupBox_PaintEvent(void* c_this, void* event);
	[LinkName("QGroupBox_FocusInEvent")]
	public static extern void QGroupBox_FocusInEvent(void* c_this, void* event);
	[LinkName("QGroupBox_ChangeEvent")]
	public static extern void QGroupBox_ChangeEvent(void* c_this, void* event);
	[LinkName("QGroupBox_MousePressEvent")]
	public static extern void QGroupBox_MousePressEvent(void* c_this, void* event);
	[LinkName("QGroupBox_MouseMoveEvent")]
	public static extern void QGroupBox_MouseMoveEvent(void* c_this, void* event);
	[LinkName("QGroupBox_MouseReleaseEvent")]
	public static extern void QGroupBox_MouseReleaseEvent(void* c_this, void* event);
	[LinkName("QGroupBox_InitStyleOption")]
	public static extern void QGroupBox_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QGroupBox_Connect_Clicked1(void* c_this, c_intptr slot);
	/// Delete this object from C++ memory
	[LinkName("QGroupBox_Delete")]
	public static extern void QGroupBox_Delete(void* self);
}