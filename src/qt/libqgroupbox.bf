...
public class QGroupBox
{
	...
	{
		this.nativePtr = CQt.QGroupBox_new(parent);
	}
	...
	{
		CQt.QGroupBox_SetTitle(this.nativePtr, title);
	}
	...
	{
		return CQt.QGroupBox_Event(this.nativePtr, event);
	}
	
	public virtual void ChildEvent(void* event)
	{
		CQt.QGroupBox_ChildEvent(this.nativePtr, event);
	}
	
	public virtual void ResizeEvent(void* event)
	{
		CQt.QGroupBox_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void PaintEvent(void* event)
	{
		CQt.QGroupBox_PaintEvent(this.nativePtr, event);
	}
	
	public virtual void FocusInEvent(void* event)
	{
		CQt.QGroupBox_FocusInEvent(this.nativePtr, event);
	}
	
	public virtual void ChangeEvent(void* event)
	{
		CQt.QGroupBox_ChangeEvent(this.nativePtr, event);
	}
	
	public virtual void MousePressEvent(void* event)
	{
		CQt.QGroupBox_MousePressEvent(this.nativePtr, event);
	}
	
	public virtual void MouseMoveEvent(void* event)
	{
		CQt.QGroupBox_MouseMoveEvent(this.nativePtr, event);
	}
	
	public virtual void MouseReleaseEvent(void* event)
	{
		CQt.QGroupBox_MouseReleaseEvent(this.nativePtr, event);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QGroupBox_InitStyleOption(this.nativePtr, option);
	}
