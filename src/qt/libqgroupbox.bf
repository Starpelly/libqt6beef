...
public class QGroupBox : IQGroupBox, IQWidget
{
	...
	{
		this.nativePtr = CQt.QGroupBox_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QGroupBox_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QGroupBox_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ChildEvent(IQChildEvent event)
	{
		CQt.QGroupBox_ChildEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent event)
	{
		CQt.QGroupBox_ResizeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent event)
	{
		CQt.QGroupBox_PaintEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void FocusInEvent(IQFocusEvent event)
	{
		CQt.QGroupBox_FocusInEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent event)
	{
		CQt.QGroupBox_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MousePressEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseMoveEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseReleaseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionGroupBox option)
	{
		CQt.QGroupBox_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
