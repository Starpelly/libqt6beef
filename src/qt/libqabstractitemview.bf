...
public struct QAbstractItemViewPtr : IQAbstractItemView, IDisposable, IQAbstractScrollArea
{
	...
	{
		return .(CQt.QAbstractItemView_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QAbstractItemView_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QAbstractItemView_VisualRect(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	
	public void ScrollTo(IQModelIndex index, int64 hint)
	{
		CQt.QAbstractItemView_ScrollTo(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, (int64)hint);
	}
	
	public void IndexAt(IQPoint point)
	{
		CQt.QAbstractItemView_IndexAt(this.nativePtr, (point == default || point.NativePtr == default) ? default : point.NativePtr);
	}
	...
	{
		CQt.QAbstractItemView_DataChanged(this.nativePtr, (topLeft == default || topLeft.NativePtr == default) ? default : topLeft.NativePtr, (bottomRight == default || bottomRight.NativePtr == default) ? default : bottomRight.NativePtr, null);
	}
	
	public void RowsInserted(IQModelIndex parent, int32 start, int32 end)
	{
		CQt.QAbstractItemView_RowsInserted(this.nativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, start, end);
	}
	
	public void RowsAboutToBeRemoved(IQModelIndex parent, int32 start, int32 end)
	{
		CQt.QAbstractItemView_RowsAboutToBeRemoved(this.nativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, start, end);
	}
	
	public void SelectionChanged(IQItemSelection selected, IQItemSelection deselected)
	{
		CQt.QAbstractItemView_SelectionChanged(this.nativePtr, (selected == default || selected.NativePtr == default) ? default : selected.NativePtr, (deselected == default || deselected.NativePtr == default) ? default : deselected.NativePtr);
	}
	
	public void CurrentChanged(IQModelIndex current, IQModelIndex previous)
	{
		CQt.QAbstractItemView_CurrentChanged(this.nativePtr, (current == default || current.NativePtr == default) ? default : current.NativePtr, (previous == default || previous.NativePtr == default) ? default : previous.NativePtr);
	}
	...
	public void HorizontalScrollbarValueChanged(int32 value)
	{
		CQt.QAbstractItemView_HorizontalScrollbarValueChanged(this.nativePtr, value);
	}
	
	public void CloseEditor(IQWidget editor, int64 hint)
	{
		CQt.QAbstractItemView_CloseEditor(this.nativePtr, (editor == default || editor.NativePtr == default) ? default : editor.NativePtr, (int64)hint);
	}
	
	public void CommitData(IQWidget editor)
	{
		CQt.QAbstractItemView_CommitData(this.nativePtr, (editor == default || editor.NativePtr == default) ? default : editor.NativePtr);
	}
	
	public void EditorDestroyed(IQObject editor)
	{
		CQt.QAbstractItemView_EditorDestroyed(this.nativePtr, (editor == default || editor.NativePtr == default) ? default : editor.NativePtr);
	}
	
	public void MoveCursor(int64 cursorAction, int64 modifiers)
	{
		CQt.QAbstractItemView_MoveCursor(this.nativePtr, (int64)cursorAction, modifiers);
	}
	...
	{
		return CQt.QAbstractItemView_IsIndexHidden(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	
	public void SetSelection(IQRect rect, int64 command)
	{
		CQt.QAbstractItemView_SetSelection(this.nativePtr, (rect == default || rect.NativePtr == default) ? default : rect.NativePtr, command);
	}
	
	public void VisualRegionForSelection(IQItemSelection selection)
	{
		CQt.QAbstractItemView_VisualRegionForSelection(this.nativePtr, (selection == default || selection.NativePtr == default) ? default : selection.NativePtr);
	}
	...
	public bool Edit2(IQModelIndex index, int64 trigger, IQEvent event)
	{
		return CQt.QAbstractItemView_Edit2(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, (int64)trigger, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public int64 SelectionCommand(IQModelIndex index, IQEvent event)
	{
		return CQt.QAbstractItemView_SelectionCommand(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	{
		CQt.QAbstractItemView_InitViewItemOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	...
	{
		CQt.QAbstractItemView_SetState(this.nativePtr, (int64)state);
	}
	...
	{
		CQt.QAbstractItemView_SetDirtyRegion(this.nativePtr, (region == default || region.NativePtr == default) ? default : region.NativePtr);
	}
	...
	{
		return CQt.QAbstractItemView_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool ViewportEvent(IQEvent event)
	{
		return CQt.QAbstractItemView_ViewportEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QAbstractItemView_MousePressEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QAbstractItemView_MouseMoveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QAbstractItemView_MouseReleaseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseDoubleClickEvent(IQMouseEvent event)
	{
		CQt.QAbstractItemView_MouseDoubleClickEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QAbstractItemView_DragEnterEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QAbstractItemView_DragMoveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QAbstractItemView_DragLeaveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void DropEvent(IQDropEvent event)
	{
		CQt.QAbstractItemView_DropEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QAbstractItemView_FocusInEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QAbstractItemView_FocusOutEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QAbstractItemView_KeyPressEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QAbstractItemView_ResizeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent event)
	{
		CQt.QAbstractItemView_TimerEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InputMethodEvent(IQInputMethodEvent event)
	{
		CQt.QAbstractItemView_InputMethodEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QAbstractItemView_EventFilter(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
...
{
	public QAbstractItemViewPtr handle;
	
	public static implicit operator QAbstractItemViewPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QAbstractItemViewPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractItemViewPtr.Tr(s);
	}
	...
	{
		this.handle.UpdateEditorData();
	}
	
	public virtual void UpdateEditorGeometries()
	{
		this.handle.UpdateEditorGeometries();
	}
	...
	{
		return this.handle.Edit2(index, trigger, event);
	}
	
	public virtual int64 SelectionCommand(IQModelIndex index, IQEvent event)
	{
		return this.handle.SelectionCommand(index, event);
	}
	...
	public void ScheduleDelayedItemsLayout()
	{
		this.handle.ScheduleDelayedItemsLayout();
	}
	
	public void ExecuteDelayedItemsLayout()
	{
		this.handle.ExecuteDelayedItemsLayout();
	}
	
	public void SetDirtyRegion(IQRegion region)
	{
		this.handle.SetDirtyRegion(region);
	}
	
	public void ScrollDirtyRegion(int32 dx, int32 dy)
	{
		this.handle.ScrollDirtyRegion(dx, dy);
	}
	
	public void DirtyRegionOffset()
	{
		this.handle.DirtyRegionOffset();
	}
	
	public void StartAutoScroll()
	{
		this.handle.StartAutoScroll();
	}
	
	public void StopAutoScroll()
	{
		this.handle.StopAutoScroll();
	}
	
	public void DoAutoScroll()
	{
		this.handle.DoAutoScroll();
	}
	...
	public int64 DropIndicatorPosition()
	{
		return this.handle.DropIndicatorPosition();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractItemViewPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractItemViewPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QAbstractItemViewPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QAbstractItemViewPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QAbstractItemViewPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QAbstractItemViewPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QAbstractItemViewPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QAbstractItemViewPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QAbstractItemViewPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractItemViewPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractItemViewPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractItemViewPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractItemViewPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QAbstractItemViewPtr.DevicePixelRatioFScale();
	}
