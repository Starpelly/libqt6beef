...
public struct QPainterPtr : IQPainter, IDisposable
{
	...
	{
		return CQt.QPainter_Begin(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
...
{
	public QPainterPtr handle;
	
	public static implicit operator QPainterPtr(Self self)
	{
		return self.handle;
	}
	...
	public bool Begin(IQPaintDevice param1)
	{
		return this.handle.Begin(param1);
	}
...
public struct QPainter__PixmapFragmentPtr : IQPainter__PixmapFragment, IDisposable
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		CQt.QPainter__PixmapFragment_Create((pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (sourceRect == default || sourceRect.NativePtr == default) ? default : sourceRect.NativePtr);
	}
	
	public static void Create3(IQPointF pos, IQRectF sourceRect, double scaleX)
	{
		CQt.QPainter__PixmapFragment_Create3((pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (sourceRect == default || sourceRect.NativePtr == default) ? default : sourceRect.NativePtr, scaleX);
	}
	
	public static void Create4(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY)
	{
		CQt.QPainter__PixmapFragment_Create4((pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (sourceRect == default || sourceRect.NativePtr == default) ? default : sourceRect.NativePtr, scaleX, scaleY);
	}
	
	public static void Create5(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY, double rotation)
	{
		CQt.QPainter__PixmapFragment_Create5((pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (sourceRect == default || sourceRect.NativePtr == default) ? default : sourceRect.NativePtr, scaleX, scaleY, rotation);
	}
	
	public static void Create6(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY, double rotation, double opacity)
	{
		CQt.QPainter__PixmapFragment_Create6((pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (sourceRect == default || sourceRect.NativePtr == default) ? default : sourceRect.NativePtr, scaleX, scaleY, rotation, opacity);
	}
	
}
public class QPainter__PixmapFragment
{
	public QPainter__PixmapFragmentPtr handle;
	
	public static implicit operator QPainter__PixmapFragmentPtr(Self self)
	{
		return self.handle;
	}
	...
	public static void Create(IQPointF pos, IQRectF sourceRect)
	{
		QPainter__PixmapFragmentPtr.Create(pos, sourceRect);
	}
	
	public static void Create3(IQPointF pos, IQRectF sourceRect, double scaleX)
	{
		QPainter__PixmapFragmentPtr.Create3(pos, sourceRect, scaleX);
	}
	
	public static void Create4(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY)
	{
		QPainter__PixmapFragmentPtr.Create4(pos, sourceRect, scaleX, scaleY);
	}
	
	public static void Create5(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY, double rotation)
	{
		QPainter__PixmapFragmentPtr.Create5(pos, sourceRect, scaleX, scaleY, rotation);
	}
	
	public static void Create6(IQPointF pos, IQRectF sourceRect, double scaleX, double scaleY, double rotation, double opacity)
	{
		QPainter__PixmapFragmentPtr.Create6(pos, sourceRect, scaleX, scaleY, rotation, opacity);
	}
