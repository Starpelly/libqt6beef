...
public struct QIODevicePtr : IQIODevice, IDisposable, IQObject, IQIODeviceBase
{
	...
	{
		return CQt.QIODevice_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public int64 ReadLineData(char8* data, int64 maxlen)
	{
		return CQt.QIODevice_ReadLineData(this.nativePtr, data, maxlen);
	}
	
	public int64 SkipData(int64 maxSize)
	{
...
{
	public QIODevicePtr handle;
	
	public static implicit operator QIODevicePtr(Self self)
	{
		return self.handle;
	}
	...
	{
		return this.handle.ReadLineData(data, maxlen);
	}
	
	public virtual int64 SkipData(int64 maxSize)
	{
		return this.handle.SkipData(maxSize);
	}
	...
	public void SetOpenMode(int64 openMode)
	{
		this.handle.SetOpenMode(openMode);
	}
	
	public void SetErrorString(String errorString)
	{
		this.handle.SetErrorString(errorString);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QIODevicePtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QIODevicePtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QIODevicePtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QIODevicePtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QIODevicePtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QIODevicePtr.Connect5(sender, signal, receiver, method, typeVal);
	}
