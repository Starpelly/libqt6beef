...
public class QCalendarWidget
{
	...
	{
		this.nativePtr = CQt.QCalendarWidget_new(parent);
	}
	...
	public void SetMinimumDate(void date)
	{
		CQt.QCalendarWidget_SetMinimumDate(this.nativePtr, date);
	}
	...
	public void SetMaximumDate(void date)
	{
		CQt.QCalendarWidget_SetMaximumDate(this.nativePtr, date);
	}
	...
	{
		CQt.QCalendarWidget_SetCalendar(this.nativePtr, calendar);
	}
	...
	public void SetHeaderTextFormat(void* format)
	{
		CQt.QCalendarWidget_SetHeaderTextFormat(this.nativePtr, format);
	}
	...
	public void SetWeekdayTextFormat(int64 dayOfWeek, void* format)
	{
		CQt.QCalendarWidget_SetWeekdayTextFormat(this.nativePtr, dayOfWeek, format);
	}
	...
	public void DateTextFormatWithDate(void date)
	{
		CQt.QCalendarWidget_DateTextFormatWithDate(this.nativePtr, date);
	}
	
	public void SetDateTextFormat(void date, void* format)
	{
		CQt.QCalendarWidget_SetDateTextFormat(this.nativePtr, date, format);
	}
	...
	{
		return CQt.QCalendarWidget_Event(this.nativePtr, event);
	}
	
	public virtual bool EventFilter(void* watched, void* event)
	{
		return CQt.QCalendarWidget_EventFilter(this.nativePtr, watched, event);
	}
	
	public virtual void MousePressEvent(void* event)
	{
		CQt.QCalendarWidget_MousePressEvent(this.nativePtr, event);
	}
	
	public virtual void ResizeEvent(void* event)
	{
		CQt.QCalendarWidget_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void KeyPressEvent(void* event)
	{
		CQt.QCalendarWidget_KeyPressEvent(this.nativePtr, event);
	}
	
	public virtual void PaintCell(void* painter, void* rect, void date)
	{
		CQt.QCalendarWidget_PaintCell(this.nativePtr, painter, rect, date);
	}
	
	public void UpdateCell(void date)
	{
		CQt.QCalendarWidget_UpdateCell(this.nativePtr, date);
	}
	...
	public void SetSelectedDate(void date)
	{
		CQt.QCalendarWidget_SetSelectedDate(this.nativePtr, date);
	}
	
	public void SetDateRange(void min, void max)
	{
		CQt.QCalendarWidget_SetDateRange(this.nativePtr, min, max);
	}
