...
public class QLabel : IQLabel, IQFrame
{
	...
	{
		this.nativePtr = CQt.QLabel_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QLabel_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QLabel_Pixmap(this.nativePtr, param1);
	}
	...
	{
		CQt.QLabel_Picture(this.nativePtr, param1);
	}
	...
	{
		CQt.QLabel_SetTextFormat(this.nativePtr, textFormat);
	}
	...
	{
		CQt.QLabel_SetBuddy(this.nativePtr, (buddy == null) ? null : (void*)buddy.NativePtr);
	}
	...
	{
		CQt.QLabel_SetPixmap(this.nativePtr, (pixmap == default) ? default : (void*)pixmap.NativePtr);
	}
	
	public void SetPicture(IQPicture picture)
	{
		CQt.QLabel_SetPicture(this.nativePtr, (picture == default) ? default : (void*)picture.NativePtr);
	}
	
	public void SetMovie(IQMovie movie)
	{
		CQt.QLabel_SetMovie(this.nativePtr, (movie == null) ? null : (void*)movie.NativePtr);
	}
	...
	{
		return CQt.QLabel_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent ev)
	{
		CQt.QLabel_KeyPressEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QLabel_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QLabel_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MousePressEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MouseMoveEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MouseReleaseEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void ContextMenuEvent(IQContextMenuEvent ev)
	{
		CQt.QLabel_ContextMenuEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void FocusInEvent(IQFocusEvent ev)
	{
		CQt.QLabel_FocusInEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void FocusOutEvent(IQFocusEvent ev)
	{
		CQt.QLabel_FocusOutEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
