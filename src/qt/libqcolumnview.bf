...
public class QColumnView
{
	...
	{
		this.nativePtr = CQt.QColumnView_new(parent);
	}
	...
	{
		CQt.QColumnView_IndexAt(this.nativePtr, point);
	}
	
	public virtual void ScrollTo(void* index, int64 hint)
	{
		CQt.QColumnView_ScrollTo(this.nativePtr, index, hint);
	}
	...
	{
		CQt.QColumnView_VisualRect(this.nativePtr, index);
	}
	
	public virtual void SetModel(void* model)
	{
		CQt.QColumnView_SetModel(this.nativePtr, model);
	}
	
	public virtual void SetSelectionModel(void* selectionModel)
	{
		CQt.QColumnView_SetSelectionModel(this.nativePtr, selectionModel);
	}
	
	public virtual void SetRootIndex(void* index)
	{
		CQt.QColumnView_SetRootIndex(this.nativePtr, index);
	}
	...
	public void SetPreviewWidget(void* widget)
	{
		CQt.QColumnView_SetPreviewWidget(this.nativePtr, widget);
	}
	
	public void SetColumnWidths(int32[] list)
	{
		CQt.QColumnView_SetColumnWidths(this.nativePtr, list);
	}
	...
	{
		return CQt.QColumnView_IsIndexHidden(this.nativePtr, index);
	}
	...
	{
		CQt.QColumnView_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void SetSelection(void* rect, int64 command)
	{
		CQt.QColumnView_SetSelection(this.nativePtr, rect, command);
	}
	
	public virtual void VisualRegionForSelection(void* selection)
	{
		CQt.QColumnView_VisualRegionForSelection(this.nativePtr, selection);
	}
	...
	{
		CQt.QColumnView_RowsInserted(this.nativePtr, parent, start, end);
	}
	
	public virtual void CurrentChanged(void* current, void* previous)
	{
		CQt.QColumnView_CurrentChanged(this.nativePtr, current, previous);
	}
	...
	public virtual void* CreateColumn(void* rootIndex)
	{
		return CQt.QColumnView_CreateColumn(this.nativePtr, rootIndex);
	}
	
	public void InitializeColumn(void* column)
	{
		CQt.QColumnView_InitializeColumn(this.nativePtr, column);
	}
