...
public class QDialogButtonBox
{
	...
	{
		this.nativePtr = CQt.QDialogButtonBox_new(parent);
	}
	...
	{
		CQt.QDialogButtonBox_AddButton(this.nativePtr, button, role);
	}
	
	public void* AddButton2(libqt_string text, int64 role)
	{
		return CQt.QDialogButtonBox_AddButton2(this.nativePtr, text, role);
	}
	...
	{
		CQt.QDialogButtonBox_RemoveButton(this.nativePtr, button);
	}
	...
	{
		return CQt.QDialogButtonBox_ButtonRole(this.nativePtr, button);
	}
	...
	{
		return CQt.QDialogButtonBox_StandardButton(this.nativePtr, button);
	}
	...
	{
		CQt.QDialogButtonBox_ChangeEvent(this.nativePtr, event);
	}
	
	public virtual bool Event(void* event)
	{
		return CQt.QDialogButtonBox_Event(this.nativePtr, event);
	}
