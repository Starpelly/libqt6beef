...
public interface IQDialogButtonBox
{
	void* NativePtr { get; }
}
public struct QDialogButtonBoxPtr : IQDialogButtonBox, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QDialogButtonBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QDialogButtonBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QDialogButtonBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QDialogButtonBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QDialogButtonBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QDialogButtonBox_SetOrientation(this.nativePtr, (int64)orientation);
	}
	
	public int64 Orientation()
	{
		return CQt.QDialogButtonBox_Orientation(this.nativePtr);
	}
	
	public void AddButton(IQAbstractButton button, int64 role)
	{
		CQt.QDialogButtonBox_AddButton(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr, (int64)role);
	}
	
	public void* AddButton2(String text, int64 role)
	{
		return CQt.QDialogButtonBox_AddButton2(this.nativePtr, libqt_string(text), (int64)role);
	}
	
	public void* AddButtonWithButton(int64 button)
	{
		return CQt.QDialogButtonBox_AddButtonWithButton(this.nativePtr, (int64)button);
	}
	
	public void RemoveButton(IQAbstractButton button)
	{
		CQt.QDialogButtonBox_RemoveButton(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr);
	}
	
	public void Clear()
	{
		CQt.QDialogButtonBox_Clear(this.nativePtr);
	}
	
	public void*[] Buttons()
	{
		return CQt.QDialogButtonBox_Buttons(this.nativePtr);
	}
	
	public int64 ButtonRole(IQAbstractButton button)
	{
		return CQt.QDialogButtonBox_ButtonRole(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr);
	}
	
	public void SetStandardButtons(int64 buttons)
	{
		CQt.QDialogButtonBox_SetStandardButtons(this.nativePtr, buttons);
	}
	
	public int64 StandardButtons()
	{
		return CQt.QDialogButtonBox_StandardButtons(this.nativePtr);
	}
	
	public int64 StandardButton(IQAbstractButton button)
	{
		return CQt.QDialogButtonBox_StandardButton(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr);
	}
	
	public void* Button(int64 which)
	{
		return CQt.QDialogButtonBox_Button(this.nativePtr, (int64)which);
	}
	
	public void SetCenterButtons(bool center)
	{
		CQt.QDialogButtonBox_SetCenterButtons(this.nativePtr, center);
	}
	
	public bool CenterButtons()
	{
		return CQt.QDialogButtonBox_CenterButtons(this.nativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QDialogButtonBox_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QDialogButtonBox_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
...
{
	public QDialogButtonBoxPtr handle;
	
	public static implicit operator QDialogButtonBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QDialogButtonBoxPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QDialogButtonBoxPtr.Tr(s);
	}
	...
	public void SetCenterButtons(bool center)
	{
		this.handle.SetCenterButtons(center);
	}
	
	public bool CenterButtons()
	{
		return this.handle.CenterButtons();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QDialogButtonBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QDialogButtonBoxPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QDialogButtonBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QDialogButtonBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QDialogButtonBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QDialogButtonBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QDialogButtonBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QDialogButtonBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QDialogButtonBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QDialogButtonBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QDialogButtonBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QDialogButtonBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QDialogButtonBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QDialogButtonBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QDialogButtonBox_new(void* parent);
	[LinkName("QDialogButtonBox_new2")]
	public static extern void* QDialogButtonBox_new2();
	[LinkName("QDialogButtonBox_new3")]
	public static extern void* QDialogButtonBox_new3(int64 orientation);
	[LinkName("QDialogButtonBox_new4")]
	public static extern void* QDialogButtonBox_new4(int64 buttons);
	[LinkName("QDialogButtonBox_new5")]
	public static extern void* QDialogButtonBox_new5(int64 buttons, int64 orientation);
	[LinkName("QDialogButtonBox_new6")]
	public static extern void* QDialogButtonBox_new6(int64 orientation, void* parent);
	[LinkName("QDialogButtonBox_new7")]
	public static extern void* QDialogButtonBox_new7(int64 buttons, void* parent);
	[LinkName("QDialogButtonBox_new8")]
	public static extern void* QDialogButtonBox_new8(int64 buttons, int64 orientation, void* parent);
	[LinkName("QDialogButtonBox_MetaObject")]
	public static extern void* QDialogButtonBox_MetaObject(void* c_this);
	[LinkName("QDialogButtonBox_Metacast")]
	public static extern void* QDialogButtonBox_Metacast(void* c_this, char8* param1);
	[LinkName("QDialogButtonBox_Metacall")]
	public static extern int32 QDialogButtonBox_Metacall(void* c_this, int64 param1, int32 param2, void* param3);
	...
	public static extern void QDialogButtonBox_SetOrientation(void* c_this, int64 orientation);
	[LinkName("QDialogButtonBox_Orientation")]
	public static extern int64 QDialogButtonBox_Orientation(void* c_this);
	[LinkName("QDialogButtonBox_AddButton")]
	public static extern void QDialogButtonBox_AddButton(void* c_this, void* button, int64 role);
	[LinkName("QDialogButtonBox_AddButton2")]
	public static extern void* QDialogButtonBox_AddButton2(void* c_this, libqt_string text, int64 role);
	[LinkName("QDialogButtonBox_AddButtonWithButton")]
	public static extern void* QDialogButtonBox_AddButtonWithButton(void* c_this, int64 button);
	[LinkName("QDialogButtonBox_RemoveButton")]
	public static extern void QDialogButtonBox_RemoveButton(void* c_this, void* button);
	[LinkName("QDialogButtonBox_Clear")]
	public static extern void QDialogButtonBox_Clear(void* c_this);
	[LinkName("QDialogButtonBox_Buttons")]
	public static extern void*[] QDialogButtonBox_Buttons(void* c_this);
	[LinkName("QDialogButtonBox_ButtonRole")]
	public static extern int64 QDialogButtonBox_ButtonRole(void* c_this, void* button);
	[LinkName("QDialogButtonBox_SetStandardButtons")]
	public static extern void QDialogButtonBox_SetStandardButtons(void* c_this, int64 buttons);
	[LinkName("QDialogButtonBox_StandardButtons")]
	public static extern int64 QDialogButtonBox_StandardButtons(void* c_this);
	[LinkName("QDialogButtonBox_StandardButton")]
	public static extern int64 QDialogButtonBox_StandardButton(void* c_this, void* button);
	[LinkName("QDialogButtonBox_Button")]
	public static extern void* QDialogButtonBox_Button(void* c_this, int64 which);
	[LinkName("QDialogButtonBox_SetCenterButtons")]
	public static extern void QDialogButtonBox_SetCenterButtons(void* c_this, bool center);
	[LinkName("QDialogButtonBox_CenterButtons")]
	public static extern bool QDialogButtonBox_CenterButtons(void* c_this);
	[LinkName("QDialogButtonBox_Connect_Clicked")]
	public static extern void QDialogButtonBox_Connect_Clicked(void* c_this, c_intptr slot);
	[LinkName("QDialogButtonBox_Connect_Accepted")]
	public static extern void QDialogButtonBox_Connect_Accepted(void* c_this, c_intptr slot);
	[LinkName("QDialogButtonBox_Connect_HelpRequested")]
	public static extern void QDialogButtonBox_Connect_HelpRequested(void* c_this, c_intptr slot);
	[LinkName("QDialogButtonBox_Connect_Rejected")]
	public static extern void QDialogButtonBox_Connect_Rejected(void* c_this, c_intptr slot);
	[LinkName("QDialogButtonBox_ChangeEvent")]
	public static extern void QDialogButtonBox_ChangeEvent(void* c_this, void* event);
	[LinkName("QDialogButtonBox_Event")]
	public static extern bool QDialogButtonBox_Event(void* c_this, void* event);
	...
	public static extern void QDialogButtonBox_Delete(void* self);
}