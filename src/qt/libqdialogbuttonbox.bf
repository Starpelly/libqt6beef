...
public class QDialogButtonBox : IQDialogButtonBox, IQWidget
{
	...
	{
		this.nativePtr = CQt.QDialogButtonBox_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QDialogButtonBox_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QDialogButtonBox_SetOrientation(this.nativePtr, orientation);
	}
	...
	{
		CQt.QDialogButtonBox_AddButton(this.nativePtr, (button == null) ? null : (void*)button.NativePtr, role);
	}
	
	public void* AddButton2(String text, int64 role)
	{
		return CQt.QDialogButtonBox_AddButton2(this.nativePtr, libqt_string(text), role);
	}
	
	public void* AddButtonWithButton(int64 button)
	{
		return CQt.QDialogButtonBox_AddButtonWithButton(this.nativePtr, button);
	}
	
	public void RemoveButton(IQAbstractButton button)
	{
		CQt.QDialogButtonBox_RemoveButton(this.nativePtr, (button == null) ? null : (void*)button.NativePtr);
	}
	...
	{
		return CQt.QDialogButtonBox_ButtonRole(this.nativePtr, (button == null) ? null : (void*)button.NativePtr);
	}
	...
	{
		return CQt.QDialogButtonBox_StandardButton(this.nativePtr, (button == null) ? null : (void*)button.NativePtr);
	}
	
	public void* Button(int64 which)
	{
		return CQt.QDialogButtonBox_Button(this.nativePtr, which);
	}
	...
	{
		CQt.QDialogButtonBox_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual bool Event(IQEvent event)
	{
		return CQt.QDialogButtonBox_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
