...
public class QKeySequenceEdit
{
	...
	{
		this.nativePtr = CQt.QKeySequenceEdit_new(parent);
	}
	...
	public void SetKeySequence(void* keySequence)
	{
		CQt.QKeySequenceEdit_SetKeySequence(this.nativePtr, keySequence);
	}
	...
	{
		return CQt.QKeySequenceEdit_Event(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QKeySequenceEdit_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyReleaseEvent(void* param1)
	{
		CQt.QKeySequenceEdit_KeyReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void TimerEvent(void* param1)
	{
		CQt.QKeySequenceEdit_TimerEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusOutEvent(void* param1)
	{
		CQt.QKeySequenceEdit_FocusOutEvent(this.nativePtr, param1);
	}
