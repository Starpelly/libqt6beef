...
public interface IQKeySequenceEdit
{
	void* NativePtr { get; }
}
public struct QKeySequenceEditPtr : IQKeySequenceEdit, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QKeySequenceEdit_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QKeySequenceEdit_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QKeySequenceEdit_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QKeySequenceEdit_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QKeySequenceEdit_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public void KeySequence()
	{
		CQt.QKeySequenceEdit_KeySequence(this.nativePtr);
	}
	
	public void SetClearButtonEnabled(bool enable)
	{
		CQt.QKeySequenceEdit_SetClearButtonEnabled(this.nativePtr, enable);
	}
	
	public bool IsClearButtonEnabled()
	{
		return CQt.QKeySequenceEdit_IsClearButtonEnabled(this.nativePtr);
	}
	
	public void SetKeySequence(IQKeySequence keySequence)
	{
		CQt.QKeySequenceEdit_SetKeySequence(this.nativePtr, (keySequence == default || keySequence.NativePtr == default) ? default : keySequence.NativePtr);
	}
	
	public void Clear()
	{
		CQt.QKeySequenceEdit_Clear(this.nativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QKeySequenceEdit_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyReleaseEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QKeySequenceEdit_TimerEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent param1)
	{
		CQt.QKeySequenceEdit_FocusOutEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
...
{
	public QKeySequenceEditPtr handle;
	
	public static implicit operator QKeySequenceEditPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QKeySequenceEditPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QKeySequenceEditPtr.Tr(s);
	}
	
	public void KeySequence()
	{
		this.handle.KeySequence();
	}
	...
	public void SetKeySequence(IQKeySequence keySequence)
	{
		this.handle.SetKeySequence(keySequence);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QKeySequenceEditPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QKeySequenceEditPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QKeySequenceEditPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QKeySequenceEditPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QKeySequenceEditPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QKeySequenceEditPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QKeySequenceEditPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QKeySequenceEditPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QKeySequenceEditPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QKeySequenceEditPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QKeySequenceEditPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QKeySequenceEditPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QKeySequenceEditPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QKeySequenceEditPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QKeySequenceEdit_new(void* parent);
	[LinkName("QKeySequenceEdit_new2")]
	public static extern void* QKeySequenceEdit_new2();
	[LinkName("QKeySequenceEdit_new3")]
	public static extern void* QKeySequenceEdit_new3(void* keySequence);
	[LinkName("QKeySequenceEdit_new4")]
	public static extern void* QKeySequenceEdit_new4(void* keySequence, void* parent);
	[LinkName("QKeySequenceEdit_MetaObject")]
	public static extern void* QKeySequenceEdit_MetaObject(void* c_this);
	[LinkName("QKeySequenceEdit_Metacast")]
	public static extern void* QKeySequenceEdit_Metacast(void* c_this, char8* param1);
	[LinkName("QKeySequenceEdit_Metacall")]
	public static extern int32 QKeySequenceEdit_Metacall(void* c_this, int64 param1, int32 param2, void* param3);
	...
	public static extern void QKeySequenceEdit_KeySequence(void* c_this);
	[LinkName("QKeySequenceEdit_SetClearButtonEnabled")]
	public static extern void QKeySequenceEdit_SetClearButtonEnabled(void* c_this, bool enable);
	[LinkName("QKeySequenceEdit_IsClearButtonEnabled")]
	public static extern bool QKeySequenceEdit_IsClearButtonEnabled(void* c_this);
	[LinkName("QKeySequenceEdit_SetKeySequence")]
	public static extern void QKeySequenceEdit_SetKeySequence(void* c_this, void* keySequence);
	[LinkName("QKeySequenceEdit_Clear")]
	public static extern void QKeySequenceEdit_Clear(void* c_this);
	[LinkName("QKeySequenceEdit_Connect_EditingFinished")]
	public static extern void QKeySequenceEdit_Connect_EditingFinished(void* c_this, c_intptr slot);
	[LinkName("QKeySequenceEdit_Connect_KeySequenceChanged")]
	public static extern void QKeySequenceEdit_Connect_KeySequenceChanged(void* c_this, c_intptr slot);
	[LinkName("QKeySequenceEdit_Event")]
	public static extern bool QKeySequenceEdit_Event(void* c_this, void* param1);
	[LinkName("QKeySequenceEdit_KeyPressEvent")]
	public static extern void QKeySequenceEdit_KeyPressEvent(void* c_this, void* param1);
	[LinkName("QKeySequenceEdit_KeyReleaseEvent")]
	public static extern void QKeySequenceEdit_KeyReleaseEvent(void* c_this, void* param1);
	[LinkName("QKeySequenceEdit_TimerEvent")]
	public static extern void QKeySequenceEdit_TimerEvent(void* c_this, void* param1);
	[LinkName("QKeySequenceEdit_FocusOutEvent")]
	public static extern void QKeySequenceEdit_FocusOutEvent(void* c_this, void* param1);
	...
	public static extern void QKeySequenceEdit_Delete(void* self);
}