...
public class QKeySequenceEdit : IQKeySequenceEdit, IQWidget
{
	...
	{
		this.nativePtr = CQt.QKeySequenceEdit_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QKeySequenceEdit_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QKeySequenceEdit_SetKeySequence(this.nativePtr, (keySequence == default) ? default : (void*)keySequence.NativePtr);
	}
	...
	{
		return CQt.QKeySequenceEdit_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyPressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void KeyReleaseEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyReleaseEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void TimerEvent(IQTimerEvent param1)
	{
		CQt.QKeySequenceEdit_TimerEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void FocusOutEvent(IQFocusEvent param1)
	{
		CQt.QKeySequenceEdit_FocusOutEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
