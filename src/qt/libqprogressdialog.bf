...
public interface IQProgressDialog
{
	void* NativePtr { get; }
}
public struct QProgressDialogPtr : IQProgressDialog, IDisposable, IQDialog
{
	...
	{
		return .(CQt.QProgressDialog_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QProgressDialog_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QProgressDialog_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QProgressDialog_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QProgressDialog_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QProgressDialog_SetLabel(this.nativePtr, (label == default || label.NativePtr == default) ? default : label.NativePtr);
	}
	
	public void SetCancelButton(IQPushButton button)
	{
		CQt.QProgressDialog_SetCancelButton(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr);
	}
	
	public void SetBar(IQProgressBar bar)
	{
		CQt.QProgressDialog_SetBar(this.nativePtr, (bar == default || bar.NativePtr == default) ? default : bar.NativePtr);
	}
	
	public bool WasCanceled()
	{
		return CQt.QProgressDialog_WasCanceled(this.nativePtr);
	}
	
	public int32 Minimum()
	{
		return CQt.QProgressDialog_Minimum(this.nativePtr);
	}
	
	public int32 Maximum()
	{
		return CQt.QProgressDialog_Maximum(this.nativePtr);
	}
	
	public int32 Value()
	{
		return CQt.QProgressDialog_Value(this.nativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QProgressDialog_SizeHint(this.nativePtr);
	}
	
	public libqt_string LabelText()
	{
		return CQt.QProgressDialog_LabelText(this.nativePtr);
	}
	
	public int32 MinimumDuration()
	{
		return CQt.QProgressDialog_MinimumDuration(this.nativePtr);
	}
	
	public void SetAutoReset(bool reset)
	{
		CQt.QProgressDialog_SetAutoReset(this.nativePtr, reset);
	}
	
	public bool AutoReset()
	{
		return CQt.QProgressDialog_AutoReset(this.nativePtr);
	}
	
	public void SetAutoClose(bool close)
	{
		CQt.QProgressDialog_SetAutoClose(this.nativePtr, close);
	}
	
	public bool AutoClose()
	{
		return CQt.QProgressDialog_AutoClose(this.nativePtr);
	}
	
	public void Cancel()
	{
		CQt.QProgressDialog_Cancel(this.nativePtr);
	}
	
	public void Reset()
	{
		CQt.QProgressDialog_Reset(this.nativePtr);
	}
	
	public void SetMaximum(int32 maximum)
	{
		CQt.QProgressDialog_SetMaximum(this.nativePtr, maximum);
	}
	
	public void SetMinimum(int32 minimum)
	{
		CQt.QProgressDialog_SetMinimum(this.nativePtr, minimum);
	}
	
	public void SetRange(int32 minimum, int32 maximum)
	{
		CQt.QProgressDialog_SetRange(this.nativePtr, minimum, maximum);
	}
	
	public void SetValue(int32 progress)
	{
		CQt.QProgressDialog_SetValue(this.nativePtr, progress);
	}
	
	public void SetLabelText(String text)
	{
		CQt.QProgressDialog_SetLabelText(this.nativePtr, libqt_string(text));
	}
	
	public void SetCancelButtonText(String text)
	{
		CQt.QProgressDialog_SetCancelButtonText(this.nativePtr, libqt_string(text));
	}
	
	public void SetMinimumDuration(int32 ms)
	{
		CQt.QProgressDialog_SetMinimumDuration(this.nativePtr, ms);
	}
	
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QProgressDialog_ResizeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QProgressDialog_CloseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QProgressDialog_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QProgressDialog_ShowEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ForceShow()
	{
		CQt.QProgressDialog_ForceShow(this.nativePtr);
	}
...
{
	public QProgressDialogPtr handle;
	
	public static implicit operator QProgressDialogPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QProgressDialogPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QProgressDialogPtr.Tr(s);
	}
	...
	public void SetCancelButton(IQPushButton button)
	{
		this.handle.SetCancelButton(button);
	}
	
	public void SetBar(IQProgressBar bar)
	{
		this.handle.SetBar(bar);
	}
	
	public bool WasCanceled()
	{
		return this.handle.WasCanceled();
	}
	...
	public int32 MinimumDuration()
	{
		return this.handle.MinimumDuration();
	}
	
	public void SetAutoReset(bool reset)
	{
		this.handle.SetAutoReset(reset);
	}
	
	public bool AutoReset()
	{
		return this.handle.AutoReset();
	}
	
	public void SetAutoClose(bool close)
	{
		this.handle.SetAutoClose(close);
	}
	
	public bool AutoClose()
	{
		return this.handle.AutoClose();
	}
	...
	public void SetRange(int32 minimum, int32 maximum)
	{
		this.handle.SetRange(minimum, maximum);
	}
	
	public void SetValue(int32 progress)
	{
		this.handle.SetValue(progress);
	}
	...
	public void SetMinimumDuration(int32 ms)
	{
		this.handle.SetMinimumDuration(ms);
	}
	...
	public void ForceShow()
	{
		this.handle.ForceShow();
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QProgressDialogPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QProgressDialogPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QProgressDialogPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QProgressDialogPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QProgressDialogPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QProgressDialogPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QProgressDialogPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QProgressDialogPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QProgressDialogPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QProgressDialogPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QProgressDialogPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QProgressDialogPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QProgressDialogPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QProgressDialogPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QProgressDialog_new(void* parent);
	[LinkName("QProgressDialog_new2")]
	public static extern void* QProgressDialog_new2();
	[LinkName("QProgressDialog_new3")]
	public static extern void* QProgressDialog_new3(libqt_string labelText, libqt_string cancelButtonText, int32 minimum, int32 maximum);
	[LinkName("QProgressDialog_new4")]
	public static extern void* QProgressDialog_new4(void* parent, int64 flags);
	[LinkName("QProgressDialog_new5")]
	public static extern void* QProgressDialog_new5(libqt_string labelText, libqt_string cancelButtonText, int32 minimum, int32 maximum, void* parent);
	[LinkName("QProgressDialog_new6")]
	public static extern void* QProgressDialog_new6(libqt_string labelText, libqt_string cancelButtonText, int32 minimum, int32 maximum, void* parent, int64 flags);
	[LinkName("QProgressDialog_MetaObject")]
	public static extern void* QProgressDialog_MetaObject(void* c_this);
	...
	public static extern void QProgressDialog_SetLabel(void* c_this, void* label);
	[LinkName("QProgressDialog_SetCancelButton")]
	public static extern void QProgressDialog_SetCancelButton(void* c_this, void* button);
	[LinkName("QProgressDialog_SetBar")]
	public static extern void QProgressDialog_SetBar(void* c_this, void* bar);
	...
	public static extern void QProgressDialog_SizeHint(void* c_this);
	[LinkName("QProgressDialog_LabelText")]
	public static extern libqt_string QProgressDialog_LabelText(void* c_this);
	...
	public static extern void QProgressDialog_SetLabelText(void* c_this, libqt_string text);
	[LinkName("QProgressDialog_SetCancelButtonText")]
	public static extern void QProgressDialog_SetCancelButtonText(void* c_this, libqt_string text);
	...
	public static extern void QProgressDialog_Connect_Canceled(void* c_this, c_intptr slot);
	[LinkName("QProgressDialog_ResizeEvent")]
	public static extern void QProgressDialog_ResizeEvent(void* c_this, void* event);
	[LinkName("QProgressDialog_CloseEvent")]
	public static extern void QProgressDialog_CloseEvent(void* c_this, void* event);
	[LinkName("QProgressDialog_ChangeEvent")]
	public static extern void QProgressDialog_ChangeEvent(void* c_this, void* event);
	[LinkName("QProgressDialog_ShowEvent")]
	public static extern void QProgressDialog_ShowEvent(void* c_this, void* event);
	...
	public static extern void QProgressDialog_Delete(void* self);
}