...
public class QProgressDialog
{
	...
	{
		this.nativePtr = CQt.QProgressDialog_new(parent);
	}
	...
	public void SetLabel(void* label)
	{
		CQt.QProgressDialog_SetLabel(this.nativePtr, label);
	}
	
	public void SetCancelButton(void* button)
	{
		CQt.QProgressDialog_SetCancelButton(this.nativePtr, button);
	}
	
	public void SetBar(void* bar)
	{
		CQt.QProgressDialog_SetBar(this.nativePtr, bar);
	}
	...
	{
		CQt.QProgressDialog_SetLabelText(this.nativePtr, text);
	}
	
	public void SetCancelButtonText(libqt_string text)
	{
		CQt.QProgressDialog_SetCancelButtonText(this.nativePtr, text);
	}
	...
	{
		CQt.QProgressDialog_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void CloseEvent(void* event)
	{
		CQt.QProgressDialog_CloseEvent(this.nativePtr, event);
	}
	
	public virtual void ChangeEvent(void* event)
	{
		CQt.QProgressDialog_ChangeEvent(this.nativePtr, event);
	}
	
	public virtual void ShowEvent(void* event)
	{
		CQt.QProgressDialog_ShowEvent(this.nativePtr, event);
	}
