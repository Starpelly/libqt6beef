...
public class QProgressDialog : IQProgressDialog, IQDialog
{
	...
	{
		this.nativePtr = CQt.QProgressDialog_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QProgressDialog_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QProgressDialog_SetLabel(this.nativePtr, (label == null) ? null : (void*)label.NativePtr);
	}
	
	public void SetCancelButton(IQPushButton button)
	{
		CQt.QProgressDialog_SetCancelButton(this.nativePtr, (button == null) ? null : (void*)button.NativePtr);
	}
	
	public void SetBar(IQProgressBar bar)
	{
		CQt.QProgressDialog_SetBar(this.nativePtr, (bar == null) ? null : (void*)bar.NativePtr);
	}
	...
	{
		CQt.QProgressDialog_ResizeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void CloseEvent(IQCloseEvent event)
	{
		CQt.QProgressDialog_CloseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent event)
	{
		CQt.QProgressDialog_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent event)
	{
		CQt.QProgressDialog_ShowEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
