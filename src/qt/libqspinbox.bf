...
public interface IQSpinBox
{
	void* NativePtr { get; }
}
public struct QSpinBoxPtr : IQSpinBox, IDisposable, IQAbstractSpinBox
{
	...
	{
		return .(CQt.QSpinBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QSpinBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QSpinBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QSpinBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QSpinBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public int32 Value()
	{
		return CQt.QSpinBox_Value(this.nativePtr);
	}
	
	public libqt_string Prefix()
	{
		return CQt.QSpinBox_Prefix(this.nativePtr);
	}
	
	public void SetPrefix(String prefix)
	{
		CQt.QSpinBox_SetPrefix(this.nativePtr, libqt_string(prefix));
	}
	
	public libqt_string Suffix()
	{
		return CQt.QSpinBox_Suffix(this.nativePtr);
	}
	
	public void SetSuffix(String suffix)
	{
		CQt.QSpinBox_SetSuffix(this.nativePtr, libqt_string(suffix));
	}
	
	public libqt_string CleanText()
	{
		return CQt.QSpinBox_CleanText(this.nativePtr);
	}
	
	public int32 SingleStep()
	{
		return CQt.QSpinBox_SingleStep(this.nativePtr);
	}
	
	public void SetSingleStep(int32 val)
	{
		CQt.QSpinBox_SetSingleStep(this.nativePtr, val);
	}
	
	public int32 Minimum()
	{
		return CQt.QSpinBox_Minimum(this.nativePtr);
	}
	
	public void SetMinimum(int32 min)
	{
		CQt.QSpinBox_SetMinimum(this.nativePtr, min);
	}
	
	public int32 Maximum()
	{
		return CQt.QSpinBox_Maximum(this.nativePtr);
	}
	
	public void SetMaximum(int32 max)
	{
		CQt.QSpinBox_SetMaximum(this.nativePtr, max);
	}
	
	public void SetRange(int32 min, int32 max)
	{
		CQt.QSpinBox_SetRange(this.nativePtr, min, max);
	}
	
	public int64 StepType()
	{
		return CQt.QSpinBox_StepType(this.nativePtr);
	}
	
	public void SetStepType(int64 stepType)
	{
		CQt.QSpinBox_SetStepType(this.nativePtr, (int64)stepType);
	}
	
	public int32 DisplayIntegerBase()
	{
		return CQt.QSpinBox_DisplayIntegerBase(this.nativePtr);
	}
	
	public void SetDisplayIntegerBase(int32 _base)
	{
		CQt.QSpinBox_SetDisplayIntegerBase(this.nativePtr, _base);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QSpinBox_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public int64 Validate(String input, int32* pos)
	{
		return CQt.QSpinBox_Validate(this.nativePtr, libqt_string(input), pos);
	}
	
	public int32 ValueFromText(String text)
	{
		return CQt.QSpinBox_ValueFromText(this.nativePtr, libqt_string(text));
	}
	
	public libqt_string TextFromValue(int32 val)
	{
		return CQt.QSpinBox_TextFromValue(this.nativePtr, val);
	}
	
	public void Fixup(String str)
	{
		CQt.QSpinBox_Fixup(this.nativePtr, libqt_string(str));
	}
	
	public void SetValue(int32 val)
	{
		CQt.QSpinBox_SetValue(this.nativePtr, val);
	}
	...
	{
		CQt.QAbstractSpinBox_SetButtonSymbols(this.nativePtr, (int64)bs);
	}
	
	public void SetCorrectionMode(int64 cm)
	{
		CQt.QAbstractSpinBox_SetCorrectionMode(this.nativePtr, (int64)cm);
	}
	...
	{
		CQt.QAbstractSpinBox_SizeHint(this.nativePtr);
	}
	...
	{
		CQt.QAbstractSpinBox_InputMethodQuery(this.nativePtr, (int64)param1);
	}
	
	public void StepBy(int32 steps)
	{
		CQt.QAbstractSpinBox_StepBy(this.nativePtr, steps);
	}
	...
	public void Clear()
	{
		CQt.QAbstractSpinBox_Clear(this.nativePtr);
	}
...
{
	public QSpinBoxPtr handle;
	
	public static implicit operator QSpinBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QSpinBoxPtr.New(parent);
	}
	...
	public libqt_string CleanText()
	{
		return this.handle.CleanText();
	}
	
	public int32 SingleStep()
	{
		return this.handle.SingleStep();
	}
	
	public void SetSingleStep(int32 val)
	{
		this.handle.SetSingleStep(val);
	}
	
	public int32 Minimum()
	{
		return this.handle.Minimum();
	}
	
	public void SetMinimum(int32 min)
	{
		this.handle.SetMinimum(min);
	}
	
	public int32 Maximum()
	{
		return this.handle.Maximum();
	}
	
	public void SetMaximum(int32 max)
	{
		this.handle.SetMaximum(max);
	}
	
	public void SetRange(int32 min, int32 max)
	{
		this.handle.SetRange(min, max);
	}
	
	public int64 StepType()
	{
		return this.handle.StepType();
	}
	
	public void SetStepType(int64 stepType)
	{
		this.handle.SetStepType(stepType);
	}
	
	public int32 DisplayIntegerBase()
	{
		return this.handle.DisplayIntegerBase();
	}
	
	public void SetDisplayIntegerBase(int32 _base)
	{
		this.handle.SetDisplayIntegerBase(_base);
	}
	...
	public virtual int32 ValueFromText(String text)
	{
		return this.handle.ValueFromText(text);
	}
	
	public virtual libqt_string TextFromValue(int32 val)
	{
		return this.handle.TextFromValue(val);
	}
	
	public virtual void Fixup(String str)
	{
		this.handle.Fixup(str);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSpinBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSpinBoxPtr.Tr3(s, c, n);
	}
	
	public int64 ButtonSymbols()
	{
		return this.handle.ButtonSymbols();
	}
	
	public void SetButtonSymbols(int64 bs)
	{
		this.handle.SetButtonSymbols(bs);
	}
	
	public void SetCorrectionMode(int64 cm)
	{
		this.handle.SetCorrectionMode(cm);
	}
	
	public int64 CorrectionMode()
	{
		return this.handle.CorrectionMode();
	}
	...
	public libqt_string SpecialValueText()
	{
		return this.handle.SpecialValueText();
	}
	
	public void SetSpecialValueText(String txt)
	{
		this.handle.SetSpecialValueText(txt);
	}
	
	public bool Wrapping()
	{
		return this.handle.Wrapping();
	}
	
	public void SetWrapping(bool w)
	{
		this.handle.SetWrapping(w);
	}
	
	public void SetReadOnly(bool r)
	{
		this.handle.SetReadOnly(r);
	}
	...
	public void SetKeyboardTracking(bool kt)
	{
		this.handle.SetKeyboardTracking(kt);
	}
	
	public bool KeyboardTracking()
	{
		return this.handle.KeyboardTracking();
	}
	...
	public void SetAccelerated(bool on)
	{
		this.handle.SetAccelerated(on);
	}
	
	public bool IsAccelerated()
	{
		return this.handle.IsAccelerated();
	}
	
	public void SetGroupSeparatorShown(bool shown)
	{
		this.handle.SetGroupSeparatorShown(shown);
	}
	
	public bool IsGroupSeparatorShown()
	{
		return this.handle.IsGroupSeparatorShown();
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QSpinBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QSpinBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QSpinBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QSpinBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QSpinBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QSpinBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QSpinBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSpinBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSpinBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSpinBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSpinBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QSpinBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QSpinBox_new(void* parent);
	[LinkName("QSpinBox_new2")]
	public static extern void* QSpinBox_new2();
	[LinkName("QSpinBox_MetaObject")]
	public static extern void* QSpinBox_MetaObject(void* c_this);
	...
	public static extern libqt_string QSpinBox_Prefix(void* c_this);
	[LinkName("QSpinBox_SetPrefix")]
	public static extern void QSpinBox_SetPrefix(void* c_this, libqt_string prefix);
	[LinkName("QSpinBox_Suffix")]
	public static extern libqt_string QSpinBox_Suffix(void* c_this);
	[LinkName("QSpinBox_SetSuffix")]
	public static extern void QSpinBox_SetSuffix(void* c_this, libqt_string suffix);
	[LinkName("QSpinBox_CleanText")]
	public static extern libqt_string QSpinBox_CleanText(void* c_this);
	...
	public static extern bool QSpinBox_Event(void* c_this, void* event);
	[LinkName("QSpinBox_Validate")]
	public static extern int64 QSpinBox_Validate(void* c_this, libqt_string input, int32* pos);
	[LinkName("QSpinBox_ValueFromText")]
	public static extern int32 QSpinBox_ValueFromText(void* c_this, libqt_string text);
	[LinkName("QSpinBox_TextFromValue")]
	public static extern libqt_string QSpinBox_TextFromValue(void* c_this, int32 val);
	[LinkName("QSpinBox_Fixup")]
	public static extern void QSpinBox_Fixup(void* c_this, libqt_string str);
	...
	public static extern void QSpinBox_Connect_ValueChanged(void* c_this, c_intptr slot);
	[LinkName("QSpinBox_Connect_TextChanged")]
	public static extern void QSpinBox_Connect_TextChanged(void* c_this, c_intptr slot);
	...
	public static extern void QSpinBox_Delete(void* self);
}
public interface IQDoubleSpinBox
{
	void* NativePtr { get; }
}
public struct QDoubleSpinBoxPtr : IQDoubleSpinBox, IDisposable, IQAbstractSpinBox
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	public static Self New(IQWidget parent)
	{
		return .(CQt.QDoubleSpinBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QDoubleSpinBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QDoubleSpinBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QDoubleSpinBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QDoubleSpinBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public double Value()
	{
		return CQt.QDoubleSpinBox_Value(this.nativePtr);
	}
	
	public libqt_string Prefix()
	{
		return CQt.QDoubleSpinBox_Prefix(this.nativePtr);
	}
	
	public void SetPrefix(String prefix)
	{
		CQt.QDoubleSpinBox_SetPrefix(this.nativePtr, libqt_string(prefix));
	}
	
	public libqt_string Suffix()
	{
		return CQt.QDoubleSpinBox_Suffix(this.nativePtr);
	}
	
	public void SetSuffix(String suffix)
	{
		CQt.QDoubleSpinBox_SetSuffix(this.nativePtr, libqt_string(suffix));
	}
	
	public libqt_string CleanText()
	{
		return CQt.QDoubleSpinBox_CleanText(this.nativePtr);
	}
	
	public double SingleStep()
	{
		return CQt.QDoubleSpinBox_SingleStep(this.nativePtr);
	}
	
	public void SetSingleStep(double val)
	{
		CQt.QDoubleSpinBox_SetSingleStep(this.nativePtr, val);
	}
	
	public double Minimum()
	{
		return CQt.QDoubleSpinBox_Minimum(this.nativePtr);
	}
	
	public void SetMinimum(double min)
	{
		CQt.QDoubleSpinBox_SetMinimum(this.nativePtr, min);
	}
	
	public double Maximum()
	{
		return CQt.QDoubleSpinBox_Maximum(this.nativePtr);
	}
	
	public void SetMaximum(double max)
	{
		CQt.QDoubleSpinBox_SetMaximum(this.nativePtr, max);
	}
	
	public void SetRange(double min, double max)
	{
		CQt.QDoubleSpinBox_SetRange(this.nativePtr, min, max);
	}
	
	public int64 StepType()
	{
		return CQt.QDoubleSpinBox_StepType(this.nativePtr);
	}
	
	public void SetStepType(int64 stepType)
	{
		CQt.QDoubleSpinBox_SetStepType(this.nativePtr, (int64)stepType);
	}
	
	public int32 Decimals()
	{
		return CQt.QDoubleSpinBox_Decimals(this.nativePtr);
	}
	
	public void SetDecimals(int32 prec)
	{
		CQt.QDoubleSpinBox_SetDecimals(this.nativePtr, prec);
	}
	
	public int64 Validate(String input, int32* pos)
	{
		return CQt.QDoubleSpinBox_Validate(this.nativePtr, libqt_string(input), pos);
	}
	
	public double ValueFromText(String text)
	{
		return CQt.QDoubleSpinBox_ValueFromText(this.nativePtr, libqt_string(text));
	}
	
	public libqt_string TextFromValue(double val)
	{
		return CQt.QDoubleSpinBox_TextFromValue(this.nativePtr, val);
	}
	
	public void Fixup(String str)
	{
		CQt.QDoubleSpinBox_Fixup(this.nativePtr, libqt_string(str));
	}
	
	public void SetValue(double val)
	{
		CQt.QDoubleSpinBox_SetValue(this.nativePtr, val);
	}
	...
	public bool Event(IQEvent event)
	{
		return CQt.QAbstractSpinBox_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
...
{
	public QDoubleSpinBoxPtr handle;
	
	public static implicit operator QDoubleSpinBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	public this(IQWidget parent)
	{
		this.handle = QDoubleSpinBoxPtr.New(parent);
	}
	...
	public virtual libqt_string TextFromValue(double val)
	{
		return this.handle.TextFromValue(val);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QDoubleSpinBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QDoubleSpinBoxPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QDoubleSpinBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QDoubleSpinBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QDoubleSpinBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QDoubleSpinBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QDoubleSpinBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QDoubleSpinBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QDoubleSpinBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QDoubleSpinBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QDoubleSpinBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QDoubleSpinBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QDoubleSpinBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QDoubleSpinBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QDoubleSpinBox_new(void* parent);
	[LinkName("QDoubleSpinBox_new2")]
	public static extern void* QDoubleSpinBox_new2();
	[LinkName("QDoubleSpinBox_MetaObject")]
	public static extern void* QDoubleSpinBox_MetaObject(void* c_this);
	...
	public static extern libqt_string QDoubleSpinBox_Prefix(void* c_this);
	[LinkName("QDoubleSpinBox_SetPrefix")]
	public static extern void QDoubleSpinBox_SetPrefix(void* c_this, libqt_string prefix);
	[LinkName("QDoubleSpinBox_Suffix")]
	public static extern libqt_string QDoubleSpinBox_Suffix(void* c_this);
	[LinkName("QDoubleSpinBox_SetSuffix")]
	public static extern void QDoubleSpinBox_SetSuffix(void* c_this, libqt_string suffix);
	[LinkName("QDoubleSpinBox_CleanText")]
	public static extern libqt_string QDoubleSpinBox_CleanText(void* c_this);
	...
	public static extern int64 QDoubleSpinBox_Validate(void* c_this, libqt_string input, int32* pos);
	[LinkName("QDoubleSpinBox_ValueFromText")]
	public static extern double QDoubleSpinBox_ValueFromText(void* c_this, libqt_string text);
	[LinkName("QDoubleSpinBox_TextFromValue")]
	public static extern libqt_string QDoubleSpinBox_TextFromValue(void* c_this, double val);
	[LinkName("QDoubleSpinBox_Fixup")]
	public static extern void QDoubleSpinBox_Fixup(void* c_this, libqt_string str);
	...
	public static extern void QDoubleSpinBox_Connect_ValueChanged(void* c_this, c_intptr slot);
	[LinkName("QDoubleSpinBox_Connect_TextChanged")]
	public static extern void QDoubleSpinBox_Connect_TextChanged(void* c_this, c_intptr slot);
	...
	public static extern void QDoubleSpinBox_Delete(void* self);
}