...
public class QSplitter : IQSplitter, IQFrame
{
	...
	{
		this.nativePtr = CQt.QSplitter_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QSplitter_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSplitter_AddWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void InsertWidget(int32 index, IQWidget widget)
	{
		CQt.QSplitter_InsertWidget(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void* ReplaceWidget(int32 index, IQWidget widget)
	{
		return CQt.QSplitter_ReplaceWidget(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void SetOrientation(int64 orientation)
	{
		CQt.QSplitter_SetOrientation(this.nativePtr, orientation);
	}
	...
	{
		return CQt.QSplitter_IndexOf(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	...
	{
		CQt.QSplitter_ChildEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual bool Event(IQEvent param1)
	{
		return CQt.QSplitter_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QSplitter_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QSplitter_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
...
public class QSplitterHandle : IQSplitterHandle, IQWidget
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		this.nativePtr = CQt.QSplitterHandle_new(o, (parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	public virtual int32 Metacall(int64 param1, int32 param2, void** param3)
	{
		return CQt.QSplitterHandle_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSplitterHandle_SetOrientation(this.nativePtr, o);
	}
	...
	{
		CQt.QSplitterHandle_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QSplitterHandle_MouseMoveEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSplitterHandle_MousePressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QSplitterHandle_MouseReleaseEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QSplitterHandle_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual bool Event(IQEvent param1)
	{
		return CQt.QSplitterHandle_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
