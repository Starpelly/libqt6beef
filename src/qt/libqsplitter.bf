...
public class QSplitter
{
	...
	{
		this.nativePtr = CQt.QSplitter_new(parent);
	}
	...
	{
		CQt.QSplitter_AddWidget(this.nativePtr, widget);
	}
	
	public void InsertWidget(int32 index, void* widget)
	{
		CQt.QSplitter_InsertWidget(this.nativePtr, index, widget);
	}
	
	public void* ReplaceWidget(int32 index, void* widget)
	{
		return CQt.QSplitter_ReplaceWidget(this.nativePtr, index, widget);
	}
	...
	{
		CQt.QSplitter_SetSizes(this.nativePtr, list);
	}
	...
	{
		return CQt.QSplitter_RestoreState(this.nativePtr, state);
	}
	...
	public int32 IndexOf(void* w)
	{
		return CQt.QSplitter_IndexOf(this.nativePtr, w);
	}
	...
	public virtual void ChildEvent(void* param1)
	{
		CQt.QSplitter_ChildEvent(this.nativePtr, param1);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QSplitter_Event(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QSplitter_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QSplitter_ChangeEvent(this.nativePtr, param1);
	}
...
public class QSplitterHandle
{
	...
	public this(int64 o, void* parent)
	{
		this.nativePtr = CQt.QSplitterHandle_new(o, parent);
	}
	...
	{
		CQt.QSplitterHandle_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QSplitterHandle_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QSplitterHandle_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QSplitterHandle_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QSplitterHandle_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QSplitterHandle_Event(this.nativePtr, param1);
	}
