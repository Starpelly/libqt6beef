...
public interface IQMenu
{
	void* NativePtr { get; }
}
public struct QMenuPtr : IQMenu, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QMenu_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QMenu_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QMenu_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QMenu_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QMenu_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QMenu_AddMenu(this.nativePtr, (menu == default || menu.NativePtr == default) ? default : menu.NativePtr);
	}
	
	public void* AddMenuWithTitle(String title)
	{
		return CQt.QMenu_AddMenuWithTitle(this.nativePtr, libqt_string(title));
	}
	
	public void* AddMenu2(IQIcon icon, String title)
	{
		return CQt.QMenu_AddMenu2(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(title));
	}
	
	public void* AddSeparator()
	{
		return CQt.QMenu_AddSeparator(this.nativePtr);
	}
	
	public void* AddSection(String text)
	{
		return CQt.QMenu_AddSection(this.nativePtr, libqt_string(text));
	}
	
	public void* AddSection2(IQIcon icon, String text)
	{
		return CQt.QMenu_AddSection2(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	
	public void* InsertMenu(IQAction before, IQMenu menu)
	{
		return CQt.QMenu_InsertMenu(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr, (menu == default || menu.NativePtr == default) ? default : menu.NativePtr);
	}
	
	public void* InsertSeparator(IQAction before)
	{
		return CQt.QMenu_InsertSeparator(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr);
	}
	
	public void* InsertSection(IQAction before, String text)
	{
		return CQt.QMenu_InsertSection(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr, libqt_string(text));
	}
	
	public void* InsertSection2(IQAction before, IQIcon icon, String text)
	{
		return CQt.QMenu_InsertSection2(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	
	public bool IsEmpty()
	{
		return CQt.QMenu_IsEmpty(this.nativePtr);
	}
	
	public void Clear()
	{
		CQt.QMenu_Clear(this.nativePtr);
	}
	
	public void SetTearOffEnabled(bool tearOffEnabled)
	{
		CQt.QMenu_SetTearOffEnabled(this.nativePtr, tearOffEnabled);
	}
	
	public bool IsTearOffEnabled()
	{
		return CQt.QMenu_IsTearOffEnabled(this.nativePtr);
	}
	
	public bool IsTearOffMenuVisible()
	{
		return CQt.QMenu_IsTearOffMenuVisible(this.nativePtr);
	}
	
	public void ShowTearOffMenu()
	{
		CQt.QMenu_ShowTearOffMenu(this.nativePtr);
	}
	
	public void ShowTearOffMenuWithPos(IQPoint pos)
	{
		CQt.QMenu_ShowTearOffMenuWithPos(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void HideTearOffMenu()
	{
		CQt.QMenu_HideTearOffMenu(this.nativePtr);
	}
	
	public void SetDefaultAction(IQAction defaultAction)
	{
		CQt.QMenu_SetDefaultAction(this.nativePtr, (defaultAction == default || defaultAction.NativePtr == default) ? default : defaultAction.NativePtr);
	}
	
	public void* DefaultAction()
	{
		return CQt.QMenu_DefaultAction(this.nativePtr);
	}
	
	public void SetActiveAction(IQAction act)
	{
		CQt.QMenu_SetActiveAction(this.nativePtr, (act == default || act.NativePtr == default) ? default : act.NativePtr);
	}
	
	public void* ActiveAction()
	{
		return CQt.QMenu_ActiveAction(this.nativePtr);
	}
	
	public void Popup(IQPoint pos)
	{
		CQt.QMenu_Popup(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void* Exec()
	{
		return CQt.QMenu_Exec(this.nativePtr);
	}
	
	public void* ExecWithPos(IQPoint pos)
	{
		return CQt.QMenu_ExecWithPos(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public static void* Exec2(IQAction[] actions, IQPoint pos)
	{
		return CQt.QMenu_Exec2(null, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QMenu_SizeHint(this.nativePtr);
	}
	
	public void ActionGeometry(IQAction param1)
	{
		CQt.QMenu_ActionGeometry(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void* ActionAt(IQPoint param1)
	{
		return CQt.QMenu_ActionAt(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void* MenuAction()
	{
		return CQt.QMenu_MenuAction(this.nativePtr);
	}
	
	public static void* MenuInAction(IQAction action)
	{
		return CQt.QMenu_MenuInAction((action == default || action.NativePtr == default) ? default : action.NativePtr);
	}
	
	public libqt_string Title()
	{
		return CQt.QMenu_Title(this.nativePtr);
	}
	
	public void SetTitle(String title)
	{
		CQt.QMenu_SetTitle(this.nativePtr, libqt_string(title));
	}
	
	public void Icon()
	{
		CQt.QMenu_Icon(this.nativePtr);
	}
	
	public void SetIcon(IQIcon icon)
	{
		CQt.QMenu_SetIcon(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	
	public void SetNoReplayFor(IQWidget widget)
	{
		CQt.QMenu_SetNoReplayFor(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public bool SeparatorsCollapsible()
	{
		return CQt.QMenu_SeparatorsCollapsible(this.nativePtr);
	}
	
	public void SetSeparatorsCollapsible(bool collapse)
	{
		CQt.QMenu_SetSeparatorsCollapsible(this.nativePtr, collapse);
	}
	
	public bool ToolTipsVisible()
	{
		return CQt.QMenu_ToolTipsVisible(this.nativePtr);
	}
	
	public void SetToolTipsVisible(bool visible)
	{
		CQt.QMenu_SetToolTipsVisible(this.nativePtr, visible);
	}
	
	public int32 ColumnCount()
	{
		return CQt.QMenu_ColumnCount(this.nativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QMenu_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QMenu_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QMenu_MouseReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QMenu_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QMenu_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent param1)
	{
		CQt.QMenu_WheelEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void EnterEvent(IQEnterEvent param1)
	{
		CQt.QMenu_EnterEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void LeaveEvent(IQEvent param1)
	{
		CQt.QMenu_LeaveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void HideEvent(IQHideEvent param1)
	{
		CQt.QMenu_HideEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QMenu_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ActionEvent(IQActionEvent param1)
	{
		CQt.QMenu_ActionEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QMenu_TimerEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QMenu_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool FocusNextPrevChild(bool next)
	{
		return CQt.QMenu_FocusNextPrevChild(this.nativePtr, next);
	}
	
	public void InitStyleOption(IQStyleOptionMenuItem option, IQAction action)
	{
		CQt.QMenu_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr, (action == default || action.NativePtr == default) ? default : action.NativePtr);
	}
	...
	public void Popup2(IQPoint pos, IQAction at)
	{
		CQt.QMenu_Popup2(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (at == default || at.NativePtr == default) ? default : at.NativePtr);
	}
	
	public void* Exec22(IQPoint pos, IQAction at)
	{
		return CQt.QMenu_Exec22(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (at == default || at.NativePtr == default) ? default : at.NativePtr);
	}
	
	public static void* Exec3(IQAction[] actions, IQPoint pos, IQAction at)
	{
		return CQt.QMenu_Exec3(null, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (at == default || at.NativePtr == default) ? default : at.NativePtr);
	}
	
	public static void* Exec4(IQAction[] actions, IQPoint pos, IQAction at, IQWidget parent)
	{
		return CQt.QMenu_Exec4(null, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr, (at == default || at.NativePtr == default) ? default : at.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
...
public class QMenu
{
	public QMenuPtr handle;
	
	public static implicit operator QMenuPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QMenuPtr.New(parent);
	}
	...
	public void* AddSection(String text)
	{
		return this.handle.AddSection(text);
	}
	
	public void* AddSection2(IQIcon icon, String text)
	{
		return this.handle.AddSection2(icon, text);
	}
	...
	public void* InsertSection(IQAction before, String text)
	{
		return this.handle.InsertSection(before, text);
	}
	
	public void* InsertSection2(IQAction before, IQIcon icon, String text)
	{
		return this.handle.InsertSection2(before, icon, text);
	}
	...
	public void SetTearOffEnabled(bool tearOffEnabled)
	{
		this.handle.SetTearOffEnabled(tearOffEnabled);
	}
	
	public bool IsTearOffEnabled()
	{
		return this.handle.IsTearOffEnabled();
	}
	
	public bool IsTearOffMenuVisible()
	{
		return this.handle.IsTearOffMenuVisible();
	}
	
	public void ShowTearOffMenu()
	{
		this.handle.ShowTearOffMenu();
	}
	
	public void ShowTearOffMenuWithPos(IQPoint pos)
	{
		this.handle.ShowTearOffMenuWithPos(pos);
	}
	
	public void HideTearOffMenu()
	{
		this.handle.HideTearOffMenu();
	}
	
	public void SetDefaultAction(IQAction defaultAction)
	{
		this.handle.SetDefaultAction(defaultAction);
	}
	...
	public void SetActiveAction(IQAction act)
	{
		this.handle.SetActiveAction(act);
	}
	...
	public void* ExecWithPos(IQPoint pos)
	{
		return this.handle.ExecWithPos(pos);
	}
	
	public static void* Exec2(IQAction[] actions, IQPoint pos)
	{
		return QMenuPtr.Exec2(null, pos);
	}
	...
	public void* MenuAction()
	{
		return this.handle.MenuAction();
	}
	
	public static void* MenuInAction(IQAction action)
	{
		return QMenuPtr.MenuInAction(action);
	}
	...
	public void SetNoReplayFor(IQWidget widget)
	{
		this.handle.SetNoReplayFor(widget);
	}
	
	public bool SeparatorsCollapsible()
	{
		return this.handle.SeparatorsCollapsible();
	}
	
	public void SetSeparatorsCollapsible(bool collapse)
	{
		this.handle.SetSeparatorsCollapsible(collapse);
	}
	
	public bool ToolTipsVisible()
	{
		return this.handle.ToolTipsVisible();
	}
	
	public void SetToolTipsVisible(bool visible)
	{
		this.handle.SetToolTipsVisible(visible);
	}
	...
	public virtual void EnterEvent(IQEnterEvent param1)
	{
		this.handle.EnterEvent(param1);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QMenuPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QMenuPtr.Tr3(s, c, n);
	}
	
	public void Popup2(IQPoint pos, IQAction at)
	{
		this.handle.Popup2(pos, at);
	}
	
	public void* Exec22(IQPoint pos, IQAction at)
	{
		return this.handle.Exec22(pos, at);
	}
	
	public static void* Exec3(IQAction[] actions, IQPoint pos, IQAction at)
	{
		return QMenuPtr.Exec3(null, pos, at);
	}
	
	public static void* Exec4(IQAction[] actions, IQPoint pos, IQAction at, IQWidget parent)
	{
		return QMenuPtr.Exec4(null, pos, at, parent);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QMenuPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QMenuPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QMenuPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QMenuPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QMenuPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QMenuPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QMenuPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QMenuPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QMenuPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QMenuPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QMenuPtr.DevicePixelRatioFScale();
	}
...
{
	[LinkName("QMenu_new")]
	public static extern void* QMenu_new(void* parent);
	[LinkName("QMenu_new2")]
	public static extern void* QMenu_new2();
	[LinkName("QMenu_new3")]
	public static extern void* QMenu_new3(libqt_string title);
	[LinkName("QMenu_new4")]
	public static extern void* QMenu_new4(libqt_string title, void* parent);
	[LinkName("QMenu_MetaObject")]
	public static extern void* QMenu_MetaObject(void* c_this);
	...
	public static extern void* QMenu_AddMenu(void* c_this, void* menu);
	[LinkName("QMenu_AddMenuWithTitle")]
	public static extern void* QMenu_AddMenuWithTitle(void* c_this, libqt_string title);
	[LinkName("QMenu_AddMenu2")]
	public static extern void* QMenu_AddMenu2(void* c_this, void* icon, libqt_string title);
	[LinkName("QMenu_AddSeparator")]
	public static extern void* QMenu_AddSeparator(void* c_this);
	[LinkName("QMenu_AddSection")]
	public static extern void* QMenu_AddSection(void* c_this, libqt_string text);
	[LinkName("QMenu_AddSection2")]
	public static extern void* QMenu_AddSection2(void* c_this, void* icon, libqt_string text);
	[LinkName("QMenu_InsertMenu")]
	public static extern void* QMenu_InsertMenu(void* c_this, void* before, void* menu);
	[LinkName("QMenu_InsertSeparator")]
	public static extern void* QMenu_InsertSeparator(void* c_this, void* before);
	[LinkName("QMenu_InsertSection")]
	public static extern void* QMenu_InsertSection(void* c_this, void* before, libqt_string text);
	[LinkName("QMenu_InsertSection2")]
	public static extern void* QMenu_InsertSection2(void* c_this, void* before, void* icon, libqt_string text);
	...
	public static extern void QMenu_ShowTearOffMenuWithPos(void* c_this, void* pos);
	[LinkName("QMenu_HideTearOffMenu")]
	public static extern void QMenu_HideTearOffMenu(void* c_this);
	[LinkName("QMenu_SetDefaultAction")]
	public static extern void QMenu_SetDefaultAction(void* c_this, void* defaultAction);
	[LinkName("QMenu_DefaultAction")]
	public static extern void* QMenu_DefaultAction(void* c_this);
	[LinkName("QMenu_SetActiveAction")]
	public static extern void QMenu_SetActiveAction(void* c_this, void* act);
	[LinkName("QMenu_ActiveAction")]
	public static extern void* QMenu_ActiveAction(void* c_this);
	[LinkName("QMenu_Popup")]
	public static extern void QMenu_Popup(void* c_this, void* pos);
	[LinkName("QMenu_Exec")]
	public static extern void* QMenu_Exec(void* c_this);
	[LinkName("QMenu_ExecWithPos")]
	public static extern void* QMenu_ExecWithPos(void* c_this, void* pos);
	[LinkName("QMenu_Exec2")]
	public static extern void* QMenu_Exec2(void*[] actions, void* pos);
	[LinkName("QMenu_SizeHint")]
	public static extern void QMenu_SizeHint(void* c_this);
	[LinkName("QMenu_ActionGeometry")]
	public static extern void QMenu_ActionGeometry(void* c_this, void* param1);
	[LinkName("QMenu_ActionAt")]
	public static extern void* QMenu_ActionAt(void* c_this, void* param1);
	[LinkName("QMenu_MenuAction")]
	public static extern void* QMenu_MenuAction(void* c_this);
	[LinkName("QMenu_MenuInAction")]
	public static extern void* QMenu_MenuInAction(void* action);
	[LinkName("QMenu_Title")]
	public static extern libqt_string QMenu_Title(void* c_this);
	[LinkName("QMenu_SetTitle")]
	public static extern void QMenu_SetTitle(void* c_this, libqt_string title);
	[LinkName("QMenu_Icon")]
	public static extern void QMenu_Icon(void* c_this);
	[LinkName("QMenu_SetIcon")]
	public static extern void QMenu_SetIcon(void* c_this, void* icon);
	[LinkName("QMenu_SetNoReplayFor")]
	public static extern void QMenu_SetNoReplayFor(void* c_this, void* widget);
	...
	public static extern void QMenu_Connect_AboutToShow(void* c_this, c_intptr slot);
	[LinkName("QMenu_Connect_AboutToHide")]
	public static extern void QMenu_Connect_AboutToHide(void* c_this, c_intptr slot);
	[LinkName("QMenu_Connect_Triggered")]
	public static extern void QMenu_Connect_Triggered(void* c_this, c_intptr slot);
	[LinkName("QMenu_Connect_Hovered")]
	public static extern void QMenu_Connect_Hovered(void* c_this, c_intptr slot);
	[LinkName("QMenu_ColumnCount")]
	public static extern int32 QMenu_ColumnCount(void* c_this);
	[LinkName("QMenu_ChangeEvent")]
	public static extern void QMenu_ChangeEvent(void* c_this, void* param1);
	[LinkName("QMenu_KeyPressEvent")]
	public static extern void QMenu_KeyPressEvent(void* c_this, void* param1);
	[LinkName("QMenu_MouseReleaseEvent")]
	public static extern void QMenu_MouseReleaseEvent(void* c_this, void* param1);
	[LinkName("QMenu_MousePressEvent")]
	public static extern void QMenu_MousePressEvent(void* c_this, void* param1);
	[LinkName("QMenu_MouseMoveEvent")]
	public static extern void QMenu_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QMenu_WheelEvent")]
	public static extern void QMenu_WheelEvent(void* c_this, void* param1);
	[LinkName("QMenu_EnterEvent")]
	public static extern void QMenu_EnterEvent(void* c_this, void* param1);
	[LinkName("QMenu_LeaveEvent")]
	public static extern void QMenu_LeaveEvent(void* c_this, void* param1);
	[LinkName("QMenu_HideEvent")]
	public static extern void QMenu_HideEvent(void* c_this, void* param1);
	[LinkName("QMenu_PaintEvent")]
	public static extern void QMenu_PaintEvent(void* c_this, void* param1);
	[LinkName("QMenu_ActionEvent")]
	public static extern void QMenu_ActionEvent(void* c_this, void* param1);
	[LinkName("QMenu_TimerEvent")]
	public static extern void QMenu_TimerEvent(void* c_this, void* param1);
	[LinkName("QMenu_Event")]
	public static extern bool QMenu_Event(void* c_this, void* param1);
	...
	public static extern void QMenu_InitStyleOption(void* c_this, void* option, void* action);
	[LinkName("QMenu_Tr2")]
	...
	public static extern void QMenu_Popup2(void* c_this, void* pos, void* at);
	[LinkName("QMenu_Exec22")]
	public static extern void* QMenu_Exec22(void* c_this, void* pos, void* at);
	[LinkName("QMenu_Exec3")]
	public static extern void* QMenu_Exec3(void*[] actions, void* pos, void* at);
	[LinkName("QMenu_Exec4")]
	public static extern void* QMenu_Exec4(void*[] actions, void* pos, void* at, void* parent);
	/// Delete this object from C++ memory
	[LinkName("QMenu_Delete")]
	public static extern void QMenu_Delete(void* self);
}