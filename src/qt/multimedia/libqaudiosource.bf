...
public class QAudioSource : IQAudioSource, IQObject
{
	...
	public this()
	{
		this.nativePtr = CQt.QAudioSource_new();
	}
	...
	{
		return CQt.QAudioSource_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QAudioSource_Start(this.nativePtr, (device == null) ? null : (void*)device.NativePtr);
	}
