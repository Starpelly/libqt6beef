...
public class QVideoWidget : IQVideoWidget, IQWidget
{
	...
	{
		this.nativePtr = CQt.QVideoWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QVideoWidget_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QVideoWidget_SetAspectRatioMode(this.nativePtr, mode);
	}
	
	public virtual bool Event(IQEvent event)
	{
		return CQt.QVideoWidget_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent event)
	{
		CQt.QVideoWidget_ShowEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void HideEvent(IQHideEvent event)
	{
		CQt.QVideoWidget_HideEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent event)
	{
		CQt.QVideoWidget_ResizeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MoveEvent(IQMoveEvent event)
	{
		CQt.QVideoWidget_MoveEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
