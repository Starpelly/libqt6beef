...
public class QVideoWidget
{
	...
	{
		this.nativePtr = CQt.QVideoWidget_new(parent);
	}
	...
	{
		return CQt.QVideoWidget_Event(this.nativePtr, event);
	}
	
	public virtual void ShowEvent(void* event)
	{
		CQt.QVideoWidget_ShowEvent(this.nativePtr, event);
	}
	
	public virtual void HideEvent(void* event)
	{
		CQt.QVideoWidget_HideEvent(this.nativePtr, event);
	}
	
	public virtual void ResizeEvent(void* event)
	{
		CQt.QVideoWidget_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void MoveEvent(void* event)
	{
		CQt.QVideoWidget_MoveEvent(this.nativePtr, event);
	}
