...
public interface IQVideoWidget
{
	void* NativePtr { get; }
}
public struct QVideoWidgetPtr : IQVideoWidget, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QVideoWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QVideoWidget_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QVideoWidget_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QVideoWidget_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QVideoWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	
	public static libqt_string Tr(char8* s)
	{
		return CQt.QVideoWidget_Tr(s);
	}
	
	public void* VideoSink()
	{
		return CQt.QVideoWidget_VideoSink(this.nativePtr);
	}
	
	public int64 AspectRatioMode()
	{
		return CQt.QVideoWidget_AspectRatioMode(this.nativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QVideoWidget_SizeHint(this.nativePtr);
	}
	
	public void SetFullScreen(bool fullScreen)
	{
		CQt.QVideoWidget_SetFullScreen(this.nativePtr, fullScreen);
	}
	
	public void SetAspectRatioMode(int64 mode)
	{
		CQt.QVideoWidget_SetAspectRatioMode(this.nativePtr, (int64)mode);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QVideoWidget_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QVideoWidget_ShowEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void HideEvent(IQHideEvent event)
	{
		CQt.QVideoWidget_HideEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QVideoWidget_ResizeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QVideoWidget_MoveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return CQt.QVideoWidget_Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return CQt.QVideoWidget_Tr3(s, c, n);
	}
...
public class QVideoWidget
{
	public QVideoWidgetPtr handle;
	
	public static implicit operator QVideoWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QVideoWidgetPtr.New(parent);
	}
	...
	public void SetFullScreen(bool fullScreen)
	{
		this.handle.SetFullScreen(fullScreen);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QVideoWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QVideoWidgetPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QVideoWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QVideoWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QVideoWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QVideoWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QVideoWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QVideoWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QVideoWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QVideoWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QVideoWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QVideoWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QVideoWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QVideoWidgetPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QVideoWidget_new(void* parent);
	[LinkName("QVideoWidget_new2")]
	public static extern void* QVideoWidget_new2();
	[LinkName("QVideoWidget_MetaObject")]
	public static extern void* QVideoWidget_MetaObject(void* c_this);
	...
	public static extern void* QVideoWidget_VideoSink(void* c_this);
	...
	public static extern void QVideoWidget_SizeHint(void* c_this);
	...
	public static extern void QVideoWidget_Connect_FullScreenChanged(void* c_this, c_intptr slot);
	[LinkName("QVideoWidget_Connect_AspectRatioModeChanged")]
	public static extern void QVideoWidget_Connect_AspectRatioModeChanged(void* c_this, c_intptr slot);
	[LinkName("QVideoWidget_Event")]
	public static extern bool QVideoWidget_Event(void* c_this, void* event);
	[LinkName("QVideoWidget_ShowEvent")]
	public static extern void QVideoWidget_ShowEvent(void* c_this, void* event);
	[LinkName("QVideoWidget_HideEvent")]
	public static extern void QVideoWidget_HideEvent(void* c_this, void* event);
	[LinkName("QVideoWidget_ResizeEvent")]
	public static extern void QVideoWidget_ResizeEvent(void* c_this, void* event);
	[LinkName("QVideoWidget_MoveEvent")]
	public static extern void QVideoWidget_MoveEvent(void* c_this, void* event);
	...
	[LinkName("QVideoWidget_Delete")]
	public static extern void QVideoWidget_Delete(void* self);
}