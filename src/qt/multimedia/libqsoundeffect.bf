...
public class QSoundEffect : IQSoundEffect, IQObject
{
	...
	{
		CQt.QSoundEffect_SetSource(this.nativePtr, (url == default) ? default : (void*)url.NativePtr);
	}
	...
	{
		CQt.QSoundEffect_SetAudioDevice(this.nativePtr, (device == default) ? default : (void*)device.NativePtr);
	}
