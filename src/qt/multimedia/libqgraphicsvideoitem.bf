...
public class QGraphicsVideoItem
{
	...
	{
		CQt.QGraphicsVideoItem_SetOffset(this.nativePtr, offset);
	}
	...
	{
		CQt.QGraphicsVideoItem_SetSize(this.nativePtr, size);
	}
	...
	{
		CQt.QGraphicsVideoItem_Paint(this.nativePtr, painter, option, widget);
	}
	...
	{
		CQt.QGraphicsVideoItem_TimerEvent(this.nativePtr, event);
	}
	
	public virtual void ItemChange(int64 change, void* value)
	{
		CQt.QGraphicsVideoItem_ItemChange(this.nativePtr, change, value);
	}
