...
public class QGraphicsVideoItem : IQGraphicsVideoItem, IQGraphicsObject
{
	...
	public this()
	{
		this.nativePtr = CQt.QGraphicsVideoItem_new();
	}
	...
	{
		return CQt.QGraphicsVideoItem_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QGraphicsVideoItem_SetAspectRatioMode(this.nativePtr, mode);
	}
	...
	{
		CQt.QGraphicsVideoItem_SetOffset(this.nativePtr, (offset == default) ? default : (void*)offset.NativePtr);
	}
	...
	{
		CQt.QGraphicsVideoItem_SetSize(this.nativePtr, (size == default) ? default : (void*)size.NativePtr);
	}
	...
	{
		CQt.QGraphicsVideoItem_Paint(this.nativePtr, (painter == null) ? null : (void*)painter.NativePtr, (option == null) ? null : (void*)option.NativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QGraphicsVideoItem_TimerEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ItemChange(int64 change, IQVariant value)
	{
		CQt.QGraphicsVideoItem_ItemChange(this.nativePtr, change, (value == default) ? default : (void*)value.NativePtr);
	}
