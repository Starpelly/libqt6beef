...
public interface IQVideoSink
{
	void* NativePtr { get; }
}
public struct QVideoSinkPtr : IQVideoSink, IDisposable, IQObject
{
	...
	{
		return CQt.QVideoSink_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QVideoSink_SetSubtitleText(this.nativePtr, libqt_string(subtitle));
	}
	
	public void SetVideoFrame(IQVideoFrame frame)
	{
		CQt.QVideoSink_SetVideoFrame(this.nativePtr, (frame == default || frame.NativePtr == default) ? default : frame.NativePtr);
	}
...
{
	public QVideoSinkPtr handle;
	
	public static implicit operator QVideoSinkPtr(Self self)
	{
		return self.handle;
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QVideoSinkPtr.Tr(s);
	}
	
	public void VideoSize()
	{
		this.handle.VideoSize();
	}
	...
	public void SetSubtitleText(String subtitle)
	{
		this.handle.SetSubtitleText(subtitle);
	}
	
	public void SetVideoFrame(IQVideoFrame frame)
	{
		this.handle.SetVideoFrame(frame);
	}
	
	public void VideoFrame()
	{
		this.handle.VideoFrame();
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QVideoSinkPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QVideoSinkPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QVideoSinkPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QVideoSinkPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QVideoSinkPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QVideoSinkPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
