...
public struct QMediaDevicesPtr : IQMediaDevices, IDisposable, IQObject
{
	...
	{
		return CQt.QMediaDevices_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
...
{
	public QMediaDevicesPtr handle;
	
	public static implicit operator QMediaDevicesPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QMediaDevicesPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QMediaDevicesPtr.Tr(s);
	}
	
	public static void[] AudioInputs()
	{
		return QMediaDevicesPtr.AudioInputs();
	}
	
	public static void[] AudioOutputs()
	{
		return QMediaDevicesPtr.AudioOutputs();
	}
	
	public static void[] VideoInputs()
	{
		return QMediaDevicesPtr.VideoInputs();
	}
	
	public static void DefaultAudioInput()
	{
		QMediaDevicesPtr.DefaultAudioInput();
	}
	
	public static void DefaultAudioOutput()
	{
		QMediaDevicesPtr.DefaultAudioOutput();
	}
	
	public static void DefaultVideoInput()
	{
		QMediaDevicesPtr.DefaultVideoInput();
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QMediaDevicesPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QMediaDevicesPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QMediaDevicesPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QMediaDevicesPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QMediaDevicesPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QMediaDevicesPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
