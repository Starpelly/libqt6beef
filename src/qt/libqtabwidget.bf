...
public interface IQTabWidget
{
	void* NativePtr { get; }
}
public struct QTabWidgetPtr : IQTabWidget, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QTabWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QTabWidget_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QTabWidget_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QTabWidget_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QTabWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public int32 AddTab(IQWidget widget, String param2)
	{
		return CQt.QTabWidget_AddTab(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, libqt_string(param2));
	}
	
	public int32 AddTab2(IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_AddTab2(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(label));
	}
	
	public int32 InsertTab(int32 index, IQWidget widget, String param3)
	{
		return CQt.QTabWidget_InsertTab(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, libqt_string(param3));
	}
	
	public int32 InsertTab2(int32 index, IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_InsertTab2(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(label));
	}
	
	public void RemoveTab(int32 index)
	{
		CQt.QTabWidget_RemoveTab(this.nativePtr, index);
	}
	
	public bool IsTabEnabled(int32 index)
	{
		return CQt.QTabWidget_IsTabEnabled(this.nativePtr, index);
	}
	
	public void SetTabEnabled(int32 index, bool enabled)
	{
		CQt.QTabWidget_SetTabEnabled(this.nativePtr, index, enabled);
	}
	
	public bool IsTabVisible(int32 index)
	{
		return CQt.QTabWidget_IsTabVisible(this.nativePtr, index);
	}
	
	public void SetTabVisible(int32 index, bool visible)
	{
		CQt.QTabWidget_SetTabVisible(this.nativePtr, index, visible);
	}
	
	public libqt_string TabText(int32 index)
	{
		return CQt.QTabWidget_TabText(this.nativePtr, index);
	}
	
	public void SetTabText(int32 index, String text)
	{
		CQt.QTabWidget_SetTabText(this.nativePtr, index, libqt_string(text));
	}
	
	public void TabIcon(int32 index)
	{
		CQt.QTabWidget_TabIcon(this.nativePtr, index);
	}
	
	public void SetTabIcon(int32 index, IQIcon icon)
	{
		CQt.QTabWidget_SetTabIcon(this.nativePtr, index, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	
	public void SetTabToolTip(int32 index, String tip)
	{
		CQt.QTabWidget_SetTabToolTip(this.nativePtr, index, libqt_string(tip));
	}
	
	public libqt_string TabToolTip(int32 index)
	{
		return CQt.QTabWidget_TabToolTip(this.nativePtr, index);
	}
	
	public void SetTabWhatsThis(int32 index, String text)
	{
		CQt.QTabWidget_SetTabWhatsThis(this.nativePtr, index, libqt_string(text));
	}
	
	public libqt_string TabWhatsThis(int32 index)
	{
		return CQt.QTabWidget_TabWhatsThis(this.nativePtr, index);
	}
	
	public int32 CurrentIndex()
	{
		return CQt.QTabWidget_CurrentIndex(this.nativePtr);
	}
	
	public void* CurrentWidget()
	{
		return CQt.QTabWidget_CurrentWidget(this.nativePtr);
	}
	
	public void* Widget(int32 index)
	{
		return CQt.QTabWidget_Widget(this.nativePtr, index);
	}
	
	public int32 IndexOf(IQWidget widget)
	{
		return CQt.QTabWidget_IndexOf(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public int32 Count()
	{
		return CQt.QTabWidget_Count(this.nativePtr);
	}
	
	public int64 TabPosition()
	{
		return CQt.QTabWidget_TabPosition(this.nativePtr);
	}
	
	public void SetTabPosition(int64 position)
	{
		CQt.QTabWidget_SetTabPosition(this.nativePtr, (int64)position);
	}
	
	public bool TabsClosable()
	{
		return CQt.QTabWidget_TabsClosable(this.nativePtr);
	}
	
	public void SetTabsClosable(bool closeable)
	{
		CQt.QTabWidget_SetTabsClosable(this.nativePtr, closeable);
	}
	
	public bool IsMovable()
	{
		return CQt.QTabWidget_IsMovable(this.nativePtr);
	}
	
	public void SetMovable(bool movable)
	{
		CQt.QTabWidget_SetMovable(this.nativePtr, movable);
	}
	
	public int64 TabShape()
	{
		return CQt.QTabWidget_TabShape(this.nativePtr);
	}
	
	public void SetTabShape(int64 s)
	{
		CQt.QTabWidget_SetTabShape(this.nativePtr, (int64)s);
	}
	
	public void SizeHint()
	{
		CQt.QTabWidget_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QTabWidget_MinimumSizeHint(this.nativePtr);
	}
	
	public int32 HeightForWidth(int32 width)
	{
		return CQt.QTabWidget_HeightForWidth(this.nativePtr, width);
	}
	
	public bool HasHeightForWidth()
	{
		return CQt.QTabWidget_HasHeightForWidth(this.nativePtr);
	}
	
	public void SetCornerWidget(IQWidget w)
	{
		CQt.QTabWidget_SetCornerWidget(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public void* CornerWidget()
	{
		return CQt.QTabWidget_CornerWidget(this.nativePtr);
	}
	
	public int64 ElideMode()
	{
		return CQt.QTabWidget_ElideMode(this.nativePtr);
	}
	
	public void SetElideMode(int64 mode)
	{
		CQt.QTabWidget_SetElideMode(this.nativePtr, (int64)mode);
	}
	
	public void IconSize()
	{
		CQt.QTabWidget_IconSize(this.nativePtr);
	}
	
	public void SetIconSize(IQSize size)
	{
		CQt.QTabWidget_SetIconSize(this.nativePtr, (size == default || size.NativePtr == default) ? default : size.NativePtr);
	}
	
	public bool UsesScrollButtons()
	{
		return CQt.QTabWidget_UsesScrollButtons(this.nativePtr);
	}
	
	public void SetUsesScrollButtons(bool useButtons)
	{
		CQt.QTabWidget_SetUsesScrollButtons(this.nativePtr, useButtons);
	}
	
	public bool DocumentMode()
	{
		return CQt.QTabWidget_DocumentMode(this.nativePtr);
	}
	
	public void SetDocumentMode(bool set)
	{
		CQt.QTabWidget_SetDocumentMode(this.nativePtr, set);
	}
	
	public bool TabBarAutoHide()
	{
		return CQt.QTabWidget_TabBarAutoHide(this.nativePtr);
	}
	
	public void SetTabBarAutoHide(bool enabled)
	{
		CQt.QTabWidget_SetTabBarAutoHide(this.nativePtr, enabled);
	}
	
	public void Clear()
	{
		CQt.QTabWidget_Clear(this.nativePtr);
	}
	
	public void* TabBar()
	{
		return CQt.QTabWidget_TabBar(this.nativePtr);
	}
	
	public void SetCurrentIndex(int32 index)
	{
		CQt.QTabWidget_SetCurrentIndex(this.nativePtr, index);
	}
	
	public void SetCurrentWidget(IQWidget widget)
	{
		CQt.QTabWidget_SetCurrentWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void TabInserted(int32 index)
	{
		CQt.QTabWidget_TabInserted(this.nativePtr, index);
	}
	
	public void TabRemoved(int32 index)
	{
		CQt.QTabWidget_TabRemoved(this.nativePtr, index);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QTabWidget_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QTabWidget_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QTabWidget_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QTabWidget_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void SetTabBar(IQTabBar tabBar)
	{
		CQt.QTabWidget_SetTabBar(this.nativePtr, (tabBar == default || tabBar.NativePtr == default) ? default : tabBar.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QTabWidget_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QTabWidget_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionTabWidgetFrame option)
	{
		CQt.QTabWidget_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	...
	{
		CQt.QTabWidget_SetCornerWidget2(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr, (int64)corner);
	}
	
	public void* CornerWidget1(int64 corner)
	{
		return CQt.QTabWidget_CornerWidget1(this.nativePtr, (int64)corner);
	}
...
{
	public QTabWidgetPtr handle;
	
	public static implicit operator QTabWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QTabWidgetPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QTabWidgetPtr.Tr(s);
	}
	
	public int32 AddTab(IQWidget widget, String param2)
	{
		return this.handle.AddTab(widget, param2);
	}
	
	public int32 AddTab2(IQWidget widget, IQIcon icon, String label)
	{
		return this.handle.AddTab2(widget, icon, label);
	}
	
	public int32 InsertTab(int32 index, IQWidget widget, String param3)
	{
		return this.handle.InsertTab(index, widget, param3);
	}
	
	public int32 InsertTab2(int32 index, IQWidget widget, IQIcon icon, String label)
	{
		return this.handle.InsertTab2(index, widget, icon, label);
	}
	
	public void RemoveTab(int32 index)
	{
		this.handle.RemoveTab(index);
	}
	
	public bool IsTabEnabled(int32 index)
	{
		return this.handle.IsTabEnabled(index);
	}
	
	public void SetTabEnabled(int32 index, bool enabled)
	{
		this.handle.SetTabEnabled(index, enabled);
	}
	
	public bool IsTabVisible(int32 index)
	{
		return this.handle.IsTabVisible(index);
	}
	
	public void SetTabVisible(int32 index, bool visible)
	{
		this.handle.SetTabVisible(index, visible);
	}
	
	public libqt_string TabText(int32 index)
	{
		return this.handle.TabText(index);
	}
	
	public void SetTabText(int32 index, String text)
	{
		this.handle.SetTabText(index, text);
	}
	
	public void TabIcon(int32 index)
	{
		this.handle.TabIcon(index);
	}
	
	public void SetTabIcon(int32 index, IQIcon icon)
	{
		this.handle.SetTabIcon(index, icon);
	}
	
	public void SetTabToolTip(int32 index, String tip)
	{
		this.handle.SetTabToolTip(index, tip);
	}
	
	public libqt_string TabToolTip(int32 index)
	{
		return this.handle.TabToolTip(index);
	}
	
	public void SetTabWhatsThis(int32 index, String text)
	{
		this.handle.SetTabWhatsThis(index, text);
	}
	
	public libqt_string TabWhatsThis(int32 index)
	{
		return this.handle.TabWhatsThis(index);
	}
	...
	public int32 IndexOf(IQWidget widget)
	{
		return this.handle.IndexOf(widget);
	}
	...
	public int64 TabPosition()
	{
		return this.handle.TabPosition();
	}
	
	public void SetTabPosition(int64 position)
	{
		this.handle.SetTabPosition(position);
	}
	
	public bool TabsClosable()
	{
		return this.handle.TabsClosable();
	}
	
	public void SetTabsClosable(bool closeable)
	{
		this.handle.SetTabsClosable(closeable);
	}
	
	public bool IsMovable()
	{
		return this.handle.IsMovable();
	}
	
	public void SetMovable(bool movable)
	{
		this.handle.SetMovable(movable);
	}
	...
	public int64 ElideMode()
	{
		return this.handle.ElideMode();
	}
	
	public void SetElideMode(int64 mode)
	{
		this.handle.SetElideMode(mode);
	}
	...
	public bool UsesScrollButtons()
	{
		return this.handle.UsesScrollButtons();
	}
	
	public void SetUsesScrollButtons(bool useButtons)
	{
		this.handle.SetUsesScrollButtons(useButtons);
	}
	...
	public void SetDocumentMode(bool set)
	{
		this.handle.SetDocumentMode(set);
	}
	
	public bool TabBarAutoHide()
	{
		return this.handle.TabBarAutoHide();
	}
	
	public void SetTabBarAutoHide(bool enabled)
	{
		this.handle.SetTabBarAutoHide(enabled);
	}
	...
	public void SetCurrentWidget(IQWidget widget)
	{
		this.handle.SetCurrentWidget(widget);
	}
	
	public virtual void TabInserted(int32 index)
	{
		this.handle.TabInserted(index);
	}
	
	public virtual void TabRemoved(int32 index)
	{
		this.handle.TabRemoved(index);
	}
	...
	public virtual void InitStyleOption(IQStyleOptionTabWidgetFrame option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QTabWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QTabWidgetPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QTabWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QTabWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QTabWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QTabWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QTabWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QTabWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QTabWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QTabWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QTabWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QTabWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QTabWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QTabWidgetPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QTabWidget_new(void* parent);
	[LinkName("QTabWidget_new2")]
	public static extern void* QTabWidget_new2();
	[LinkName("QTabWidget_MetaObject")]
	public static extern void* QTabWidget_MetaObject(void* c_this);
	...
	public static extern int32 QTabWidget_AddTab(void* c_this, void* widget, libqt_string param2);
	[LinkName("QTabWidget_AddTab2")]
	public static extern int32 QTabWidget_AddTab2(void* c_this, void* widget, void* icon, libqt_string label);
	[LinkName("QTabWidget_InsertTab")]
	public static extern int32 QTabWidget_InsertTab(void* c_this, int32 index, void* widget, libqt_string param3);
	[LinkName("QTabWidget_InsertTab2")]
	public static extern int32 QTabWidget_InsertTab2(void* c_this, int32 index, void* widget, void* icon, libqt_string label);
	...
	public static extern libqt_string QTabWidget_TabText(void* c_this, int32 index);
	[LinkName("QTabWidget_SetTabText")]
	public static extern void QTabWidget_SetTabText(void* c_this, int32 index, libqt_string text);
	[LinkName("QTabWidget_TabIcon")]
	public static extern void QTabWidget_TabIcon(void* c_this, int32 index);
	[LinkName("QTabWidget_SetTabIcon")]
	public static extern void QTabWidget_SetTabIcon(void* c_this, int32 index, void* icon);
	[LinkName("QTabWidget_SetTabToolTip")]
	public static extern void QTabWidget_SetTabToolTip(void* c_this, int32 index, libqt_string tip);
	[LinkName("QTabWidget_TabToolTip")]
	public static extern libqt_string QTabWidget_TabToolTip(void* c_this, int32 index);
	[LinkName("QTabWidget_SetTabWhatsThis")]
	public static extern void QTabWidget_SetTabWhatsThis(void* c_this, int32 index, libqt_string text);
	[LinkName("QTabWidget_TabWhatsThis")]
	public static extern libqt_string QTabWidget_TabWhatsThis(void* c_this, int32 index);
	...
	public static extern void* QTabWidget_CurrentWidget(void* c_this);
	[LinkName("QTabWidget_Widget")]
	public static extern void* QTabWidget_Widget(void* c_this, int32 index);
	[LinkName("QTabWidget_IndexOf")]
	public static extern int32 QTabWidget_IndexOf(void* c_this, void* widget);
	...
	public static extern void QTabWidget_SizeHint(void* c_this);
	[LinkName("QTabWidget_MinimumSizeHint")]
	public static extern void QTabWidget_MinimumSizeHint(void* c_this);
	...
	public static extern void QTabWidget_SetCornerWidget(void* c_this, void* w);
	[LinkName("QTabWidget_CornerWidget")]
	public static extern void* QTabWidget_CornerWidget(void* c_this);
	...
	public static extern void QTabWidget_IconSize(void* c_this);
	[LinkName("QTabWidget_SetIconSize")]
	public static extern void QTabWidget_SetIconSize(void* c_this, void* size);
	...
	public static extern void* QTabWidget_TabBar(void* c_this);
	...
	public static extern void QTabWidget_SetCurrentWidget(void* c_this, void* widget);
	[LinkName("QTabWidget_Connect_CurrentChanged")]
	public static extern void QTabWidget_Connect_CurrentChanged(void* c_this, c_intptr slot);
	[LinkName("QTabWidget_Connect_TabCloseRequested")]
	public static extern void QTabWidget_Connect_TabCloseRequested(void* c_this, c_intptr slot);
	[LinkName("QTabWidget_Connect_TabBarClicked")]
	public static extern void QTabWidget_Connect_TabBarClicked(void* c_this, c_intptr slot);
	[LinkName("QTabWidget_Connect_TabBarDoubleClicked")]
	public static extern void QTabWidget_Connect_TabBarDoubleClicked(void* c_this, c_intptr slot);
	...
	public static extern void QTabWidget_ShowEvent(void* c_this, void* param1);
	[LinkName("QTabWidget_ResizeEvent")]
	public static extern void QTabWidget_ResizeEvent(void* c_this, void* param1);
	[LinkName("QTabWidget_KeyPressEvent")]
	public static extern void QTabWidget_KeyPressEvent(void* c_this, void* param1);
	[LinkName("QTabWidget_PaintEvent")]
	public static extern void QTabWidget_PaintEvent(void* c_this, void* param1);
	[LinkName("QTabWidget_SetTabBar")]
	public static extern void QTabWidget_SetTabBar(void* c_this, void* tabBar);
	[LinkName("QTabWidget_ChangeEvent")]
	public static extern void QTabWidget_ChangeEvent(void* c_this, void* param1);
	[LinkName("QTabWidget_Event")]
	public static extern bool QTabWidget_Event(void* c_this, void* param1);
	[LinkName("QTabWidget_InitStyleOption")]
	public static extern void QTabWidget_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QTabWidget_SetCornerWidget2(void* c_this, void* w, int64 corner);
	[LinkName("QTabWidget_CornerWidget1")]
	public static extern void* QTabWidget_CornerWidget1(void* c_this, int64 corner);
	/// Delete this object from C++ memory
	[LinkName("QTabWidget_Delete")]
	public static extern void QTabWidget_Delete(void* self);
}