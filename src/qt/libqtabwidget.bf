...
public class QTabWidget
{
	...
	{
		this.nativePtr = CQt.QTabWidget_new(parent);
	}
	...
	public int32 AddTab(void* widget, libqt_string param2)
	{
		return CQt.QTabWidget_AddTab(this.nativePtr, widget, param2);
	}
	
	public int32 AddTab2(void* widget, void* icon, libqt_string label)
	{
		return CQt.QTabWidget_AddTab2(this.nativePtr, widget, icon, label);
	}
	
	public int32 InsertTab(int32 index, void* widget, libqt_string param3)
	{
		return CQt.QTabWidget_InsertTab(this.nativePtr, index, widget, param3);
	}
	
	public int32 InsertTab2(int32 index, void* widget, void* icon, libqt_string label)
	{
		return CQt.QTabWidget_InsertTab2(this.nativePtr, index, widget, icon, label);
	}
	...
	{
		CQt.QTabWidget_SetTabText(this.nativePtr, index, text);
	}
	...
	{
		CQt.QTabWidget_SetTabIcon(this.nativePtr, index, icon);
	}
	
	public void SetTabToolTip(int32 index, libqt_string tip)
	{
		CQt.QTabWidget_SetTabToolTip(this.nativePtr, index, tip);
	}
	...
	{
		CQt.QTabWidget_SetTabWhatsThis(this.nativePtr, index, text);
	}
	...
	public int32 IndexOf(void* widget)
	{
		return CQt.QTabWidget_IndexOf(this.nativePtr, widget);
	}
	...
	public void SetCornerWidget(void* w)
	{
		CQt.QTabWidget_SetCornerWidget(this.nativePtr, w);
	}
	...
	{
		CQt.QTabWidget_SetIconSize(this.nativePtr, size);
	}
	...
	public void SetCurrentWidget(void* widget)
	{
		CQt.QTabWidget_SetCurrentWidget(this.nativePtr, widget);
	}
	...
	{
		CQt.QTabWidget_ShowEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QTabWidget_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QTabWidget_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QTabWidget_PaintEvent(this.nativePtr, param1);
	}
	
	public void SetTabBar(void* tabBar)
	{
		CQt.QTabWidget_SetTabBar(this.nativePtr, tabBar);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QTabWidget_ChangeEvent(this.nativePtr, param1);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QTabWidget_Event(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QTabWidget_InitStyleOption(this.nativePtr, option);
	}
	...
	public void SetCornerWidget2(void* w, int64 corner)
	{
		CQt.QTabWidget_SetCornerWidget2(this.nativePtr, w, corner);
	}
