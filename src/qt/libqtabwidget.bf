...
public class QTabWidget : IQTabWidget, IQWidget
{
	...
	{
		this.nativePtr = CQt.QTabWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QTabWidget_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QTabWidget_AddTab(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, libqt_string(param2));
	}
	
	public int32 AddTab2(IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_AddTab2(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, (icon == default) ? default : (void*)icon.NativePtr, libqt_string(label));
	}
	
	public int32 InsertTab(int32 index, IQWidget widget, String param3)
	{
		return CQt.QTabWidget_InsertTab(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, libqt_string(param3));
	}
	
	public int32 InsertTab2(int32 index, IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_InsertTab2(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, (icon == default) ? default : (void*)icon.NativePtr, libqt_string(label));
	}
	...
	{
		CQt.QTabWidget_SetTabIcon(this.nativePtr, index, (icon == default) ? default : (void*)icon.NativePtr);
	}
	...
	{
		return CQt.QTabWidget_IndexOf(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QTabWidget_SetTabPosition(this.nativePtr, position);
	}
	...
	{
		CQt.QTabWidget_SetTabShape(this.nativePtr, s);
	}
	...
	{
		CQt.QTabWidget_SetCornerWidget(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	...
	{
		CQt.QTabWidget_SetElideMode(this.nativePtr, mode);
	}
	...
	{
		CQt.QTabWidget_SetIconSize(this.nativePtr, (size == default) ? default : (void*)size.NativePtr);
	}
	...
	{
		CQt.QTabWidget_SetCurrentWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QTabWidget_ShowEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QTabWidget_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QTabWidget_KeyPressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QTabWidget_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public void SetTabBar(IQTabBar tabBar)
	{
		CQt.QTabWidget_SetTabBar(this.nativePtr, (tabBar == null) ? null : (void*)tabBar.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QTabWidget_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual bool Event(IQEvent param1)
	{
		return CQt.QTabWidget_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionTabWidgetFrame option)
	{
		CQt.QTabWidget_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
	...
	{
		CQt.QTabWidget_SetCornerWidget2(this.nativePtr, (w == null) ? null : (void*)w.NativePtr, corner);
	}
	
	public void* CornerWidget1(int64 corner)
	{
		return CQt.QTabWidget_CornerWidget1(this.nativePtr, corner);
	}
