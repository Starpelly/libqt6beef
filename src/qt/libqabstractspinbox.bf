...
public interface IQAbstractSpinBox
{
	void* NativePtr { get; }
}
public struct QAbstractSpinBoxPtr : IQAbstractSpinBox, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QAbstractSpinBox_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QAbstractSpinBox_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QAbstractSpinBox_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QAbstractSpinBox_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QAbstractSpinBox_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QAbstractSpinBox_ResizeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QAbstractSpinBox_KeyPressEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QAbstractSpinBox_KeyReleaseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QAbstractSpinBox_WheelEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QAbstractSpinBox_FocusInEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QAbstractSpinBox_FocusOutEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QAbstractSpinBox_ContextMenuEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QAbstractSpinBox_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QAbstractSpinBox_CloseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void HideEvent(IQHideEvent event)
	{
		CQt.QAbstractSpinBox_HideEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MousePressEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MouseReleaseEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MouseMoveEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent event)
	{
		CQt.QAbstractSpinBox_TimerEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QAbstractSpinBox_PaintEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QAbstractSpinBox_ShowEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionSpinBox option)
	{
		CQt.QAbstractSpinBox_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	
	public void* LineEdit()
	{
		return CQt.QAbstractSpinBox_LineEdit(this.nativePtr);
	}
	
	public void SetLineEdit(IQLineEdit edit)
	{
		CQt.QAbstractSpinBox_SetLineEdit(this.nativePtr, (edit == default || edit.NativePtr == default) ? default : edit.NativePtr);
	}
	
	public int64 StepEnabled()
	{
		return CQt.QAbstractSpinBox_StepEnabled(this.nativePtr);
	}
...
{
	public QAbstractSpinBoxPtr handle;
	
	public static implicit operator QAbstractSpinBoxPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QAbstractSpinBoxPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractSpinBoxPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractSpinBoxPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractSpinBoxPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QAbstractSpinBoxPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QAbstractSpinBoxPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QAbstractSpinBoxPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QAbstractSpinBoxPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QAbstractSpinBoxPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QAbstractSpinBoxPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QAbstractSpinBoxPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractSpinBoxPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractSpinBoxPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractSpinBoxPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractSpinBoxPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QAbstractSpinBoxPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QAbstractSpinBox_new(void* parent);
	[LinkName("QAbstractSpinBox_new2")]
	public static extern void* QAbstractSpinBox_new2();
	[LinkName("QAbstractSpinBox_MetaObject")]
	public static extern void* QAbstractSpinBox_MetaObject(void* c_this);
	...
	public static extern libqt_string QAbstractSpinBox_Text(void* c_this);
	[LinkName("QAbstractSpinBox_SpecialValueText")]
	public static extern libqt_string QAbstractSpinBox_SpecialValueText(void* c_this);
	[LinkName("QAbstractSpinBox_SetSpecialValueText")]
	public static extern void QAbstractSpinBox_SetSpecialValueText(void* c_this, libqt_string txt);
	...
	public static extern void QAbstractSpinBox_SizeHint(void* c_this);
	[LinkName("QAbstractSpinBox_MinimumSizeHint")]
	public static extern void QAbstractSpinBox_MinimumSizeHint(void* c_this);
	...
	public static extern bool QAbstractSpinBox_Event(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_InputMethodQuery")]
	public static extern void QAbstractSpinBox_InputMethodQuery(void* c_this, int64 param1);
	[LinkName("QAbstractSpinBox_Validate")]
	public static extern int64 QAbstractSpinBox_Validate(void* c_this, libqt_string input, int32* pos);
	[LinkName("QAbstractSpinBox_Fixup")]
	public static extern void QAbstractSpinBox_Fixup(void* c_this, libqt_string input);
	...
	public static extern void QAbstractSpinBox_ResizeEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_KeyPressEvent")]
	public static extern void QAbstractSpinBox_KeyPressEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_KeyReleaseEvent")]
	public static extern void QAbstractSpinBox_KeyReleaseEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_WheelEvent")]
	public static extern void QAbstractSpinBox_WheelEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_FocusInEvent")]
	public static extern void QAbstractSpinBox_FocusInEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_FocusOutEvent")]
	public static extern void QAbstractSpinBox_FocusOutEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_ContextMenuEvent")]
	public static extern void QAbstractSpinBox_ContextMenuEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_ChangeEvent")]
	public static extern void QAbstractSpinBox_ChangeEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_CloseEvent")]
	public static extern void QAbstractSpinBox_CloseEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_HideEvent")]
	public static extern void QAbstractSpinBox_HideEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_MousePressEvent")]
	public static extern void QAbstractSpinBox_MousePressEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_MouseReleaseEvent")]
	public static extern void QAbstractSpinBox_MouseReleaseEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_MouseMoveEvent")]
	public static extern void QAbstractSpinBox_MouseMoveEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_TimerEvent")]
	public static extern void QAbstractSpinBox_TimerEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_PaintEvent")]
	public static extern void QAbstractSpinBox_PaintEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_ShowEvent")]
	public static extern void QAbstractSpinBox_ShowEvent(void* c_this, void* event);
	[LinkName("QAbstractSpinBox_InitStyleOption")]
	public static extern void QAbstractSpinBox_InitStyleOption(void* c_this, void* option);
	[LinkName("QAbstractSpinBox_LineEdit")]
	public static extern void* QAbstractSpinBox_LineEdit(void* c_this);
	[LinkName("QAbstractSpinBox_SetLineEdit")]
	public static extern void QAbstractSpinBox_SetLineEdit(void* c_this, void* edit);
	...
	public static extern void QAbstractSpinBox_Connect_EditingFinished(void* c_this, c_intptr slot);
	...
	public static extern void QAbstractSpinBox_Delete(void* self);
}