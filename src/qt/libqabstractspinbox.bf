...
public class QAbstractSpinBox
{
	...
	{
		this.nativePtr = CQt.QAbstractSpinBox_new(parent);
	}
	...
	{
		CQt.QAbstractSpinBox_ResizeEvent(this.nativePtr, event);
	}
	
	public virtual void KeyPressEvent(void* event)
	{
		CQt.QAbstractSpinBox_KeyPressEvent(this.nativePtr, event);
	}
	
	public virtual void KeyReleaseEvent(void* event)
	{
		CQt.QAbstractSpinBox_KeyReleaseEvent(this.nativePtr, event);
	}
	
	public virtual void WheelEvent(void* event)
	{
		CQt.QAbstractSpinBox_WheelEvent(this.nativePtr, event);
	}
	
	public virtual void FocusInEvent(void* event)
	{
		CQt.QAbstractSpinBox_FocusInEvent(this.nativePtr, event);
	}
	
	public virtual void FocusOutEvent(void* event)
	{
		CQt.QAbstractSpinBox_FocusOutEvent(this.nativePtr, event);
	}
	
	public virtual void ContextMenuEvent(void* event)
	{
		CQt.QAbstractSpinBox_ContextMenuEvent(this.nativePtr, event);
	}
	
	public virtual void ChangeEvent(void* event)
	{
		CQt.QAbstractSpinBox_ChangeEvent(this.nativePtr, event);
	}
	
	public virtual void CloseEvent(void* event)
	{
		CQt.QAbstractSpinBox_CloseEvent(this.nativePtr, event);
	}
	
	public virtual void HideEvent(void* event)
	{
		CQt.QAbstractSpinBox_HideEvent(this.nativePtr, event);
	}
	
	public virtual void MousePressEvent(void* event)
	{
		CQt.QAbstractSpinBox_MousePressEvent(this.nativePtr, event);
	}
	
	public virtual void MouseReleaseEvent(void* event)
	{
		CQt.QAbstractSpinBox_MouseReleaseEvent(this.nativePtr, event);
	}
	
	public virtual void MouseMoveEvent(void* event)
	{
		CQt.QAbstractSpinBox_MouseMoveEvent(this.nativePtr, event);
	}
	
	public virtual void TimerEvent(void* event)
	{
		CQt.QAbstractSpinBox_TimerEvent(this.nativePtr, event);
	}
	
	public virtual void PaintEvent(void* event)
	{
		CQt.QAbstractSpinBox_PaintEvent(this.nativePtr, event);
	}
	
	public virtual void ShowEvent(void* event)
	{
		CQt.QAbstractSpinBox_ShowEvent(this.nativePtr, event);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QAbstractSpinBox_InitStyleOption(this.nativePtr, option);
	}
	...
	{
		CQt.QAbstractSpinBox_SetLineEdit(this.nativePtr, edit);
	}
