...
public class QAbstractSpinBox : IQAbstractSpinBox, IQWidget
{
	...
	{
		this.nativePtr = CQt.QAbstractSpinBox_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QAbstractSpinBox_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QAbstractSpinBox_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	...
	{
		CQt.QAbstractSpinBox_ResizeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QAbstractSpinBox_KeyPressEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QAbstractSpinBox_KeyReleaseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void WheelEvent(IQWheelEvent event)
	{
		CQt.QAbstractSpinBox_WheelEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void FocusInEvent(IQFocusEvent event)
	{
		CQt.QAbstractSpinBox_FocusInEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QAbstractSpinBox_FocusOutEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QAbstractSpinBox_ContextMenuEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent event)
	{
		CQt.QAbstractSpinBox_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void CloseEvent(IQCloseEvent event)
	{
		CQt.QAbstractSpinBox_CloseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void HideEvent(IQHideEvent event)
	{
		CQt.QAbstractSpinBox_HideEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MousePressEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MouseReleaseEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QAbstractSpinBox_MouseMoveEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void TimerEvent(IQTimerEvent event)
	{
		CQt.QAbstractSpinBox_TimerEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent event)
	{
		CQt.QAbstractSpinBox_PaintEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent event)
	{
		CQt.QAbstractSpinBox_ShowEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionSpinBox option)
	{
		CQt.QAbstractSpinBox_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
	...
	{
		CQt.QAbstractSpinBox_SetLineEdit(this.nativePtr, (edit == null) ? null : (void*)edit.NativePtr);
	}
