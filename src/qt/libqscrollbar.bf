...
public interface IQScrollBar
{
	void* NativePtr { get; }
}
public struct QScrollBarPtr : IQScrollBar, IDisposable, IQAbstractSlider
{
	...
	{
		return .(CQt.QScrollBar_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QScrollBar_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QScrollBar_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QScrollBar_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QScrollBar_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QScrollBar_SizeHint(this.nativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QScrollBar_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent param1)
	{
		CQt.QScrollBar_WheelEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QScrollBar_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void HideEvent(IQHideEvent param1)
	{
		CQt.QScrollBar_HideEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void SliderChange(int64 change)
	{
		CQt.QScrollBar_SliderChange(this.nativePtr, (int64)change);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent param1)
	{
		CQt.QScrollBar_ContextMenuEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QScrollBar_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QScrollBarPtr handle;
	
	public static implicit operator QScrollBarPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QScrollBarPtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QScrollBarPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QScrollBarPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QScrollBarPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QScrollBarPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QScrollBarPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QScrollBarPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QScrollBarPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QScrollBarPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QScrollBarPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QScrollBarPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QScrollBarPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QScrollBarPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QScrollBarPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QScrollBarPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QScrollBar_new(void* parent);
	...
	public static extern void* QScrollBar_new4(int64 param1, void* parent);
	[LinkName("QScrollBar_MetaObject")]
	public static extern void* QScrollBar_MetaObject(void* c_this);
	...
	public static extern void QScrollBar_SizeHint(void* c_this);
	[LinkName("QScrollBar_Event")]
	public static extern bool QScrollBar_Event(void* c_this, void* event);
	[LinkName("QScrollBar_WheelEvent")]
	public static extern void QScrollBar_WheelEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_PaintEvent")]
	public static extern void QScrollBar_PaintEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_MousePressEvent")]
	public static extern void QScrollBar_MousePressEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_MouseReleaseEvent")]
	public static extern void QScrollBar_MouseReleaseEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_MouseMoveEvent")]
	public static extern void QScrollBar_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_HideEvent")]
	public static extern void QScrollBar_HideEvent(void* c_this, void* param1);
	...
	public static extern void QScrollBar_ContextMenuEvent(void* c_this, void* param1);
	[LinkName("QScrollBar_InitStyleOption")]
	public static extern void QScrollBar_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QScrollBar_Delete(void* self);
}