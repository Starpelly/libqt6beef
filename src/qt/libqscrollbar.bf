...
public class QScrollBar : IQScrollBar, IQAbstractSlider
{
	...
	{
		this.nativePtr = CQt.QScrollBar_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QScrollBar_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QScrollBar_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void WheelEvent(IQWheelEvent param1)
	{
		CQt.QScrollBar_WheelEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QScrollBar_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MousePressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseReleaseEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseMoveEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void HideEvent(IQHideEvent param1)
	{
		CQt.QScrollBar_HideEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void SliderChange(int64 change)
	{
		CQt.QScrollBar_SliderChange(this.nativePtr, change);
	}
	
	public virtual void ContextMenuEvent(IQContextMenuEvent param1)
	{
		CQt.QScrollBar_ContextMenuEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QScrollBar_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
