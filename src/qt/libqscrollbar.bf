...
public class QScrollBar
{
	...
	{
		this.nativePtr = CQt.QScrollBar_new(parent);
	}
	...
	{
		return CQt.QScrollBar_Event(this.nativePtr, event);
	}
	
	public virtual void WheelEvent(void* param1)
	{
		CQt.QScrollBar_WheelEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QScrollBar_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QScrollBar_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QScrollBar_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QScrollBar_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void HideEvent(void* param1)
	{
		CQt.QScrollBar_HideEvent(this.nativePtr, param1);
	}
	...
	{
		CQt.QScrollBar_ContextMenuEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QScrollBar_InitStyleOption(this.nativePtr, option);
	}
