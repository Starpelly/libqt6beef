...
public interface IQSvgWidget
{
	void* NativePtr { get; }
}
public struct QSvgWidgetPtr : IQSvgWidget, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QSvgWidget_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QSvgWidget_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QSvgWidget_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QSvgWidget_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QSvgWidget_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	
	public static libqt_string Tr(char8* s)
	{
		return CQt.QSvgWidget_Tr(s);
	}
	
	public void* Renderer()
	{
		return CQt.QSvgWidget_Renderer(this.nativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QSvgWidget_SizeHint(this.nativePtr);
	}
	
	public void Load(String file)
	{
		CQt.QSvgWidget_Load(this.nativePtr, libqt_string(file));
	}
	
	public void LoadWithContents(String contents)
	{
		CQt.QSvgWidget_LoadWithContents(this.nativePtr, libqt_string(contents));
	}
	
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QSvgWidget_PaintEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return CQt.QSvgWidget_Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return CQt.QSvgWidget_Tr3(s, c, n);
	}
...
{
	public QSvgWidgetPtr handle;
	
	public static implicit operator QSvgWidgetPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QSvgWidgetPtr.New(parent);
	}
	...
	public void LoadWithContents(String contents)
	{
		this.handle.LoadWithContents(contents);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSvgWidgetPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSvgWidgetPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QSvgWidgetPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QSvgWidgetPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QSvgWidgetPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QSvgWidgetPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QSvgWidgetPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QSvgWidgetPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QSvgWidgetPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSvgWidgetPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSvgWidgetPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSvgWidgetPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSvgWidgetPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QSvgWidgetPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QSvgWidget_new(void* parent);
	[LinkName("QSvgWidget_new2")]
	public static extern void* QSvgWidget_new2();
	[LinkName("QSvgWidget_new3")]
	public static extern void* QSvgWidget_new3(libqt_string file);
	[LinkName("QSvgWidget_new4")]
	public static extern void* QSvgWidget_new4(libqt_string file, void* parent);
	[LinkName("QSvgWidget_MetaObject")]
	public static extern void* QSvgWidget_MetaObject(void* c_this);
	...
	public static extern void* QSvgWidget_Renderer(void* c_this);
	[LinkName("QSvgWidget_SizeHint")]
	public static extern void QSvgWidget_SizeHint(void* c_this);
	[LinkName("QSvgWidget_Load")]
	public static extern void QSvgWidget_Load(void* c_this, libqt_string file);
	[LinkName("QSvgWidget_LoadWithContents")]
	public static extern void QSvgWidget_LoadWithContents(void* c_this, libqt_string contents);
	[LinkName("QSvgWidget_PaintEvent")]
	public static extern void QSvgWidget_PaintEvent(void* c_this, void* event);
	...
	[LinkName("QSvgWidget_Delete")]
	public static extern void QSvgWidget_Delete(void* self);
}