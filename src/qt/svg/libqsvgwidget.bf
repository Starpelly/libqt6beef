...
public class QSvgWidget : IQSvgWidget, IQWidget
{
	...
	{
		this.nativePtr = CQt.QSvgWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QSvgWidget_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSvgWidget_PaintEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
