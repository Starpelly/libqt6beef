...
public class QSvgWidget
{
	...
	{
		this.nativePtr = CQt.QSvgWidget_new(parent);
	}
	...
	public void Load(libqt_string file)
	{
		CQt.QSvgWidget_Load(this.nativePtr, file);
	}
	
	public void LoadWithContents(libqt_string contents)
	{
		CQt.QSvgWidget_LoadWithContents(this.nativePtr, contents);
	}
	
	public virtual void PaintEvent(void* event)
	{
		CQt.QSvgWidget_PaintEvent(this.nativePtr, event);
	}
