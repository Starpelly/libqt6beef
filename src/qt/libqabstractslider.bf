...
public class QAbstractSlider : IQAbstractSlider, IQWidget
{
	...
	{
		this.nativePtr = CQt.QAbstractSlider_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QAbstractSlider_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QAbstractSlider_TriggerAction(this.nativePtr, action);
	}
	...
	{
		CQt.QAbstractSlider_SetOrientation(this.nativePtr, orientation);
	}
	...
	{
		return CQt.QAbstractSlider_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public void SetRepeatAction(int64 action)
	{
		CQt.QAbstractSlider_SetRepeatAction(this.nativePtr, action);
	}
	...
	{
		CQt.QAbstractSlider_SliderChange(this.nativePtr, change);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent ev)
	{
		CQt.QAbstractSlider_KeyPressEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void TimerEvent(IQTimerEvent param1)
	{
		CQt.QAbstractSlider_TimerEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void WheelEvent(IQWheelEvent e)
	{
		CQt.QAbstractSlider_WheelEvent(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent e)
	{
		CQt.QAbstractSlider_ChangeEvent(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	...
	{
		CQt.QAbstractSlider_SetRepeatAction2(this.nativePtr, action, thresholdTime);
	}
	
	public void SetRepeatAction3(int64 action, int32 thresholdTime, int32 repeatTime)
	{
		CQt.QAbstractSlider_SetRepeatAction3(this.nativePtr, action, thresholdTime, repeatTime);
	}
