...
public class QAbstractSlider
{
	...
	{
		this.nativePtr = CQt.QAbstractSlider_new(parent);
	}
	...
	{
		return CQt.QAbstractSlider_Event(this.nativePtr, e);
	}
	...
	{
		CQt.QAbstractSlider_KeyPressEvent(this.nativePtr, ev);
	}
	
	public virtual void TimerEvent(void* param1)
	{
		CQt.QAbstractSlider_TimerEvent(this.nativePtr, param1);
	}
	
	public virtual void WheelEvent(void* e)
	{
		CQt.QAbstractSlider_WheelEvent(this.nativePtr, e);
	}
	
	public virtual void ChangeEvent(void* e)
	{
		CQt.QAbstractSlider_ChangeEvent(this.nativePtr, e);
	}
