...
public interface IQAbstractSlider
{
	void* NativePtr { get; }
}
public struct QAbstractSliderPtr : IQAbstractSlider, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QAbstractSlider_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QAbstractSlider_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QAbstractSlider_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QAbstractSlider_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QAbstractSlider_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QAbstractSlider_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void SetRepeatAction(int64 action)
	{
		CQt.QAbstractSlider_SetRepeatAction(this.nativePtr, (int64)action);
	}
	
	public int64 RepeatAction()
	{
		return CQt.QAbstractSlider_RepeatAction(this.nativePtr);
	}
	
	public void SliderChange(int64 change)
	{
		CQt.QAbstractSlider_SliderChange(this.nativePtr, (int64)change);
	}
	
	public void KeyPressEvent(IQKeyEvent ev)
	{
		CQt.QAbstractSlider_KeyPressEvent(this.nativePtr, (ev == default || ev.NativePtr == default) ? default : ev.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QAbstractSlider_TimerEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent e)
	{
		CQt.QAbstractSlider_WheelEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ChangeEvent(IQEvent e)
	{
		CQt.QAbstractSlider_ChangeEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	...
	public void SetRepeatAction2(int64 action, int32 thresholdTime)
	{
		CQt.QAbstractSlider_SetRepeatAction2(this.nativePtr, (int64)action, thresholdTime);
	}
	
	public void SetRepeatAction3(int64 action, int32 thresholdTime, int32 repeatTime)
	{
		CQt.QAbstractSlider_SetRepeatAction3(this.nativePtr, (int64)action, thresholdTime, repeatTime);
	}
...
{
	public QAbstractSliderPtr handle;
	
	public static implicit operator QAbstractSliderPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QAbstractSliderPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractSliderPtr.Tr(s);
	}
	...
	public void SetRepeatAction(int64 action)
	{
		this.handle.SetRepeatAction(action);
	}
	
	public int64 RepeatAction()
	{
		return this.handle.RepeatAction();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractSliderPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractSliderPtr.Tr3(s, c, n);
	}
	
	public void SetRepeatAction2(int64 action, int32 thresholdTime)
	{
		this.handle.SetRepeatAction2(action, thresholdTime);
	}
	
	public void SetRepeatAction3(int64 action, int32 thresholdTime, int32 repeatTime)
	{
		this.handle.SetRepeatAction3(action, thresholdTime, repeatTime);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QAbstractSliderPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QAbstractSliderPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QAbstractSliderPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QAbstractSliderPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QAbstractSliderPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QAbstractSliderPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QAbstractSliderPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractSliderPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractSliderPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractSliderPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractSliderPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QAbstractSliderPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QAbstractSlider_new(void* parent);
	[LinkName("QAbstractSlider_new2")]
	public static extern void* QAbstractSlider_new2();
	[LinkName("QAbstractSlider_MetaObject")]
	public static extern void* QAbstractSlider_MetaObject(void* c_this);
	...
	public static extern void QAbstractSlider_Connect_ValueChanged(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Connect_SliderPressed")]
	public static extern void QAbstractSlider_Connect_SliderPressed(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Connect_SliderMoved")]
	public static extern void QAbstractSlider_Connect_SliderMoved(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Connect_SliderReleased")]
	public static extern void QAbstractSlider_Connect_SliderReleased(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Connect_RangeChanged")]
	public static extern void QAbstractSlider_Connect_RangeChanged(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Connect_ActionTriggered")]
	public static extern void QAbstractSlider_Connect_ActionTriggered(void* c_this, c_intptr slot);
	[LinkName("QAbstractSlider_Event")]
	public static extern bool QAbstractSlider_Event(void* c_this, void* e);
	...
	public static extern void QAbstractSlider_KeyPressEvent(void* c_this, void* ev);
	[LinkName("QAbstractSlider_TimerEvent")]
	public static extern void QAbstractSlider_TimerEvent(void* c_this, void* param1);
	[LinkName("QAbstractSlider_WheelEvent")]
	public static extern void QAbstractSlider_WheelEvent(void* c_this, void* e);
	[LinkName("QAbstractSlider_ChangeEvent")]
	public static extern void QAbstractSlider_ChangeEvent(void* c_this, void* e);
	...
	public static extern void QAbstractSlider_Delete(void* self);
}