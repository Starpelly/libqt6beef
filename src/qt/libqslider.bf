...
public class QSlider
{
	...
	{
		this.nativePtr = CQt.QSlider_new(parent);
	}
	...
	{
		return CQt.QSlider_Event(this.nativePtr, event);
	}
	
	public virtual void PaintEvent(void* ev)
	{
		CQt.QSlider_PaintEvent(this.nativePtr, ev);
	}
	
	public virtual void MousePressEvent(void* ev)
	{
		CQt.QSlider_MousePressEvent(this.nativePtr, ev);
	}
	
	public virtual void MouseReleaseEvent(void* ev)
	{
		CQt.QSlider_MouseReleaseEvent(this.nativePtr, ev);
	}
	
	public virtual void MouseMoveEvent(void* ev)
	{
		CQt.QSlider_MouseMoveEvent(this.nativePtr, ev);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QSlider_InitStyleOption(this.nativePtr, option);
	}
