...
public interface IQSlider
{
	void* NativePtr { get; }
}
public struct QSliderPtr : IQSlider, IDisposable, IQAbstractSlider
{
	...
	{
		return .(CQt.QSlider_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QSlider_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QSlider_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QSlider_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QSlider_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QSlider_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QSlider_MinimumSizeHint(this.nativePtr);
	}
	
	public void SetTickPosition(int64 position)
	{
		CQt.QSlider_SetTickPosition(this.nativePtr, (int64)position);
	}
	
	public int64 TickPosition()
	{
		return CQt.QSlider_TickPosition(this.nativePtr);
	}
	
	public void SetTickInterval(int32 ti)
	{
		CQt.QSlider_SetTickInterval(this.nativePtr, ti);
	}
	
	public int32 TickInterval()
	{
		return CQt.QSlider_TickInterval(this.nativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QSlider_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent ev)
	{
		CQt.QSlider_PaintEvent(this.nativePtr, (ev == default || ev.NativePtr == default) ? default : ev.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MousePressEvent(this.nativePtr, (ev == default || ev.NativePtr == default) ? default : ev.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseReleaseEvent(this.nativePtr, (ev == default || ev.NativePtr == default) ? default : ev.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseMoveEvent(this.nativePtr, (ev == default || ev.NativePtr == default) ? default : ev.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QSlider_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QSliderPtr handle;
	
	public static implicit operator QSliderPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QSliderPtr.New(parent);
	}
	...
	public void SetTickPosition(int64 position)
	{
		this.handle.SetTickPosition(position);
	}
	
	public int64 TickPosition()
	{
		return this.handle.TickPosition();
	}
	
	public void SetTickInterval(int32 ti)
	{
		this.handle.SetTickInterval(ti);
	}
	
	public int32 TickInterval()
	{
		return this.handle.TickInterval();
	}
	...
	public virtual void PaintEvent(IQPaintEvent ev)
	{
		this.handle.PaintEvent(ev);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSliderPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSliderPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QSliderPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QSliderPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QSliderPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QSliderPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QSliderPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QSliderPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSliderPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSliderPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSliderPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSliderPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QSliderPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QSlider_new(void* parent);
	...
	public static extern void* QSlider_new4(int64 orientation, void* parent);
	[LinkName("QSlider_MetaObject")]
	public static extern void* QSlider_MetaObject(void* c_this);
	...
	[LinkName("QSlider_Tr")]
	public static extern libqt_string QSlider_Tr(char8* s);
	[LinkName("QSlider_SizeHint")]
	public static extern void QSlider_SizeHint(void* c_this);
	[LinkName("QSlider_MinimumSizeHint")]
	public static extern void QSlider_MinimumSizeHint(void* c_this);
	...
	public static extern bool QSlider_Event(void* c_this, void* event);
	[LinkName("QSlider_PaintEvent")]
	public static extern void QSlider_PaintEvent(void* c_this, void* ev);
	[LinkName("QSlider_MousePressEvent")]
	public static extern void QSlider_MousePressEvent(void* c_this, void* ev);
	[LinkName("QSlider_MouseReleaseEvent")]
	public static extern void QSlider_MouseReleaseEvent(void* c_this, void* ev);
	[LinkName("QSlider_MouseMoveEvent")]
	public static extern void QSlider_MouseMoveEvent(void* c_this, void* ev);
	[LinkName("QSlider_InitStyleOption")]
	public static extern void QSlider_InitStyleOption(void* c_this, void* option);
	[LinkName("QSlider_Tr2")]
	public static extern libqt_string QSlider_Tr2(char8* s, char8* c);
	[LinkName("QSlider_Tr3")]
	public static extern libqt_string QSlider_Tr3(char8* s, char8* c, int32 n);
	/// Delete this object from C++ memory
	[LinkName("QSlider_Delete")]
	public static extern void QSlider_Delete(void* self);
}