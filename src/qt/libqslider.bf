...
public class QSlider : IQSlider, IQAbstractSlider
{
	...
	{
		this.nativePtr = CQt.QSlider_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QSlider_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSlider_SetTickPosition(this.nativePtr, position);
	}
	...
	{
		return CQt.QSlider_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent ev)
	{
		CQt.QSlider_PaintEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MousePressEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseReleaseEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseMoveEvent(this.nativePtr, (ev == null) ? null : (void*)ev.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QSlider_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
