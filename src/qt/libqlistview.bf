...
public class QListView
{
	...
	{
		this.nativePtr = CQt.QListView_new(parent);
	}
	...
	{
		return CQt.QListView_Event(this.nativePtr, e);
	}
	...
	{
		CQt.QListView_DataChanged(this.nativePtr, topLeft, bottomRight, roles);
	}
	
	public virtual void RowsInserted(void* parent, int32 start, int32 end)
	{
		CQt.QListView_RowsInserted(this.nativePtr, parent, start, end);
	}
	
	public virtual void RowsAboutToBeRemoved(void* parent, int32 start, int32 end)
	{
		CQt.QListView_RowsAboutToBeRemoved(this.nativePtr, parent, start, end);
	}
	
	public virtual void MouseMoveEvent(void* e)
	{
		CQt.QListView_MouseMoveEvent(this.nativePtr, e);
	}
	
	public virtual void MouseReleaseEvent(void* e)
	{
		CQt.QListView_MouseReleaseEvent(this.nativePtr, e);
	}
	
	public virtual void WheelEvent(void* e)
	{
		CQt.QListView_WheelEvent(this.nativePtr, e);
	}
	
	public virtual void TimerEvent(void* e)
	{
		CQt.QListView_TimerEvent(this.nativePtr, e);
	}
	
	public virtual void ResizeEvent(void* e)
	{
		CQt.QListView_ResizeEvent(this.nativePtr, e);
	}
	
	public virtual void DragMoveEvent(void* e)
	{
		CQt.QListView_DragMoveEvent(this.nativePtr, e);
	}
	
	public virtual void DragLeaveEvent(void* e)
	{
		CQt.QListView_DragLeaveEvent(this.nativePtr, e);
	}
	
	public virtual void DropEvent(void* e)
	{
		CQt.QListView_DropEvent(this.nativePtr, e);
	}
	...
	{
		CQt.QListView_InitViewItemOption(this.nativePtr, option);
	}
	
	public virtual void PaintEvent(void* e)
	{
		CQt.QListView_PaintEvent(this.nativePtr, e);
	}
	...
	public void RectForIndex(void* index)
	{
		CQt.QListView_RectForIndex(this.nativePtr, index);
	}
	
	public void SetPositionForIndex(void* position, void* index)
	{
		CQt.QListView_SetPositionForIndex(this.nativePtr, position, index);
	}
	
	public virtual void SetSelection(void* rect, int64 command)
	{
		CQt.QListView_SetSelection(this.nativePtr, rect, command);
	}
	
	public virtual void VisualRegionForSelection(void* selection)
	{
		CQt.QListView_VisualRegionForSelection(this.nativePtr, selection);
	}
	...
	{
		return CQt.QListView_IsIndexHidden(this.nativePtr, index);
	}
	
	public virtual void SelectionChanged(void* selected, void* deselected)
	{
		CQt.QListView_SelectionChanged(this.nativePtr, selected, deselected);
	}
	
	public virtual void CurrentChanged(void* current, void* previous)
	{
		CQt.QListView_CurrentChanged(this.nativePtr, current, previous);
	}
