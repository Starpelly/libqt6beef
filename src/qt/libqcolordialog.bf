...
public class QColorDialog : IQColorDialog, IQDialog
{
	...
	{
		this.nativePtr = CQt.QColorDialog_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QColorDialog_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QColorDialog_SetCurrentColor(this.nativePtr, (color == default) ? default : (void*)color.NativePtr);
	}
	...
	{
		CQt.QColorDialog_SetOption(this.nativePtr, option);
	}
	
	public bool TestOption(int64 option)
	{
		return CQt.QColorDialog_TestOption(this.nativePtr, option);
	}
	...
	{
		CQt.QColorDialog_SetCustomColor(index, (color == default) ? default : (void)color.NativePtr);
	}
	...
	{
		CQt.QColorDialog_SetStandardColor(index, (color == default) ? default : (void)color.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent event)
	{
		CQt.QColorDialog_ChangeEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	...
	{
		CQt.QColorDialog_SetOption2(this.nativePtr, option, on);
	}
	
	public static void GetColor1(IQColor initial)
	{
		CQt.QColorDialog_GetColor1((initial == default) ? default : (void*)initial.NativePtr);
	}
	
	public static void GetColor2(IQColor initial, IQWidget parent)
	{
		CQt.QColorDialog_GetColor2((initial == default) ? default : (void*)initial.NativePtr, (parent == null) ? null : (void*)parent.NativePtr);
	}
	
	public static void GetColor3(IQColor initial, IQWidget parent, String title)
	{
		CQt.QColorDialog_GetColor3((initial == default) ? default : (void*)initial.NativePtr, (parent == null) ? null : (void*)parent.NativePtr, libqt_string(title));
	}
	
	public static void GetColor4(IQColor initial, IQWidget parent, String title, int64 options)
	{
		CQt.QColorDialog_GetColor4((initial == default) ? default : (void*)initial.NativePtr, (parent == null) ? null : (void*)parent.NativePtr, libqt_string(title), options);
	}
