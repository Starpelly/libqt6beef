...
public class QColorDialog
{
	...
	{
		this.nativePtr = CQt.QColorDialog_new(parent);
	}
	...
	public void SetCurrentColor(void* color)
	{
		CQt.QColorDialog_SetCurrentColor(this.nativePtr, color);
	}
	...
	public static void SetCustomColor(int32 index, void color)
	{
	...
	public static void SetStandardColor(int32 index, void color)
	{
	...
	{
		CQt.QColorDialog_ChangeEvent(this.nativePtr, event);
	}
	...
	public static void GetColor1(void* initial)
	{
		CQt.QColorDialog_GetColor1(initial);
	}
	
	public static void GetColor2(void* initial, void* parent)
	{
		CQt.QColorDialog_GetColor2(initial, parent);
	}
	
	public static void GetColor3(void* initial, void* parent, libqt_string title)
	{
		CQt.QColorDialog_GetColor3(initial, parent, title);
	}
	
	public static void GetColor4(void* initial, void* parent, libqt_string title, int64 options)
	{
		CQt.QColorDialog_GetColor4(initial, parent, title, options);
	}
