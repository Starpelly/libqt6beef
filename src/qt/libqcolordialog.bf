...
public interface IQColorDialog
{
	void* NativePtr { get; }
}
public struct QColorDialogPtr : IQColorDialog, IDisposable, IQDialog
{
	...
	{
		return .(CQt.QColorDialog_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QColorDialog_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QColorDialog_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QColorDialog_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QColorDialog_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QColorDialog_SetCurrentColor(this.nativePtr, (color == default || color.NativePtr == default) ? default : color.NativePtr);
	}
	
	public void CurrentColor()
	{
		CQt.QColorDialog_CurrentColor(this.nativePtr);
	}
	
	public void SelectedColor()
	{
		CQt.QColorDialog_SelectedColor(this.nativePtr);
	}
	
	public void SetOption(int64 option)
	{
		CQt.QColorDialog_SetOption(this.nativePtr, (int64)option);
	}
	
	public bool TestOption(int64 option)
	{
		return CQt.QColorDialog_TestOption(this.nativePtr, (int64)option);
	}
	
	public void SetOptions(int64 options)
	{
		CQt.QColorDialog_SetOptions(this.nativePtr, options);
	}
	
	public int64 Options()
	{
		return CQt.QColorDialog_Options(this.nativePtr);
	}
	
	public void SetVisible(bool visible)
	{
		CQt.QColorDialog_SetVisible(this.nativePtr, visible);
	}
	
	public static void GetColor()
	{
		CQt.QColorDialog_GetColor();
	}
	
	public static int32 CustomCount()
	{
		return CQt.QColorDialog_CustomCount();
	}
	
	public static void CustomColor(int32 index)
	{
		CQt.QColorDialog_CustomColor(index);
	}
	
	public static void SetCustomColor(int32 index, IQColor color)
	{
		CQt.QColorDialog_SetCustomColor(index, default);
	}
	
	public static void StandardColor(int32 index)
	{
		CQt.QColorDialog_StandardColor(index);
	}
	
	public static void SetStandardColor(int32 index, IQColor color)
	{
		CQt.QColorDialog_SetStandardColor(index, default);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QColorDialog_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void Done(int32 result)
	{
		CQt.QColorDialog_Done(this.nativePtr, result);
	}
	...
	{
		CQt.QColorDialog_SetOption2(this.nativePtr, (int64)option, on);
	}
	
	public static void GetColor1(IQColor initial)
	{
		CQt.QColorDialog_GetColor1((initial == default || initial.NativePtr == default) ? default : initial.NativePtr);
	}
	
	public static void GetColor2(IQColor initial, IQWidget parent)
	{
		CQt.QColorDialog_GetColor2((initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public static void GetColor3(IQColor initial, IQWidget parent, String title)
	{
		CQt.QColorDialog_GetColor3((initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, libqt_string(title));
	}
	
	public static void GetColor4(IQColor initial, IQWidget parent, String title, int64 options)
	{
		CQt.QColorDialog_GetColor4((initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, libqt_string(title), options);
	}
...
{
	public QColorDialogPtr handle;
	
	public static implicit operator QColorDialogPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QColorDialogPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QColorDialogPtr.Tr(s);
	}
	
	public void SetCurrentColor(IQColor color)
	{
		this.handle.SetCurrentColor(color);
	}
	
	public void CurrentColor()
	{
		this.handle.CurrentColor();
	}
	
	public void SelectedColor()
	{
		this.handle.SelectedColor();
	}
	...
	public static void GetColor()
	{
		QColorDialogPtr.GetColor();
	}
	
	public static int32 CustomCount()
	{
		return QColorDialogPtr.CustomCount();
	}
	
	public static void CustomColor(int32 index)
	{
		QColorDialogPtr.CustomColor(index);
	}
	
	public static void SetCustomColor(int32 index, IQColor color)
	{
		QColorDialogPtr.SetCustomColor(index, default);
	}
	
	public static void StandardColor(int32 index)
	{
		QColorDialogPtr.StandardColor(index);
	}
	
	public static void SetStandardColor(int32 index, IQColor color)
	{
		QColorDialogPtr.SetStandardColor(index, default);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QColorDialogPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QColorDialogPtr.Tr3(s, c, n);
	}
	...
	public static void GetColor1(IQColor initial)
	{
		QColorDialogPtr.GetColor1(initial);
	}
	
	public static void GetColor2(IQColor initial, IQWidget parent)
	{
		QColorDialogPtr.GetColor2(initial, parent);
	}
	
	public static void GetColor3(IQColor initial, IQWidget parent, String title)
	{
		QColorDialogPtr.GetColor3(initial, parent, title);
	}
	
	public static void GetColor4(IQColor initial, IQWidget parent, String title, int64 options)
	{
		QColorDialogPtr.GetColor4(initial, parent, title, options);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QColorDialogPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QColorDialogPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QColorDialogPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QColorDialogPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QColorDialogPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QColorDialogPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QColorDialogPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QColorDialogPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QColorDialogPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QColorDialogPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QColorDialogPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QColorDialogPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QColorDialog_new(void* parent);
	[LinkName("QColorDialog_new2")]
	public static extern void* QColorDialog_new2();
	[LinkName("QColorDialog_new3")]
	public static extern void* QColorDialog_new3(void* initial);
	[LinkName("QColorDialog_new4")]
	public static extern void* QColorDialog_new4(void* initial, void* parent);
	[LinkName("QColorDialog_MetaObject")]
	public static extern void* QColorDialog_MetaObject(void* c_this);
	...
	public static extern void QColorDialog_SetCurrentColor(void* c_this, void* color);
	[LinkName("QColorDialog_CurrentColor")]
	public static extern void QColorDialog_CurrentColor(void* c_this);
	[LinkName("QColorDialog_SelectedColor")]
	public static extern void QColorDialog_SelectedColor(void* c_this);
	...
	public static extern void QColorDialog_CustomColor(int32 index);
	[LinkName("QColorDialog_SetCustomColor")]
	public static extern void QColorDialog_SetCustomColor(int32 index, void color);
	[LinkName("QColorDialog_StandardColor")]
	public static extern void QColorDialog_StandardColor(int32 index);
	[LinkName("QColorDialog_SetStandardColor")]
	public static extern void QColorDialog_SetStandardColor(int32 index, void color);
	[LinkName("QColorDialog_Connect_CurrentColorChanged")]
	public static extern void QColorDialog_Connect_CurrentColorChanged(void* c_this, c_intptr slot);
	[LinkName("QColorDialog_Connect_ColorSelected")]
	public static extern void QColorDialog_Connect_ColorSelected(void* c_this, c_intptr slot);
	[LinkName("QColorDialog_ChangeEvent")]
	public static extern void QColorDialog_ChangeEvent(void* c_this, void* event);
	...
	public static extern void QColorDialog_GetColor4(void* initial, void* parent, libqt_string title, int64 options);
	/// Delete this object from C++ memory
	[LinkName("QColorDialog_Delete")]
	public static extern void QColorDialog_Delete(void* self);
}