...
public interface IQAbstractScrollArea
{
	void* NativePtr { get; }
}
public struct QAbstractScrollAreaPtr : IQAbstractScrollArea, IDisposable, IQFrame
{
	...
	{
		return .(CQt.QAbstractScrollArea_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QAbstractScrollArea_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QAbstractScrollArea_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QAbstractScrollArea_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QAbstractScrollArea_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public void SetViewportMargins(int32 left, int32 top, int32 right, int32 bottom)
	{
		CQt.QAbstractScrollArea_SetViewportMargins(this.nativePtr, left, top, right, bottom);
	}
	
	public void SetViewportMarginsWithMargins(IQMargins margins)
	{
		CQt.QAbstractScrollArea_SetViewportMarginsWithMargins(this.nativePtr, (margins == default || margins.NativePtr == default) ? default : margins.NativePtr);
	}
	
	public void ViewportMargins()
	{
		CQt.QAbstractScrollArea_ViewportMargins(this.nativePtr);
	}
	
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QAbstractScrollArea_EventFilter(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr, (param2 == default || param2.NativePtr == default) ? default : param2.NativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QAbstractScrollArea_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool ViewportEvent(IQEvent param1)
	{
		return CQt.QAbstractScrollArea_ViewportEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QAbstractScrollArea_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QAbstractScrollArea_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QAbstractScrollArea_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QAbstractScrollArea_MouseReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseDoubleClickEvent(IQMouseEvent param1)
	{
		CQt.QAbstractScrollArea_MouseDoubleClickEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QAbstractScrollArea_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent param1)
	{
		CQt.QAbstractScrollArea_WheelEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent param1)
	{
		CQt.QAbstractScrollArea_ContextMenuEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void DragEnterEvent(IQDragEnterEvent param1)
	{
		CQt.QAbstractScrollArea_DragEnterEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void DragMoveEvent(IQDragMoveEvent param1)
	{
		CQt.QAbstractScrollArea_DragMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void DragLeaveEvent(IQDragLeaveEvent param1)
	{
		CQt.QAbstractScrollArea_DragLeaveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void DropEvent(IQDropEvent param1)
	{
		CQt.QAbstractScrollArea_DropEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QAbstractScrollArea_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ScrollContentsBy(int32 dx, int32 dy)
	{
		CQt.QAbstractScrollArea_ScrollContentsBy(this.nativePtr, dx, dy);
	}
	
	public void ViewportSizeHint()
	{
		CQt.QAbstractScrollArea_ViewportSizeHint(this.nativePtr);
	}
...
{
	public QAbstractScrollAreaPtr handle;
	
	public static implicit operator QAbstractScrollAreaPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QAbstractScrollAreaPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractScrollAreaPtr.Tr(s);
	}
	...
	public void SetViewportMargins(int32 left, int32 top, int32 right, int32 bottom)
	{
		this.handle.SetViewportMargins(left, top, right, bottom);
	}
	
	public void SetViewportMarginsWithMargins(IQMargins margins)
	{
		this.handle.SetViewportMarginsWithMargins(margins);
	}
	
	public void ViewportMargins()
	{
		this.handle.ViewportMargins();
	}
	...
	public virtual bool ViewportEvent(IQEvent param1)
	{
		return this.handle.ViewportEvent(param1);
	}
	...
	public virtual void DragMoveEvent(IQDragMoveEvent param1)
	{
		this.handle.DragMoveEvent(param1);
	}
	
	public virtual void DragLeaveEvent(IQDragLeaveEvent param1)
	{
		this.handle.DragLeaveEvent(param1);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractScrollAreaPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractScrollAreaPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QAbstractScrollAreaPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QAbstractScrollAreaPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QAbstractScrollAreaPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QAbstractScrollAreaPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QAbstractScrollAreaPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QAbstractScrollAreaPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QAbstractScrollAreaPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractScrollAreaPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractScrollAreaPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractScrollAreaPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractScrollAreaPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QAbstractScrollAreaPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QAbstractScrollArea_new(void* parent);
	...
	public static extern void* QAbstractScrollArea_MetaObject(void* c_this);
	...
	public static extern void* QAbstractScrollArea_VerticalScrollBar(void* c_this);
	[LinkName("QAbstractScrollArea_SetVerticalScrollBar")]
	public static extern void QAbstractScrollArea_SetVerticalScrollBar(void* c_this, void* scrollbar);
	...
	public static extern void* QAbstractScrollArea_HorizontalScrollBar(void* c_this);
	[LinkName("QAbstractScrollArea_SetHorizontalScrollBar")]
	public static extern void QAbstractScrollArea_SetHorizontalScrollBar(void* c_this, void* scrollbar);
	[LinkName("QAbstractScrollArea_CornerWidget")]
	public static extern void* QAbstractScrollArea_CornerWidget(void* c_this);
	[LinkName("QAbstractScrollArea_SetCornerWidget")]
	public static extern void QAbstractScrollArea_SetCornerWidget(void* c_this, void* widget);
	[LinkName("QAbstractScrollArea_AddScrollBarWidget")]
	public static extern void QAbstractScrollArea_AddScrollBarWidget(void* c_this, void* widget, int64 alignment);
	[LinkName("QAbstractScrollArea_ScrollBarWidgets")]
	public static extern void*[] QAbstractScrollArea_ScrollBarWidgets(void* c_this, int64 alignment);
	[LinkName("QAbstractScrollArea_Viewport")]
	public static extern void* QAbstractScrollArea_Viewport(void* c_this);
	[LinkName("QAbstractScrollArea_SetViewport")]
	public static extern void QAbstractScrollArea_SetViewport(void* c_this, void* widget);
	[LinkName("QAbstractScrollArea_MaximumViewportSize")]
	public static extern void QAbstractScrollArea_MaximumViewportSize(void* c_this);
	[LinkName("QAbstractScrollArea_MinimumSizeHint")]
	public static extern void QAbstractScrollArea_MinimumSizeHint(void* c_this);
	[LinkName("QAbstractScrollArea_SizeHint")]
	public static extern void QAbstractScrollArea_SizeHint(void* c_this);
	[LinkName("QAbstractScrollArea_SetupViewport")]
	public static extern void QAbstractScrollArea_SetupViewport(void* c_this, void* viewport);
	...
	public static extern void QAbstractScrollArea_SetViewportMarginsWithMargins(void* c_this, void* margins);
	[LinkName("QAbstractScrollArea_ViewportMargins")]
	public static extern void QAbstractScrollArea_ViewportMargins(void* c_this);
	[LinkName("QAbstractScrollArea_EventFilter")]
	public static extern bool QAbstractScrollArea_EventFilter(void* c_this, void* param1, void* param2);
	[LinkName("QAbstractScrollArea_Event")]
	public static extern bool QAbstractScrollArea_Event(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_ViewportEvent")]
	public static extern bool QAbstractScrollArea_ViewportEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_ResizeEvent")]
	public static extern void QAbstractScrollArea_ResizeEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_PaintEvent")]
	public static extern void QAbstractScrollArea_PaintEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_MousePressEvent")]
	public static extern void QAbstractScrollArea_MousePressEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_MouseReleaseEvent")]
	public static extern void QAbstractScrollArea_MouseReleaseEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_MouseDoubleClickEvent")]
	public static extern void QAbstractScrollArea_MouseDoubleClickEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_MouseMoveEvent")]
	public static extern void QAbstractScrollArea_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_WheelEvent")]
	public static extern void QAbstractScrollArea_WheelEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_ContextMenuEvent")]
	public static extern void QAbstractScrollArea_ContextMenuEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_DragEnterEvent")]
	public static extern void QAbstractScrollArea_DragEnterEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_DragMoveEvent")]
	public static extern void QAbstractScrollArea_DragMoveEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_DragLeaveEvent")]
	public static extern void QAbstractScrollArea_DragLeaveEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_DropEvent")]
	public static extern void QAbstractScrollArea_DropEvent(void* c_this, void* param1);
	[LinkName("QAbstractScrollArea_KeyPressEvent")]
	public static extern void QAbstractScrollArea_KeyPressEvent(void* c_this, void* param1);
	...
	public static extern void QAbstractScrollArea_ViewportSizeHint(void* c_this);
	...
	public static extern void QAbstractScrollArea_Delete(void* self);
}