...
public class QAbstractScrollArea
{
	...
	{
		this.nativePtr = CQt.QAbstractScrollArea_new(parent);
	}
	...
	public void SetViewportMarginsWithMargins(void* margins)
	{
		CQt.QAbstractScrollArea_SetViewportMarginsWithMargins(this.nativePtr, margins);
	}
	...
	{
		return CQt.QAbstractScrollArea_EventFilter(this.nativePtr, param1, param2);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QAbstractScrollArea_Event(this.nativePtr, param1);
	}
	
	public virtual bool ViewportEvent(void* param1)
	{
		return CQt.QAbstractScrollArea_ViewportEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QAbstractScrollArea_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QAbstractScrollArea_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QAbstractScrollArea_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QAbstractScrollArea_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseDoubleClickEvent(void* param1)
	{
		CQt.QAbstractScrollArea_MouseDoubleClickEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QAbstractScrollArea_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void WheelEvent(void* param1)
	{
		CQt.QAbstractScrollArea_WheelEvent(this.nativePtr, param1);
	}
	
	public virtual void ContextMenuEvent(void* param1)
	{
		CQt.QAbstractScrollArea_ContextMenuEvent(this.nativePtr, param1);
	}
	
	public virtual void DragEnterEvent(void* param1)
	{
		CQt.QAbstractScrollArea_DragEnterEvent(this.nativePtr, param1);
	}
	
	public virtual void DragMoveEvent(void* param1)
	{
		CQt.QAbstractScrollArea_DragMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void DragLeaveEvent(void* param1)
	{
		CQt.QAbstractScrollArea_DragLeaveEvent(this.nativePtr, param1);
	}
	
	public virtual void DropEvent(void* param1)
	{
		CQt.QAbstractScrollArea_DropEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QAbstractScrollArea_KeyPressEvent(this.nativePtr, param1);
	}
