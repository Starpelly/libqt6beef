...
public class QCommandLinkButton : IQCommandLinkButton, IQPushButton
{
	...
	{
		this.nativePtr = CQt.QCommandLinkButton_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QCommandLinkButton_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QCommandLinkButton_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QCommandLinkButton_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QCommandLinkButton_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
