...
public class QCommandLinkButton
{
	...
	{
		this.nativePtr = CQt.QCommandLinkButton_new(parent);
	}
	...
	{
		CQt.QCommandLinkButton_SetDescription(this.nativePtr, description);
	}
	...
	{
		CQt.QCommandLinkButton_InitStyleOption(this.nativePtr, option);
	}
	
	public virtual bool Event(void* e)
	{
		return CQt.QCommandLinkButton_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QCommandLinkButton_PaintEvent(this.nativePtr, param1);
	}
