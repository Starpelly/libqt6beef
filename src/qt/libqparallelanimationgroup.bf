...
public struct QParallelAnimationGroupPtr : IQParallelAnimationGroup, IDisposable, IQAnimationGroup
{
	...
	{
		return .(CQt.QParallelAnimationGroup_new());
	}
	...
	{
		return CQt.QParallelAnimationGroup_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QParallelAnimationGroup_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	{
		CQt.QParallelAnimationGroup_UpdateState(this.nativePtr, (int64)newState, (int64)oldState);
	}
	
	public void UpdateDirection(int64 direction)
	{
		CQt.QParallelAnimationGroup_UpdateDirection(this.nativePtr, (int64)direction);
	}
...
{
	public QParallelAnimationGroupPtr handle;
	
	public static implicit operator QParallelAnimationGroupPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QParallelAnimationGroupPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QParallelAnimationGroupPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QParallelAnimationGroupPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QParallelAnimationGroupPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QParallelAnimationGroupPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QParallelAnimationGroupPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QParallelAnimationGroupPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QParallelAnimationGroupPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
