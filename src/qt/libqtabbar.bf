...
public struct QTabBarPtr : IQTabBar, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QTabBar_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QTabBar_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QTabBar_SetShape(this.nativePtr, (int64)shape);
	}
	...
	{
		return CQt.QTabBar_AddTab2(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	...
	{
		return CQt.QTabBar_InsertTab2(this.nativePtr, index, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr, libqt_string(text));
	}
	...
	{
		CQt.QTabBar_SetTabTextColor(this.nativePtr, index, (color == default || color.NativePtr == default) ? default : color.NativePtr);
	}
	...
	{
		CQt.QTabBar_SetTabIcon(this.nativePtr, index, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	...
	{
		CQt.QTabBar_SetElideMode(this.nativePtr, (int64)mode);
	}
	...
	{
		CQt.QTabBar_SetTabData(this.nativePtr, index, (data == default || data.NativePtr == default) ? default : data.NativePtr);
	}
	...
	{
		return CQt.QTabBar_TabAt(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	...
	{
		CQt.QTabBar_SetIconSize(this.nativePtr, (size == default || size.NativePtr == default) ? default : size.NativePtr);
	}
	...
	{
		CQt.QTabBar_SetTabButton(this.nativePtr, index, (int64)position, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* TabButton(int32 index, int64 position)
	{
		return CQt.QTabBar_TabButton(this.nativePtr, index, (int64)position);
	}
	...
	{
		CQt.QTabBar_SetSelectionBehaviorOnRemove(this.nativePtr, (int64)behavior);
	}
	...
	public void TabSizeHint(int32 index)
	{
		CQt.QTabBar_TabSizeHint(this.nativePtr, index);
	}
	
	public void MinimumTabSizeHint(int32 index)
	{
	...
	{
		return CQt.QTabBar_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QTabBar_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QTabBar_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void HideEvent(IQHideEvent param1)
	{
		CQt.QTabBar_HideEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QTabBar_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseReleaseEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseDoubleClickEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseDoubleClickEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QTabBar_WheelEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QTabBar_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QTabBar_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent event)
	{
		CQt.QTabBar_TimerEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionTab option, int32 tabIndex)
	{
		CQt.QTabBar_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr, tabIndex);
	}
...
{
	public QTabBarPtr handle;
	
	public static implicit operator QTabBarPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QTabBarPtr.New(parent);
	}
	...
	public void SetShape(int64 shape)
	{
		this.handle.SetShape(shape);
	}
	
	public int32 AddTab(String text)
	{
		return this.handle.AddTab(text);
	}
	
	public int32 AddTab2(IQIcon icon, String text)
	{
		return this.handle.AddTab2(icon, text);
	}
	
	public int32 InsertTab(int32 index, String text)
	{
		return this.handle.InsertTab(index, text);
	}
	
	public int32 InsertTab2(int32 index, IQIcon icon, String text)
	{
		return this.handle.InsertTab2(index, icon, text);
	}
	...
	public void TabTextColor(int32 index)
	{
		this.handle.TabTextColor(index);
	}
	
	public void SetTabTextColor(int32 index, IQColor color)
	{
		this.handle.SetTabTextColor(index, color);
	}
	...
	public void SetTabData(int32 index, IQVariant data)
	{
		this.handle.SetTabData(index, data);
	}
	
	public void TabData(int32 index)
	{
		this.handle.TabData(index);
	}
	
	public void TabRect(int32 index)
	{
		this.handle.TabRect(index);
	}
	
	public int32 TabAt(IQPoint pos)
	{
		return this.handle.TabAt(pos);
	}
	...
	public void SetDrawBase(bool drawTheBase)
	{
		this.handle.SetDrawBase(drawTheBase);
	}
	
	public bool DrawBase()
	{
		return this.handle.DrawBase();
	}
	...
	public void SetTabButton(int32 index, int64 position, IQWidget widget)
	{
		this.handle.SetTabButton(index, position, widget);
	}
	
	public void* TabButton(int32 index, int64 position)
	{
		return this.handle.TabButton(index, position);
	}
	
	public int64 SelectionBehaviorOnRemove()
	{
		return this.handle.SelectionBehaviorOnRemove();
	}
	
	public void SetSelectionBehaviorOnRemove(int64 behavior)
	{
		this.handle.SetSelectionBehaviorOnRemove(behavior);
	}
	
	public bool Expanding()
	{
		return this.handle.Expanding();
	}
	
	public void SetExpanding(bool enabled)
	{
		this.handle.SetExpanding(enabled);
	}
	...
	public bool AutoHide()
	{
		return this.handle.AutoHide();
	}
	
	public void SetAutoHide(bool hide)
	{
		this.handle.SetAutoHide(hide);
	}
	
	public bool ChangeCurrentOnDrag()
	{
		return this.handle.ChangeCurrentOnDrag();
	}
	
	public void SetChangeCurrentOnDrag(bool change)
	{
		this.handle.SetChangeCurrentOnDrag(change);
	}
	
	public libqt_string AccessibleTabName(int32 index)
	{
		return this.handle.AccessibleTabName(index);
	}
	
	public void SetAccessibleTabName(int32 index, String name)
	{
		this.handle.SetAccessibleTabName(index, name);
	}
	...
	{
		this.handle.TabSizeHint(index);
	}
	
	public virtual void MinimumTabSizeHint(int32 index)
	{
		this.handle.MinimumTabSizeHint(index);
	}
	...
	{
		this.handle.InitStyleOption(option, tabIndex);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QTabBarPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QTabBarPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QTabBarPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QTabBarPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QTabBarPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QTabBarPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QTabBarPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QTabBarPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QTabBarPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QTabBarPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QTabBarPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QTabBarPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QTabBarPtr.DevicePixelRatioFScale();
	}
