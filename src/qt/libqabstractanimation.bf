...
public struct QAbstractAnimationPtr : IQAbstractAnimation, IDisposable, IQObject
{
	...
	{
		return .(CQt.QAbstractAnimation_new());
	}
	...
	{
		return CQt.QAbstractAnimation_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QAbstractAnimation_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void UpdateCurrentTime(int32 currentTime)
	{
	...
	{
		CQt.QAbstractAnimation_UpdateState(this.nativePtr, (int64)newState, (int64)oldState);
	}
	
	public void UpdateDirection(int64 direction)
	{
		CQt.QAbstractAnimation_UpdateDirection(this.nativePtr, (int64)direction);
	}
...
{
	public QAbstractAnimationPtr handle;
	
	public static implicit operator QAbstractAnimationPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QAbstractAnimationPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractAnimationPtr.Tr(s);
	}
	...
	{
		this.handle.UpdateCurrentTime(currentTime);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractAnimationPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractAnimationPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractAnimationPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractAnimationPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractAnimationPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractAnimationPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
...
public struct QAnimationDriverPtr : IQAnimationDriver, IDisposable, IQObject
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	public static Self New()
	{
		return .(CQt.QAnimationDriver_new());
	}
	...
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QAnimationDriver_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
...
{
	public QAnimationDriverPtr handle;
	
	public static implicit operator QAnimationDriverPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QAnimationDriverPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAnimationDriverPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAnimationDriverPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAnimationDriverPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAnimationDriverPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAnimationDriverPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAnimationDriverPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAnimationDriverPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
