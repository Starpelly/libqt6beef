...
public struct QStringListModelPtr : IQStringListModel, IDisposable, IQAbstractListModel
{
	...
	{
		return .(CQt.QStringListModel_new());
	}
	...
	{
		return CQt.QStringListModel_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QStringListModel_RowCount(this.nativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public void Sibling(int32 row, int32 column, IQModelIndex idx)
	{
		CQt.QStringListModel_Sibling(this.nativePtr, row, column, (idx == default || idx.NativePtr == default) ? default : idx.NativePtr);
	}
	
	public void Data(IQModelIndex index, int32 role)
	{
		CQt.QStringListModel_Data(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, role);
	}
	
	public bool SetData(IQModelIndex index, IQVariant value, int32 role)
	{
		return CQt.QStringListModel_SetData(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, (value == default || value.NativePtr == default) ? default : value.NativePtr, role);
	}
	
	public bool ClearItemData(IQModelIndex index)
	{
		return CQt.QStringListModel_ClearItemData(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	
	public int64 Flags(IQModelIndex index)
	{
		return CQt.QStringListModel_Flags(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	
	public bool InsertRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QStringListModel_InsertRows(this.nativePtr, row, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public bool RemoveRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QStringListModel_RemoveRows(this.nativePtr, row, count, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	...
	{
		return CQt.QStringListModel_MoveRows(this.nativePtr, (sourceParent == default || sourceParent.NativePtr == default) ? default : sourceParent.NativePtr, sourceRow, count, (destinationParent == default || destinationParent.NativePtr == default) ? default : destinationParent.NativePtr, destinationChild);
	}
	
	public void* ItemData(IQModelIndex index)
	{
		return CQt.QStringListModel_ItemData(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr);
	}
	
	public bool SetItemData(IQModelIndex index, void* roles)
	{
		return CQt.QStringListModel_SetItemData(this.nativePtr, (index == default || index.NativePtr == default) ? default : index.NativePtr, roles);
	}
	
	public void Sort(int32 column, int64 order)
	{
		CQt.QStringListModel_Sort(this.nativePtr, column, (int64)order);
	}
...
{
	public QStringListModelPtr handle;
	
	public static implicit operator QStringListModelPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QStringListModelPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QStringListModelPtr.Tr(s);
	}
	...
	public libqt_string[] StringList()
	{
		return this.handle.StringList();
	}
	
	public void SetStringList(String[] strings)
	{
		this.handle.SetStringList(null);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QStringListModelPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QStringListModelPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QStringListModelPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QStringListModelPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QStringListModelPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QStringListModelPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
