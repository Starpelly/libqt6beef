...
public struct QErrorMessagePtr : IQErrorMessage, IDisposable, IQDialog
{
	...
	{
		return .(CQt.QErrorMessage_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QErrorMessage_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QErrorMessage_ChangeEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
...
public class QErrorMessage
{
	public QErrorMessagePtr handle;
	
	public static implicit operator QErrorMessagePtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QErrorMessagePtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QErrorMessagePtr.Tr(s);
	}
	
	public static void* QtHandler()
	{
		return QErrorMessagePtr.QtHandler();
	}
	...
	public void ShowMessage2(String message, String typeVal)
	{
		this.handle.ShowMessage2(message, typeVal);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QErrorMessagePtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QErrorMessagePtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QErrorMessagePtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QErrorMessagePtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QErrorMessagePtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QErrorMessagePtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QErrorMessagePtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QErrorMessagePtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QErrorMessagePtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QErrorMessagePtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QErrorMessagePtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QErrorMessagePtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QErrorMessagePtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QErrorMessagePtr.DevicePixelRatioFScale();
	}
