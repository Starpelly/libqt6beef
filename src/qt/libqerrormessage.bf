...
public class QErrorMessage
{
	...
	{
		this.nativePtr = CQt.QErrorMessage_new(parent);
	}
	...
	{
		CQt.QErrorMessage_ShowMessage(this.nativePtr, message);
	}
	
	public void ShowMessage2(libqt_string message, libqt_string typeVal)
	{
		CQt.QErrorMessage_ShowMessage2(this.nativePtr, message, typeVal);
	}
	...
	{
		CQt.QErrorMessage_ChangeEvent(this.nativePtr, e);
	}
