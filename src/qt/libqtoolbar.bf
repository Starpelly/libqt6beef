...
public interface IQToolBar
{
	void* NativePtr { get; }
}
public struct QToolBarPtr : IQToolBar, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QToolBar_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QToolBar_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QToolBar_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QToolBar_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QToolBar_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QToolBar_SetMovable(this.nativePtr, movable);
	}
	
	public bool IsMovable()
	{
		return CQt.QToolBar_IsMovable(this.nativePtr);
	}
	
	public void SetAllowedAreas(int64 areas)
	{
		CQt.QToolBar_SetAllowedAreas(this.nativePtr, areas);
	}
	
	public int64 AllowedAreas()
	{
		return CQt.QToolBar_AllowedAreas(this.nativePtr);
	}
	
	public bool IsAreaAllowed(int64 area)
	{
		return CQt.QToolBar_IsAreaAllowed(this.nativePtr, (int64)area);
	}
	
	public void SetOrientation(int64 orientation)
	{
		CQt.QToolBar_SetOrientation(this.nativePtr, (int64)orientation);
	}
	
	public int64 Orientation()
	{
		return CQt.QToolBar_Orientation(this.nativePtr);
	}
	
	public void Clear()
	{
		CQt.QToolBar_Clear(this.nativePtr);
	}
	
	public void* AddSeparator()
	{
		return CQt.QToolBar_AddSeparator(this.nativePtr);
	}
	
	public void* InsertSeparator(IQAction before)
	{
		return CQt.QToolBar_InsertSeparator(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr);
	}
	
	public void* AddWidget(IQWidget widget)
	{
		return CQt.QToolBar_AddWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* InsertWidget(IQAction before, IQWidget widget)
	{
		return CQt.QToolBar_InsertWidget(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void ActionGeometry(IQAction action)
	{
		CQt.QToolBar_ActionGeometry(this.nativePtr, (action == default || action.NativePtr == default) ? default : action.NativePtr);
	}
	
	public void* ActionAt(IQPoint p)
	{
		return CQt.QToolBar_ActionAt(this.nativePtr, (p == default || p.NativePtr == default) ? default : p.NativePtr);
	}
	
	public void* ActionAt2(int32 x, int32 y)
	{
		return CQt.QToolBar_ActionAt2(this.nativePtr, x, y);
	}
	
	public void* ToggleViewAction()
	{
		return CQt.QToolBar_ToggleViewAction(this.nativePtr);
	}
	
	public void IconSize()
	{
		CQt.QToolBar_IconSize(this.nativePtr);
	}
	
	public int64 ToolButtonStyle()
	{
		return CQt.QToolBar_ToolButtonStyle(this.nativePtr);
	}
	
	public void* WidgetForAction(IQAction action)
	{
		return CQt.QToolBar_WidgetForAction(this.nativePtr, (action == default || action.NativePtr == default) ? default : action.NativePtr);
	}
	
	public bool IsFloatable()
	{
		return CQt.QToolBar_IsFloatable(this.nativePtr);
	}
	
	public void SetFloatable(bool floatable)
	{
		CQt.QToolBar_SetFloatable(this.nativePtr, floatable);
	}
	
	public bool IsFloating()
	{
		return CQt.QToolBar_IsFloating(this.nativePtr);
	}
	
	public void SetIconSize(IQSize iconSize)
	{
		CQt.QToolBar_SetIconSize(this.nativePtr, (iconSize == default || iconSize.NativePtr == default) ? default : iconSize.NativePtr);
	}
	
	public void SetToolButtonStyle(int64 toolButtonStyle)
	{
		CQt.QToolBar_SetToolButtonStyle(this.nativePtr, (int64)toolButtonStyle);
	}
	
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QToolBar_ActionEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QToolBar_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QToolBar_PaintEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QToolBar_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionToolBar option)
	{
		CQt.QToolBar_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QToolBarPtr handle;
	
	public static implicit operator QToolBarPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QToolBarPtr.New(parent);
	}
	...
	public void SetAllowedAreas(int64 areas)
	{
		this.handle.SetAllowedAreas(areas);
	}
	
	public int64 AllowedAreas()
	{
		return this.handle.AllowedAreas();
	}
	
	public bool IsAreaAllowed(int64 area)
	{
		return this.handle.IsAreaAllowed(area);
	}
	...
	public void* InsertWidget(IQAction before, IQWidget widget)
	{
		return this.handle.InsertWidget(before, widget);
	}
	
	public void ActionGeometry(IQAction action)
	{
		this.handle.ActionGeometry(action);
	}
	
	public void* ActionAt(IQPoint p)
	{
		return this.handle.ActionAt(p);
	}
	
	public void* ActionAt2(int32 x, int32 y)
	{
		return this.handle.ActionAt2(x, y);
	}
	
	public void* ToggleViewAction()
	{
		return this.handle.ToggleViewAction();
	}
	...
	public void* WidgetForAction(IQAction action)
	{
		return this.handle.WidgetForAction(action);
	}
	
	public bool IsFloatable()
	{
		return this.handle.IsFloatable();
	}
	
	public void SetFloatable(bool floatable)
	{
		this.handle.SetFloatable(floatable);
	}
	
	public bool IsFloating()
	{
		return this.handle.IsFloating();
	}
	...
	public virtual void InitStyleOption(IQStyleOptionToolBar option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QToolBarPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QToolBarPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QToolBarPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QToolBarPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QToolBarPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QToolBarPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QToolBarPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QToolBarPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QToolBarPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QToolBarPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QToolBarPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QToolBarPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QToolBarPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QToolBarPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QToolBar_new(void* parent);
	[LinkName("QToolBar_new2")]
	public static extern void* QToolBar_new2(libqt_string title);
	[LinkName("QToolBar_new3")]
	public static extern void* QToolBar_new3();
	[LinkName("QToolBar_new4")]
	public static extern void* QToolBar_new4(libqt_string title, void* parent);
	[LinkName("QToolBar_MetaObject")]
	public static extern void* QToolBar_MetaObject(void* c_this);
	...
	public static extern void* QToolBar_AddSeparator(void* c_this);
	[LinkName("QToolBar_InsertSeparator")]
	public static extern void* QToolBar_InsertSeparator(void* c_this, void* before);
	[LinkName("QToolBar_AddWidget")]
	public static extern void* QToolBar_AddWidget(void* c_this, void* widget);
	[LinkName("QToolBar_InsertWidget")]
	public static extern void* QToolBar_InsertWidget(void* c_this, void* before, void* widget);
	[LinkName("QToolBar_ActionGeometry")]
	public static extern void QToolBar_ActionGeometry(void* c_this, void* action);
	[LinkName("QToolBar_ActionAt")]
	public static extern void* QToolBar_ActionAt(void* c_this, void* p);
	[LinkName("QToolBar_ActionAt2")]
	public static extern void* QToolBar_ActionAt2(void* c_this, int32 x, int32 y);
	[LinkName("QToolBar_ToggleViewAction")]
	public static extern void* QToolBar_ToggleViewAction(void* c_this);
	[LinkName("QToolBar_IconSize")]
	public static extern void QToolBar_IconSize(void* c_this);
	...
	public static extern void* QToolBar_WidgetForAction(void* c_this, void* action);
	...
	public static extern void QToolBar_SetIconSize(void* c_this, void* iconSize);
	...
	public static extern void QToolBar_Connect_ActionTriggered(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_MovableChanged")]
	public static extern void QToolBar_Connect_MovableChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_AllowedAreasChanged")]
	public static extern void QToolBar_Connect_AllowedAreasChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_OrientationChanged")]
	public static extern void QToolBar_Connect_OrientationChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_IconSizeChanged")]
	public static extern void QToolBar_Connect_IconSizeChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_ToolButtonStyleChanged")]
	public static extern void QToolBar_Connect_ToolButtonStyleChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_TopLevelChanged")]
	public static extern void QToolBar_Connect_TopLevelChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_Connect_VisibilityChanged")]
	public static extern void QToolBar_Connect_VisibilityChanged(void* c_this, c_intptr slot);
	[LinkName("QToolBar_ActionEvent")]
	public static extern void QToolBar_ActionEvent(void* c_this, void* event);
	[LinkName("QToolBar_ChangeEvent")]
	public static extern void QToolBar_ChangeEvent(void* c_this, void* event);
	[LinkName("QToolBar_PaintEvent")]
	public static extern void QToolBar_PaintEvent(void* c_this, void* event);
	[LinkName("QToolBar_Event")]
	public static extern bool QToolBar_Event(void* c_this, void* event);
	[LinkName("QToolBar_InitStyleOption")]
	public static extern void QToolBar_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QToolBar_Delete(void* self);
}