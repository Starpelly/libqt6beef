...
public class QMenuBar
{
	...
	{
		this.nativePtr = CQt.QMenuBar_new(parent);
	}
	...
	{
		return CQt.QMenuBar_AddMenu(this.nativePtr, menu);
	}
	
	public void* AddMenuWithTitle(libqt_string title)
	{
		return CQt.QMenuBar_AddMenuWithTitle(this.nativePtr, title);
	}
	
	public void* AddMenu2(void* icon, libqt_string title)
	{
		return CQt.QMenuBar_AddMenu2(this.nativePtr, icon, title);
	}
	...
	{
		return CQt.QMenuBar_InsertSeparator(this.nativePtr, before);
	}
	
	public void* InsertMenu(void* before, void* menu)
	{
		return CQt.QMenuBar_InsertMenu(this.nativePtr, before, menu);
	}
	...
	public void SetActiveAction(void* action)
	{
		CQt.QMenuBar_SetActiveAction(this.nativePtr, action);
	}
	...
	{
		CQt.QMenuBar_ActionGeometry(this.nativePtr, param1);
	}
	
	public void* ActionAt(void* param1)
	{
		return CQt.QMenuBar_ActionAt(this.nativePtr, param1);
	}
	
	public void SetCornerWidget(void* w)
	{
		CQt.QMenuBar_SetCornerWidget(this.nativePtr, w);
	}
	...
	{
		CQt.QMenuBar_ChangeEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QMenuBar_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* param1)
	{
		CQt.QMenuBar_MouseReleaseEvent(this.nativePtr, param1);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QMenuBar_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QMenuBar_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void LeaveEvent(void* param1)
	{
		CQt.QMenuBar_LeaveEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QMenuBar_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QMenuBar_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void ActionEvent(void* param1)
	{
		CQt.QMenuBar_ActionEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusOutEvent(void* param1)
	{
		CQt.QMenuBar_FocusOutEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusInEvent(void* param1)
	{
		CQt.QMenuBar_FocusInEvent(this.nativePtr, param1);
	}
	
	public virtual void TimerEvent(void* param1)
	{
		CQt.QMenuBar_TimerEvent(this.nativePtr, param1);
	}
	
	public virtual bool EventFilter(void* param1, void* param2)
	{
		return CQt.QMenuBar_EventFilter(this.nativePtr, param1, param2);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QMenuBar_Event(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option, void* action)
	{
		CQt.QMenuBar_InitStyleOption(this.nativePtr, option, action);
	}
	...
	{
		CQt.QMenuBar_SetCornerWidget2(this.nativePtr, w, corner);
	}
