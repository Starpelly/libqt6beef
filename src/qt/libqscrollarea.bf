...
public interface IQScrollArea
{
	void* NativePtr { get; }
}
public struct QScrollAreaPtr : IQScrollArea, IDisposable, IQAbstractScrollArea
{
	...
	{
		return .(CQt.QScrollArea_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QScrollArea_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QScrollArea_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QScrollArea_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QScrollArea_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public void* Widget()
	{
		return CQt.QScrollArea_Widget(this.nativePtr);
	}
	
	public void SetWidget(IQWidget widget)
	{
		CQt.QScrollArea_SetWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* TakeWidget()
	{
		return CQt.QScrollArea_TakeWidget(this.nativePtr);
	}
	
	public bool WidgetResizable()
	{
		return CQt.QScrollArea_WidgetResizable(this.nativePtr);
	}
	
	public void SetWidgetResizable(bool resizable)
	{
		CQt.QScrollArea_SetWidgetResizable(this.nativePtr, resizable);
	}
	
	public void SizeHint()
	{
		CQt.QScrollArea_SizeHint(this.nativePtr);
	}
	
	public bool FocusNextPrevChild(bool next)
	{
		return CQt.QScrollArea_FocusNextPrevChild(this.nativePtr, next);
	}
	
	public int64 Alignment()
	{
		return CQt.QScrollArea_Alignment(this.nativePtr);
	}
	
	public void SetAlignment(int64 alignment)
	{
		CQt.QScrollArea_SetAlignment(this.nativePtr, alignment);
	}
	
	public void EnsureVisible(int32 x, int32 y)
	{
		CQt.QScrollArea_EnsureVisible(this.nativePtr, x, y);
	}
	
	public void EnsureWidgetVisible(IQWidget childWidget)
	{
		CQt.QScrollArea_EnsureWidgetVisible(this.nativePtr, (childWidget == default || childWidget.NativePtr == default) ? default : childWidget.NativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QScrollArea_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QScrollArea_EventFilter(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr, (param2 == default || param2.NativePtr == default) ? default : param2.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QScrollArea_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ScrollContentsBy(int32 dx, int32 dy)
	{
		CQt.QScrollArea_ScrollContentsBy(this.nativePtr, dx, dy);
	}
	
	public void ViewportSizeHint()
	{
		CQt.QScrollArea_ViewportSizeHint(this.nativePtr);
	}
	...
	public void EnsureVisible3(int32 x, int32 y, int32 xmargin)
	{
		CQt.QScrollArea_EnsureVisible3(this.nativePtr, x, y, xmargin);
	}
	
	public void EnsureVisible4(int32 x, int32 y, int32 xmargin, int32 ymargin)
	{
		CQt.QScrollArea_EnsureVisible4(this.nativePtr, x, y, xmargin, ymargin);
	}
	
	public void EnsureWidgetVisible2(IQWidget childWidget, int32 xmargin)
	{
		CQt.QScrollArea_EnsureWidgetVisible2(this.nativePtr, (childWidget == default || childWidget.NativePtr == default) ? default : childWidget.NativePtr, xmargin);
	}
	
	public void EnsureWidgetVisible3(IQWidget childWidget, int32 xmargin, int32 ymargin)
	{
		CQt.QScrollArea_EnsureWidgetVisible3(this.nativePtr, (childWidget == default || childWidget.NativePtr == default) ? default : childWidget.NativePtr, xmargin, ymargin);
	}
...
{
	public QScrollAreaPtr handle;
	
	public static implicit operator QScrollAreaPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QScrollAreaPtr.New(parent);
	}
	...
	public void* TakeWidget()
	{
		return this.handle.TakeWidget();
	}
	
	public bool WidgetResizable()
	{
		return this.handle.WidgetResizable();
	}
	
	public void SetWidgetResizable(bool resizable)
	{
		this.handle.SetWidgetResizable(resizable);
	}
	...
	public void EnsureVisible(int32 x, int32 y)
	{
		this.handle.EnsureVisible(x, y);
	}
	
	public void EnsureWidgetVisible(IQWidget childWidget)
	{
		this.handle.EnsureWidgetVisible(childWidget);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QScrollAreaPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QScrollAreaPtr.Tr3(s, c, n);
	}
	
	public void EnsureVisible3(int32 x, int32 y, int32 xmargin)
	{
		this.handle.EnsureVisible3(x, y, xmargin);
	}
	
	public void EnsureVisible4(int32 x, int32 y, int32 xmargin, int32 ymargin)
	{
		this.handle.EnsureVisible4(x, y, xmargin, ymargin);
	}
	
	public void EnsureWidgetVisible2(IQWidget childWidget, int32 xmargin)
	{
		this.handle.EnsureWidgetVisible2(childWidget, xmargin);
	}
	
	public void EnsureWidgetVisible3(IQWidget childWidget, int32 xmargin, int32 ymargin)
	{
		this.handle.EnsureWidgetVisible3(childWidget, xmargin, ymargin);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QScrollAreaPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QScrollAreaPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QScrollAreaPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QScrollAreaPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QScrollAreaPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QScrollAreaPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QScrollAreaPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QScrollAreaPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QScrollAreaPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QScrollAreaPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QScrollAreaPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QScrollAreaPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QScrollArea_new(void* parent);
	[LinkName("QScrollArea_new2")]
	public static extern void* QScrollArea_new2();
	[LinkName("QScrollArea_MetaObject")]
	public static extern void* QScrollArea_MetaObject(void* c_this);
	...
	public static extern void* QScrollArea_Widget(void* c_this);
	[LinkName("QScrollArea_SetWidget")]
	public static extern void QScrollArea_SetWidget(void* c_this, void* widget);
	[LinkName("QScrollArea_TakeWidget")]
	public static extern void* QScrollArea_TakeWidget(void* c_this);
	...
	public static extern void QScrollArea_SizeHint(void* c_this);
	...
	public static extern void QScrollArea_EnsureWidgetVisible(void* c_this, void* childWidget);
	[LinkName("QScrollArea_Event")]
	public static extern bool QScrollArea_Event(void* c_this, void* param1);
	[LinkName("QScrollArea_EventFilter")]
	public static extern bool QScrollArea_EventFilter(void* c_this, void* param1, void* param2);
	[LinkName("QScrollArea_ResizeEvent")]
	public static extern void QScrollArea_ResizeEvent(void* c_this, void* param1);
	...
	public static extern void QScrollArea_ViewportSizeHint(void* c_this);
	...
	public static extern void QScrollArea_EnsureWidgetVisible2(void* c_this, void* childWidget, int32 xmargin);
	[LinkName("QScrollArea_EnsureWidgetVisible3")]
	public static extern void QScrollArea_EnsureWidgetVisible3(void* c_this, void* childWidget, int32 xmargin, int32 ymargin);
	/// Delete this object from C++ memory
	[LinkName("QScrollArea_Delete")]
	public static extern void QScrollArea_Delete(void* self);
}