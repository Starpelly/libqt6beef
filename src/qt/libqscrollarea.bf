...
public class QScrollArea : IQScrollArea, IQAbstractScrollArea
{
	...
	{
		this.nativePtr = CQt.QScrollArea_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QScrollArea_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QScrollArea_SetWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QScrollArea_EnsureWidgetVisible(this.nativePtr, (childWidget == null) ? null : (void*)childWidget.NativePtr);
	}
	
	public virtual bool Event(IQEvent param1)
	{
		return CQt.QScrollArea_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QScrollArea_EventFilter(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr, (param2 == null) ? null : (void*)param2.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QScrollArea_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	...
	{
		CQt.QScrollArea_EnsureWidgetVisible2(this.nativePtr, (childWidget == null) ? null : (void*)childWidget.NativePtr, xmargin);
	}
	
	public void EnsureWidgetVisible3(IQWidget childWidget, int32 xmargin, int32 ymargin)
	{
		CQt.QScrollArea_EnsureWidgetVisible3(this.nativePtr, (childWidget == null) ? null : (void*)childWidget.NativePtr, xmargin, ymargin);
	}
