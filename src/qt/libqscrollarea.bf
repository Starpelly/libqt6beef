...
public class QScrollArea
{
	...
	{
		this.nativePtr = CQt.QScrollArea_new(parent);
	}
	...
	{
		CQt.QScrollArea_SetWidget(this.nativePtr, widget);
	}
	...
	public void EnsureWidgetVisible(void* childWidget)
	{
		CQt.QScrollArea_EnsureWidgetVisible(this.nativePtr, childWidget);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QScrollArea_Event(this.nativePtr, param1);
	}
	
	public virtual bool EventFilter(void* param1, void* param2)
	{
		return CQt.QScrollArea_EventFilter(this.nativePtr, param1, param2);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QScrollArea_ResizeEvent(this.nativePtr, param1);
	}
	...
	public void EnsureWidgetVisible2(void* childWidget, int32 xmargin)
	{
		CQt.QScrollArea_EnsureWidgetVisible2(this.nativePtr, childWidget, xmargin);
	}
	
	public void EnsureWidgetVisible3(void* childWidget, int32 xmargin, int32 ymargin)
	{
		CQt.QScrollArea_EnsureWidgetVisible3(this.nativePtr, childWidget, xmargin, ymargin);
	}
