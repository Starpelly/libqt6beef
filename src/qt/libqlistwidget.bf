...
public class QListWidgetItem : IQListWidgetItem
{
	...
	{
		CQt.QListWidgetItem_SetIcon(this.nativePtr, (icon == default) ? default : (void*)icon.NativePtr);
	}
	...
	{
		CQt.QListWidgetItem_SetFont(this.nativePtr, (font == default) ? default : (void*)font.NativePtr);
	}
	...
	{
		CQt.QListWidgetItem_SetBackground(this.nativePtr, (brush == default) ? default : (void*)brush.NativePtr);
	}
	...
	{
		CQt.QListWidgetItem_SetForeground(this.nativePtr, (brush == default) ? default : (void*)brush.NativePtr);
	}
	...
	{
		CQt.QListWidgetItem_SetSizeHint(this.nativePtr, (size == default) ? default : (void*)size.NativePtr);
	}
	...
	{
		CQt.QListWidgetItem_SetData(this.nativePtr, role, (value == default) ? default : (void*)value.NativePtr);
	}
	
	public virtual bool OperatorLesser(IQListWidgetItem other)
	{
		return CQt.QListWidgetItem_OperatorLesser(this.nativePtr, (other == default) ? default : (void*)other.NativePtr);
	}
	
	public virtual void Read(IQDataStream _in)
	{
		CQt.QListWidgetItem_Read(this.nativePtr, (_in == default) ? default : (void*)_in.NativePtr);
	}
	
	public virtual void Write(IQDataStream _out)
	{
		CQt.QListWidgetItem_Write(this.nativePtr, (_out == default) ? default : (void*)_out.NativePtr);
	}
	
	public void OperatorAssign(IQListWidgetItem other)
	{
		CQt.QListWidgetItem_OperatorAssign(this.nativePtr, (other == default) ? default : (void*)other.NativePtr);
	}
...
public class QListWidget : IQListWidget, IQListView
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		this.nativePtr = CQt.QListWidget_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		CQt.QListWidget_SetSelectionModel(this.nativePtr, (selectionModel == null) ? null : (void*)selectionModel.NativePtr);
	}
	...
	{
		return CQt.QListWidget_Row(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void InsertItem(int32 row, IQListWidgetItem item)
	{
		CQt.QListWidget_InsertItem(this.nativePtr, row, (item == null) ? null : (void*)item.NativePtr);
	}
	...
	{
		CQt.QListWidget_AddItemWithItem(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	...
	{
		CQt.QListWidget_SetCurrentItem(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void SetCurrentItem2(IQListWidgetItem item, int64 command)
	{
		CQt.QListWidget_SetCurrentItem2(this.nativePtr, (item == null) ? null : (void*)item.NativePtr, command);
	}
	...
	{
		return CQt.QListWidget_ItemAt(this.nativePtr, (p == default) ? default : (void*)p.NativePtr);
	}
	...
	{
		CQt.QListWidget_VisualItemRect(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	...
	{
		CQt.QListWidget_EditItem(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void OpenPersistentEditor(IQListWidgetItem item)
	{
		CQt.QListWidget_OpenPersistentEditor(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void ClosePersistentEditor(IQListWidgetItem item)
	{
		CQt.QListWidget_ClosePersistentEditor(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public bool IsPersistentEditorOpen(IQListWidgetItem item)
	{
		return CQt.QListWidget_IsPersistentEditorOpen(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void* ItemWidget(IQListWidgetItem item)
	{
		return CQt.QListWidget_ItemWidget(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void SetItemWidget(IQListWidgetItem item, IQWidget widget)
	{
		CQt.QListWidget_SetItemWidget(this.nativePtr, (item == null) ? null : (void*)item.NativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void RemoveItemWidget(IQListWidgetItem item)
	{
		CQt.QListWidget_RemoveItemWidget(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	...
	{
		return CQt.QListWidget_Items(this.nativePtr, (data == null) ? null : (void*)data.NativePtr);
	}
	
	public void IndexFromItem(IQListWidgetItem item)
	{
		CQt.QListWidget_IndexFromItem(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	
	public void* ItemFromIndex(IQModelIndex index)
	{
		return CQt.QListWidget_ItemFromIndex(this.nativePtr, (index == default) ? default : (void*)index.NativePtr);
	}
	
	public virtual void DropEvent(IQDropEvent event)
	{
		CQt.QListWidget_DropEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public void ScrollToItem(IQListWidgetItem item)
	{
		CQt.QListWidget_ScrollToItem(this.nativePtr, (item == null) ? null : (void*)item.NativePtr);
	}
	...
	{
		return CQt.QListWidget_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	...
	{
		return CQt.QListWidget_DropMimeData(this.nativePtr, index, (data == null) ? null : (void*)data.NativePtr, action);
	}
	...
	{
		CQt.QListWidget_ScrollToItem2(this.nativePtr, (item == null) ? null : (void*)item.NativePtr, hint);
	}
