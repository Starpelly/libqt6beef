...
public interface IQRubberBand
{
	void* NativePtr { get; }
}
public struct QRubberBandPtr : IQRubberBand, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QRubberBand_new((int64)param1));
	}
	
	public void Dispose()
	{
		CQt.QRubberBand_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QRubberBand_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QRubberBand_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QRubberBand_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public int64 Shape()
	{
		return CQt.QRubberBand_Shape(this.nativePtr);
	}
	
	public void SetGeometry(IQRect r)
	{
		CQt.QRubberBand_SetGeometry(this.nativePtr, (r == default || r.NativePtr == default) ? default : r.NativePtr);
	}
	
	public void SetGeometry2(int32 x, int32 y, int32 w, int32 h)
	{
		CQt.QRubberBand_SetGeometry2(this.nativePtr, x, y, w, h);
	}
	
	public void Move(int32 x, int32 y)
	{
		CQt.QRubberBand_Move(this.nativePtr, x, y);
	}
	
	public void MoveWithQPoint(IQPoint p)
	{
		CQt.QRubberBand_MoveWithQPoint(this.nativePtr, (p == default || p.NativePtr == default) ? default : p.NativePtr);
	}
	
	public void Resize(int32 w, int32 h)
	{
		CQt.QRubberBand_Resize(this.nativePtr, w, h);
	}
	
	public void ResizeWithQSize(IQSize s)
	{
		CQt.QRubberBand_ResizeWithQSize(this.nativePtr, (s == default || s.NativePtr == default) ? default : s.NativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QRubberBand_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QRubberBand_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QRubberBand_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QRubberBand_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QRubberBand_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MoveEvent(IQMoveEvent param1)
	{
		CQt.QRubberBand_MoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionRubberBand option)
	{
		CQt.QRubberBand_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QRubberBandPtr handle;
	
	public static implicit operator QRubberBandPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QRubberBandPtr.New(param1);
	}
	...
	public virtual void InitStyleOption(IQStyleOptionRubberBand option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QRubberBandPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QRubberBandPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QRubberBandPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QRubberBandPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QRubberBandPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QRubberBandPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QRubberBandPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QRubberBandPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QRubberBandPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QRubberBandPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QRubberBandPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QRubberBandPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QRubberBandPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QRubberBandPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QRubberBand_new2(int64 param1, void* param2);
	[LinkName("QRubberBand_MetaObject")]
	public static extern void* QRubberBand_MetaObject(void* c_this);
	...
	public static extern void QRubberBand_SetGeometry(void* c_this, void* r);
	...
	public static extern void QRubberBand_MoveWithQPoint(void* c_this, void* p);
	...
	public static extern void QRubberBand_ResizeWithQSize(void* c_this, void* s);
	[LinkName("QRubberBand_Event")]
	public static extern bool QRubberBand_Event(void* c_this, void* e);
	[LinkName("QRubberBand_PaintEvent")]
	public static extern void QRubberBand_PaintEvent(void* c_this, void* param1);
	[LinkName("QRubberBand_ChangeEvent")]
	public static extern void QRubberBand_ChangeEvent(void* c_this, void* param1);
	[LinkName("QRubberBand_ShowEvent")]
	public static extern void QRubberBand_ShowEvent(void* c_this, void* param1);
	[LinkName("QRubberBand_ResizeEvent")]
	public static extern void QRubberBand_ResizeEvent(void* c_this, void* param1);
	[LinkName("QRubberBand_MoveEvent")]
	public static extern void QRubberBand_MoveEvent(void* c_this, void* param1);
	[LinkName("QRubberBand_InitStyleOption")]
	public static extern void QRubberBand_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QRubberBand_Delete(void* self);
}