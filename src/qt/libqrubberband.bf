...
public class QRubberBand : IQRubberBand, IQWidget
{
	...
	{
		this.nativePtr = CQt.QRubberBand_new(param1);
	}
	...
	{
		return CQt.QRubberBand_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QRubberBand_SetGeometry(this.nativePtr, (r == default) ? default : (void*)r.NativePtr);
	}
	...
	{
		CQt.QRubberBand_MoveWithQPoint(this.nativePtr, (p == default) ? default : (void*)p.NativePtr);
	}
	...
	{
		CQt.QRubberBand_ResizeWithQSize(this.nativePtr, (s == default) ? default : (void*)s.NativePtr);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QRubberBand_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QRubberBand_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QRubberBand_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent param1)
	{
		CQt.QRubberBand_ShowEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QRubberBand_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MoveEvent(IQMoveEvent param1)
	{
		CQt.QRubberBand_MoveEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionRubberBand option)
	{
		CQt.QRubberBand_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
