...
public class QRubberBand
{
	...
	public void SetGeometry(void* r)
	{
		CQt.QRubberBand_SetGeometry(this.nativePtr, r);
	}
	...
	public void MoveWithQPoint(void* p)
	{
		CQt.QRubberBand_MoveWithQPoint(this.nativePtr, p);
	}
	...
	public void ResizeWithQSize(void* s)
	{
		CQt.QRubberBand_ResizeWithQSize(this.nativePtr, s);
	}
	
	public virtual bool Event(void* e)
	{
		return CQt.QRubberBand_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QRubberBand_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QRubberBand_ChangeEvent(this.nativePtr, param1);
	}
	
	public virtual void ShowEvent(void* param1)
	{
		CQt.QRubberBand_ShowEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QRubberBand_ResizeEvent(this.nativePtr, param1);
	}
	
	public virtual void MoveEvent(void* param1)
	{
		CQt.QRubberBand_MoveEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QRubberBand_InitStyleOption(this.nativePtr, option);
	}
