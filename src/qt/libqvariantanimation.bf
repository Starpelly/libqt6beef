...
public class QVariantAnimation : IQVariantAnimation, IQAbstractAnimation
{
	...
	{
		return CQt.QVariantAnimation_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	...
	{
		CQt.QVariantAnimation_UpdateCurrentValue(this.nativePtr, (value == default) ? default : (void*)value.NativePtr);
	}
	
	public virtual void Interpolated(IQVariant from, IQVariant to, double progress)
	{
		CQt.QVariantAnimation_Interpolated(this.nativePtr, (from == default) ? default : (void*)from.NativePtr, (to == default) ? default : (void*)to.NativePtr, progress);
	}
