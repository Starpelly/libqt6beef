...
public struct QTextEditPtr : IQTextEdit, IDisposable, IQAbstractScrollArea
{
	...
	{
		return .(CQt.QTextEdit_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QTextEdit_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QTextEdit_LoadResource(this.nativePtr, typeVal, (name == default || name.NativePtr == default) ? default : name.NativePtr);
	}
	...
	{
		return CQt.QTextEdit_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent e)
	{
		CQt.QTextEdit_TimerEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent e)
	{
		CQt.QTextEdit_KeyPressEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void KeyReleaseEvent(IQKeyEvent e)
	{
		CQt.QTextEdit_KeyReleaseEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent e)
	{
		CQt.QTextEdit_ResizeEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent e)
	{
		CQt.QTextEdit_PaintEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MousePressEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MouseMoveEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MouseReleaseEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MouseDoubleClickEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MouseDoubleClickEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	...
	{
		CQt.QTextEdit_ContextMenuEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void DragEnterEvent(IQDragEnterEvent e)
	{
		CQt.QTextEdit_DragEnterEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void DragLeaveEvent(IQDragLeaveEvent e)
	{
		CQt.QTextEdit_DragLeaveEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void DragMoveEvent(IQDragMoveEvent e)
	{
		CQt.QTextEdit_DragMoveEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void DropEvent(IQDropEvent e)
	{
		CQt.QTextEdit_DropEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent e)
	{
		CQt.QTextEdit_FocusInEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent e)
	{
		CQt.QTextEdit_FocusOutEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QTextEdit_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ChangeEvent(IQEvent e)
	{
		CQt.QTextEdit_ChangeEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void WheelEvent(IQWheelEvent e)
	{
		CQt.QTextEdit_WheelEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	...
	{
		return CQt.QTextEdit_CanInsertFromMimeData(this.nativePtr, (source == default || source.NativePtr == default) ? default : source.NativePtr);
	}
	
	public void InsertFromMimeData(IQMimeData source)
	{
		CQt.QTextEdit_InsertFromMimeData(this.nativePtr, (source == default || source.NativePtr == default) ? default : source.NativePtr);
	}
	
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QTextEdit_InputMethodEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	...
	{
		CQt.QTextEdit_DoSetTextCursor(this.nativePtr, (cursor == default || cursor.NativePtr == default) ? default : cursor.NativePtr);
	}
...
{
	public QTextEditPtr handle;
	
	public static implicit operator QTextEditPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QTextEditPtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QTextEditPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QTextEditPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QTextEditPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QTextEditPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QTextEditPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QTextEditPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QTextEditPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QTextEditPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QTextEditPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QTextEditPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QTextEditPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QTextEditPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QTextEditPtr.DevicePixelRatioFScale();
	}
...
public struct QTextEdit__ExtraSelectionPtr : IQTextEdit__ExtraSelection, IDisposable
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	public static Self New(QTextEdit__ExtraSelectionPtr param1)
	{
		return .(CQt.QTextEdit__ExtraSelection_new((param1 == default || param1.NativePtr == default) ? default : param1.NativePtr));
	}
	...
	public void OperatorAssign(QTextEdit__ExtraSelectionPtr param1)
	{
		CQt.QTextEdit__ExtraSelection_OperatorAssign(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
}
public class QTextEdit__ExtraSelection
{
	public QTextEdit__ExtraSelectionPtr handle;
	
	public static implicit operator QTextEdit__ExtraSelectionPtr(Self self)
	{
		return self.handle;
	}
	
	public this(QTextEdit__ExtraSelectionPtr param1)
	{
		this.handle = QTextEdit__ExtraSelectionPtr.New(param1);
	}
