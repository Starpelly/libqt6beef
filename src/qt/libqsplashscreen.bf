...
public class QSplashScreen : IQSplashScreen, IQWidget
{
	...
	public this()
	{
		this.nativePtr = CQt.QSplashScreen_new();
	}
	...
	{
		return CQt.QSplashScreen_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSplashScreen_SetPixmap(this.nativePtr, (pixmap == default) ? default : (void*)pixmap.NativePtr);
	}
	...
	{
		CQt.QSplashScreen_Finish(this.nativePtr, (w == null) ? null : (void*)w.NativePtr);
	}
	...
	{
		return CQt.QSplashScreen_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void DrawContents(IQPainter painter)
	{
		CQt.QSplashScreen_DrawContents(this.nativePtr, (painter == null) ? null : (void*)painter.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSplashScreen_MousePressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	...
	{
		CQt.QSplashScreen_ShowMessage3(this.nativePtr, libqt_string(message), alignment, (color == default) ? default : (void*)color.NativePtr);
	}
