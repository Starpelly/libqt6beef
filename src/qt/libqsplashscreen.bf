...
public interface IQSplashScreen
{
	void* NativePtr { get; }
}
public struct QSplashScreenPtr : IQSplashScreen, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QSplashScreen_new());
	}
	
	public void Dispose()
	{
		CQt.QSplashScreen_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QSplashScreen_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QSplashScreen_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QSplashScreen_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QSplashScreen_SetPixmap(this.nativePtr, (pixmap == default || pixmap.NativePtr == default) ? default : pixmap.NativePtr);
	}
	
	public void Pixmap()
	{
		CQt.QSplashScreen_Pixmap(this.nativePtr);
	}
	
	public void Finish(IQWidget w)
	{
		CQt.QSplashScreen_Finish(this.nativePtr, (w == default || w.NativePtr == default) ? default : w.NativePtr);
	}
	
	public void Repaint()
	{
		CQt.QSplashScreen_Repaint(this.nativePtr);
	}
	
	public libqt_string Message()
	{
		return CQt.QSplashScreen_Message(this.nativePtr);
	}
	
	public void ShowMessage(String message)
	{
		CQt.QSplashScreen_ShowMessage(this.nativePtr, libqt_string(message));
	}
	
	public void ClearMessage()
	{
		CQt.QSplashScreen_ClearMessage(this.nativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QSplashScreen_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void DrawContents(IQPainter painter)
	{
		CQt.QSplashScreen_DrawContents(this.nativePtr, (painter == default || painter.NativePtr == default) ? default : painter.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSplashScreen_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	...
	public void ShowMessage2(String message, int32 alignment)
	{
		CQt.QSplashScreen_ShowMessage2(this.nativePtr, libqt_string(message), alignment);
	}
	
	public void ShowMessage3(String message, int32 alignment, IQColor color)
	{
		CQt.QSplashScreen_ShowMessage3(this.nativePtr, libqt_string(message), alignment, (color == default || color.NativePtr == default) ? default : color.NativePtr);
	}
...
{
	public QSplashScreenPtr handle;
	
	public static implicit operator QSplashScreenPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QSplashScreenPtr.New();
	}
	...
	public void ShowMessage(String message)
	{
		this.handle.ShowMessage(message);
	}
	...
	public virtual void DrawContents(IQPainter painter)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSplashScreenPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSplashScreenPtr.Tr3(s, c, n);
	}
	
	public void ShowMessage2(String message, int32 alignment)
	{
		this.handle.ShowMessage2(message, alignment);
	}
	
	public void ShowMessage3(String message, int32 alignment, IQColor color)
	{
		this.handle.ShowMessage3(message, alignment, color);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QSplashScreenPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QSplashScreenPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QSplashScreenPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QSplashScreenPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QSplashScreenPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QSplashScreenPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QSplashScreenPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSplashScreenPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSplashScreenPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSplashScreenPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSplashScreenPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QSplashScreenPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QSplashScreen_new2(void* screen);
	[LinkName("QSplashScreen_new3")]
	public static extern void* QSplashScreen_new3(void* pixmap);
	[LinkName("QSplashScreen_new4")]
	public static extern void* QSplashScreen_new4(void* pixmap, int64 f);
	[LinkName("QSplashScreen_new5")]
	public static extern void* QSplashScreen_new5(void* screen, void* pixmap);
	[LinkName("QSplashScreen_new6")]
	public static extern void* QSplashScreen_new6(void* screen, void* pixmap, int64 f);
	[LinkName("QSplashScreen_MetaObject")]
	public static extern void* QSplashScreen_MetaObject(void* c_this);
	...
	public static extern void QSplashScreen_SetPixmap(void* c_this, void* pixmap);
	[LinkName("QSplashScreen_Pixmap")]
	public static extern void QSplashScreen_Pixmap(void* c_this);
	[LinkName("QSplashScreen_Finish")]
	public static extern void QSplashScreen_Finish(void* c_this, void* w);
	[LinkName("QSplashScreen_Repaint")]
	public static extern void QSplashScreen_Repaint(void* c_this);
	[LinkName("QSplashScreen_Message")]
	public static extern libqt_string QSplashScreen_Message(void* c_this);
	[LinkName("QSplashScreen_ShowMessage")]
	public static extern void QSplashScreen_ShowMessage(void* c_this, libqt_string message);
	...
	public static extern void QSplashScreen_Connect_MessageChanged(void* c_this, c_intptr slot);
	[LinkName("QSplashScreen_Event")]
	public static extern bool QSplashScreen_Event(void* c_this, void* e);
	[LinkName("QSplashScreen_DrawContents")]
	public static extern void QSplashScreen_DrawContents(void* c_this, void* painter);
	[LinkName("QSplashScreen_MousePressEvent")]
	public static extern void QSplashScreen_MousePressEvent(void* c_this, void* param1);
	...
	public static extern void QSplashScreen_ShowMessage2(void* c_this, libqt_string message, int32 alignment);
	[LinkName("QSplashScreen_ShowMessage3")]
	public static extern void QSplashScreen_ShowMessage3(void* c_this, libqt_string message, int32 alignment, void* color);
	/// Delete this object from C++ memory
	[LinkName("QSplashScreen_Delete")]
	public static extern void QSplashScreen_Delete(void* self);
}