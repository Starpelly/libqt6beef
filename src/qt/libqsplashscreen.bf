...
public class QSplashScreen
{
	...
	{
		CQt.QSplashScreen_SetPixmap(this.nativePtr, pixmap);
	}
	...
	public void Finish(void* w)
	{
		CQt.QSplashScreen_Finish(this.nativePtr, w);
	}
	...
	{
		CQt.QSplashScreen_ShowMessage(this.nativePtr, message);
	}
	...
	{
		return CQt.QSplashScreen_Event(this.nativePtr, e);
	}
	
	public virtual void DrawContents(void* painter)
	{
		CQt.QSplashScreen_DrawContents(this.nativePtr, painter);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QSplashScreen_MousePressEvent(this.nativePtr, param1);
	}
	...
	public void ShowMessage2(libqt_string message, int32 alignment)
	{
		CQt.QSplashScreen_ShowMessage2(this.nativePtr, message, alignment);
	}
	
	public void ShowMessage3(libqt_string message, int32 alignment, void* color)
	{
		CQt.QSplashScreen_ShowMessage3(this.nativePtr, message, alignment, color);
	}
