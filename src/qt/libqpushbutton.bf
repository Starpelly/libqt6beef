...
public class QPushButton
{
	...
	{
		this.nativePtr = CQt.QPushButton_new(parent);
	}
	...
	{
		CQt.QPushButton_SetMenu(this.nativePtr, menu);
	}
	...
	{
		return CQt.QPushButton_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QPushButton_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void KeyPressEvent(void* param1)
	{
		CQt.QPushButton_KeyPressEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusInEvent(void* param1)
	{
		CQt.QPushButton_FocusInEvent(this.nativePtr, param1);
	}
	
	public virtual void FocusOutEvent(void* param1)
	{
		CQt.QPushButton_FocusOutEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QPushButton_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QPushButton_InitStyleOption(this.nativePtr, option);
	}
	
	public virtual bool HitButton(void* pos)
	{
		return CQt.QPushButton_HitButton(this.nativePtr, pos);
	}
