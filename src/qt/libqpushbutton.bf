...
public interface IQPushButton
{
	void* NativePtr { get; }
}
public struct QPushButtonPtr : IQPushButton, IDisposable, IQAbstractButton
{
	...
	{
		return .(CQt.QPushButton_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QPushButton_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QPushButton_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QPushButton_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QPushButton_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QPushButton_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QPushButton_MinimumSizeHint(this.nativePtr);
	}
	
	public bool AutoDefault()
	{
		return CQt.QPushButton_AutoDefault(this.nativePtr);
	}
	
	public void SetAutoDefault(bool autoDefault)
	{
		CQt.QPushButton_SetAutoDefault(this.nativePtr, autoDefault);
	}
	
	public bool IsDefault()
	{
		return CQt.QPushButton_IsDefault(this.nativePtr);
	}
	
	public void SetDefault(bool defaultVal)
	{
		CQt.QPushButton_SetDefault(this.nativePtr, defaultVal);
	}
	
	public void SetMenu(IQMenu menu)
	{
		CQt.QPushButton_SetMenu(this.nativePtr, (menu == default || menu.NativePtr == default) ? default : menu.NativePtr);
	}
	
	public void* Menu()
	{
		return CQt.QPushButton_Menu(this.nativePtr);
	}
	
	public void SetFlat(bool flat)
	{
		CQt.QPushButton_SetFlat(this.nativePtr, flat);
	}
	
	public bool IsFlat()
	{
		return CQt.QPushButton_IsFlat(this.nativePtr);
	}
	
	public void ShowMenu()
	{
		CQt.QPushButton_ShowMenu(this.nativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QPushButton_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QPushButton_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QPushButton_KeyPressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent param1)
	{
		CQt.QPushButton_FocusInEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent param1)
	{
		CQt.QPushButton_FocusOutEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QPushButton_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionButton option)
	{
		CQt.QPushButton_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	
	public bool HitButton(IQPoint pos)
	{
		return CQt.QPushButton_HitButton(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
...
{
	public QPushButtonPtr handle;
	
	public static implicit operator QPushButtonPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QPushButtonPtr.New(parent);
	}
	...
	public bool AutoDefault()
	{
		return this.handle.AutoDefault();
	}
	
	public void SetAutoDefault(bool autoDefault)
	{
		this.handle.SetAutoDefault(autoDefault);
	}
	...
	public void SetDefault(bool defaultVal)
	{
		this.handle.SetDefault(defaultVal);
	}
	...
	public void SetFlat(bool flat)
	{
		this.handle.SetFlat(flat);
	}
	
	public bool IsFlat()
	{
		return this.handle.IsFlat();
	}
	...
	public virtual void InitStyleOption(IQStyleOptionButton option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QPushButtonPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QPushButtonPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QPushButtonPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QPushButtonPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QPushButtonPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QPushButtonPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QPushButtonPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QPushButtonPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QPushButtonPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QPushButtonPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QPushButtonPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QPushButtonPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QPushButtonPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QPushButtonPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QPushButton_new(void* parent);
	[LinkName("QPushButton_new2")]
	public static extern void* QPushButton_new2();
	[LinkName("QPushButton_new3")]
	public static extern void* QPushButton_new3(libqt_string text);
	[LinkName("QPushButton_new4")]
	public static extern void* QPushButton_new4(void* icon, libqt_string text);
	...
	public static extern void* QPushButton_new6(void* icon, libqt_string text, void* parent);
	[LinkName("QPushButton_MetaObject")]
	public static extern void* QPushButton_MetaObject(void* c_this);
	...
	public static extern void QPushButton_SizeHint(void* c_this);
	[LinkName("QPushButton_MinimumSizeHint")]
	public static extern void QPushButton_MinimumSizeHint(void* c_this);
	...
	public static extern void QPushButton_SetMenu(void* c_this, void* menu);
	[LinkName("QPushButton_Menu")]
	public static extern void* QPushButton_Menu(void* c_this);
	...
	public static extern bool QPushButton_Event(void* c_this, void* e);
	[LinkName("QPushButton_PaintEvent")]
	public static extern void QPushButton_PaintEvent(void* c_this, void* param1);
	[LinkName("QPushButton_KeyPressEvent")]
	public static extern void QPushButton_KeyPressEvent(void* c_this, void* param1);
	[LinkName("QPushButton_FocusInEvent")]
	public static extern void QPushButton_FocusInEvent(void* c_this, void* param1);
	[LinkName("QPushButton_FocusOutEvent")]
	public static extern void QPushButton_FocusOutEvent(void* c_this, void* param1);
	[LinkName("QPushButton_MouseMoveEvent")]
	public static extern void QPushButton_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QPushButton_InitStyleOption")]
	public static extern void QPushButton_InitStyleOption(void* c_this, void* option);
	[LinkName("QPushButton_HitButton")]
	public static extern bool QPushButton_HitButton(void* c_this, void* pos);
	...
	public static extern void QPushButton_Delete(void* self);
}