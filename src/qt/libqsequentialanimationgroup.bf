...
public class QSequentialAnimationGroup : IQSequentialAnimationGroup, IQAnimationGroup
{
	...
	{
		return CQt.QSequentialAnimationGroup_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
