...
public class QPointingDeviceUniqueId
{
	...
	{
		this.nativePtr = CQt.QPointingDeviceUniqueId_new(other);
	}
...
public class QPointingDevice
{
	...
	{
		return CQt.QPointingDevice_OperatorEqual(this.nativePtr, other);
	}
	...
	public static void* PrimaryPointingDevice1(libqt_string seatName)
	{
