...
public interface IQMdiSubWindow
{
	void* NativePtr { get; }
}
public struct QMdiSubWindowPtr : IQMdiSubWindow, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QMdiSubWindow_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QMdiSubWindow_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QMdiSubWindow_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QMdiSubWindow_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QMdiSubWindow_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QMdiSubWindow_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QMdiSubWindow_MinimumSizeHint(this.nativePtr);
	}
	
	public void SetWidget(IQWidget widget)
	{
		CQt.QMdiSubWindow_SetWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* Widget()
	{
		return CQt.QMdiSubWindow_Widget(this.nativePtr);
	}
	
	public void* MaximizedButtonsWidget()
	{
		return CQt.QMdiSubWindow_MaximizedButtonsWidget(this.nativePtr);
	}
	
	public void* MaximizedSystemMenuIconWidget()
	{
		return CQt.QMdiSubWindow_MaximizedSystemMenuIconWidget(this.nativePtr);
	}
	
	public bool IsShaded()
	{
		return CQt.QMdiSubWindow_IsShaded(this.nativePtr);
	}
	
	public void SetOption(int64 option)
	{
		CQt.QMdiSubWindow_SetOption(this.nativePtr, (int64)option);
	}
	
	public bool TestOption(int64 param1)
	{
		return CQt.QMdiSubWindow_TestOption(this.nativePtr, (int64)param1);
	}
	
	public void SetKeyboardSingleStep(int32 step)
	{
		CQt.QMdiSubWindow_SetKeyboardSingleStep(this.nativePtr, step);
	}
	
	public int32 KeyboardSingleStep()
	{
		return CQt.QMdiSubWindow_KeyboardSingleStep(this.nativePtr);
	}
	
	public void SetKeyboardPageStep(int32 step)
	{
		CQt.QMdiSubWindow_SetKeyboardPageStep(this.nativePtr, step);
	}
	
	public int32 KeyboardPageStep()
	{
		return CQt.QMdiSubWindow_KeyboardPageStep(this.nativePtr);
	}
	
	public void SetSystemMenu(IQMenu systemMenu)
	{
		CQt.QMdiSubWindow_SetSystemMenu(this.nativePtr, (systemMenu == default || systemMenu.NativePtr == default) ? default : systemMenu.NativePtr);
	}
	
	public void* SystemMenu()
	{
		return CQt.QMdiSubWindow_SystemMenu(this.nativePtr);
	}
	
	public void* MdiArea()
	{
		return CQt.QMdiSubWindow_MdiArea(this.nativePtr);
	}
	
	public void ShowSystemMenu()
	{
		CQt.QMdiSubWindow_ShowSystemMenu(this.nativePtr);
	}
	
	public void ShowShaded()
	{
		CQt.QMdiSubWindow_ShowShaded(this.nativePtr);
	}
	
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QMdiSubWindow_EventFilter(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QMdiSubWindow_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QMdiSubWindow_ShowEvent(this.nativePtr, (showEvent == default || showEvent.NativePtr == default) ? default : showEvent.NativePtr);
	}
	
	public void HideEvent(IQHideEvent hideEvent)
	{
		CQt.QMdiSubWindow_HideEvent(this.nativePtr, (hideEvent == default || hideEvent.NativePtr == default) ? default : hideEvent.NativePtr);
	}
	
	public void ChangeEvent(IQEvent changeEvent)
	{
		CQt.QMdiSubWindow_ChangeEvent(this.nativePtr, (changeEvent == default || changeEvent.NativePtr == default) ? default : changeEvent.NativePtr);
	}
	
	public void CloseEvent(IQCloseEvent closeEvent)
	{
		CQt.QMdiSubWindow_CloseEvent(this.nativePtr, (closeEvent == default || closeEvent.NativePtr == default) ? default : closeEvent.NativePtr);
	}
	
	public void LeaveEvent(IQEvent leaveEvent)
	{
		CQt.QMdiSubWindow_LeaveEvent(this.nativePtr, (leaveEvent == default || leaveEvent.NativePtr == default) ? default : leaveEvent.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent resizeEvent)
	{
		CQt.QMdiSubWindow_ResizeEvent(this.nativePtr, (resizeEvent == default || resizeEvent.NativePtr == default) ? default : resizeEvent.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent timerEvent)
	{
		CQt.QMdiSubWindow_TimerEvent(this.nativePtr, (timerEvent == default || timerEvent.NativePtr == default) ? default : timerEvent.NativePtr);
	}
	
	public void MoveEvent(IQMoveEvent moveEvent)
	{
		CQt.QMdiSubWindow_MoveEvent(this.nativePtr, (moveEvent == default || moveEvent.NativePtr == default) ? default : moveEvent.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent paintEvent)
	{
		CQt.QMdiSubWindow_PaintEvent(this.nativePtr, (paintEvent == default || paintEvent.NativePtr == default) ? default : paintEvent.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MousePressEvent(this.nativePtr, (mouseEvent == default || mouseEvent.NativePtr == default) ? default : mouseEvent.NativePtr);
	}
	
	public void MouseDoubleClickEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseDoubleClickEvent(this.nativePtr, (mouseEvent == default || mouseEvent.NativePtr == default) ? default : mouseEvent.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseReleaseEvent(this.nativePtr, (mouseEvent == default || mouseEvent.NativePtr == default) ? default : mouseEvent.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseMoveEvent(this.nativePtr, (mouseEvent == default || mouseEvent.NativePtr == default) ? default : mouseEvent.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent keyEvent)
	{
		CQt.QMdiSubWindow_KeyPressEvent(this.nativePtr, (keyEvent == default || keyEvent.NativePtr == default) ? default : keyEvent.NativePtr);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent contextMenuEvent)
	{
		CQt.QMdiSubWindow_ContextMenuEvent(this.nativePtr, (contextMenuEvent == default || contextMenuEvent.NativePtr == default) ? default : contextMenuEvent.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent focusInEvent)
	{
		CQt.QMdiSubWindow_FocusInEvent(this.nativePtr, (focusInEvent == default || focusInEvent.NativePtr == default) ? default : focusInEvent.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent focusOutEvent)
	{
		CQt.QMdiSubWindow_FocusOutEvent(this.nativePtr, (focusOutEvent == default || focusOutEvent.NativePtr == default) ? default : focusOutEvent.NativePtr);
	}
	
	public void ChildEvent(IQChildEvent childEvent)
	{
		CQt.QMdiSubWindow_ChildEvent(this.nativePtr, (childEvent == default || childEvent.NativePtr == default) ? default : childEvent.NativePtr);
	}
	...
	{
		CQt.QMdiSubWindow_SetOption2(this.nativePtr, (int64)option, on);
	}
...
{
	public QMdiSubWindowPtr handle;
	
	public static implicit operator QMdiSubWindowPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QMdiSubWindowPtr.New(parent);
	}
	...
	public void* MaximizedButtonsWidget()
	{
		return this.handle.MaximizedButtonsWidget();
	}
	
	public void* MaximizedSystemMenuIconWidget()
	{
		return this.handle.MaximizedSystemMenuIconWidget();
	}
	
	public bool IsShaded()
	{
		return this.handle.IsShaded();
	}
	...
	public bool TestOption(int64 param1)
	{
		return this.handle.TestOption(param1);
	}
	
	public void SetKeyboardSingleStep(int32 step)
	{
		this.handle.SetKeyboardSingleStep(step);
	}
	
	public int32 KeyboardSingleStep()
	{
		return this.handle.KeyboardSingleStep();
	}
	
	public void SetKeyboardPageStep(int32 step)
	{
		this.handle.SetKeyboardPageStep(step);
	}
	
	public int32 KeyboardPageStep()
	{
		return this.handle.KeyboardPageStep();
	}
	
	public void SetSystemMenu(IQMenu systemMenu)
	{
		this.handle.SetSystemMenu(systemMenu);
	}
	
	public void* SystemMenu()
	{
		return this.handle.SystemMenu();
	}
	
	public void* MdiArea()
	{
		return this.handle.MdiArea();
	}
	
	public void ShowSystemMenu()
	{
		this.handle.ShowSystemMenu();
	}
	
	public void ShowShaded()
	{
		this.handle.ShowShaded();
	}
	...
	public virtual void ShowEvent(IQShowEvent showEvent)
	{
		this.handle.ShowEvent(showEvent);
	}
	
	public virtual void HideEvent(IQHideEvent hideEvent)
	{
		this.handle.HideEvent(hideEvent);
	}
	
	public virtual void ChangeEvent(IQEvent changeEvent)
	{
		this.handle.ChangeEvent(changeEvent);
	}
	
	public virtual void CloseEvent(IQCloseEvent closeEvent)
	{
		this.handle.CloseEvent(closeEvent);
	}
	
	public virtual void LeaveEvent(IQEvent leaveEvent)
	{
		this.handle.LeaveEvent(leaveEvent);
	}
	
	public virtual void ResizeEvent(IQResizeEvent resizeEvent)
	{
		this.handle.ResizeEvent(resizeEvent);
	}
	
	public virtual void TimerEvent(IQTimerEvent timerEvent)
	{
		this.handle.TimerEvent(timerEvent);
	}
	
	public virtual void MoveEvent(IQMoveEvent moveEvent)
	{
		this.handle.MoveEvent(moveEvent);
	}
	
	public virtual void PaintEvent(IQPaintEvent paintEvent)
	{
		this.handle.PaintEvent(paintEvent);
	}
	
	public virtual void MousePressEvent(IQMouseEvent mouseEvent)
	{
		this.handle.MousePressEvent(mouseEvent);
	}
	
	public virtual void MouseDoubleClickEvent(IQMouseEvent mouseEvent)
	{
		this.handle.MouseDoubleClickEvent(mouseEvent);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		this.handle.MouseReleaseEvent(mouseEvent);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent mouseEvent)
	{
		this.handle.MouseMoveEvent(mouseEvent);
	}
	
	public virtual void KeyPressEvent(IQKeyEvent keyEvent)
	{
		this.handle.KeyPressEvent(keyEvent);
	}
	
	public virtual void ContextMenuEvent(IQContextMenuEvent contextMenuEvent)
	{
		this.handle.ContextMenuEvent(contextMenuEvent);
	}
	
	public virtual void FocusInEvent(IQFocusEvent focusInEvent)
	{
		this.handle.FocusInEvent(focusInEvent);
	}
	
	public virtual void FocusOutEvent(IQFocusEvent focusOutEvent)
	{
		this.handle.FocusOutEvent(focusOutEvent);
	}
	
	public virtual void ChildEvent(IQChildEvent childEvent)
	{
		this.handle.ChildEvent(childEvent);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QMdiSubWindowPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QMdiSubWindowPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QMdiSubWindowPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QMdiSubWindowPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QMdiSubWindowPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QMdiSubWindowPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QMdiSubWindowPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QMdiSubWindowPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QMdiSubWindowPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QMdiSubWindowPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QMdiSubWindowPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QMdiSubWindowPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QMdiSubWindowPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QMdiSubWindowPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QMdiSubWindow_new(void* parent);
	[LinkName("QMdiSubWindow_new2")]
	public static extern void* QMdiSubWindow_new2();
	[LinkName("QMdiSubWindow_new3")]
	public static extern void* QMdiSubWindow_new3(void* parent, int64 flags);
	[LinkName("QMdiSubWindow_MetaObject")]
	public static extern void* QMdiSubWindow_MetaObject(void* c_this);
	...
	public static extern void QMdiSubWindow_SizeHint(void* c_this);
	[LinkName("QMdiSubWindow_MinimumSizeHint")]
	public static extern void QMdiSubWindow_MinimumSizeHint(void* c_this);
	[LinkName("QMdiSubWindow_SetWidget")]
	public static extern void QMdiSubWindow_SetWidget(void* c_this, void* widget);
	[LinkName("QMdiSubWindow_Widget")]
	public static extern void* QMdiSubWindow_Widget(void* c_this);
	[LinkName("QMdiSubWindow_MaximizedButtonsWidget")]
	public static extern void* QMdiSubWindow_MaximizedButtonsWidget(void* c_this);
	[LinkName("QMdiSubWindow_MaximizedSystemMenuIconWidget")]
	public static extern void* QMdiSubWindow_MaximizedSystemMenuIconWidget(void* c_this);
	...
	public static extern void QMdiSubWindow_SetSystemMenu(void* c_this, void* systemMenu);
	[LinkName("QMdiSubWindow_SystemMenu")]
	public static extern void* QMdiSubWindow_SystemMenu(void* c_this);
	[LinkName("QMdiSubWindow_MdiArea")]
	public static extern void* QMdiSubWindow_MdiArea(void* c_this);
	[LinkName("QMdiSubWindow_Connect_WindowStateChanged")]
	public static extern void QMdiSubWindow_Connect_WindowStateChanged(void* c_this, c_intptr slot);
	[LinkName("QMdiSubWindow_Connect_AboutToActivate")]
	public static extern void QMdiSubWindow_Connect_AboutToActivate(void* c_this, c_intptr slot);
	...
	public static extern bool QMdiSubWindow_EventFilter(void* c_this, void* object, void* event);
	[LinkName("QMdiSubWindow_Event")]
	public static extern bool QMdiSubWindow_Event(void* c_this, void* event);
	[LinkName("QMdiSubWindow_ShowEvent")]
	public static extern void QMdiSubWindow_ShowEvent(void* c_this, void* showEvent);
	[LinkName("QMdiSubWindow_HideEvent")]
	public static extern void QMdiSubWindow_HideEvent(void* c_this, void* hideEvent);
	[LinkName("QMdiSubWindow_ChangeEvent")]
	public static extern void QMdiSubWindow_ChangeEvent(void* c_this, void* changeEvent);
	[LinkName("QMdiSubWindow_CloseEvent")]
	public static extern void QMdiSubWindow_CloseEvent(void* c_this, void* closeEvent);
	[LinkName("QMdiSubWindow_LeaveEvent")]
	public static extern void QMdiSubWindow_LeaveEvent(void* c_this, void* leaveEvent);
	[LinkName("QMdiSubWindow_ResizeEvent")]
	public static extern void QMdiSubWindow_ResizeEvent(void* c_this, void* resizeEvent);
	[LinkName("QMdiSubWindow_TimerEvent")]
	public static extern void QMdiSubWindow_TimerEvent(void* c_this, void* timerEvent);
	[LinkName("QMdiSubWindow_MoveEvent")]
	public static extern void QMdiSubWindow_MoveEvent(void* c_this, void* moveEvent);
	[LinkName("QMdiSubWindow_PaintEvent")]
	public static extern void QMdiSubWindow_PaintEvent(void* c_this, void* paintEvent);
	[LinkName("QMdiSubWindow_MousePressEvent")]
	public static extern void QMdiSubWindow_MousePressEvent(void* c_this, void* mouseEvent);
	[LinkName("QMdiSubWindow_MouseDoubleClickEvent")]
	public static extern void QMdiSubWindow_MouseDoubleClickEvent(void* c_this, void* mouseEvent);
	[LinkName("QMdiSubWindow_MouseReleaseEvent")]
	public static extern void QMdiSubWindow_MouseReleaseEvent(void* c_this, void* mouseEvent);
	[LinkName("QMdiSubWindow_MouseMoveEvent")]
	public static extern void QMdiSubWindow_MouseMoveEvent(void* c_this, void* mouseEvent);
	[LinkName("QMdiSubWindow_KeyPressEvent")]
	public static extern void QMdiSubWindow_KeyPressEvent(void* c_this, void* keyEvent);
	[LinkName("QMdiSubWindow_ContextMenuEvent")]
	public static extern void QMdiSubWindow_ContextMenuEvent(void* c_this, void* contextMenuEvent);
	[LinkName("QMdiSubWindow_FocusInEvent")]
	public static extern void QMdiSubWindow_FocusInEvent(void* c_this, void* focusInEvent);
	[LinkName("QMdiSubWindow_FocusOutEvent")]
	public static extern void QMdiSubWindow_FocusOutEvent(void* c_this, void* focusOutEvent);
	[LinkName("QMdiSubWindow_ChildEvent")]
	public static extern void QMdiSubWindow_ChildEvent(void* c_this, void* childEvent);
	...
	public static extern void QMdiSubWindow_Delete(void* self);
}