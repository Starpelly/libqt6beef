...
public class QMdiSubWindow
{
	...
	{
		this.nativePtr = CQt.QMdiSubWindow_new(parent);
	}
	...
	{
		CQt.QMdiSubWindow_SetWidget(this.nativePtr, widget);
	}
	...
	public void SetSystemMenu(void* systemMenu)
	{
		CQt.QMdiSubWindow_SetSystemMenu(this.nativePtr, systemMenu);
	}
	...
	{
		return CQt.QMdiSubWindow_EventFilter(this.nativePtr, object, event);
	}
	
	public virtual bool Event(void* event)
	{
		return CQt.QMdiSubWindow_Event(this.nativePtr, event);
	}
	
	public virtual void ShowEvent(void* showEvent)
	{
		CQt.QMdiSubWindow_ShowEvent(this.nativePtr, showEvent);
	}
	
	public virtual void HideEvent(void* hideEvent)
	{
		CQt.QMdiSubWindow_HideEvent(this.nativePtr, hideEvent);
	}
	
	public virtual void ChangeEvent(void* changeEvent)
	{
		CQt.QMdiSubWindow_ChangeEvent(this.nativePtr, changeEvent);
	}
	
	public virtual void CloseEvent(void* closeEvent)
	{
		CQt.QMdiSubWindow_CloseEvent(this.nativePtr, closeEvent);
	}
	
	public virtual void LeaveEvent(void* leaveEvent)
	{
		CQt.QMdiSubWindow_LeaveEvent(this.nativePtr, leaveEvent);
	}
	
	public virtual void ResizeEvent(void* resizeEvent)
	{
		CQt.QMdiSubWindow_ResizeEvent(this.nativePtr, resizeEvent);
	}
	
	public virtual void TimerEvent(void* timerEvent)
	{
		CQt.QMdiSubWindow_TimerEvent(this.nativePtr, timerEvent);
	}
	
	public virtual void MoveEvent(void* moveEvent)
	{
		CQt.QMdiSubWindow_MoveEvent(this.nativePtr, moveEvent);
	}
	
	public virtual void PaintEvent(void* paintEvent)
	{
		CQt.QMdiSubWindow_PaintEvent(this.nativePtr, paintEvent);
	}
	
	public virtual void MousePressEvent(void* mouseEvent)
	{
		CQt.QMdiSubWindow_MousePressEvent(this.nativePtr, mouseEvent);
	}
	
	public virtual void MouseDoubleClickEvent(void* mouseEvent)
	{
		CQt.QMdiSubWindow_MouseDoubleClickEvent(this.nativePtr, mouseEvent);
	}
	
	public virtual void MouseReleaseEvent(void* mouseEvent)
	{
		CQt.QMdiSubWindow_MouseReleaseEvent(this.nativePtr, mouseEvent);
	}
	
	public virtual void MouseMoveEvent(void* mouseEvent)
	{
		CQt.QMdiSubWindow_MouseMoveEvent(this.nativePtr, mouseEvent);
	}
	
	public virtual void KeyPressEvent(void* keyEvent)
	{
		CQt.QMdiSubWindow_KeyPressEvent(this.nativePtr, keyEvent);
	}
	
	public virtual void ContextMenuEvent(void* contextMenuEvent)
	{
		CQt.QMdiSubWindow_ContextMenuEvent(this.nativePtr, contextMenuEvent);
	}
	
	public virtual void FocusInEvent(void* focusInEvent)
	{
		CQt.QMdiSubWindow_FocusInEvent(this.nativePtr, focusInEvent);
	}
	
	public virtual void FocusOutEvent(void* focusOutEvent)
	{
		CQt.QMdiSubWindow_FocusOutEvent(this.nativePtr, focusOutEvent);
	}
	
	public virtual void ChildEvent(void* childEvent)
	{
		CQt.QMdiSubWindow_ChildEvent(this.nativePtr, childEvent);
	}
