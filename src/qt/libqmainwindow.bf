...
public class QMainWindow
{
	...
	{
		this.nativePtr = CQt.QMainWindow_new(parent);
	}
	...
	public void SetIconSize(void* iconSize)
	{
		CQt.QMainWindow_SetIconSize(this.nativePtr, iconSize);
	}
	...
	public bool IsSeparator(void* pos)
	{
		return CQt.QMainWindow_IsSeparator(this.nativePtr, pos);
	}
	...
	public void SetMenuBar(void* menubar)
	{
		CQt.QMainWindow_SetMenuBar(this.nativePtr, menubar);
	}
	...
	public void SetMenuWidget(void* menubar)
	{
		CQt.QMainWindow_SetMenuWidget(this.nativePtr, menubar);
	}
	...
	public void SetStatusBar(void* statusbar)
	{
		CQt.QMainWindow_SetStatusBar(this.nativePtr, statusbar);
	}
	...
	public void SetCentralWidget(void* widget)
	{
		CQt.QMainWindow_SetCentralWidget(this.nativePtr, widget);
	}
	...
	public void InsertToolBarBreak(void* before)
	{
		CQt.QMainWindow_InsertToolBarBreak(this.nativePtr, before);
	}
	
	public void AddToolBar(int64 area, void* toolbar)
	{
		CQt.QMainWindow_AddToolBar(this.nativePtr, area, toolbar);
	}
	
	public void AddToolBarWithToolbar(void* toolbar)
	{
		CQt.QMainWindow_AddToolBarWithToolbar(this.nativePtr, toolbar);
	}
	
	public void* AddToolBarWithTitle(libqt_string title)
	{
		return CQt.QMainWindow_AddToolBarWithTitle(this.nativePtr, title);
	}
	
	public void InsertToolBar(void* before, void* toolbar)
	{
		CQt.QMainWindow_InsertToolBar(this.nativePtr, before, toolbar);
	}
	
	public void RemoveToolBar(void* toolbar)
	{
		CQt.QMainWindow_RemoveToolBar(this.nativePtr, toolbar);
	}
	
	public void RemoveToolBarBreak(void* before)
	{
		CQt.QMainWindow_RemoveToolBarBreak(this.nativePtr, before);
	}
	...
	public int64 ToolBarArea(void* toolbar)
	{
		return CQt.QMainWindow_ToolBarArea(this.nativePtr, toolbar);
	}
	
	public bool ToolBarBreak(void* toolbar)
	{
		return CQt.QMainWindow_ToolBarBreak(this.nativePtr, toolbar);
	}
	
	public void AddDockWidget(int64 area, void* dockwidget)
	{
		CQt.QMainWindow_AddDockWidget(this.nativePtr, area, dockwidget);
	}
	
	public void AddDockWidget2(int64 area, void* dockwidget, int64 orientation)
	{
		CQt.QMainWindow_AddDockWidget2(this.nativePtr, area, dockwidget, orientation);
	}
	
	public void SplitDockWidget(void* after, void* dockwidget, int64 orientation)
	{
		CQt.QMainWindow_SplitDockWidget(this.nativePtr, after, dockwidget, orientation);
	}
	
	public void TabifyDockWidget(void* first, void* second)
	{
		CQt.QMainWindow_TabifyDockWidget(this.nativePtr, first, second);
	}
	
	public void*[] TabifiedDockWidgets(void* dockwidget)
	{
		return CQt.QMainWindow_TabifiedDockWidgets(this.nativePtr, dockwidget);
	}
	
	public void RemoveDockWidget(void* dockwidget)
	{
		CQt.QMainWindow_RemoveDockWidget(this.nativePtr, dockwidget);
	}
	
	public bool RestoreDockWidget(void* dockwidget)
	{
		return CQt.QMainWindow_RestoreDockWidget(this.nativePtr, dockwidget);
	}
	
	public int64 DockWidgetArea(void* dockwidget)
	{
		return CQt.QMainWindow_DockWidgetArea(this.nativePtr, dockwidget);
	}
	
	public void ResizeDocks(void*[] docks, int32[] sizes, int64 orientation)
	{
		CQt.QMainWindow_ResizeDocks(this.nativePtr, docks, sizes, orientation);
	}
	...
	{
		return CQt.QMainWindow_RestoreState(this.nativePtr, state);
	}
	...
	{
		CQt.QMainWindow_ContextMenuEvent(this.nativePtr, event);
	}
	
	public virtual bool Event(void* event)
	{
		return CQt.QMainWindow_Event(this.nativePtr, event);
	}
	...
	public bool RestoreState2(libqt_string state, int32 version)
	{
		return CQt.QMainWindow_RestoreState2(this.nativePtr, state, version);
	}
