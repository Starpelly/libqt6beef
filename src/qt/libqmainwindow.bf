...
public interface IQMainWindow
{
	void* NativePtr { get; }
}
public struct QMainWindowPtr : IQMainWindow, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QMainWindow_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QMainWindow_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QMainWindow_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QMainWindow_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QMainWindow_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QMainWindow_IconSize(this.nativePtr);
	}
	
	public void SetIconSize(IQSize iconSize)
	{
		CQt.QMainWindow_SetIconSize(this.nativePtr, (iconSize == default || iconSize.NativePtr == default) ? default : iconSize.NativePtr);
	}
	
	public int64 ToolButtonStyle()
	{
		return CQt.QMainWindow_ToolButtonStyle(this.nativePtr);
	}
	
	public void SetToolButtonStyle(int64 toolButtonStyle)
	{
		CQt.QMainWindow_SetToolButtonStyle(this.nativePtr, (int64)toolButtonStyle);
	}
	
	public bool IsAnimated()
	{
		return CQt.QMainWindow_IsAnimated(this.nativePtr);
	}
	
	public bool IsDockNestingEnabled()
	{
		return CQt.QMainWindow_IsDockNestingEnabled(this.nativePtr);
	}
	
	public bool DocumentMode()
	{
		return CQt.QMainWindow_DocumentMode(this.nativePtr);
	}
	
	public void SetDocumentMode(bool enabled)
	{
		CQt.QMainWindow_SetDocumentMode(this.nativePtr, enabled);
	}
	
	public int64 TabShape()
	{
		return CQt.QMainWindow_TabShape(this.nativePtr);
	}
	
	public void SetTabShape(int64 tabShape)
	{
		CQt.QMainWindow_SetTabShape(this.nativePtr, (int64)tabShape);
	}
	
	public int64 TabPosition(int64 area)
	{
		return CQt.QMainWindow_TabPosition(this.nativePtr, (int64)area);
	}
	
	public void SetTabPosition(int64 areas, int64 tabPosition)
	{
		CQt.QMainWindow_SetTabPosition(this.nativePtr, areas, (int64)tabPosition);
	}
	
	public void SetDockOptions(int64 options)
	{
		CQt.QMainWindow_SetDockOptions(this.nativePtr, options);
	}
	
	public int64 DockOptions()
	{
		return CQt.QMainWindow_DockOptions(this.nativePtr);
	}
	
	public bool IsSeparator(IQPoint pos)
	{
		return CQt.QMainWindow_IsSeparator(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void* MenuBar()
	{
		return CQt.QMainWindow_MenuBar(this.nativePtr);
	}
	
	public void SetMenuBar(IQMenuBar menubar)
	{
		CQt.QMainWindow_SetMenuBar(this.nativePtr, (menubar == default || menubar.NativePtr == default) ? default : menubar.NativePtr);
	}
	
	public void* MenuWidget()
	{
		return CQt.QMainWindow_MenuWidget(this.nativePtr);
	}
	
	public void SetMenuWidget(IQWidget menubar)
	{
		CQt.QMainWindow_SetMenuWidget(this.nativePtr, (menubar == default || menubar.NativePtr == default) ? default : menubar.NativePtr);
	}
	
	public void* StatusBar()
	{
		return CQt.QMainWindow_StatusBar(this.nativePtr);
	}
	
	public void SetStatusBar(IQStatusBar statusbar)
	{
		CQt.QMainWindow_SetStatusBar(this.nativePtr, (statusbar == default || statusbar.NativePtr == default) ? default : statusbar.NativePtr);
	}
	
	public void* CentralWidget()
	{
		return CQt.QMainWindow_CentralWidget(this.nativePtr);
	}
	
	public void SetCentralWidget(IQWidget widget)
	{
		CQt.QMainWindow_SetCentralWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* TakeCentralWidget()
	{
		return CQt.QMainWindow_TakeCentralWidget(this.nativePtr);
	}
	
	public void SetCorner(int64 corner, int64 area)
	{
		CQt.QMainWindow_SetCorner(this.nativePtr, (int64)corner, (int64)area);
	}
	
	public int64 Corner(int64 corner)
	{
		return CQt.QMainWindow_Corner(this.nativePtr, (int64)corner);
	}
	
	public void AddToolBarBreak()
	{
		CQt.QMainWindow_AddToolBarBreak(this.nativePtr);
	}
	
	public void InsertToolBarBreak(IQToolBar before)
	{
		CQt.QMainWindow_InsertToolBarBreak(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr);
	}
	
	public void AddToolBar(int64 area, IQToolBar toolbar)
	{
		CQt.QMainWindow_AddToolBar(this.nativePtr, (int64)area, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public void AddToolBarWithToolbar(IQToolBar toolbar)
	{
		CQt.QMainWindow_AddToolBarWithToolbar(this.nativePtr, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public void* AddToolBarWithTitle(String title)
	{
		return CQt.QMainWindow_AddToolBarWithTitle(this.nativePtr, libqt_string(title));
	}
	
	public void InsertToolBar(IQToolBar before, IQToolBar toolbar)
	{
		CQt.QMainWindow_InsertToolBar(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public void RemoveToolBar(IQToolBar toolbar)
	{
		CQt.QMainWindow_RemoveToolBar(this.nativePtr, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public void RemoveToolBarBreak(IQToolBar before)
	{
		CQt.QMainWindow_RemoveToolBarBreak(this.nativePtr, (before == default || before.NativePtr == default) ? default : before.NativePtr);
	}
	
	public bool UnifiedTitleAndToolBarOnMac()
	{
		return CQt.QMainWindow_UnifiedTitleAndToolBarOnMac(this.nativePtr);
	}
	
	public int64 ToolBarArea(IQToolBar toolbar)
	{
		return CQt.QMainWindow_ToolBarArea(this.nativePtr, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public bool ToolBarBreak(IQToolBar toolbar)
	{
		return CQt.QMainWindow_ToolBarBreak(this.nativePtr, (toolbar == default || toolbar.NativePtr == default) ? default : toolbar.NativePtr);
	}
	
	public void AddDockWidget(int64 area, IQDockWidget dockwidget)
	{
		CQt.QMainWindow_AddDockWidget(this.nativePtr, (int64)area, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr);
	}
	
	public void AddDockWidget2(int64 area, IQDockWidget dockwidget, int64 orientation)
	{
		CQt.QMainWindow_AddDockWidget2(this.nativePtr, (int64)area, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr, (int64)orientation);
	}
	
	public void SplitDockWidget(IQDockWidget after, IQDockWidget dockwidget, int64 orientation)
	{
		CQt.QMainWindow_SplitDockWidget(this.nativePtr, (after == default || after.NativePtr == default) ? default : after.NativePtr, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr, (int64)orientation);
	}
	
	public void TabifyDockWidget(IQDockWidget first, IQDockWidget second)
	{
		CQt.QMainWindow_TabifyDockWidget(this.nativePtr, (first == default || first.NativePtr == default) ? default : first.NativePtr, (second == default || second.NativePtr == default) ? default : second.NativePtr);
	}
	
	public void*[] TabifiedDockWidgets(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_TabifiedDockWidgets(this.nativePtr, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr);
	}
	
	public void RemoveDockWidget(IQDockWidget dockwidget)
	{
		CQt.QMainWindow_RemoveDockWidget(this.nativePtr, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr);
	}
	
	public bool RestoreDockWidget(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_RestoreDockWidget(this.nativePtr, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr);
	}
	
	public int64 DockWidgetArea(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_DockWidgetArea(this.nativePtr, (dockwidget == default || dockwidget.NativePtr == default) ? default : dockwidget.NativePtr);
	}
	
	public void ResizeDocks(IQDockWidget[] docks, int32[] sizes, int64 orientation)
	{
		CQt.QMainWindow_ResizeDocks(this.nativePtr, null, null, (int64)orientation);
	}
	
	public libqt_string SaveState()
	{
		return CQt.QMainWindow_SaveState(this.nativePtr);
	}
	
	public bool RestoreState(String state)
	{
		return CQt.QMainWindow_RestoreState(this.nativePtr, libqt_string(state));
	}
	
	public void* CreatePopupMenu()
	{
		return CQt.QMainWindow_CreatePopupMenu(this.nativePtr);
	}
	
	public void SetAnimated(bool enabled)
	{
		CQt.QMainWindow_SetAnimated(this.nativePtr, enabled);
	}
	
	public void SetDockNestingEnabled(bool enabled)
	{
		CQt.QMainWindow_SetDockNestingEnabled(this.nativePtr, enabled);
	}
	
	public void SetUnifiedTitleAndToolBarOnMac(bool set)
	{
		CQt.QMainWindow_SetUnifiedTitleAndToolBarOnMac(this.nativePtr, set);
	}
	
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QMainWindow_ContextMenuEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QMainWindow_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	public void AddToolBarBreak1(int64 area)
	{
		CQt.QMainWindow_AddToolBarBreak1(this.nativePtr, (int64)area);
	}
	
	public libqt_string SaveState1(int32 version)
	{
		return CQt.QMainWindow_SaveState1(this.nativePtr, version);
	}
	
	public bool RestoreState2(String state, int32 version)
	{
		return CQt.QMainWindow_RestoreState2(this.nativePtr, libqt_string(state), version);
	}
...
{
	public QMainWindowPtr handle;
	
	public static implicit operator QMainWindowPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QMainWindowPtr.New(parent);
	}
	...
	public void SetIconSize(IQSize iconSize)
	{
		this.handle.SetIconSize(iconSize);
	}
	
	public int64 ToolButtonStyle()
	{
		return this.handle.ToolButtonStyle();
	}
	
	public void SetToolButtonStyle(int64 toolButtonStyle)
	{
		this.handle.SetToolButtonStyle(toolButtonStyle);
	}
	...
	public bool IsDockNestingEnabled()
	{
		return this.handle.IsDockNestingEnabled();
	}
	
	public bool DocumentMode()
	{
		return this.handle.DocumentMode();
	}
	
	public void SetDocumentMode(bool enabled)
	{
		this.handle.SetDocumentMode(enabled);
	}
	
	public int64 TabShape()
	{
		return this.handle.TabShape();
	}
	
	public void SetTabShape(int64 tabShape)
	{
		this.handle.SetTabShape(tabShape);
	}
	
	public int64 TabPosition(int64 area)
	{
		return this.handle.TabPosition(area);
	}
	
	public void SetTabPosition(int64 areas, int64 tabPosition)
	{
		this.handle.SetTabPosition(areas, tabPosition);
	}
	
	public void SetDockOptions(int64 options)
	{
		this.handle.SetDockOptions(options);
	}
	
	public int64 DockOptions()
	{
		return this.handle.DockOptions();
	}
	
	public bool IsSeparator(IQPoint pos)
	{
		return this.handle.IsSeparator(pos);
	}
	...
	public void SetMenuBar(IQMenuBar menubar)
	{
		this.handle.SetMenuBar(menubar);
	}
	
	public void* MenuWidget()
	{
		return this.handle.MenuWidget();
	}
	
	public void SetMenuWidget(IQWidget menubar)
	{
		this.handle.SetMenuWidget(menubar);
	}
	
	public void* StatusBar()
	{
		return this.handle.StatusBar();
	}
	
	public void SetStatusBar(IQStatusBar statusbar)
	{
		this.handle.SetStatusBar(statusbar);
	}
	
	public void* CentralWidget()
	{
		return this.handle.CentralWidget();
	}
	
	public void SetCentralWidget(IQWidget widget)
	{
		this.handle.SetCentralWidget(widget);
	}
	
	public void* TakeCentralWidget()
	{
		return this.handle.TakeCentralWidget();
	}
	
	public void SetCorner(int64 corner, int64 area)
	{
		this.handle.SetCorner(corner, area);
	}
	
	public int64 Corner(int64 corner)
	{
		return this.handle.Corner(corner);
	}
	
	public void AddToolBarBreak()
	{
		this.handle.AddToolBarBreak();
	}
	
	public void InsertToolBarBreak(IQToolBar before)
	{
		this.handle.InsertToolBarBreak(before);
	}
	
	public void AddToolBar(int64 area, IQToolBar toolbar)
	{
		this.handle.AddToolBar(area, toolbar);
	}
	
	public void AddToolBarWithToolbar(IQToolBar toolbar)
	{
		this.handle.AddToolBarWithToolbar(toolbar);
	}
	
	public void* AddToolBarWithTitle(String title)
	{
		return this.handle.AddToolBarWithTitle(title);
	}
	
	public void InsertToolBar(IQToolBar before, IQToolBar toolbar)
	{
		this.handle.InsertToolBar(before, toolbar);
	}
	
	public void RemoveToolBar(IQToolBar toolbar)
	{
		this.handle.RemoveToolBar(toolbar);
	}
	
	public void RemoveToolBarBreak(IQToolBar before)
	{
		this.handle.RemoveToolBarBreak(before);
	}
	
	public bool UnifiedTitleAndToolBarOnMac()
	{
		return this.handle.UnifiedTitleAndToolBarOnMac();
	}
	
	public int64 ToolBarArea(IQToolBar toolbar)
	{
		return this.handle.ToolBarArea(toolbar);
	}
	
	public bool ToolBarBreak(IQToolBar toolbar)
	{
		return this.handle.ToolBarBreak(toolbar);
	}
	
	public void AddDockWidget(int64 area, IQDockWidget dockwidget)
	{
		this.handle.AddDockWidget(area, dockwidget);
	}
	
	public void AddDockWidget2(int64 area, IQDockWidget dockwidget, int64 orientation)
	{
		this.handle.AddDockWidget2(area, dockwidget, orientation);
	}
	
	public void SplitDockWidget(IQDockWidget after, IQDockWidget dockwidget, int64 orientation)
	{
		this.handle.SplitDockWidget(after, dockwidget, orientation);
	}
	
	public void TabifyDockWidget(IQDockWidget first, IQDockWidget second)
	{
		this.handle.TabifyDockWidget(first, second);
	}
	
	public void*[] TabifiedDockWidgets(IQDockWidget dockwidget)
	{
		return this.handle.TabifiedDockWidgets(dockwidget);
	}
	
	public void RemoveDockWidget(IQDockWidget dockwidget)
	{
		this.handle.RemoveDockWidget(dockwidget);
	}
	
	public bool RestoreDockWidget(IQDockWidget dockwidget)
	{
		return this.handle.RestoreDockWidget(dockwidget);
	}
	
	public int64 DockWidgetArea(IQDockWidget dockwidget)
	{
		return this.handle.DockWidgetArea(dockwidget);
	}
	
	public void ResizeDocks(IQDockWidget[] docks, int32[] sizes, int64 orientation)
	{
		this.handle.ResizeDocks(null, null, orientation);
	}
	...
	public virtual void* CreatePopupMenu()
	{
		return this.handle.CreatePopupMenu();
	}
	
	public void SetAnimated(bool enabled)
	{
		this.handle.SetAnimated(enabled);
	}
	
	public void SetDockNestingEnabled(bool enabled)
	{
		this.handle.SetDockNestingEnabled(enabled);
	}
	
	public void SetUnifiedTitleAndToolBarOnMac(bool set)
	{
		this.handle.SetUnifiedTitleAndToolBarOnMac(set);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QMainWindowPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QMainWindowPtr.Tr3(s, c, n);
	}
	
	public void AddToolBarBreak1(int64 area)
	{
		this.handle.AddToolBarBreak1(area);
	}
	
	public libqt_string SaveState1(int32 version)
	{
		return this.handle.SaveState1(version);
	}
	
	public bool RestoreState2(String state, int32 version)
	{
		return this.handle.RestoreState2(state, version);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QMainWindowPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QMainWindowPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QMainWindowPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QMainWindowPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QMainWindowPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QMainWindowPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QMainWindowPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QMainWindowPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QMainWindowPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QMainWindowPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QMainWindowPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QMainWindowPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QMainWindow_new3(void* parent, int64 flags);
	[LinkName("QMainWindow_MetaObject")]
	public static extern void* QMainWindow_MetaObject(void* c_this);
	...
	public static extern void QMainWindow_IconSize(void* c_this);
	[LinkName("QMainWindow_SetIconSize")]
	public static extern void QMainWindow_SetIconSize(void* c_this, void* iconSize);
	...
	public static extern bool QMainWindow_IsSeparator(void* c_this, void* pos);
	[LinkName("QMainWindow_MenuBar")]
	public static extern void* QMainWindow_MenuBar(void* c_this);
	[LinkName("QMainWindow_SetMenuBar")]
	public static extern void QMainWindow_SetMenuBar(void* c_this, void* menubar);
	[LinkName("QMainWindow_MenuWidget")]
	public static extern void* QMainWindow_MenuWidget(void* c_this);
	[LinkName("QMainWindow_SetMenuWidget")]
	public static extern void QMainWindow_SetMenuWidget(void* c_this, void* menubar);
	[LinkName("QMainWindow_StatusBar")]
	public static extern void* QMainWindow_StatusBar(void* c_this);
	[LinkName("QMainWindow_SetStatusBar")]
	public static extern void QMainWindow_SetStatusBar(void* c_this, void* statusbar);
	[LinkName("QMainWindow_CentralWidget")]
	public static extern void* QMainWindow_CentralWidget(void* c_this);
	[LinkName("QMainWindow_SetCentralWidget")]
	public static extern void QMainWindow_SetCentralWidget(void* c_this, void* widget);
	[LinkName("QMainWindow_TakeCentralWidget")]
	public static extern void* QMainWindow_TakeCentralWidget(void* c_this);
	...
	public static extern void QMainWindow_InsertToolBarBreak(void* c_this, void* before);
	[LinkName("QMainWindow_AddToolBar")]
	public static extern void QMainWindow_AddToolBar(void* c_this, int64 area, void* toolbar);
	[LinkName("QMainWindow_AddToolBarWithToolbar")]
	public static extern void QMainWindow_AddToolBarWithToolbar(void* c_this, void* toolbar);
	[LinkName("QMainWindow_AddToolBarWithTitle")]
	public static extern void* QMainWindow_AddToolBarWithTitle(void* c_this, libqt_string title);
	[LinkName("QMainWindow_InsertToolBar")]
	public static extern void QMainWindow_InsertToolBar(void* c_this, void* before, void* toolbar);
	[LinkName("QMainWindow_RemoveToolBar")]
	public static extern void QMainWindow_RemoveToolBar(void* c_this, void* toolbar);
	[LinkName("QMainWindow_RemoveToolBarBreak")]
	public static extern void QMainWindow_RemoveToolBarBreak(void* c_this, void* before);
	...
	public static extern int64 QMainWindow_ToolBarArea(void* c_this, void* toolbar);
	[LinkName("QMainWindow_ToolBarBreak")]
	public static extern bool QMainWindow_ToolBarBreak(void* c_this, void* toolbar);
	[LinkName("QMainWindow_AddDockWidget")]
	public static extern void QMainWindow_AddDockWidget(void* c_this, int64 area, void* dockwidget);
	[LinkName("QMainWindow_AddDockWidget2")]
	public static extern void QMainWindow_AddDockWidget2(void* c_this, int64 area, void* dockwidget, int64 orientation);
	[LinkName("QMainWindow_SplitDockWidget")]
	public static extern void QMainWindow_SplitDockWidget(void* c_this, void* after, void* dockwidget, int64 orientation);
	[LinkName("QMainWindow_TabifyDockWidget")]
	public static extern void QMainWindow_TabifyDockWidget(void* c_this, void* first, void* second);
	[LinkName("QMainWindow_TabifiedDockWidgets")]
	public static extern void*[] QMainWindow_TabifiedDockWidgets(void* c_this, void* dockwidget);
	[LinkName("QMainWindow_RemoveDockWidget")]
	public static extern void QMainWindow_RemoveDockWidget(void* c_this, void* dockwidget);
	[LinkName("QMainWindow_RestoreDockWidget")]
	public static extern bool QMainWindow_RestoreDockWidget(void* c_this, void* dockwidget);
	[LinkName("QMainWindow_DockWidgetArea")]
	public static extern int64 QMainWindow_DockWidgetArea(void* c_this, void* dockwidget);
	[LinkName("QMainWindow_ResizeDocks")]
	public static extern void QMainWindow_ResizeDocks(void* c_this, void*[] docks, int32[] sizes, int64 orientation);
	[LinkName("QMainWindow_SaveState")]
	public static extern libqt_string QMainWindow_SaveState(void* c_this);
	[LinkName("QMainWindow_RestoreState")]
	public static extern bool QMainWindow_RestoreState(void* c_this, libqt_string state);
	[LinkName("QMainWindow_CreatePopupMenu")]
	public static extern void* QMainWindow_CreatePopupMenu(void* c_this);
	...
	public static extern void QMainWindow_Connect_IconSizeChanged(void* c_this, c_intptr slot);
	[LinkName("QMainWindow_Connect_ToolButtonStyleChanged")]
	public static extern void QMainWindow_Connect_ToolButtonStyleChanged(void* c_this, c_intptr slot);
	[LinkName("QMainWindow_Connect_TabifiedDockWidgetActivated")]
	public static extern void QMainWindow_Connect_TabifiedDockWidgetActivated(void* c_this, c_intptr slot);
	[LinkName("QMainWindow_ContextMenuEvent")]
	public static extern void QMainWindow_ContextMenuEvent(void* c_this, void* event);
	[LinkName("QMainWindow_Event")]
	public static extern bool QMainWindow_Event(void* c_this, void* event);
	...
	public static extern libqt_string QMainWindow_SaveState1(void* c_this, int32 version);
	[LinkName("QMainWindow_RestoreState2")]
	public static extern bool QMainWindow_RestoreState2(void* c_this, libqt_string state, int32 version);
	/// Delete this object from C++ memory
	[LinkName("QMainWindow_Delete")]
	public static extern void QMainWindow_Delete(void* self);
}