...
public struct QObjectCleanupHandlerPtr : IQObjectCleanupHandler, IDisposable, IQObject
{
	...
	{
		return .(CQt.QObjectCleanupHandler_new());
	}
	...
	{
		return CQt.QObjectCleanupHandler_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QObjectCleanupHandler_Add(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr);
	}
	
	public void Remove(IQObject object)
	{
		CQt.QObjectCleanupHandler_Remove(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr);
	}
...
{
	public QObjectCleanupHandlerPtr handle;
	
	public static implicit operator QObjectCleanupHandlerPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QObjectCleanupHandlerPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QObjectCleanupHandlerPtr.Tr(s);
	}
	
	public void* Add(IQObject object)
	{
		return this.handle.Add(object);
	}
	
	public void Remove(IQObject object)
	{
		this.handle.Remove(object);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QObjectCleanupHandlerPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QObjectCleanupHandlerPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QObjectCleanupHandlerPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QObjectCleanupHandlerPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QObjectCleanupHandlerPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QObjectCleanupHandlerPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
