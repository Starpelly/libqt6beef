...
public class QFocusFrame
{
	...
	{
		this.nativePtr = CQt.QFocusFrame_new(parent);
	}
	...
	{
		CQt.QFocusFrame_SetWidget(this.nativePtr, widget);
	}
	...
	{
		return CQt.QFocusFrame_Event(this.nativePtr, e);
	}
	
	public virtual bool EventFilter(void* param1, void* param2)
	{
		return CQt.QFocusFrame_EventFilter(this.nativePtr, param1, param2);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QFocusFrame_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QFocusFrame_InitStyleOption(this.nativePtr, option);
	}
