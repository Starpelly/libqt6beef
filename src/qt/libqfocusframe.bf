...
public interface IQFocusFrame
{
	void* NativePtr { get; }
}
public struct QFocusFramePtr : IQFocusFrame, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QFocusFrame_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QFocusFrame_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QFocusFrame_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QFocusFrame_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QFocusFrame_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QFocusFrame_SetWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void* Widget()
	{
		return CQt.QFocusFrame_Widget(this.nativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QFocusFrame_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QFocusFrame_EventFilter(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr, (param2 == default || param2.NativePtr == default) ? default : param2.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QFocusFrame_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOption option)
	{
		CQt.QFocusFrame_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
public class QFocusFrame
{
	public QFocusFramePtr handle;
	
	public static implicit operator QFocusFramePtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QFocusFramePtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QFocusFramePtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QFocusFramePtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QFocusFramePtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QFocusFramePtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QFocusFramePtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QFocusFramePtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QFocusFramePtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QFocusFramePtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QFocusFramePtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QFocusFramePtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QFocusFramePtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QFocusFramePtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QFocusFramePtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QFocusFramePtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QFocusFrame_new(void* parent);
	[LinkName("QFocusFrame_new2")]
	public static extern void* QFocusFrame_new2();
	[LinkName("QFocusFrame_MetaObject")]
	public static extern void* QFocusFrame_MetaObject(void* c_this);
	...
	public static extern libqt_string QFocusFrame_Tr(char8* s);
	[LinkName("QFocusFrame_SetWidget")]
	public static extern void QFocusFrame_SetWidget(void* c_this, void* widget);
	[LinkName("QFocusFrame_Widget")]
	public static extern void* QFocusFrame_Widget(void* c_this);
	[LinkName("QFocusFrame_Event")]
	public static extern bool QFocusFrame_Event(void* c_this, void* e);
	[LinkName("QFocusFrame_EventFilter")]
	public static extern bool QFocusFrame_EventFilter(void* c_this, void* param1, void* param2);
	[LinkName("QFocusFrame_PaintEvent")]
	public static extern void QFocusFrame_PaintEvent(void* c_this, void* param1);
	[LinkName("QFocusFrame_InitStyleOption")]
	public static extern void QFocusFrame_InitStyleOption(void* c_this, void* option);
	[LinkName("QFocusFrame_Tr2")]
	public static extern libqt_string QFocusFrame_Tr2(char8* s, char8* c);
	[LinkName("QFocusFrame_Tr3")]
	public static extern libqt_string QFocusFrame_Tr3(char8* s, char8* c, int32 n);
	/// Delete this object from C++ memory
	[LinkName("QFocusFrame_Delete")]
	public static extern void QFocusFrame_Delete(void* self);
}