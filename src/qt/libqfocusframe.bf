...
public class QFocusFrame : IQFocusFrame, IQWidget
{
	...
	{
		this.nativePtr = CQt.QFocusFrame_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QFocusFrame_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QFocusFrame_SetWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		return CQt.QFocusFrame_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QFocusFrame_EventFilter(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr, (param2 == null) ? null : (void*)param2.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QFocusFrame_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOption option)
	{
		CQt.QFocusFrame_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
