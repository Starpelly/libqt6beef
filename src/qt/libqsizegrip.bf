...
public interface IQSizeGrip
{
	void* NativePtr { get; }
}
public struct QSizeGripPtr : IQSizeGrip, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QSizeGrip_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QSizeGrip_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QSizeGrip_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QSizeGrip_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QSizeGrip_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QSizeGrip_SizeHint(this.nativePtr);
	}
	
	public void SetVisible(bool visible)
	{
		CQt.QSizeGrip_SetVisible(this.nativePtr, visible);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QSizeGrip_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MousePressEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		CQt.QSizeGrip_MouseReleaseEvent(this.nativePtr, (mouseEvent == default || mouseEvent.NativePtr == default) ? default : mouseEvent.NativePtr);
	}
	
	public void MoveEvent(IQMoveEvent moveEvent)
	{
		CQt.QSizeGrip_MoveEvent(this.nativePtr, (moveEvent == default || moveEvent.NativePtr == default) ? default : moveEvent.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QSizeGrip_ShowEvent(this.nativePtr, (showEvent == default || showEvent.NativePtr == default) ? default : showEvent.NativePtr);
	}
	
	public void HideEvent(IQHideEvent hideEvent)
	{
		CQt.QSizeGrip_HideEvent(this.nativePtr, (hideEvent == default || hideEvent.NativePtr == default) ? default : hideEvent.NativePtr);
	}
	
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QSizeGrip_EventFilter(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr, (param2 == default || param2.NativePtr == default) ? default : param2.NativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QSizeGrip_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
...
{
	public QSizeGripPtr handle;
	
	public static implicit operator QSizeGripPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QSizeGripPtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QSizeGripPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QSizeGripPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QSizeGripPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QSizeGripPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QSizeGripPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QSizeGripPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QSizeGripPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QSizeGripPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QSizeGripPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QSizeGripPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QSizeGripPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QSizeGripPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QSizeGripPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QSizeGripPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QSizeGrip_new(void* parent);
	[LinkName("QSizeGrip_MetaObject")]
	public static extern void* QSizeGrip_MetaObject(void* c_this);
	...
	public static extern void QSizeGrip_SizeHint(void* c_this);
	...
	public static extern void QSizeGrip_PaintEvent(void* c_this, void* param1);
	[LinkName("QSizeGrip_MousePressEvent")]
	public static extern void QSizeGrip_MousePressEvent(void* c_this, void* param1);
	[LinkName("QSizeGrip_MouseMoveEvent")]
	public static extern void QSizeGrip_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QSizeGrip_MouseReleaseEvent")]
	public static extern void QSizeGrip_MouseReleaseEvent(void* c_this, void* mouseEvent);
	[LinkName("QSizeGrip_MoveEvent")]
	public static extern void QSizeGrip_MoveEvent(void* c_this, void* moveEvent);
	[LinkName("QSizeGrip_ShowEvent")]
	public static extern void QSizeGrip_ShowEvent(void* c_this, void* showEvent);
	[LinkName("QSizeGrip_HideEvent")]
	public static extern void QSizeGrip_HideEvent(void* c_this, void* hideEvent);
	[LinkName("QSizeGrip_EventFilter")]
	public static extern bool QSizeGrip_EventFilter(void* c_this, void* param1, void* param2);
	[LinkName("QSizeGrip_Event")]
	public static extern bool QSizeGrip_Event(void* c_this, void* param1);
	...
	public static extern void QSizeGrip_Delete(void* self);
}