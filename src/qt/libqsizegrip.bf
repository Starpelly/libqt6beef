...
public class QSizeGrip : IQSizeGrip, IQWidget
{
	...
	{
		this.nativePtr = CQt.QSizeGrip_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QSizeGrip_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QSizeGrip_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MousePressEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MouseMoveEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		CQt.QSizeGrip_MouseReleaseEvent(this.nativePtr, (mouseEvent == null) ? null : (void*)mouseEvent.NativePtr);
	}
	
	public virtual void MoveEvent(IQMoveEvent moveEvent)
	{
		CQt.QSizeGrip_MoveEvent(this.nativePtr, (moveEvent == null) ? null : (void*)moveEvent.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QSizeGrip_ShowEvent(this.nativePtr, (showEvent == null) ? null : (void*)showEvent.NativePtr);
	}
	
	public virtual void HideEvent(IQHideEvent hideEvent)
	{
		CQt.QSizeGrip_HideEvent(this.nativePtr, (hideEvent == null) ? null : (void*)hideEvent.NativePtr);
	}
	
	public virtual bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QSizeGrip_EventFilter(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr, (param2 == null) ? null : (void*)param2.NativePtr);
	}
	
	public virtual bool Event(IQEvent param1)
	{
		return CQt.QSizeGrip_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
