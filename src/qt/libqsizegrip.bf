...
public class QSizeGrip
{
	...
	{
		this.nativePtr = CQt.QSizeGrip_new(parent);
	}
	...
	{
		CQt.QSizeGrip_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MousePressEvent(void* param1)
	{
		CQt.QSizeGrip_MousePressEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QSizeGrip_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseReleaseEvent(void* mouseEvent)
	{
		CQt.QSizeGrip_MouseReleaseEvent(this.nativePtr, mouseEvent);
	}
	
	public virtual void MoveEvent(void* moveEvent)
	{
		CQt.QSizeGrip_MoveEvent(this.nativePtr, moveEvent);
	}
	
	public virtual void ShowEvent(void* showEvent)
	{
		CQt.QSizeGrip_ShowEvent(this.nativePtr, showEvent);
	}
	
	public virtual void HideEvent(void* hideEvent)
	{
		CQt.QSizeGrip_HideEvent(this.nativePtr, hideEvent);
	}
	
	public virtual bool EventFilter(void* param1, void* param2)
	{
		return CQt.QSizeGrip_EventFilter(this.nativePtr, param1, param2);
	}
	
	public virtual bool Event(void* param1)
	{
		return CQt.QSizeGrip_Event(this.nativePtr, param1);
	}
