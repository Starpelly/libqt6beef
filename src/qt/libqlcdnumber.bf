...
public class QLCDNumber : IQLCDNumber, IQFrame
{
	...
	{
		this.nativePtr = CQt.QLCDNumber_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QLCDNumber_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QLCDNumber_SetMode(this.nativePtr, mode);
	}
	...
	{
		CQt.QLCDNumber_SetSegmentStyle(this.nativePtr, segmentStyle);
	}
	...
	{
		return CQt.QLCDNumber_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QLCDNumber_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
