...
public class QLCDNumber
{
	...
	{
		this.nativePtr = CQt.QLCDNumber_new(parent);
	}
	...
	{
		CQt.QLCDNumber_Display(this.nativePtr, str);
	}
	...
	{
		return CQt.QLCDNumber_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QLCDNumber_PaintEvent(this.nativePtr, param1);
	}
