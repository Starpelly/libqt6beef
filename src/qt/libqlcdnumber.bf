...
public interface IQLCDNumber
{
	void* NativePtr { get; }
}
public struct QLCDNumberPtr : IQLCDNumber, IDisposable, IQFrame
{
	...
	{
		return .(CQt.QLCDNumber_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QLCDNumber_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QLCDNumber_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QLCDNumber_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QLCDNumber_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QLCDNumber_SmallDecimalPoint(this.nativePtr);
	}
	
	public int32 DigitCount()
	{
		return CQt.QLCDNumber_DigitCount(this.nativePtr);
	}
	
	public void SetDigitCount(int32 nDigits)
	{
		CQt.QLCDNumber_SetDigitCount(this.nativePtr, nDigits);
	}
	
	public bool CheckOverflow(double num)
	{
		return CQt.QLCDNumber_CheckOverflow(this.nativePtr, num);
	}
	
	public bool CheckOverflowWithNum(int32 num)
	{
		return CQt.QLCDNumber_CheckOverflowWithNum(this.nativePtr, num);
	}
	
	public int64 Mode()
	{
		return CQt.QLCDNumber_Mode(this.nativePtr);
	}
	
	public void SetMode(int64 mode)
	{
		CQt.QLCDNumber_SetMode(this.nativePtr, (int64)mode);
	}
	
	public int64 SegmentStyle()
	{
		return CQt.QLCDNumber_SegmentStyle(this.nativePtr);
	}
	
	public void SetSegmentStyle(int64 segmentStyle)
	{
		CQt.QLCDNumber_SetSegmentStyle(this.nativePtr, (int64)segmentStyle);
	}
	
	public double Value()
	{
		return CQt.QLCDNumber_Value(this.nativePtr);
	}
	
	public int32 IntValue()
	{
		return CQt.QLCDNumber_IntValue(this.nativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QLCDNumber_SizeHint(this.nativePtr);
	}
	
	public void Display(String str)
	{
		CQt.QLCDNumber_Display(this.nativePtr, libqt_string(str));
	}
	
	public void DisplayWithNum(int32 num)
	{
		CQt.QLCDNumber_DisplayWithNum(this.nativePtr, num);
	}
	
	public void Display2(double num)
	{
		CQt.QLCDNumber_Display2(this.nativePtr, num);
	}
	
	public void SetHexMode()
	{
		CQt.QLCDNumber_SetHexMode(this.nativePtr);
	}
	
	public void SetDecMode()
	{
		CQt.QLCDNumber_SetDecMode(this.nativePtr);
	}
	
	public void SetOctMode()
	{
		CQt.QLCDNumber_SetOctMode(this.nativePtr);
	}
	
	public void SetBinMode()
	{
		CQt.QLCDNumber_SetBinMode(this.nativePtr);
	}
	
	public void SetSmallDecimalPoint(bool smallDecimalPoint)
	{
		CQt.QLCDNumber_SetSmallDecimalPoint(this.nativePtr, smallDecimalPoint);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QLCDNumber_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QLCDNumber_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
...
{
	public QLCDNumberPtr handle;
	
	public static implicit operator QLCDNumberPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QLCDNumberPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QLCDNumberPtr.Tr(s);
	}
	
	public bool SmallDecimalPoint()
	{
		return this.handle.SmallDecimalPoint();
	}
	
	public int32 DigitCount()
	{
		return this.handle.DigitCount();
	}
	
	public void SetDigitCount(int32 nDigits)
	{
		this.handle.SetDigitCount(nDigits);
	}
	
	public bool CheckOverflow(double num)
	{
		return this.handle.CheckOverflow(num);
	}
	
	public bool CheckOverflowWithNum(int32 num)
	{
		return this.handle.CheckOverflowWithNum(num);
	}
	...
	public int64 SegmentStyle()
	{
		return this.handle.SegmentStyle();
	}
	
	public void SetSegmentStyle(int64 segmentStyle)
	{
		this.handle.SetSegmentStyle(segmentStyle);
	}
	...
	public void Display(String str)
	{
		this.handle.Display(str);
	}
	
	public void DisplayWithNum(int32 num)
	{
		this.handle.DisplayWithNum(num);
	}
	
	public void Display2(double num)
	{
		this.handle.Display2(num);
	}
	
	public void SetHexMode()
	{
		this.handle.SetHexMode();
	}
	
	public void SetDecMode()
	{
		this.handle.SetDecMode();
	}
	
	public void SetOctMode()
	{
		this.handle.SetOctMode();
	}
	
	public void SetBinMode()
	{
		this.handle.SetBinMode();
	}
	
	public void SetSmallDecimalPoint(bool smallDecimalPoint)
	{
		this.handle.SetSmallDecimalPoint(smallDecimalPoint);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QLCDNumberPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QLCDNumberPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QLCDNumberPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QLCDNumberPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QLCDNumberPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QLCDNumberPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QLCDNumberPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QLCDNumberPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QLCDNumberPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QLCDNumberPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QLCDNumberPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QLCDNumberPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QLCDNumberPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QLCDNumberPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QLCDNumber_new(void* parent);
	...
	public static extern void* QLCDNumber_new4(uint32 numDigits, void* parent);
	[LinkName("QLCDNumber_MetaObject")]
	public static extern void* QLCDNumber_MetaObject(void* c_this);
	...
	public static extern void QLCDNumber_SizeHint(void* c_this);
	[LinkName("QLCDNumber_Display")]
	public static extern void QLCDNumber_Display(void* c_this, libqt_string str);
	...
	public static extern void QLCDNumber_Connect_Overflow(void* c_this, c_intptr slot);
	[LinkName("QLCDNumber_Event")]
	public static extern bool QLCDNumber_Event(void* c_this, void* e);
	[LinkName("QLCDNumber_PaintEvent")]
	public static extern void QLCDNumber_PaintEvent(void* c_this, void* param1);
	...
	public static extern void QLCDNumber_Delete(void* self);
}