...
public interface IQAbstractButton
{
	void* NativePtr { get; }
}
public struct QAbstractButtonPtr : IQAbstractButton, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QAbstractButton_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QAbstractButton_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QAbstractButton_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QAbstractButton_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QAbstractButton_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QAbstractButton_PaintEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public bool HitButton(IQPoint pos)
	{
		return CQt.QAbstractButton_HitButton(this.nativePtr, (pos == default || pos.NativePtr == default) ? default : pos.NativePtr);
	}
	
	public void CheckStateSet()
	{
		CQt.QAbstractButton_CheckStateSet(this.nativePtr);
	}
	
	public void NextCheckState()
	{
		CQt.QAbstractButton_NextCheckState(this.nativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QAbstractButton_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void KeyPressEvent(IQKeyEvent e)
	{
		CQt.QAbstractButton_KeyPressEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void KeyReleaseEvent(IQKeyEvent e)
	{
		CQt.QAbstractButton_KeyReleaseEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MousePressEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MouseReleaseEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MouseMoveEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void FocusInEvent(IQFocusEvent e)
	{
		CQt.QAbstractButton_FocusInEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void FocusOutEvent(IQFocusEvent e)
	{
		CQt.QAbstractButton_FocusOutEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ChangeEvent(IQEvent e)
	{
		CQt.QAbstractButton_ChangeEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent e)
	{
		CQt.QAbstractButton_TimerEvent(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
...
public class QAbstractButton
{
	public QAbstractButtonPtr handle;
	
	public static implicit operator QAbstractButtonPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QAbstractButtonPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractButtonPtr.Tr(s);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractButtonPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractButtonPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QAbstractButtonPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QAbstractButtonPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QAbstractButtonPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QAbstractButtonPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QAbstractButtonPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QAbstractButtonPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QAbstractButtonPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractButtonPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractButtonPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractButtonPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractButtonPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QAbstractButtonPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QAbstractButton_new(void* parent);
	[LinkName("QAbstractButton_new2")]
	public static extern void* QAbstractButton_new2();
	[LinkName("QAbstractButton_MetaObject")]
	public static extern void* QAbstractButton_MetaObject(void* c_this);
	...
	public static extern libqt_string QAbstractButton_Text(void* c_this);
	[LinkName("QAbstractButton_SetIcon")]
	public static extern void QAbstractButton_SetIcon(void* c_this, void* icon);
	[LinkName("QAbstractButton_Icon")]
	public static extern void QAbstractButton_Icon(void* c_this);
	[LinkName("QAbstractButton_IconSize")]
	public static extern void QAbstractButton_IconSize(void* c_this);
	[LinkName("QAbstractButton_SetShortcut")]
	public static extern void QAbstractButton_SetShortcut(void* c_this, void* key);
	[LinkName("QAbstractButton_Shortcut")]
	public static extern void QAbstractButton_Shortcut(void* c_this);
	...
	public static extern void* QAbstractButton_Group(void* c_this);
	[LinkName("QAbstractButton_SetIconSize")]
	public static extern void QAbstractButton_SetIconSize(void* c_this, void* size);
	...
	public static extern void QAbstractButton_Connect_Pressed(void* c_this, c_intptr slot);
	[LinkName("QAbstractButton_Connect_Released")]
	public static extern void QAbstractButton_Connect_Released(void* c_this, c_intptr slot);
	[LinkName("QAbstractButton_Connect_Clicked")]
	public static extern void QAbstractButton_Connect_Clicked(void* c_this, c_intptr slot);
	[LinkName("QAbstractButton_Connect_Toggled")]
	public static extern void QAbstractButton_Connect_Toggled(void* c_this, c_intptr slot);
	[LinkName("QAbstractButton_PaintEvent")]
	public static extern void QAbstractButton_PaintEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_HitButton")]
	public static extern bool QAbstractButton_HitButton(void* c_this, void* pos);
	...
	public static extern bool QAbstractButton_Event(void* c_this, void* e);
	[LinkName("QAbstractButton_KeyPressEvent")]
	public static extern void QAbstractButton_KeyPressEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_KeyReleaseEvent")]
	public static extern void QAbstractButton_KeyReleaseEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_MousePressEvent")]
	public static extern void QAbstractButton_MousePressEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_MouseReleaseEvent")]
	public static extern void QAbstractButton_MouseReleaseEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_MouseMoveEvent")]
	public static extern void QAbstractButton_MouseMoveEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_FocusInEvent")]
	public static extern void QAbstractButton_FocusInEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_FocusOutEvent")]
	public static extern void QAbstractButton_FocusOutEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_ChangeEvent")]
	public static extern void QAbstractButton_ChangeEvent(void* c_this, void* e);
	[LinkName("QAbstractButton_TimerEvent")]
	public static extern void QAbstractButton_TimerEvent(void* c_this, void* e);
	...
	public static extern void QAbstractButton_Connect_Clicked1(void* c_this, c_intptr slot);
	/// Delete this object from C++ memory
	[LinkName("QAbstractButton_Delete")]
	public static extern void QAbstractButton_Delete(void* self);
}