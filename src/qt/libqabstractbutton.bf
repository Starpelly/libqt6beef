...
public class QAbstractButton
{
	...
	{
		this.nativePtr = CQt.QAbstractButton_new(parent);
	}
	...
	{
		CQt.QAbstractButton_PaintEvent(this.nativePtr, e);
	}
	
	public virtual bool HitButton(void* pos)
	{
		return CQt.QAbstractButton_HitButton(this.nativePtr, pos);
	}
	...
	{
		return CQt.QAbstractButton_Event(this.nativePtr, e);
	}
	
	public virtual void KeyPressEvent(void* e)
	{
		CQt.QAbstractButton_KeyPressEvent(this.nativePtr, e);
	}
	
	public virtual void KeyReleaseEvent(void* e)
	{
		CQt.QAbstractButton_KeyReleaseEvent(this.nativePtr, e);
	}
	
	public virtual void MousePressEvent(void* e)
	{
		CQt.QAbstractButton_MousePressEvent(this.nativePtr, e);
	}
	
	public virtual void MouseReleaseEvent(void* e)
	{
		CQt.QAbstractButton_MouseReleaseEvent(this.nativePtr, e);
	}
	
	public virtual void MouseMoveEvent(void* e)
	{
		CQt.QAbstractButton_MouseMoveEvent(this.nativePtr, e);
	}
	
	public virtual void FocusInEvent(void* e)
	{
		CQt.QAbstractButton_FocusInEvent(this.nativePtr, e);
	}
	
	public virtual void FocusOutEvent(void* e)
	{
		CQt.QAbstractButton_FocusOutEvent(this.nativePtr, e);
	}
	
	public virtual void ChangeEvent(void* e)
	{
		CQt.QAbstractButton_ChangeEvent(this.nativePtr, e);
	}
	
	public virtual void TimerEvent(void* e)
	{
		CQt.QAbstractButton_TimerEvent(this.nativePtr, e);
	}
