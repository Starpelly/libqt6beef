...
public interface IQRadioButton
{
	void* NativePtr { get; }
}
public struct QRadioButtonPtr : IQRadioButton, IDisposable, IQAbstractButton
{
	...
	{
		return .(CQt.QRadioButton_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QRadioButton_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QRadioButton_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QRadioButton_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QRadioButton_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QRadioButton_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QRadioButton_MinimumSizeHint(this.nativePtr);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QRadioButton_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public bool HitButton(IQPoint param1)
	{
		return CQt.QRadioButton_HitButton(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QRadioButton_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QRadioButton_MouseMoveEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionButton button)
	{
		CQt.QRadioButton_InitStyleOption(this.nativePtr, (button == default || button.NativePtr == default) ? default : button.NativePtr);
	}
...
{
	public QRadioButtonPtr handle;
	
	public static implicit operator QRadioButtonPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QRadioButtonPtr.New(parent);
	}
	...
	public virtual bool HitButton(IQPoint param1)
	{
		return this.handle.HitButton(param1);
	}
	...
	public virtual void InitStyleOption(IQStyleOptionButton button)
	{
		this.handle.InitStyleOption(button);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QRadioButtonPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QRadioButtonPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QRadioButtonPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QRadioButtonPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QRadioButtonPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QRadioButtonPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QRadioButtonPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QRadioButtonPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QRadioButtonPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QRadioButtonPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QRadioButtonPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QRadioButtonPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QRadioButtonPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QRadioButtonPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QRadioButton_new(void* parent);
	[LinkName("QRadioButton_new2")]
	public static extern void* QRadioButton_new2();
	[LinkName("QRadioButton_new3")]
	public static extern void* QRadioButton_new3(libqt_string text);
	[LinkName("QRadioButton_new4")]
	public static extern void* QRadioButton_new4(libqt_string text, void* parent);
	[LinkName("QRadioButton_MetaObject")]
	public static extern void* QRadioButton_MetaObject(void* c_this);
	...
	public static extern void QRadioButton_SizeHint(void* c_this);
	[LinkName("QRadioButton_MinimumSizeHint")]
	public static extern void QRadioButton_MinimumSizeHint(void* c_this);
	[LinkName("QRadioButton_Event")]
	public static extern bool QRadioButton_Event(void* c_this, void* e);
	[LinkName("QRadioButton_HitButton")]
	public static extern bool QRadioButton_HitButton(void* c_this, void* param1);
	[LinkName("QRadioButton_PaintEvent")]
	public static extern void QRadioButton_PaintEvent(void* c_this, void* param1);
	[LinkName("QRadioButton_MouseMoveEvent")]
	public static extern void QRadioButton_MouseMoveEvent(void* c_this, void* param1);
	[LinkName("QRadioButton_InitStyleOption")]
	public static extern void QRadioButton_InitStyleOption(void* c_this, void* button);
	...
	public static extern void QRadioButton_Delete(void* self);
}