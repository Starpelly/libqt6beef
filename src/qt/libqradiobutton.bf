...
public class QRadioButton
{
	...
	{
		this.nativePtr = CQt.QRadioButton_new(parent);
	}
	...
	{
		return CQt.QRadioButton_Event(this.nativePtr, e);
	}
	
	public virtual bool HitButton(void* param1)
	{
		return CQt.QRadioButton_HitButton(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QRadioButton_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void MouseMoveEvent(void* param1)
	{
		CQt.QRadioButton_MouseMoveEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* button)
	{
		CQt.QRadioButton_InitStyleOption(this.nativePtr, button);
	}
