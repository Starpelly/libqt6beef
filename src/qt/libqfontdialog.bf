...
public struct QFontDialogPtr : IQFontDialog, IDisposable, IQDialog
{
	...
	{
		return .(CQt.QFontDialog_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QFontDialog_Delete(this.nativePtr);
	}
	...
	{
		return CQt.QFontDialog_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QFontDialog_SetCurrentFont(this.nativePtr, (font == default || font.NativePtr == default) ? default : font.NativePtr);
	}
	
	public void CurrentFont()
	{
		CQt.QFontDialog_CurrentFont(this.nativePtr);
	}
	
	public void SelectedFont()
	{
		CQt.QFontDialog_SelectedFont(this.nativePtr);
	}
	
	public void SetOption(int64 option)
	{
		CQt.QFontDialog_SetOption(this.nativePtr, (int64)option);
	}
	
	public bool TestOption(int64 option)
	{
		return CQt.QFontDialog_TestOption(this.nativePtr, (int64)option);
	}
	
	public void SetOptions(int64 options)
	{
		CQt.QFontDialog_SetOptions(this.nativePtr, options);
	}
	
	public int64 Options()
	{
		return CQt.QFontDialog_Options(this.nativePtr);
	}
	
	public void SetVisible(bool visible)
	{
		CQt.QFontDialog_SetVisible(this.nativePtr, visible);
	}
	
	public static void GetFont(bool* ok)
	{
	...
	{
		CQt.QFontDialog_GetFont2(ok, (initial == default || initial.NativePtr == default) ? default : initial.NativePtr);
	}
	
	public void ChangeEvent(IQEvent event)
	{
		CQt.QFontDialog_ChangeEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	{
		return CQt.QFontDialog_EventFilter(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	...
	{
		CQt.QFontDialog_SetOption2(this.nativePtr, (int64)option, on);
	}
	
	public static void GetFont22(bool* ok, IQWidget parent)
	{
		CQt.QFontDialog_GetFont22(ok, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public static void GetFont3(bool* ok, IQFont initial, IQWidget parent)
	{
		CQt.QFontDialog_GetFont3(ok, (initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr);
	}
	
	public static void GetFont4(bool* ok, IQFont initial, IQWidget parent, String title)
	{
		CQt.QFontDialog_GetFont4(ok, (initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, libqt_string(title));
	}
	
	public static void GetFont5(bool* ok, IQFont initial, IQWidget parent, String title, int64 options)
	{
		CQt.QFontDialog_GetFont5(ok, (initial == default || initial.NativePtr == default) ? default : initial.NativePtr, (parent == default || parent.NativePtr == default) ? default : parent.NativePtr, libqt_string(title), options);
	}
...
{
	public QFontDialogPtr handle;
	
	public static implicit operator QFontDialogPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QFontDialogPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QFontDialogPtr.Tr(s);
	}
	
	public void SetCurrentFont(IQFont font)
	{
		this.handle.SetCurrentFont(font);
	}
	...
	public static void GetFont(bool* ok)
	{
		QFontDialogPtr.GetFont(ok);
	}
	
	public static void GetFont2(bool* ok, IQFont initial)
	{
		QFontDialogPtr.GetFont2(ok, initial);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QFontDialogPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QFontDialogPtr.Tr3(s, c, n);
	}
	...
	public static void GetFont22(bool* ok, IQWidget parent)
	{
		QFontDialogPtr.GetFont22(ok, parent);
	}
	
	public static void GetFont3(bool* ok, IQFont initial, IQWidget parent)
	{
		QFontDialogPtr.GetFont3(ok, initial, parent);
	}
	
	public static void GetFont4(bool* ok, IQFont initial, IQWidget parent, String title)
	{
		QFontDialogPtr.GetFont4(ok, initial, parent, title);
	}
	
	public static void GetFont5(bool* ok, IQFont initial, IQWidget parent, String title, int64 options)
	{
		QFontDialogPtr.GetFont5(ok, initial, parent, title, options);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QFontDialogPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QFontDialogPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QFontDialogPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QFontDialogPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QFontDialogPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QFontDialogPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QFontDialogPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QFontDialogPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QFontDialogPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QFontDialogPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QFontDialogPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QFontDialogPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QFontDialog_new(void* parent);
	[LinkName("QFontDialog_new2")]
	public static extern void* QFontDialog_new2();
	[LinkName("QFontDialog_new3")]
	public static extern void* QFontDialog_new3(void* initial);
	[LinkName("QFontDialog_new4")]
	public static extern void* QFontDialog_new4(void* initial, void* parent);
	...
	public static extern void QFontDialog_CurrentFont(void* c_this);
	[LinkName("QFontDialog_SelectedFont")]
	public static extern void QFontDialog_SelectedFont(void* c_this);
	...
	public static extern void QFontDialog_Connect_CurrentFontChanged(void* c_this, c_intptr slot);
	[LinkName("QFontDialog_Connect_FontSelected")]
	public static extern void QFontDialog_Connect_FontSelected(void* c_this, c_intptr slot);
	[LinkName("QFontDialog_ChangeEvent")]
	public static extern void QFontDialog_ChangeEvent(void* c_this, void* event);
	...
	public static extern void QFontDialog_GetFont5(bool* ok, void* initial, void* parent, libqt_string title, int64 options);
	/// Delete this object from C++ memory
	[LinkName("QFontDialog_Delete")]
	public static extern void QFontDialog_Delete(void* self);
}