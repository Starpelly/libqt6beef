...
public class QStatusBar
{
	...
	{
		this.nativePtr = CQt.QStatusBar_new(parent);
	}
	...
	{
		CQt.QStatusBar_AddWidget(this.nativePtr, widget);
	}
	
	public int32 InsertWidget(int32 index, void* widget)
	{
		return CQt.QStatusBar_InsertWidget(this.nativePtr, index, widget);
	}
	
	public void AddPermanentWidget(void* widget)
	{
		CQt.QStatusBar_AddPermanentWidget(this.nativePtr, widget);
	}
	
	public int32 InsertPermanentWidget(int32 index, void* widget)
	{
		return CQt.QStatusBar_InsertPermanentWidget(this.nativePtr, index, widget);
	}
	
	public void RemoveWidget(void* widget)
	{
		CQt.QStatusBar_RemoveWidget(this.nativePtr, widget);
	}
	...
	{
		CQt.QStatusBar_ShowMessage(this.nativePtr, text);
	}
	...
	{
		CQt.QStatusBar_ShowEvent(this.nativePtr, param1);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QStatusBar_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void ResizeEvent(void* param1)
	{
		CQt.QStatusBar_ResizeEvent(this.nativePtr, param1);
	}
	...
	{
		return CQt.QStatusBar_Event(this.nativePtr, param1);
	}
	...
	public void AddWidget2(void* widget, int32 stretch)
	{
		CQt.QStatusBar_AddWidget2(this.nativePtr, widget, stretch);
	}
	
	public int32 InsertWidget3(int32 index, void* widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertWidget3(this.nativePtr, index, widget, stretch);
	}
	
	public void AddPermanentWidget2(void* widget, int32 stretch)
	{
		CQt.QStatusBar_AddPermanentWidget2(this.nativePtr, widget, stretch);
	}
	
	public int32 InsertPermanentWidget3(int32 index, void* widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertPermanentWidget3(this.nativePtr, index, widget, stretch);
	}
	
	public void ShowMessage2(libqt_string text, int32 timeout)
	{
		CQt.QStatusBar_ShowMessage2(this.nativePtr, text, timeout);
	}
