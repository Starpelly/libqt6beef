...
public interface IQStatusBar
{
	void* NativePtr { get; }
}
public struct QStatusBarPtr : IQStatusBar, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QStatusBar_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QStatusBar_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QStatusBar_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QStatusBar_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QStatusBar_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QStatusBar_AddWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public int32 InsertWidget(int32 index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertWidget(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void AddPermanentWidget(IQWidget widget)
	{
		CQt.QStatusBar_AddPermanentWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public int32 InsertPermanentWidget(int32 index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertPermanentWidget(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void RemoveWidget(IQWidget widget)
	{
		CQt.QStatusBar_RemoveWidget(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void SetSizeGripEnabled(bool sizeGripEnabled)
	{
		CQt.QStatusBar_SetSizeGripEnabled(this.nativePtr, sizeGripEnabled);
	}
	
	public bool IsSizeGripEnabled()
	{
		return CQt.QStatusBar_IsSizeGripEnabled(this.nativePtr);
	}
	
	public libqt_string CurrentMessage()
	{
		return CQt.QStatusBar_CurrentMessage(this.nativePtr);
	}
	
	public void ShowMessage(String text)
	{
		CQt.QStatusBar_ShowMessage(this.nativePtr, libqt_string(text));
	}
	
	public void ClearMessage()
	{
		CQt.QStatusBar_ClearMessage(this.nativePtr);
	}
	
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QStatusBar_ShowEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QStatusBar_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QStatusBar_ResizeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void Reformat()
	{
		CQt.QStatusBar_Reformat(this.nativePtr);
	}
	
	public void HideOrShow()
	{
		CQt.QStatusBar_HideOrShow(this.nativePtr);
	}
	
	public bool Event(IQEvent param1)
	{
		return CQt.QStatusBar_Event(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	...
	public void AddWidget2(IQWidget widget, int32 stretch)
	{
		CQt.QStatusBar_AddWidget2(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, stretch);
	}
	
	public int32 InsertWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertWidget3(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, stretch);
	}
	
	public void AddPermanentWidget2(IQWidget widget, int32 stretch)
	{
		CQt.QStatusBar_AddPermanentWidget2(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, stretch);
	}
	
	public int32 InsertPermanentWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertPermanentWidget3(this.nativePtr, index, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, stretch);
	}
	
	public void ShowMessage2(String text, int32 timeout)
	{
		CQt.QStatusBar_ShowMessage2(this.nativePtr, libqt_string(text), timeout);
	}
...
{
	public QStatusBarPtr handle;
	
	public static implicit operator QStatusBarPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QStatusBarPtr.New(parent);
	}
	...
	public int32 InsertWidget(int32 index, IQWidget widget)
	{
		return this.handle.InsertWidget(index, widget);
	}
	
	public void AddPermanentWidget(IQWidget widget)
	{
		this.handle.AddPermanentWidget(widget);
	}
	
	public int32 InsertPermanentWidget(int32 index, IQWidget widget)
	{
		return this.handle.InsertPermanentWidget(index, widget);
	}
	
	public void RemoveWidget(IQWidget widget)
	{
		this.handle.RemoveWidget(widget);
	}
	...
	public libqt_string CurrentMessage()
	{
		return this.handle.CurrentMessage();
	}
	
	public void ShowMessage(String text)
	{
		this.handle.ShowMessage(text);
	}
	
	public void ClearMessage()
	{
		this.handle.ClearMessage();
	}
	...
	public void Reformat()
	{
		this.handle.Reformat();
	}
	
	public void HideOrShow()
	{
		this.handle.HideOrShow();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QStatusBarPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QStatusBarPtr.Tr3(s, c, n);
	}
	
	public void AddWidget2(IQWidget widget, int32 stretch)
	{
		this.handle.AddWidget2(widget, stretch);
	}
	
	public int32 InsertWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return this.handle.InsertWidget3(index, widget, stretch);
	}
	
	public void AddPermanentWidget2(IQWidget widget, int32 stretch)
	{
		this.handle.AddPermanentWidget2(widget, stretch);
	}
	
	public int32 InsertPermanentWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return this.handle.InsertPermanentWidget3(index, widget, stretch);
	}
	
	public void ShowMessage2(String text, int32 timeout)
	{
		this.handle.ShowMessage2(text, timeout);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QStatusBarPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QStatusBarPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QStatusBarPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QStatusBarPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QStatusBarPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QStatusBarPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QStatusBarPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QStatusBarPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QStatusBarPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QStatusBarPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QStatusBarPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QStatusBarPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QStatusBar_new(void* parent);
	[LinkName("QStatusBar_new2")]
	public static extern void* QStatusBar_new2();
	[LinkName("QStatusBar_MetaObject")]
	public static extern void* QStatusBar_MetaObject(void* c_this);
	...
	public static extern void QStatusBar_AddWidget(void* c_this, void* widget);
	[LinkName("QStatusBar_InsertWidget")]
	public static extern int32 QStatusBar_InsertWidget(void* c_this, int32 index, void* widget);
	[LinkName("QStatusBar_AddPermanentWidget")]
	public static extern void QStatusBar_AddPermanentWidget(void* c_this, void* widget);
	[LinkName("QStatusBar_InsertPermanentWidget")]
	public static extern int32 QStatusBar_InsertPermanentWidget(void* c_this, int32 index, void* widget);
	[LinkName("QStatusBar_RemoveWidget")]
	public static extern void QStatusBar_RemoveWidget(void* c_this, void* widget);
	...
	public static extern libqt_string QStatusBar_CurrentMessage(void* c_this);
	[LinkName("QStatusBar_ShowMessage")]
	public static extern void QStatusBar_ShowMessage(void* c_this, libqt_string text);
	...
	public static extern void QStatusBar_Connect_MessageChanged(void* c_this, c_intptr slot);
	[LinkName("QStatusBar_ShowEvent")]
	public static extern void QStatusBar_ShowEvent(void* c_this, void* param1);
	[LinkName("QStatusBar_PaintEvent")]
	public static extern void QStatusBar_PaintEvent(void* c_this, void* param1);
	[LinkName("QStatusBar_ResizeEvent")]
	public static extern void QStatusBar_ResizeEvent(void* c_this, void* param1);
	...
	public static extern bool QStatusBar_Event(void* c_this, void* param1);
	...
	public static extern void QStatusBar_AddWidget2(void* c_this, void* widget, int32 stretch);
	[LinkName("QStatusBar_InsertWidget3")]
	public static extern int32 QStatusBar_InsertWidget3(void* c_this, int32 index, void* widget, int32 stretch);
	[LinkName("QStatusBar_AddPermanentWidget2")]
	public static extern void QStatusBar_AddPermanentWidget2(void* c_this, void* widget, int32 stretch);
	[LinkName("QStatusBar_InsertPermanentWidget3")]
	public static extern int32 QStatusBar_InsertPermanentWidget3(void* c_this, int32 index, void* widget, int32 stretch);
	[LinkName("QStatusBar_ShowMessage2")]
	public static extern void QStatusBar_ShowMessage2(void* c_this, libqt_string text, int32 timeout);
	/// Delete this object from C++ memory
	[LinkName("QStatusBar_Delete")]
	public static extern void QStatusBar_Delete(void* self);
}