...
public class QStatusBar : IQStatusBar, IQWidget
{
	...
	{
		this.nativePtr = CQt.QStatusBar_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QStatusBar_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QStatusBar_AddWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public int32 InsertWidget(int32 index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertWidget(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void AddPermanentWidget(IQWidget widget)
	{
		CQt.QStatusBar_AddPermanentWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public int32 InsertPermanentWidget(int32 index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertPermanentWidget(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void RemoveWidget(IQWidget widget)
	{
		CQt.QStatusBar_RemoveWidget(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QStatusBar_ShowEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QStatusBar_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QStatusBar_ResizeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	...
	{
		return CQt.QStatusBar_Event(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	...
	{
		CQt.QStatusBar_AddWidget2(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, stretch);
	}
	
	public int32 InsertWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertWidget3(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, stretch);
	}
	
	public void AddPermanentWidget2(IQWidget widget, int32 stretch)
	{
		CQt.QStatusBar_AddPermanentWidget2(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, stretch);
	}
	
	public int32 InsertPermanentWidget3(int32 index, IQWidget widget, int32 stretch)
	{
		return CQt.QStatusBar_InsertPermanentWidget3(this.nativePtr, index, (widget == null) ? null : (void*)widget.NativePtr, stretch);
	}
