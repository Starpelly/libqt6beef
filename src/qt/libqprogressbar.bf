...
public class QProgressBar : IQProgressBar, IQWidget
{
	...
	{
		this.nativePtr = CQt.QProgressBar_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QProgressBar_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		CQt.QProgressBar_SetTextDirection(this.nativePtr, textDirection);
	}
	...
	{
		CQt.QProgressBar_SetOrientation(this.nativePtr, orientation);
	}
	
	public virtual bool Event(IQEvent e)
	{
		return CQt.QProgressBar_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QProgressBar_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionProgressBar option)
	{
		CQt.QProgressBar_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
