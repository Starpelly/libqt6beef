...
public interface IQProgressBar
{
	void* NativePtr { get; }
}
public struct QProgressBarPtr : IQProgressBar, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QProgressBar_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QProgressBar_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QProgressBar_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QProgressBar_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QProgressBar_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QProgressBar_Minimum(this.nativePtr);
	}
	
	public int32 Maximum()
	{
		return CQt.QProgressBar_Maximum(this.nativePtr);
	}
	
	public int32 Value()
	{
		return CQt.QProgressBar_Value(this.nativePtr);
	}
	
	public libqt_string Text()
	{
		return CQt.QProgressBar_Text(this.nativePtr);
	}
	
	public void SetTextVisible(bool visible)
	{
		CQt.QProgressBar_SetTextVisible(this.nativePtr, visible);
	}
	
	public bool IsTextVisible()
	{
		return CQt.QProgressBar_IsTextVisible(this.nativePtr);
	}
	
	public int64 Alignment()
	{
		return CQt.QProgressBar_Alignment(this.nativePtr);
	}
	
	public void SetAlignment(int64 alignment)
	{
		CQt.QProgressBar_SetAlignment(this.nativePtr, alignment);
	}
	
	public void SizeHint()
	{
		CQt.QProgressBar_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QProgressBar_MinimumSizeHint(this.nativePtr);
	}
	
	public int64 Orientation()
	{
		return CQt.QProgressBar_Orientation(this.nativePtr);
	}
	
	public void SetInvertedAppearance(bool invert)
	{
		CQt.QProgressBar_SetInvertedAppearance(this.nativePtr, invert);
	}
	
	public bool InvertedAppearance()
	{
		return CQt.QProgressBar_InvertedAppearance(this.nativePtr);
	}
	
	public void SetTextDirection(int64 textDirection)
	{
		CQt.QProgressBar_SetTextDirection(this.nativePtr, (int64)textDirection);
	}
	
	public int64 TextDirection()
	{
		return CQt.QProgressBar_TextDirection(this.nativePtr);
	}
	
	public void SetFormat(String format)
	{
		CQt.QProgressBar_SetFormat(this.nativePtr, libqt_string(format));
	}
	
	public void ResetFormat()
	{
		CQt.QProgressBar_ResetFormat(this.nativePtr);
	}
	
	public libqt_string Format()
	{
		return CQt.QProgressBar_Format(this.nativePtr);
	}
	
	public void Reset()
	{
		CQt.QProgressBar_Reset(this.nativePtr);
	}
	
	public void SetRange(int32 minimum, int32 maximum)
	{
		CQt.QProgressBar_SetRange(this.nativePtr, minimum, maximum);
	}
	
	public void SetMinimum(int32 minimum)
	{
		CQt.QProgressBar_SetMinimum(this.nativePtr, minimum);
	}
	
	public void SetMaximum(int32 maximum)
	{
		CQt.QProgressBar_SetMaximum(this.nativePtr, maximum);
	}
	
	public void SetValue(int32 value)
	{
		CQt.QProgressBar_SetValue(this.nativePtr, value);
	}
	
	public void SetOrientation(int64 orientation)
	{
		CQt.QProgressBar_SetOrientation(this.nativePtr, (int64)orientation);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QProgressBar_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QProgressBar_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionProgressBar option)
	{
		CQt.QProgressBar_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
{
	public QProgressBarPtr handle;
	
	public static implicit operator QProgressBarPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QProgressBarPtr.New(parent);
	}
	...
	public virtual libqt_string Text()
	{
	...
	public void SetTextVisible(bool visible)
	{
		this.handle.SetTextVisible(visible);
	}
	
	public bool IsTextVisible()
	{
		return this.handle.IsTextVisible();
	}
	...
	public void SetInvertedAppearance(bool invert)
	{
		this.handle.SetInvertedAppearance(invert);
	}
	...
	public void SetTextDirection(int64 textDirection)
	{
		this.handle.SetTextDirection(textDirection);
	}
	...
	public virtual void InitStyleOption(IQStyleOptionProgressBar option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QProgressBarPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QProgressBarPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QProgressBarPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QProgressBarPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QProgressBarPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QProgressBarPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QProgressBarPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QProgressBarPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QProgressBarPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QProgressBarPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QProgressBarPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QProgressBarPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QProgressBarPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QProgressBarPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QProgressBar_new(void* parent);
	[LinkName("QProgressBar_new2")]
	public static extern void* QProgressBar_new2();
	[LinkName("QProgressBar_MetaObject")]
	public static extern void* QProgressBar_MetaObject(void* c_this);
	...
	public static extern libqt_string QProgressBar_Text(void* c_this);
	...
	public static extern void QProgressBar_SizeHint(void* c_this);
	[LinkName("QProgressBar_MinimumSizeHint")]
	public static extern void QProgressBar_MinimumSizeHint(void* c_this);
	...
	public static extern void QProgressBar_SetFormat(void* c_this, libqt_string format);
	...
	public static extern libqt_string QProgressBar_Format(void* c_this);
	...
	public static extern void QProgressBar_Connect_ValueChanged(void* c_this, c_intptr slot);
	[LinkName("QProgressBar_Event")]
	public static extern bool QProgressBar_Event(void* c_this, void* e);
	[LinkName("QProgressBar_PaintEvent")]
	public static extern void QProgressBar_PaintEvent(void* c_this, void* param1);
	[LinkName("QProgressBar_InitStyleOption")]
	public static extern void QProgressBar_InitStyleOption(void* c_this, void* option);
	...
	public static extern void QProgressBar_Delete(void* self);
}