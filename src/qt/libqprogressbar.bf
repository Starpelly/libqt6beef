...
public class QProgressBar
{
	...
	{
		this.nativePtr = CQt.QProgressBar_new(parent);
	}
	...
	{
		CQt.QProgressBar_SetFormat(this.nativePtr, format);
	}
	...
	{
		return CQt.QProgressBar_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QProgressBar_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QProgressBar_InitStyleOption(this.nativePtr, option);
	}
