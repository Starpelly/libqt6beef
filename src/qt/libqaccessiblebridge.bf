...
public interface IQAccessibleBridge
{
	void* NativePtr { get; }
}
public struct QAccessibleBridgePtr : IQAccessibleBridge, IDisposable
{
	...
	{
		CQt.QAccessibleBridge_SetRootObject(this.nativePtr, (rootObject == default || rootObject.NativePtr == default) ? default : rootObject.NativePtr);
	}
	
	public void NotifyAccessibilityUpdate(IQAccessibleEvent event)
	{
		CQt.QAccessibleBridge_NotifyAccessibilityUpdate(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void OperatorAssign(IQAccessibleBridge param1)
	{
		CQt.QAccessibleBridge_OperatorAssign(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
}
public class QAccessibleBridge
{
	public QAccessibleBridgePtr handle;
	
	public static implicit operator QAccessibleBridgePtr(Self self)
	{
		return self.handle;
	}
	...
	public virtual void SetRootObject(IQAccessibleInterface rootObject)
	{
		this.handle.SetRootObject(rootObject);
	}
	
	public virtual void NotifyAccessibilityUpdate(IQAccessibleEvent event)
	{
		this.handle.NotifyAccessibilityUpdate(event);
	}
...
public interface IQAccessibleBridgePlugin
{
	void* NativePtr { get; }
}
public struct QAccessibleBridgePluginPtr : IQAccessibleBridgePlugin, IDisposable, IQObject
{
	protected void* nativePtr;
	public void* NativePtr => nativePtr;
	...
	{
		return .(CQt.QAccessibleBridgePlugin_new());
	}
	...
	{
		return CQt.QAccessibleBridgePlugin_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QAccessibleBridgePlugin_Create(this.nativePtr, libqt_string(key));
	}
...
{
	public QAccessibleBridgePluginPtr handle;
	
	public static implicit operator QAccessibleBridgePluginPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QAccessibleBridgePluginPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAccessibleBridgePluginPtr.Tr(s);
	}
	
	public virtual void* Create(String key)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAccessibleBridgePluginPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAccessibleBridgePluginPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAccessibleBridgePluginPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAccessibleBridgePluginPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAccessibleBridgePluginPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAccessibleBridgePluginPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
