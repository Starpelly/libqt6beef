...
public struct QPluginLoaderPtr : IQPluginLoader, IDisposable, IQObject
{
	...
	{
		return CQt.QPluginLoader_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
...
{
	public QPluginLoaderPtr handle;
	
	public static implicit operator QPluginLoaderPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QPluginLoaderPtr.New();
	}
	...
	public static void*[] StaticInstances()
	{
		return QPluginLoaderPtr.StaticInstances();
	}
	
	public static void[] StaticPlugins()
	{
		return QPluginLoaderPtr.StaticPlugins();
	}
	...
	public void SetLoadHints(int64 loadHints)
	{
		this.handle.SetLoadHints(loadHints);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QPluginLoaderPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QPluginLoaderPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QPluginLoaderPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QPluginLoaderPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QPluginLoaderPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QPluginLoaderPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
