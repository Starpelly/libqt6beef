...
public interface IQAbstractProxyModel
{
	void* NativePtr { get; }
}
public struct QAbstractProxyModelPtr : IQAbstractProxyModel, IDisposable, IQAbstractItemModel
{
	...
	{
		return .(CQt.QAbstractProxyModel_new());
	}
	...
	{
		return CQt.QAbstractProxyModel_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QAbstractProxyModel_SetSourceModel(this.nativePtr, (sourceModel == default || sourceModel.NativePtr == default) ? default : sourceModel.NativePtr);
	}
	...
	{
		CQt.QAbstractProxyModel_MapToSource(this.nativePtr, (proxyIndex == default || proxyIndex.NativePtr == default) ? default : proxyIndex.NativePtr);
	}
	
	public void MapFromSource(IQModelIndex sourceIndex)
	{
		CQt.QAbstractProxyModel_MapFromSource(this.nativePtr, (sourceIndex == default || sourceIndex.NativePtr == default) ? default : sourceIndex.NativePtr);
	}
	...
	{
		CQt.QAbstractProxyModel_HeaderData(this.nativePtr, section, (int64)orientation, role);
	}
...
{
	public QAbstractProxyModelPtr handle;
	
	public static implicit operator QAbstractProxyModelPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QAbstractProxyModelPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QAbstractProxyModelPtr.Tr(s);
	}
	...
	public void CreateSourceIndex(int32 row, int32 col, void* internalPtr)
	{
		this.handle.CreateSourceIndex(row, col, internalPtr);
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QAbstractProxyModelPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QAbstractProxyModelPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QAbstractProxyModelPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QAbstractProxyModelPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QAbstractProxyModelPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QAbstractProxyModelPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
