...
public class QAbstractProxyModel : IQAbstractProxyModel, IQAbstractItemModel
{
	...
	{
		CQt.QAbstractProxyModel_SetSourceModel(this.nativePtr, (sourceModel == null) ? null : (void*)sourceModel.NativePtr);
	}
	...
	{
		CQt.QAbstractProxyModel_MapToSource(this.nativePtr, (proxyIndex == default) ? default : (void*)proxyIndex.NativePtr);
	}
	
	public virtual void MapFromSource(IQModelIndex sourceIndex)
	{
		CQt.QAbstractProxyModel_MapFromSource(this.nativePtr, (sourceIndex == default) ? default : (void*)sourceIndex.NativePtr);
	}
