...
public class QFrame
{
	...
	{
		this.nativePtr = CQt.QFrame_new(parent);
	}
	...
	{
		return CQt.QFrame_Event(this.nativePtr, e);
	}
	
	public virtual void PaintEvent(void* param1)
	{
		CQt.QFrame_PaintEvent(this.nativePtr, param1);
	}
	
	public virtual void ChangeEvent(void* param1)
	{
		CQt.QFrame_ChangeEvent(this.nativePtr, param1);
	}
	
	public void DrawFrame(void* param1)
	{
		CQt.QFrame_DrawFrame(this.nativePtr, param1);
	}
	
	public virtual void InitStyleOption(void* option)
	{
		CQt.QFrame_InitStyleOption(this.nativePtr, option);
	}
