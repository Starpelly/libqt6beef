...
public class QFrame : IQFrame, IQWidget
{
	...
	{
		this.nativePtr = CQt.QFrame_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QFrame_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QFrame_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent param1)
	{
		CQt.QFrame_PaintEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void ChangeEvent(IQEvent param1)
	{
		CQt.QFrame_ChangeEvent(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public void DrawFrame(IQPainter param1)
	{
		CQt.QFrame_DrawFrame(this.nativePtr, (param1 == null) ? null : (void*)param1.NativePtr);
	}
	
	public virtual void InitStyleOption(IQStyleOptionFrame option)
	{
		CQt.QFrame_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
