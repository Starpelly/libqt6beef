...
public interface IQFrame
{
	void* NativePtr { get; }
}
public struct QFramePtr : IQFrame, IDisposable, IQWidget
{
	...
	{
		return .(CQt.QFrame_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QFrame_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QFrame_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QFrame_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QFrame_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QFrame_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QFrame_PaintEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QFrame_ChangeEvent(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void DrawFrame(IQPainter param1)
	{
		CQt.QFrame_DrawFrame(this.nativePtr, (param1 == default || param1.NativePtr == default) ? default : param1.NativePtr);
	}
	
	public void InitStyleOption(IQStyleOptionFrame option)
	{
		CQt.QFrame_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
...
public class QFrame
{
	public QFramePtr handle;
	
	public static implicit operator QFramePtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QFramePtr.New(parent);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QFramePtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QFramePtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QFramePtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QFramePtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QFramePtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QFramePtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QFramePtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QFramePtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QFramePtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QFramePtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QFramePtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QFramePtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QFramePtr.DevicePixelRatioFScale();
	}
...
{
	[LinkName("QFrame_new")]
	public static extern void* QFrame_new(void* parent);
	[LinkName("QFrame_new2")]
	public static extern void* QFrame_new2();
	[LinkName("QFrame_new3")]
	public static extern void* QFrame_new3(void* parent, int64 f);
	[LinkName("QFrame_MetaObject")]
	public static extern void* QFrame_MetaObject(void* c_this);
	...
	public static extern void QFrame_SizeHint(void* c_this);
	...
	public static extern void QFrame_FrameRect(void* c_this);
	[LinkName("QFrame_SetFrameRect")]
	public static extern void QFrame_SetFrameRect(void* c_this, void* frameRect);
	[LinkName("QFrame_Event")]
	public static extern bool QFrame_Event(void* c_this, void* e);
	[LinkName("QFrame_PaintEvent")]
	public static extern void QFrame_PaintEvent(void* c_this, void* param1);
	[LinkName("QFrame_ChangeEvent")]
	public static extern void QFrame_ChangeEvent(void* c_this, void* param1);
	[LinkName("QFrame_DrawFrame")]
	public static extern void QFrame_DrawFrame(void* c_this, void* param1);
	[LinkName("QFrame_InitStyleOption")]
	public static extern void QFrame_InitStyleOption(void* c_this, void* option);
	[LinkName("QFrame_Tr2")]
	...
	public static extern void QFrame_Delete(void* self);
}