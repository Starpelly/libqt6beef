...
public class QTransposeProxyModel : IQTransposeProxyModel, IQAbstractProxyModel
{
	...
	{
		CQt.QTransposeProxyModel_SetSourceModel(this.nativePtr, (newSourceModel == null) ? null : (void*)newSourceModel.NativePtr);
	}
	
	public virtual int32 RowCount(IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_RowCount(this.nativePtr, (parent == default) ? default : (void*)parent.NativePtr);
	}
	
	public virtual int32 ColumnCount(IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_ColumnCount(this.nativePtr, (parent == default) ? default : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QTransposeProxyModel_SetHeaderData(this.nativePtr, section, orientation, (value == default) ? default : (void*)value.NativePtr, role);
	}
	
	public virtual bool SetItemData(IQModelIndex index, void* roles)
	{
		return CQt.QTransposeProxyModel_SetItemData(this.nativePtr, (index == default) ? default : (void*)index.NativePtr, roles);
	}
	
	public virtual void Span(IQModelIndex index)
	{
		CQt.QTransposeProxyModel_Span(this.nativePtr, (index == default) ? default : (void*)index.NativePtr);
	}
	
	public virtual void* ItemData(IQModelIndex index)
	{
		return CQt.QTransposeProxyModel_ItemData(this.nativePtr, (index == default) ? default : (void*)index.NativePtr);
	}
	
	public virtual void MapFromSource(IQModelIndex sourceIndex)
	{
		CQt.QTransposeProxyModel_MapFromSource(this.nativePtr, (sourceIndex == default) ? default : (void*)sourceIndex.NativePtr);
	}
	
	public virtual void MapToSource(IQModelIndex proxyIndex)
	{
		CQt.QTransposeProxyModel_MapToSource(this.nativePtr, (proxyIndex == default) ? default : (void*)proxyIndex.NativePtr);
	}
	
	public virtual void Parent(IQModelIndex index)
	{
		CQt.QTransposeProxyModel_Parent(this.nativePtr, (index == default) ? default : (void*)index.NativePtr);
	}
	
	public virtual void Index(int32 row, int32 column, IQModelIndex parent)
	{
		CQt.QTransposeProxyModel_Index(this.nativePtr, row, column, (parent == default) ? default : (void*)parent.NativePtr);
	}
	
	public virtual bool InsertRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_InsertRows(this.nativePtr, row, count, (parent == default) ? default : (void*)parent.NativePtr);
	}
	
	public virtual bool RemoveRows(int32 row, int32 count, IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_RemoveRows(this.nativePtr, row, count, (parent == default) ? default : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QTransposeProxyModel_MoveRows(this.nativePtr, (sourceParent == default) ? default : (void*)sourceParent.NativePtr, sourceRow, count, (destinationParent == default) ? default : (void*)destinationParent.NativePtr, destinationChild);
	}
	
	public virtual bool InsertColumns(int32 column, int32 count, IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_InsertColumns(this.nativePtr, column, count, (parent == default) ? default : (void*)parent.NativePtr);
	}
	
	public virtual bool RemoveColumns(int32 column, int32 count, IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_RemoveColumns(this.nativePtr, column, count, (parent == default) ? default : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QTransposeProxyModel_MoveColumns(this.nativePtr, (sourceParent == default) ? default : (void*)sourceParent.NativePtr, sourceColumn, count, (destinationParent == default) ? default : (void*)destinationParent.NativePtr, destinationChild);
	}
	...
	{
		CQt.QAbstractProxyModel_MapSelectionToSource(this.nativePtr, (selection == default) ? default : (void*)selection.NativePtr);
	}
	
	public virtual void MapSelectionFromSource(IQItemSelection selection)
	{
		CQt.QAbstractProxyModel_MapSelectionFromSource(this.nativePtr, (selection == default) ? default : (void*)selection.NativePtr);
	}
	...
	{
		CQt.QAbstractProxyModel_Sibling(this.nativePtr, row, column, (idx == default) ? default : (void*)idx.NativePtr);
	}
	...
	{
		return CQt.QAbstractProxyModel_DropMimeData(this.nativePtr, (data == null) ? null : (void*)data.NativePtr, action, row, column, (parent == default) ? default : (void*)parent.NativePtr);
	}
