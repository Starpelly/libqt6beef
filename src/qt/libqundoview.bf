...
public interface IQUndoView
{
	void* NativePtr { get; }
}
public struct QUndoViewPtr : IQUndoView, IDisposable, IQListView
{
	...
	{
		return .(CQt.QUndoView_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	...
	{
		return CQt.QUndoView_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QUndoView_SetEmptyLabel(this.nativePtr, libqt_string(label));
	}
	...
	{
		CQt.QUndoView_SetCleanIcon(this.nativePtr, (icon == default || icon.NativePtr == default) ? default : icon.NativePtr);
	}
	...
	{
		CQt.QUndoView_SetStack(this.nativePtr, (stack == default || stack.NativePtr == default) ? default : stack.NativePtr);
	}
	
	public void SetGroup(IQUndoGroup group)
	{
		CQt.QUndoView_SetGroup(this.nativePtr, (group == default || group.NativePtr == default) ? default : group.NativePtr);
	}
...
{
	public QUndoViewPtr handle;
	
	public static implicit operator QUndoViewPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QUndoViewPtr.New(parent);
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QUndoViewPtr.Tr(s);
	}
	
	public void* Stack()
	{
		return this.handle.Stack();
	}
	...
	public void SetEmptyLabel(String label)
	{
		this.handle.SetEmptyLabel(label);
	}
	
	public libqt_string EmptyLabel()
	{
		return this.handle.EmptyLabel();
	}
	
	public void SetCleanIcon(IQIcon icon)
	{
		this.handle.SetCleanIcon(icon);
	}
	
	public void CleanIcon()
	{
		this.handle.CleanIcon();
	}
	
	public void SetStack(IQUndoStack stack)
	{
		this.handle.SetStack(stack);
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QUndoViewPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QUndoViewPtr.Tr3(s, c, n);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QUndoViewPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QUndoViewPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QUndoViewPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QUndoViewPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QUndoViewPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QUndoViewPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QUndoViewPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QUndoViewPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QUndoViewPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QUndoViewPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QUndoViewPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QUndoViewPtr.DevicePixelRatioFScale();
	}
