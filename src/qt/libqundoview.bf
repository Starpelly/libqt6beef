...
public class QUndoView : IQUndoView, IQListView
{
	...
	{
		this.nativePtr = CQt.QUndoView_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		CQt.QUndoView_SetCleanIcon(this.nativePtr, (icon == default) ? default : (void*)icon.NativePtr);
	}
	...
	{
		CQt.QUndoView_SetStack(this.nativePtr, (stack == null) ? null : (void*)stack.NativePtr);
	}
	
	public void SetGroup(IQUndoGroup group)
	{
		CQt.QUndoView_SetGroup(this.nativePtr, (group == null) ? null : (void*)group.NativePtr);
	}
