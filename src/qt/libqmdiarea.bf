...
public class QMdiArea
{
	...
	{
		this.nativePtr = CQt.QMdiArea_new(parent);
	}
	...
	public void* AddSubWindow(void* widget)
	{
		return CQt.QMdiArea_AddSubWindow(this.nativePtr, widget);
	}
	
	public void RemoveSubWindow(void* widget)
	{
		CQt.QMdiArea_RemoveSubWindow(this.nativePtr, widget);
	}
	...
	public void SetBackground(void* background)
	{
		CQt.QMdiArea_SetBackground(this.nativePtr, background);
	}
	...
	public void SetActiveSubWindow(void* window)
	{
		CQt.QMdiArea_SetActiveSubWindow(this.nativePtr, window);
	}
	...
	{
		CQt.QMdiArea_SetupViewport(this.nativePtr, viewport);
	}
	
	public virtual bool Event(void* event)
	{
		return CQt.QMdiArea_Event(this.nativePtr, event);
	}
	
	public virtual bool EventFilter(void* object, void* event)
	{
		return CQt.QMdiArea_EventFilter(this.nativePtr, object, event);
	}
	
	public virtual void PaintEvent(void* paintEvent)
	{
		CQt.QMdiArea_PaintEvent(this.nativePtr, paintEvent);
	}
	
	public virtual void ChildEvent(void* childEvent)
	{
		CQt.QMdiArea_ChildEvent(this.nativePtr, childEvent);
	}
	
	public virtual void ResizeEvent(void* resizeEvent)
	{
		CQt.QMdiArea_ResizeEvent(this.nativePtr, resizeEvent);
	}
	
	public virtual void TimerEvent(void* timerEvent)
	{
		CQt.QMdiArea_TimerEvent(this.nativePtr, timerEvent);
	}
	
	public virtual void ShowEvent(void* showEvent)
	{
		CQt.QMdiArea_ShowEvent(this.nativePtr, showEvent);
	}
	
	public virtual bool ViewportEvent(void* event)
	{
		return CQt.QMdiArea_ViewportEvent(this.nativePtr, event);
	}
	...
	public void* AddSubWindow2(void* widget, int64 flags)
	{
		return CQt.QMdiArea_AddSubWindow2(this.nativePtr, widget, flags);
	}
