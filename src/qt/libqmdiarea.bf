...
public class QMdiArea : IQMdiArea, IQAbstractScrollArea
{
	...
	{
		this.nativePtr = CQt.QMdiArea_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QMdiArea_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QMdiArea_AddSubWindow(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	
	public void RemoveSubWindow(IQWidget widget)
	{
		CQt.QMdiArea_RemoveSubWindow(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr);
	}
	...
	{
		CQt.QMdiArea_SetBackground(this.nativePtr, (background == default) ? default : (void*)background.NativePtr);
	}
	...
	{
		CQt.QMdiArea_SetActivationOrder(this.nativePtr, order);
	}
	
	public void SetOption(int64 option)
	{
		CQt.QMdiArea_SetOption(this.nativePtr, option);
	}
	
	public bool TestOption(int64 opton)
	{
		return CQt.QMdiArea_TestOption(this.nativePtr, opton);
	}
	
	public void SetViewMode(int64 mode)
	{
		CQt.QMdiArea_SetViewMode(this.nativePtr, mode);
	}
	...
	{
		CQt.QMdiArea_SetTabShape(this.nativePtr, shape);
	}
	...
	{
		CQt.QMdiArea_SetTabPosition(this.nativePtr, position);
	}
	...
	{
		CQt.QMdiArea_SetActiveSubWindow(this.nativePtr, (window == null) ? null : (void*)window.NativePtr);
	}
	...
	{
		CQt.QMdiArea_SetupViewport(this.nativePtr, (viewport == null) ? null : (void*)viewport.NativePtr);
	}
	
	public virtual bool Event(IQEvent event)
	{
		return CQt.QMdiArea_Event(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QMdiArea_EventFilter(this.nativePtr, (object == null) ? null : (void*)object.NativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent paintEvent)
	{
		CQt.QMdiArea_PaintEvent(this.nativePtr, (paintEvent == null) ? null : (void*)paintEvent.NativePtr);
	}
	
	public virtual void ChildEvent(IQChildEvent childEvent)
	{
		CQt.QMdiArea_ChildEvent(this.nativePtr, (childEvent == null) ? null : (void*)childEvent.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent resizeEvent)
	{
		CQt.QMdiArea_ResizeEvent(this.nativePtr, (resizeEvent == null) ? null : (void*)resizeEvent.NativePtr);
	}
	
	public virtual void TimerEvent(IQTimerEvent timerEvent)
	{
		CQt.QMdiArea_TimerEvent(this.nativePtr, (timerEvent == null) ? null : (void*)timerEvent.NativePtr);
	}
	
	public virtual void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QMdiArea_ShowEvent(this.nativePtr, (showEvent == null) ? null : (void*)showEvent.NativePtr);
	}
	
	public virtual bool ViewportEvent(IQEvent event)
	{
		return CQt.QMdiArea_ViewportEvent(this.nativePtr, (event == null) ? null : (void*)event.NativePtr);
	}
	...
	{
		return CQt.QMdiArea_SubWindowList1(this.nativePtr, order);
	}
	
	public void* AddSubWindow2(IQWidget widget, int64 flags)
	{
		return CQt.QMdiArea_AddSubWindow2(this.nativePtr, (widget == null) ? null : (void*)widget.NativePtr, flags);
	}
	
	public void SetOption2(int64 option, bool on)
	{
		CQt.QMdiArea_SetOption2(this.nativePtr, option, on);
	}
