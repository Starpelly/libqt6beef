...
public interface IQMdiArea
{
	void* NativePtr { get; }
}
public struct QMdiAreaPtr : IQMdiArea, IDisposable, IQAbstractScrollArea
{
	...
	{
		return .(CQt.QMdiArea_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QMdiArea_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QMdiArea_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QMdiArea_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QMdiArea_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		CQt.QMdiArea_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QMdiArea_MinimumSizeHint(this.nativePtr);
	}
	
	public void* CurrentSubWindow()
	{
		return CQt.QMdiArea_CurrentSubWindow(this.nativePtr);
	}
	
	public void* ActiveSubWindow()
	{
		return CQt.QMdiArea_ActiveSubWindow(this.nativePtr);
	}
	
	public void*[] SubWindowList()
	{
		return CQt.QMdiArea_SubWindowList(this.nativePtr);
	}
	
	public void* AddSubWindow(IQWidget widget)
	{
		return CQt.QMdiArea_AddSubWindow(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void RemoveSubWindow(IQWidget widget)
	{
		CQt.QMdiArea_RemoveSubWindow(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr);
	}
	
	public void Background()
	{
		CQt.QMdiArea_Background(this.nativePtr);
	}
	
	public void SetBackground(IQBrush background)
	{
		CQt.QMdiArea_SetBackground(this.nativePtr, (background == default || background.NativePtr == default) ? default : background.NativePtr);
	}
	
	public int64 ActivationOrder()
	{
		return CQt.QMdiArea_ActivationOrder(this.nativePtr);
	}
	
	public void SetActivationOrder(int64 order)
	{
		CQt.QMdiArea_SetActivationOrder(this.nativePtr, (int64)order);
	}
	
	public void SetOption(int64 option)
	{
		CQt.QMdiArea_SetOption(this.nativePtr, (int64)option);
	}
	
	public bool TestOption(int64 opton)
	{
		return CQt.QMdiArea_TestOption(this.nativePtr, (int64)opton);
	}
	
	public void SetViewMode(int64 mode)
	{
		CQt.QMdiArea_SetViewMode(this.nativePtr, (int64)mode);
	}
	
	public int64 ViewMode()
	{
		return CQt.QMdiArea_ViewMode(this.nativePtr);
	}
	
	public bool DocumentMode()
	{
		return CQt.QMdiArea_DocumentMode(this.nativePtr);
	}
	
	public void SetDocumentMode(bool enabled)
	{
		CQt.QMdiArea_SetDocumentMode(this.nativePtr, enabled);
	}
	
	public void SetTabsClosable(bool closable)
	{
		CQt.QMdiArea_SetTabsClosable(this.nativePtr, closable);
	}
	
	public bool TabsClosable()
	{
		return CQt.QMdiArea_TabsClosable(this.nativePtr);
	}
	
	public void SetTabsMovable(bool movable)
	{
		CQt.QMdiArea_SetTabsMovable(this.nativePtr, movable);
	}
	
	public bool TabsMovable()
	{
		return CQt.QMdiArea_TabsMovable(this.nativePtr);
	}
	
	public void SetTabShape(int64 shape)
	{
		CQt.QMdiArea_SetTabShape(this.nativePtr, (int64)shape);
	}
	
	public int64 TabShape()
	{
		return CQt.QMdiArea_TabShape(this.nativePtr);
	}
	
	public void SetTabPosition(int64 position)
	{
		CQt.QMdiArea_SetTabPosition(this.nativePtr, (int64)position);
	}
	
	public int64 TabPosition()
	{
		return CQt.QMdiArea_TabPosition(this.nativePtr);
	}
	
	public void SetActiveSubWindow(IQMdiSubWindow window)
	{
		CQt.QMdiArea_SetActiveSubWindow(this.nativePtr, (window == default || window.NativePtr == default) ? default : window.NativePtr);
	}
	
	public void TileSubWindows()
	{
		CQt.QMdiArea_TileSubWindows(this.nativePtr);
	}
	
	public void CascadeSubWindows()
	{
		CQt.QMdiArea_CascadeSubWindows(this.nativePtr);
	}
	
	public void CloseActiveSubWindow()
	{
		CQt.QMdiArea_CloseActiveSubWindow(this.nativePtr);
	}
	
	public void CloseAllSubWindows()
	{
		CQt.QMdiArea_CloseAllSubWindows(this.nativePtr);
	}
	
	public void ActivateNextSubWindow()
	{
		CQt.QMdiArea_ActivateNextSubWindow(this.nativePtr);
	}
	
	public void ActivatePreviousSubWindow()
	{
		CQt.QMdiArea_ActivatePreviousSubWindow(this.nativePtr);
	}
	
	public void SetupViewport(IQWidget viewport)
	{
		CQt.QMdiArea_SetupViewport(this.nativePtr, (viewport == default || viewport.NativePtr == default) ? default : viewport.NativePtr);
	}
	
	public bool Event(IQEvent event)
	{
		return CQt.QMdiArea_Event(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QMdiArea_EventFilter(this.nativePtr, (object == default || object.NativePtr == default) ? default : object.NativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent paintEvent)
	{
		CQt.QMdiArea_PaintEvent(this.nativePtr, (paintEvent == default || paintEvent.NativePtr == default) ? default : paintEvent.NativePtr);
	}
	
	public void ChildEvent(IQChildEvent childEvent)
	{
		CQt.QMdiArea_ChildEvent(this.nativePtr, (childEvent == default || childEvent.NativePtr == default) ? default : childEvent.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent resizeEvent)
	{
		CQt.QMdiArea_ResizeEvent(this.nativePtr, (resizeEvent == default || resizeEvent.NativePtr == default) ? default : resizeEvent.NativePtr);
	}
	
	public void TimerEvent(IQTimerEvent timerEvent)
	{
		CQt.QMdiArea_TimerEvent(this.nativePtr, (timerEvent == default || timerEvent.NativePtr == default) ? default : timerEvent.NativePtr);
	}
	
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QMdiArea_ShowEvent(this.nativePtr, (showEvent == default || showEvent.NativePtr == default) ? default : showEvent.NativePtr);
	}
	
	public bool ViewportEvent(IQEvent event)
	{
		return CQt.QMdiArea_ViewportEvent(this.nativePtr, (event == default || event.NativePtr == default) ? default : event.NativePtr);
	}
	
	public void ScrollContentsBy(int32 dx, int32 dy)
	{
		CQt.QMdiArea_ScrollContentsBy(this.nativePtr, dx, dy);
	}
	...
	public void*[] SubWindowList1(int64 order)
	{
		return CQt.QMdiArea_SubWindowList1(this.nativePtr, (int64)order);
	}
	
	public void* AddSubWindow2(IQWidget widget, int64 flags)
	{
		return CQt.QMdiArea_AddSubWindow2(this.nativePtr, (widget == default || widget.NativePtr == default) ? default : widget.NativePtr, flags);
	}
	
	public void SetOption2(int64 option, bool on)
	{
		CQt.QMdiArea_SetOption2(this.nativePtr, (int64)option, on);
	}
...
{
	public QMdiAreaPtr handle;
	
	public static implicit operator QMdiAreaPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QMdiAreaPtr.New(parent);
	}
	...
	public void* CurrentSubWindow()
	{
		return this.handle.CurrentSubWindow();
	}
	
	public void* ActiveSubWindow()
	{
		return this.handle.ActiveSubWindow();
	}
	
	public void*[] SubWindowList()
	{
		return this.handle.SubWindowList();
	}
	
	public void* AddSubWindow(IQWidget widget)
	{
		return this.handle.AddSubWindow(widget);
	}
	
	public void RemoveSubWindow(IQWidget widget)
	{
		this.handle.RemoveSubWindow(widget);
	}
	...
	public void SetBackground(IQBrush background)
	{
		this.handle.SetBackground(background);
	}
	
	public int64 ActivationOrder()
	{
		return this.handle.ActivationOrder();
	}
	
	public void SetActivationOrder(int64 order)
	{
		this.handle.SetActivationOrder(order);
	}
	...
	public bool TestOption(int64 opton)
	{
		return this.handle.TestOption(opton);
	}
	...
	public void SetTabsClosable(bool closable)
	{
		this.handle.SetTabsClosable(closable);
	}
	...
	public void SetTabsMovable(bool movable)
	{
		this.handle.SetTabsMovable(movable);
	}
	
	public bool TabsMovable()
	{
		return this.handle.TabsMovable();
	}
	
	public void SetTabShape(int64 shape)
	{
		this.handle.SetTabShape(shape);
	}
	...
	public void SetActiveSubWindow(IQMdiSubWindow window)
	{
		this.handle.SetActiveSubWindow(window);
	}
	
	public void TileSubWindows()
	{
		this.handle.TileSubWindows();
	}
	
	public void CascadeSubWindows()
	{
		this.handle.CascadeSubWindows();
	}
	
	public void CloseActiveSubWindow()
	{
		this.handle.CloseActiveSubWindow();
	}
	
	public void CloseAllSubWindows()
	{
		this.handle.CloseAllSubWindows();
	}
	
	public void ActivateNextSubWindow()
	{
		this.handle.ActivateNextSubWindow();
	}
	
	public void ActivatePreviousSubWindow()
	{
		this.handle.ActivatePreviousSubWindow();
	}
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QMdiAreaPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QMdiAreaPtr.Tr3(s, c, n);
	}
	
	public void*[] SubWindowList1(int64 order)
	{
		return this.handle.SubWindowList1(order);
	}
	
	public void* AddSubWindow2(IQWidget widget, int64 flags)
	{
		return this.handle.AddSubWindow2(widget, flags);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QMdiAreaPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QMdiAreaPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QMdiAreaPtr.KeyboardGrabber();
	}
	...
	public static void* Find(uint64 param1)
	{
		return QMdiAreaPtr.Find(param1);
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QMdiAreaPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QMdiAreaPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QMdiAreaPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QMdiAreaPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QMdiAreaPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QMdiAreaPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QMdiAreaPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QMdiAreaPtr.DevicePixelRatioFScale();
	}
...
extension CQt
{
	...
	public static extern void* QMdiArea_new(void* parent);
	[LinkName("QMdiArea_new2")]
	public static extern void* QMdiArea_new2();
	[LinkName("QMdiArea_MetaObject")]
	public static extern void* QMdiArea_MetaObject(void* c_this);
	...
	public static extern void QMdiArea_SizeHint(void* c_this);
	[LinkName("QMdiArea_MinimumSizeHint")]
	public static extern void QMdiArea_MinimumSizeHint(void* c_this);
	[LinkName("QMdiArea_CurrentSubWindow")]
	public static extern void* QMdiArea_CurrentSubWindow(void* c_this);
	[LinkName("QMdiArea_ActiveSubWindow")]
	public static extern void* QMdiArea_ActiveSubWindow(void* c_this);
	[LinkName("QMdiArea_SubWindowList")]
	public static extern void*[] QMdiArea_SubWindowList(void* c_this);
	[LinkName("QMdiArea_AddSubWindow")]
	public static extern void* QMdiArea_AddSubWindow(void* c_this, void* widget);
	[LinkName("QMdiArea_RemoveSubWindow")]
	public static extern void QMdiArea_RemoveSubWindow(void* c_this, void* widget);
	[LinkName("QMdiArea_Background")]
	public static extern void QMdiArea_Background(void* c_this);
	[LinkName("QMdiArea_SetBackground")]
	public static extern void QMdiArea_SetBackground(void* c_this, void* background);
	...
	public static extern void QMdiArea_Connect_SubWindowActivated(void* c_this, c_intptr slot);
	[LinkName("QMdiArea_SetActiveSubWindow")]
	public static extern void QMdiArea_SetActiveSubWindow(void* c_this, void* window);
	...
	public static extern void QMdiArea_SetupViewport(void* c_this, void* viewport);
	[LinkName("QMdiArea_Event")]
	public static extern bool QMdiArea_Event(void* c_this, void* event);
	[LinkName("QMdiArea_EventFilter")]
	public static extern bool QMdiArea_EventFilter(void* c_this, void* object, void* event);
	[LinkName("QMdiArea_PaintEvent")]
	public static extern void QMdiArea_PaintEvent(void* c_this, void* paintEvent);
	[LinkName("QMdiArea_ChildEvent")]
	public static extern void QMdiArea_ChildEvent(void* c_this, void* childEvent);
	[LinkName("QMdiArea_ResizeEvent")]
	public static extern void QMdiArea_ResizeEvent(void* c_this, void* resizeEvent);
	[LinkName("QMdiArea_TimerEvent")]
	public static extern void QMdiArea_TimerEvent(void* c_this, void* timerEvent);
	[LinkName("QMdiArea_ShowEvent")]
	public static extern void QMdiArea_ShowEvent(void* c_this, void* showEvent);
	[LinkName("QMdiArea_ViewportEvent")]
	public static extern bool QMdiArea_ViewportEvent(void* c_this, void* event);
	...
	public static extern void*[] QMdiArea_SubWindowList1(void* c_this, int64 order);
	[LinkName("QMdiArea_AddSubWindow2")]
	public static extern void* QMdiArea_AddSubWindow2(void* c_this, void* widget, int64 flags);
	...
	public static extern void QMdiArea_Delete(void* self);
}