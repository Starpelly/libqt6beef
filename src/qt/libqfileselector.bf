...
public interface IQFileSelector
{
	void* NativePtr { get; }
}
public struct QFileSelectorPtr : IQFileSelector, IDisposable, IQObject
{
	...
	{
		return CQt.QFileSelector_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	public libqt_string Select(String filePath)
	{
		return CQt.QFileSelector_Select(this.nativePtr, libqt_string(filePath));
	}
	
	public void SelectWithFilePath(IQUrl filePath)
	{
		CQt.QFileSelector_SelectWithFilePath(this.nativePtr, (filePath == default || filePath.NativePtr == default) ? default : filePath.NativePtr);
	}
	...
	public void SetExtraSelectors(String[] list)
	{
		CQt.QFileSelector_SetExtraSelectors(this.nativePtr, null);
	}
...
{
	public QFileSelectorPtr handle;
	
	public static implicit operator QFileSelectorPtr(Self self)
	{
		return self.handle;
	}
	...
	public this()
	{
		this.handle = QFileSelectorPtr.New();
	}
	...
	public static libqt_string Tr(char8* s)
	{
		return QFileSelectorPtr.Tr(s);
	}
	
	public libqt_string Select(String filePath)
	{
		return this.handle.Select(filePath);
	}
	
	public void SelectWithFilePath(IQUrl filePath)
	{
		this.handle.SelectWithFilePath(filePath);
	}
	
	public libqt_string[] ExtraSelectors()
	{
		return this.handle.ExtraSelectors();
	}
	
	public void SetExtraSelectors(String[] list)
	{
		this.handle.SetExtraSelectors(null);
	}
	
	public libqt_string[] AllSelectors()
	{
		return this.handle.AllSelectors();
	}
	
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QFileSelectorPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QFileSelectorPtr.Tr3(s, c, n);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QFileSelectorPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QFileSelectorPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QFileSelectorPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QFileSelectorPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
