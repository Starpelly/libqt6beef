...
public interface IQGenericPlugin
{
	void* NativePtr { get; }
}
public class QGenericPlugin : IQGenericPlugin, IQObject
{
	...
	public this()
	{
		this.nativePtr = CQt.QGenericPlugin_new();
	}
	
	public ~this()
	{
		CQt.QGenericPlugin_Delete(this.nativePtr);
	}
	
	public virtual void* MetaObject()
	{
		return CQt.QGenericPlugin_MetaObject(this.nativePtr);
	}
	
	public virtual void* Metacast(char8* param1)
	{
		return CQt.QGenericPlugin_Metacast(this.nativePtr, param1);
	}
	
	public virtual int32 Metacall(int64 param1, int32 param2, void** param3)
	{
		return CQt.QGenericPlugin_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	public virtual void* Create(String name, String spec)
	{
		return CQt.QGenericPlugin_Create(this.nativePtr, libqt_string(name), libqt_string(spec));
	}
...
extension CQt
{
	...
	public static extern void* QGenericPlugin_new2(void* parent);
	[LinkName("QGenericPlugin_MetaObject")]
	public static extern void* QGenericPlugin_MetaObject(void* c_this);
	...
	public static extern void* QGenericPlugin_Create(void* c_this, libqt_string name, libqt_string spec);
	...
	public static extern void QGenericPlugin_Delete(void* self);
}