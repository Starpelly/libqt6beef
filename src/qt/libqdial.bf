...
public class QDial
{
	...
	{
		this.nativePtr = CQt.QDial_new(parent);
	}
	...
	{
		return CQt.QDial_Event(this.nativePtr, e);
	}
	
	public virtual void ResizeEvent(void* re)
	{
		CQt.QDial_ResizeEvent(this.nativePtr, re);
	}
	
	public virtual void PaintEvent(void* pe)
	{
		CQt.QDial_PaintEvent(this.nativePtr, pe);
	}
	
	public virtual void MousePressEvent(void* me)
	{
		CQt.QDial_MousePressEvent(this.nativePtr, me);
	}
	
	public virtual void MouseReleaseEvent(void* me)
	{
		CQt.QDial_MouseReleaseEvent(this.nativePtr, me);
	}
	
	public virtual void MouseMoveEvent(void* me)
	{
		CQt.QDial_MouseMoveEvent(this.nativePtr, me);
	}
	...
	{
		CQt.QDial_InitStyleOption(this.nativePtr, option);
	}
