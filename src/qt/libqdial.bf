...
public class QDial : IQDial, IQAbstractSlider
{
	...
	{
		this.nativePtr = CQt.QDial_new((parent == null) ? null : (void*)parent.NativePtr);
	}
	...
	{
		return CQt.QDial_Metacall(this.nativePtr, param1, param2, param3);
	}
	...
	{
		return CQt.QDial_Event(this.nativePtr, (e == null) ? null : (void*)e.NativePtr);
	}
	
	public virtual void ResizeEvent(IQResizeEvent re)
	{
		CQt.QDial_ResizeEvent(this.nativePtr, (re == null) ? null : (void*)re.NativePtr);
	}
	
	public virtual void PaintEvent(IQPaintEvent pe)
	{
		CQt.QDial_PaintEvent(this.nativePtr, (pe == null) ? null : (void*)pe.NativePtr);
	}
	
	public virtual void MousePressEvent(IQMouseEvent me)
	{
		CQt.QDial_MousePressEvent(this.nativePtr, (me == null) ? null : (void*)me.NativePtr);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseReleaseEvent(this.nativePtr, (me == null) ? null : (void*)me.NativePtr);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseMoveEvent(this.nativePtr, (me == null) ? null : (void*)me.NativePtr);
	}
	
	public virtual void SliderChange(int64 change)
	{
		CQt.QDial_SliderChange(this.nativePtr, change);
	}
	
	public virtual void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QDial_InitStyleOption(this.nativePtr, (option == null) ? null : (void*)option.NativePtr);
	}
