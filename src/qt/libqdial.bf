...
public interface IQDial
{
	void* NativePtr { get; }
}
public struct QDialPtr : IQDial, IDisposable, IQAbstractSlider
{
	...
	{
		return .(CQt.QDial_new((parent == default || parent.NativePtr == default) ? default : parent.NativePtr));
	}
	
	public void Dispose()
	{
		CQt.QDial_Delete(this.nativePtr);
	}
	
	public void* MetaObject()
	{
		return CQt.QDial_MetaObject(this.nativePtr);
	}
	
	public void* Metacast(char8* param1)
	{
		return CQt.QDial_Metacast(this.nativePtr, param1);
	}
	
	public int32 Metacall(int64 param1, int32 param2, void* param3)
	{
		return CQt.QDial_Metacall(this.nativePtr, (int64)param1, param2, param3);
	}
	...
	{
		return CQt.QDial_Wrapping(this.nativePtr);
	}
	
	public int32 NotchSize()
	{
		return CQt.QDial_NotchSize(this.nativePtr);
	}
	
	public void SetNotchTarget(double target)
	{
		CQt.QDial_SetNotchTarget(this.nativePtr, target);
	}
	
	public double NotchTarget()
	{
		return CQt.QDial_NotchTarget(this.nativePtr);
	}
	
	public bool NotchesVisible()
	{
		return CQt.QDial_NotchesVisible(this.nativePtr);
	}
	
	public void SizeHint()
	{
		CQt.QDial_SizeHint(this.nativePtr);
	}
	
	public void MinimumSizeHint()
	{
		CQt.QDial_MinimumSizeHint(this.nativePtr);
	}
	
	public void SetNotchesVisible(bool visible)
	{
		CQt.QDial_SetNotchesVisible(this.nativePtr, visible);
	}
	
	public void SetWrapping(bool on)
	{
		CQt.QDial_SetWrapping(this.nativePtr, on);
	}
	
	public bool Event(IQEvent e)
	{
		return CQt.QDial_Event(this.nativePtr, (e == default || e.NativePtr == default) ? default : e.NativePtr);
	}
	
	public void ResizeEvent(IQResizeEvent re)
	{
		CQt.QDial_ResizeEvent(this.nativePtr, (re == default || re.NativePtr == default) ? default : re.NativePtr);
	}
	
	public void PaintEvent(IQPaintEvent pe)
	{
		CQt.QDial_PaintEvent(this.nativePtr, (pe == default || pe.NativePtr == default) ? default : pe.NativePtr);
	}
	
	public void MousePressEvent(IQMouseEvent me)
	{
		CQt.QDial_MousePressEvent(this.nativePtr, (me == default || me.NativePtr == default) ? default : me.NativePtr);
	}
	
	public void MouseReleaseEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseReleaseEvent(this.nativePtr, (me == default || me.NativePtr == default) ? default : me.NativePtr);
	}
	
	public void MouseMoveEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseMoveEvent(this.nativePtr, (me == default || me.NativePtr == default) ? default : me.NativePtr);
	}
	
	public void SliderChange(int64 change)
	{
		CQt.QDial_SliderChange(this.nativePtr, (int64)change);
	}
	
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QDial_InitStyleOption(this.nativePtr, (option == default || option.NativePtr == default) ? default : option.NativePtr);
	}
	...
	{
		return CQt.QAbstractSlider_Orientation(this.nativePtr);
	}
	
	public void SetMinimum(int32 minimum)
	{
		CQt.QAbstractSlider_SetMinimum(this.nativePtr, minimum);
	}
	
	public int32 Minimum()
	{
		return CQt.QAbstractSlider_Minimum(this.nativePtr);
	}
	
	public void SetMaximum(int32 maximum)
	{
		CQt.QAbstractSlider_SetMaximum(this.nativePtr, maximum);
	}
	
	public int32 Maximum()
	{
		return CQt.QAbstractSlider_Maximum(this.nativePtr);
	}
	
	public void SetSingleStep(int32 singleStep)
	{
		CQt.QAbstractSlider_SetSingleStep(this.nativePtr, singleStep);
	}
	
	public int32 SingleStep()
	{
		return CQt.QAbstractSlider_SingleStep(this.nativePtr);
	}
	
	public void SetPageStep(int32 pageStep)
	{
		CQt.QAbstractSlider_SetPageStep(this.nativePtr, pageStep);
	}
	
	public int32 PageStep()
	{
		return CQt.QAbstractSlider_PageStep(this.nativePtr);
	}
	
	public void SetTracking(bool enable)
	{
		CQt.QAbstractSlider_SetTracking(this.nativePtr, enable);
	}
	
	public bool HasTracking()
	{
		return CQt.QAbstractSlider_HasTracking(this.nativePtr);
	}
	
	public void SetSliderDown(bool sliderDown)
	{
		CQt.QAbstractSlider_SetSliderDown(this.nativePtr, sliderDown);
	}
	
	public bool IsSliderDown()
	{
		return CQt.QAbstractSlider_IsSliderDown(this.nativePtr);
	}
	
	public void SetSliderPosition(int32 sliderPosition)
	{
		CQt.QAbstractSlider_SetSliderPosition(this.nativePtr, sliderPosition);
	}
	
	public int32 SliderPosition()
	{
		return CQt.QAbstractSlider_SliderPosition(this.nativePtr);
	}
	
	public void SetInvertedAppearance(bool invertedAppearance)
	{
		CQt.QAbstractSlider_SetInvertedAppearance(this.nativePtr, invertedAppearance);
	}
	
	public bool InvertedAppearance()
	{
		return CQt.QAbstractSlider_InvertedAppearance(this.nativePtr);
	}
	
	public void SetInvertedControls(bool invertedControls)
	{
		CQt.QAbstractSlider_SetInvertedControls(this.nativePtr, invertedControls);
	}
	
	public bool InvertedControls()
	{
		return CQt.QAbstractSlider_InvertedControls(this.nativePtr);
	}
	
	public int32 Value()
	{
		return CQt.QAbstractSlider_Value(this.nativePtr);
	}
	
	public void TriggerAction(int64 action)
	{
		CQt.QAbstractSlider_TriggerAction(this.nativePtr, (int64)action);
	}
	
	public void SetValue(int32 value)
	{
		CQt.QAbstractSlider_SetValue(this.nativePtr, value);
	}
	
	public void SetOrientation(int64 orientation)
	{
		CQt.QAbstractSlider_SetOrientation(this.nativePtr, (int64)orientation);
	}
	
	public void SetRange(int32 min, int32 max)
	{
		CQt.QAbstractSlider_SetRange(this.nativePtr, min, max);
	}
...
public class QDial
{
	public QDialPtr handle;
	
	public static implicit operator QDialPtr(Self self)
	{
		return self.handle;
	}
	...
	{
		this.handle = QDialPtr.New(parent);
	}
	...
	public int32 NotchSize()
	{
		return this.handle.NotchSize();
	}
	
	public void SetNotchTarget(double target)
	{
		this.handle.SetNotchTarget(target);
	}
	
	public double NotchTarget()
	{
		return this.handle.NotchTarget();
	}
	
	public bool NotchesVisible()
	{
		return this.handle.NotchesVisible();
	}
	...
	public void SetNotchesVisible(bool visible)
	{
		this.handle.SetNotchesVisible(visible);
	}
	
	public void SetWrapping(bool on)
	{
		this.handle.SetWrapping(on);
	}
	...
	public virtual void ResizeEvent(IQResizeEvent re)
	{
		this.handle.ResizeEvent(re);
	}
	
	public virtual void PaintEvent(IQPaintEvent pe)
	{
		this.handle.PaintEvent(pe);
	}
	
	public virtual void MousePressEvent(IQMouseEvent me)
	{
		this.handle.MousePressEvent(me);
	}
	
	public virtual void MouseReleaseEvent(IQMouseEvent me)
	{
		this.handle.MouseReleaseEvent(me);
	}
	
	public virtual void MouseMoveEvent(IQMouseEvent me)
	{
		this.handle.MouseMoveEvent(me);
	}
	
	public virtual void SliderChange(int64 change)
	{
		this.handle.SliderChange(change);
	}
	
	public virtual void InitStyleOption(IQStyleOptionSlider option)
	{
	...
	public static libqt_string Tr2(char8* s, char8* c)
	{
		return QDialPtr.Tr2(s, c);
	}
	
	public static libqt_string Tr3(char8* s, char8* c, int32 n)
	{
		return QDialPtr.Tr3(s, c, n);
	}
	...
	public void SetMinimum(int32 minimum)
	{
		this.handle.SetMinimum(minimum);
	}
	...
	public void SetMaximum(int32 maximum)
	{
		this.handle.SetMaximum(maximum);
	}
	...
	public void SetSingleStep(int32 singleStep)
	{
		this.handle.SetSingleStep(singleStep);
	}
	...
	public void SetPageStep(int32 pageStep)
	{
		this.handle.SetPageStep(pageStep);
	}
	
	public int32 PageStep()
	{
		return this.handle.PageStep();
	}
	
	public void SetTracking(bool enable)
	{
		this.handle.SetTracking(enable);
	}
	
	public bool HasTracking()
	{
		return this.handle.HasTracking();
	}
	
	public void SetSliderDown(bool sliderDown)
	{
		this.handle.SetSliderDown(sliderDown);
	}
	
	public bool IsSliderDown()
	{
		return this.handle.IsSliderDown();
	}
	
	public void SetSliderPosition(int32 sliderPosition)
	{
		this.handle.SetSliderPosition(sliderPosition);
	}
	
	public int32 SliderPosition()
	{
		return this.handle.SliderPosition();
	}
	
	public void SetInvertedAppearance(bool invertedAppearance)
	{
		this.handle.SetInvertedAppearance(invertedAppearance);
	}
	
	public bool InvertedAppearance()
	{
		return this.handle.InvertedAppearance();
	}
	
	public void SetInvertedControls(bool invertedControls)
	{
		this.handle.SetInvertedControls(invertedControls);
	}
	
	public bool InvertedControls()
	{
		return this.handle.InvertedControls();
	}
	...
	public void TriggerAction(int64 action)
	{
		this.handle.TriggerAction(action);
	}
	...
	public static void SetTabOrder(IQWidget param1, IQWidget param2)
	{
		QDialPtr.SetTabOrder(param1, param2);
	}
	...
	public static void* MouseGrabber()
	{
		return QDialPtr.MouseGrabber();
	}
	
	public static void* KeyboardGrabber()
	{
		return QDialPtr.KeyboardGrabber();
	}
	...
	public static void* CreateWindowContainer(IQWindow window)
	{
		return QDialPtr.CreateWindowContainer(window);
	}
	...
	public static void* CreateWindowContainer2(IQWindow window, IQWidget parent)
	{
		return QDialPtr.CreateWindowContainer2(window, parent);
	}
	
	public static void* CreateWindowContainer3(IQWindow window, IQWidget parent, int64 flags)
	{
		return QDialPtr.CreateWindowContainer3(window, parent, flags);
	}
	...
	public static void Connect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method)
	{
		QDialPtr.Connect(sender, signal, receiver, method);
	}
	...
	public static bool Disconnect(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod member)
	{
		return QDialPtr.Disconnect(sender, signal, receiver, member);
	}
	
	public static bool DisconnectWithQMetaObjectConnection(QMetaObject__ConnectionPtr param1)
	{
		return QDialPtr.DisconnectWithQMetaObjectConnection(param1);
	}
	...
	public static void Connect5(IQObject sender, IQMetaMethod signal, IQObject receiver, IQMetaMethod method, int64 typeVal)
	{
		QDialPtr.Connect5(sender, signal, receiver, method, typeVal);
	}
	...
	public static double DevicePixelRatioFScale()
	{
		return QDialPtr.DevicePixelRatioFScale();
	}
...
{
	[LinkName("QDial_new")]
	public static extern void* QDial_new(void* parent);
	[LinkName("QDial_new2")]
	public static extern void* QDial_new2();
	[LinkName("QDial_MetaObject")]
	public static extern void* QDial_MetaObject(void* c_this);
	...
	public static extern void QDial_SizeHint(void* c_this);
	[LinkName("QDial_MinimumSizeHint")]
	public static extern void QDial_MinimumSizeHint(void* c_this);
	...
	public static extern bool QDial_Event(void* c_this, void* e);
	[LinkName("QDial_ResizeEvent")]
	public static extern void QDial_ResizeEvent(void* c_this, void* re);
	[LinkName("QDial_PaintEvent")]
	public static extern void QDial_PaintEvent(void* c_this, void* pe);
	[LinkName("QDial_MousePressEvent")]
	public static extern void QDial_MousePressEvent(void* c_this, void* me);
	[LinkName("QDial_MouseReleaseEvent")]
	public static extern void QDial_MouseReleaseEvent(void* c_this, void* me);
	[LinkName("QDial_MouseMoveEvent")]
	public static extern void QDial_MouseMoveEvent(void* c_this, void* me);
	...
	public static extern void QDial_InitStyleOption(void* c_this, void* option);
	[LinkName("QDial_Tr2")]
	...
	public static extern void QDial_Delete(void* self);
}