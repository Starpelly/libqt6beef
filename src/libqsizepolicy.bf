...
public struct QSizePolicy
{
	...
	public static extern void* QSizePolicy_new(QSizePolicy other);
	[LinkName("QSizePolicy_new2")]
	public static extern void* QSizePolicy_new2(QSizePolicy other);
	...
	public static extern void* QSizePolicy_new5(QSizePolicy param1);
	...
	public static extern bool QSizePolicy_OperatorEqual(void* c_this, QSizePolicy s);
	[LinkName("QSizePolicy_OperatorNotEqual")]
	public static extern bool QSizePolicy_OperatorNotEqual(void* c_this, QSizePolicy s);
	[LinkName("QSizePolicy_ToQVariant")]
	public static extern QVariant QSizePolicy_ToQVariant(void* c_this);
	...
	public static extern QSizePolicy QSizePolicy_Transposed(void* c_this);
}