#pragma once
#ifndef SRC_QTC_LIBQFILEDIALOG_H
#define SRC_QTC_LIBQFILEDIALOG_H
...
QTLIBC_API void QFileDialog_Connect_FileSelected(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_FilesSelected(QFileDialog* self, libqt_list /* of libqt_string */ files);
QTLIBC_API void QFileDialog_Connect_FilesSelected(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_CurrentChanged(QFileDialog* self, libqt_string path);
QTLIBC_API void QFileDialog_Connect_CurrentChanged(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_DirectoryEntered(QFileDialog* self, libqt_string directory);
QTLIBC_API void QFileDialog_Connect_DirectoryEntered(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_UrlSelected(QFileDialog* self, QUrl* url);
QTLIBC_API void QFileDialog_Connect_UrlSelected(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_UrlsSelected(QFileDialog* self, libqt_list /* of QUrl* */ urls);
QTLIBC_API void QFileDialog_Connect_UrlsSelected(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_CurrentUrlChanged(QFileDialog* self, QUrl* url);
QTLIBC_API void QFileDialog_Connect_CurrentUrlChanged(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_DirectoryUrlEntered(QFileDialog* self, QUrl* directory);
QTLIBC_API void QFileDialog_Connect_DirectoryUrlEntered(QFileDialog* self, intptr_t slot);
QTLIBC_API void QFileDialog_FilterSelected(QFileDialog* self, libqt_string filter);
QTLIBC_API void QFileDialog_Connect_FilterSelected(QFileDialog* self, intptr_t slot);
