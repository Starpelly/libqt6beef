#pragma once
#ifndef SRC_QTC_LIBQBUTTONGROUP_H
#define SRC_QTC_LIBQBUTTONGROUP_H
...
QTLIBC_API void QButtonGroup_Connect_ButtonClicked(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_ButtonPressed(QButtonGroup* self, QAbstractButton* param1);
QTLIBC_API void QButtonGroup_Connect_ButtonPressed(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_ButtonReleased(QButtonGroup* self, QAbstractButton* param1);
QTLIBC_API void QButtonGroup_Connect_ButtonReleased(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_ButtonToggled(QButtonGroup* self, QAbstractButton* param1, bool param2);
QTLIBC_API void QButtonGroup_Connect_ButtonToggled(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_IdClicked(QButtonGroup* self, int param1);
QTLIBC_API void QButtonGroup_Connect_IdClicked(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_IdPressed(QButtonGroup* self, int param1);
QTLIBC_API void QButtonGroup_Connect_IdPressed(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_IdReleased(QButtonGroup* self, int param1);
QTLIBC_API void QButtonGroup_Connect_IdReleased(QButtonGroup* self, intptr_t slot);
QTLIBC_API void QButtonGroup_IdToggled(QButtonGroup* self, int param1, bool param2);
QTLIBC_API void QButtonGroup_Connect_IdToggled(QButtonGroup* self, intptr_t slot);
