...
QTLIBC_API void QPlainTextEdit_Connect_TextChanged(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_UndoAvailable(QPlainTextEdit* self, bool b);
QTLIBC_API void QPlainTextEdit_Connect_UndoAvailable(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_RedoAvailable(QPlainTextEdit* self, bool b);
QTLIBC_API void QPlainTextEdit_Connect_RedoAvailable(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_CopyAvailable(QPlainTextEdit* self, bool b);
QTLIBC_API void QPlainTextEdit_Connect_CopyAvailable(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_SelectionChanged(QPlainTextEdit* self);
QTLIBC_API void QPlainTextEdit_Connect_SelectionChanged(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_CursorPositionChanged(QPlainTextEdit* self);
QTLIBC_API void QPlainTextEdit_Connect_CursorPositionChanged(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_UpdateRequest(QPlainTextEdit* self, QRect* rect, int dy);
QTLIBC_API void QPlainTextEdit_Connect_UpdateRequest(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_BlockCountChanged(QPlainTextEdit* self, int newBlockCount);
QTLIBC_API void QPlainTextEdit_Connect_BlockCountChanged(QPlainTextEdit* self, intptr_t slot);
QTLIBC_API void QPlainTextEdit_ModificationChanged(QPlainTextEdit* self, bool param1);
QTLIBC_API void QPlainTextEdit_Connect_ModificationChanged(QPlainTextEdit* self, intptr_t slot);
