#pragma once
#ifndef SRC_QTC_LIBQLINEEDIT_H
#define SRC_QTC_LIBQLINEEDIT_H
...
QTLIBC_API void QLineEdit_Connect_TextChanged(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_TextEdited(QLineEdit* self, libqt_string param1);
QTLIBC_API void QLineEdit_Connect_TextEdited(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_CursorPositionChanged(QLineEdit* self, int param1, int param2);
QTLIBC_API void QLineEdit_Connect_CursorPositionChanged(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_ReturnPressed(QLineEdit* self);
QTLIBC_API void QLineEdit_Connect_ReturnPressed(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_EditingFinished(QLineEdit* self);
QTLIBC_API void QLineEdit_Connect_EditingFinished(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_SelectionChanged(QLineEdit* self);
QTLIBC_API void QLineEdit_Connect_SelectionChanged(QLineEdit* self, intptr_t slot);
QTLIBC_API void QLineEdit_InputRejected(QLineEdit* self);
QTLIBC_API void QLineEdit_Connect_InputRejected(QLineEdit* self, intptr_t slot);
