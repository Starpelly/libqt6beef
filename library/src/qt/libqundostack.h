...
QTLIBC_API void QUndoStack_Connect_IndexChanged(QUndoStack* self, intptr_t slot);
QTLIBC_API void QUndoStack_CleanChanged(QUndoStack* self, bool clean);
QTLIBC_API void QUndoStack_Connect_CleanChanged(QUndoStack* self, intptr_t slot);
QTLIBC_API void QUndoStack_CanUndoChanged(QUndoStack* self, bool canUndo);
QTLIBC_API void QUndoStack_Connect_CanUndoChanged(QUndoStack* self, intptr_t slot);
QTLIBC_API void QUndoStack_CanRedoChanged(QUndoStack* self, bool canRedo);
QTLIBC_API void QUndoStack_Connect_CanRedoChanged(QUndoStack* self, intptr_t slot);
QTLIBC_API void QUndoStack_UndoTextChanged(QUndoStack* self, libqt_string undoText);
QTLIBC_API void QUndoStack_Connect_UndoTextChanged(QUndoStack* self, intptr_t slot);
QTLIBC_API void QUndoStack_RedoTextChanged(QUndoStack* self, libqt_string redoText);
QTLIBC_API void QUndoStack_Connect_RedoTextChanged(QUndoStack* self, intptr_t slot);
