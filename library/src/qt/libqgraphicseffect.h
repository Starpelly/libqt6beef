#pragma once
#ifndef SRC_QTC_LIBQGRAPHICSEFFECT_H
#define SRC_QTC_LIBQGRAPHICSEFFECT_H
...
QTLIBC_API void QGraphicsEffect_Connect_EnabledChanged(QGraphicsEffect* self, intptr_t slot);
...
QTLIBC_API void QGraphicsColorizeEffect_Connect_ColorChanged(QGraphicsColorizeEffect* self, intptr_t slot);
QTLIBC_API void QGraphicsColorizeEffect_StrengthChanged(QGraphicsColorizeEffect* self, double strength);
QTLIBC_API void QGraphicsColorizeEffect_Connect_StrengthChanged(QGraphicsColorizeEffect* self, intptr_t slot);
...
QTLIBC_API void QGraphicsBlurEffect_Connect_BlurRadiusChanged(QGraphicsBlurEffect* self, intptr_t slot);
QTLIBC_API void QGraphicsBlurEffect_BlurHintsChanged(QGraphicsBlurEffect* self, int hints);
QTLIBC_API void QGraphicsBlurEffect_Connect_BlurHintsChanged(QGraphicsBlurEffect* self, intptr_t slot);
...
QTLIBC_API void QGraphicsDropShadowEffect_Connect_OffsetChanged(QGraphicsDropShadowEffect* self, intptr_t slot);
QTLIBC_API void QGraphicsDropShadowEffect_BlurRadiusChanged(QGraphicsDropShadowEffect* self, double blurRadius);
QTLIBC_API void QGraphicsDropShadowEffect_Connect_BlurRadiusChanged(QGraphicsDropShadowEffect* self, intptr_t slot);
QTLIBC_API void QGraphicsDropShadowEffect_ColorChanged(QGraphicsDropShadowEffect* self, QColor* color);
QTLIBC_API void QGraphicsDropShadowEffect_Connect_ColorChanged(QGraphicsDropShadowEffect* self, intptr_t slot);
...
QTLIBC_API void QGraphicsOpacityEffect_Connect_OpacityChanged(QGraphicsOpacityEffect* self, intptr_t slot);
QTLIBC_API void QGraphicsOpacityEffect_OpacityMaskChanged(QGraphicsOpacityEffect* self, QBrush* mask);
QTLIBC_API void QGraphicsOpacityEffect_Connect_OpacityMaskChanged(QGraphicsOpacityEffect* self, intptr_t slot);
