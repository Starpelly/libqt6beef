...
QTLIBC_API void QProcess_Connect_Finished(QProcess* self, intptr_t slot);
QTLIBC_API void QProcess_ErrorOccurred(QProcess* self, int errorVal);
QTLIBC_API void QProcess_Connect_ErrorOccurred(QProcess* self, intptr_t slot);
...
QTLIBC_API void QProcess_Connect_Finished2(QProcess* self, intptr_t slot);
