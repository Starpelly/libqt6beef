#pragma once
#ifndef SRC_QTC_LIBQMAINWINDOW_H
#define SRC_QTC_LIBQMAINWINDOW_H
...
QTLIBC_API void QMainWindow_Connect_IconSizeChanged(QMainWindow* self, intptr_t slot);
QTLIBC_API void QMainWindow_ToolButtonStyleChanged(QMainWindow* self, int toolButtonStyle);
QTLIBC_API void QMainWindow_Connect_ToolButtonStyleChanged(QMainWindow* self, intptr_t slot);
QTLIBC_API void QMainWindow_TabifiedDockWidgetActivated(QMainWindow* self, QDockWidget* dockWidget);
QTLIBC_API void QMainWindow_Connect_TabifiedDockWidgetActivated(QMainWindow* self, intptr_t slot);
