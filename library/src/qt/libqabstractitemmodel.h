...
QTLIBC_API void QAbstractItemModel_Connect_DataChanged(QAbstractItemModel* self, intptr_t slot);
QTLIBC_API void QAbstractItemModel_HeaderDataChanged(QAbstractItemModel* self, int orientation, int first, int last);
QTLIBC_API void QAbstractItemModel_Connect_HeaderDataChanged(QAbstractItemModel* self, intptr_t slot);
QTLIBC_API void QAbstractItemModel_LayoutChanged(QAbstractItemModel* self);
QTLIBC_API void QAbstractItemModel_Connect_LayoutChanged(QAbstractItemModel* self, intptr_t slot);
QTLIBC_API void QAbstractItemModel_LayoutAboutToBeChanged(QAbstractItemModel* self);
QTLIBC_API void QAbstractItemModel_Connect_LayoutAboutToBeChanged(QAbstractItemModel* self, intptr_t slot);
...
QTLIBC_API void QAbstractItemModel_Connect_DataChanged3(QAbstractItemModel* self, intptr_t slot);
QTLIBC_API void QAbstractItemModel_LayoutChanged1(QAbstractItemModel* self, libqt_list /* of QPersistentModelIndex* */ parents);
QTLIBC_API void QAbstractItemModel_Connect_LayoutChanged1(QAbstractItemModel* self, intptr_t slot);
...
QTLIBC_API void QAbstractItemModel_Connect_LayoutChanged2(QAbstractItemModel* self, intptr_t slot);
...
QTLIBC_API void QAbstractItemModel_Connect_LayoutAboutToBeChanged1(QAbstractItemModel* self, intptr_t slot);
...
QTLIBC_API void QAbstractItemModel_Connect_LayoutAboutToBeChanged2(QAbstractItemModel* self, intptr_t slot);
