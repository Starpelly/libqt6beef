#pragma once
#ifndef SRC_QTC_LIBQABSTRACTITEMDELEGATE_H
#define SRC_QTC_LIBQABSTRACTITEMDELEGATE_H
...
QTLIBC_API void QAbstractItemDelegate_Connect_CommitData(QAbstractItemDelegate* self, intptr_t slot);
QTLIBC_API void QAbstractItemDelegate_CloseEditor(QAbstractItemDelegate* self, QWidget* editor);
QTLIBC_API void QAbstractItemDelegate_Connect_CloseEditor(QAbstractItemDelegate* self, intptr_t slot);
QTLIBC_API void QAbstractItemDelegate_SizeHintChanged(QAbstractItemDelegate* self, QModelIndex* param1);
QTLIBC_API void QAbstractItemDelegate_Connect_SizeHintChanged(QAbstractItemDelegate* self, intptr_t slot);
...
QTLIBC_API void QAbstractItemDelegate_Connect_CloseEditor2(QAbstractItemDelegate* self, intptr_t slot);
