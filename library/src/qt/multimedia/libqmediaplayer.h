...
QTLIBC_API void QMediaPlayer_Connect_SourceChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_PlaybackStateChanged(QMediaPlayer* self, int newState);
QTLIBC_API void QMediaPlayer_Connect_PlaybackStateChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_MediaStatusChanged(QMediaPlayer* self, int status);
QTLIBC_API void QMediaPlayer_Connect_MediaStatusChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_DurationChanged(QMediaPlayer* self, long long duration);
QTLIBC_API void QMediaPlayer_Connect_DurationChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_PositionChanged(QMediaPlayer* self, long long position);
QTLIBC_API void QMediaPlayer_Connect_PositionChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_HasAudioChanged(QMediaPlayer* self, bool available);
QTLIBC_API void QMediaPlayer_Connect_HasAudioChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_HasVideoChanged(QMediaPlayer* self, bool videoAvailable);
QTLIBC_API void QMediaPlayer_Connect_HasVideoChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_BufferProgressChanged(QMediaPlayer* self, float progress);
QTLIBC_API void QMediaPlayer_Connect_BufferProgressChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_SeekableChanged(QMediaPlayer* self, bool seekable);
QTLIBC_API void QMediaPlayer_Connect_SeekableChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_PlaybackRateChanged(QMediaPlayer* self, double rate);
QTLIBC_API void QMediaPlayer_Connect_PlaybackRateChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_LoopsChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_LoopsChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_MetaDataChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_MetaDataChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_VideoOutputChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_VideoOutputChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_AudioOutputChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_AudioOutputChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_TracksChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_TracksChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_ActiveTracksChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_ActiveTracksChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_ErrorChanged(QMediaPlayer* self);
QTLIBC_API void QMediaPlayer_Connect_ErrorChanged(QMediaPlayer* self, intptr_t slot);
QTLIBC_API void QMediaPlayer_ErrorOccurred(QMediaPlayer* self, int errorVal, libqt_string errorString);
QTLIBC_API void QMediaPlayer_Connect_ErrorOccurred(QMediaPlayer* self, intptr_t slot);
