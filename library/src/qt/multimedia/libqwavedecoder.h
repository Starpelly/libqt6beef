#pragma once
#ifndef SRC_QT_MULTIMEDIAC_LIBQWAVEDECODER_H
#define SRC_QT_MULTIMEDIAC_LIBQWAVEDECODER_H
...
QTLIBC_API void QWaveDecoder_Connect_FormatKnown(QWaveDecoder* self, intptr_t slot);
QTLIBC_API void QWaveDecoder_ParsingError(QWaveDecoder* self);
QTLIBC_API void QWaveDecoder_Connect_ParsingError(QWaveDecoder* self, intptr_t slot);
