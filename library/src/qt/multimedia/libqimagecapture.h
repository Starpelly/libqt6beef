#pragma once
#ifndef SRC_QT_MULTIMEDIAC_LIBQIMAGECAPTURE_H
#define SRC_QT_MULTIMEDIAC_LIBQIMAGECAPTURE_H
...
QTLIBC_API void QImageCapture_Connect_ErrorChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ErrorOccurred(QImageCapture* self, int id, int errorVal, libqt_string errorString);
QTLIBC_API void QImageCapture_Connect_ErrorOccurred(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ReadyForCaptureChanged(QImageCapture* self, bool ready);
QTLIBC_API void QImageCapture_Connect_ReadyForCaptureChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_MetaDataChanged(QImageCapture* self);
QTLIBC_API void QImageCapture_Connect_MetaDataChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_FileFormatChanged(QImageCapture* self);
QTLIBC_API void QImageCapture_Connect_FileFormatChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_QualityChanged(QImageCapture* self);
QTLIBC_API void QImageCapture_Connect_QualityChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ResolutionChanged(QImageCapture* self);
QTLIBC_API void QImageCapture_Connect_ResolutionChanged(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ImageExposed(QImageCapture* self, int id);
QTLIBC_API void QImageCapture_Connect_ImageExposed(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ImageCaptured(QImageCapture* self, int id, QImage* preview);
QTLIBC_API void QImageCapture_Connect_ImageCaptured(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ImageMetadataAvailable(QImageCapture* self, int id, QMediaMetaData* metaData);
QTLIBC_API void QImageCapture_Connect_ImageMetadataAvailable(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ImageAvailable(QImageCapture* self, int id, QVideoFrame* frame);
QTLIBC_API void QImageCapture_Connect_ImageAvailable(QImageCapture* self, intptr_t slot);
QTLIBC_API void QImageCapture_ImageSaved(QImageCapture* self, int id, libqt_string fileName);
QTLIBC_API void QImageCapture_Connect_ImageSaved(QImageCapture* self, intptr_t slot);
