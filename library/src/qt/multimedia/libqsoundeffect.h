...
QTLIBC_API void QSoundEffect_Connect_SourceChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_LoopCountChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_LoopCountChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_LoopsRemainingChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_LoopsRemainingChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_VolumeChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_VolumeChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_MutedChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_MutedChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_LoadedChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_LoadedChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_PlayingChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_PlayingChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_StatusChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_StatusChanged(QSoundEffect* self, intptr_t slot);
QTLIBC_API void QSoundEffect_AudioDeviceChanged(QSoundEffect* self);
QTLIBC_API void QSoundEffect_Connect_AudioDeviceChanged(QSoundEffect* self, intptr_t slot);
