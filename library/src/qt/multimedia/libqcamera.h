#pragma once
#ifndef SRC_QT_MULTIMEDIAC_LIBQCAMERA_H
#define SRC_QT_MULTIMEDIAC_LIBQCAMERA_H
...
QTLIBC_API void QCamera_Connect_ActiveChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ErrorChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_ErrorChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ErrorOccurred(QCamera* self, int errorVal, libqt_string errorString);
QTLIBC_API void QCamera_Connect_ErrorOccurred(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_CameraDeviceChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_CameraDeviceChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_CameraFormatChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_CameraFormatChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_SupportedFeaturesChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_SupportedFeaturesChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_FocusModeChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_FocusModeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ZoomFactorChanged(QCamera* self, float param1);
QTLIBC_API void QCamera_Connect_ZoomFactorChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_MinimumZoomFactorChanged(QCamera* self, float param1);
QTLIBC_API void QCamera_Connect_MinimumZoomFactorChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_MaximumZoomFactorChanged(QCamera* self, float param1);
QTLIBC_API void QCamera_Connect_MaximumZoomFactorChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_FocusDistanceChanged(QCamera* self, float param1);
QTLIBC_API void QCamera_Connect_FocusDistanceChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_FocusPointChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_FocusPointChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_CustomFocusPointChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_CustomFocusPointChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_FlashReady(QCamera* self, bool param1);
QTLIBC_API void QCamera_Connect_FlashReady(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_FlashModeChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_FlashModeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_TorchModeChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_TorchModeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ExposureTimeChanged(QCamera* self, float speed);
QTLIBC_API void QCamera_Connect_ExposureTimeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ManualExposureTimeChanged(QCamera* self, float speed);
QTLIBC_API void QCamera_Connect_ManualExposureTimeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_IsoSensitivityChanged(QCamera* self, int param1);
QTLIBC_API void QCamera_Connect_IsoSensitivityChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ManualIsoSensitivityChanged(QCamera* self, int param1);
QTLIBC_API void QCamera_Connect_ManualIsoSensitivityChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ExposureCompensationChanged(QCamera* self, float param1);
QTLIBC_API void QCamera_Connect_ExposureCompensationChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ExposureModeChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_ExposureModeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_WhiteBalanceModeChanged(const QCamera* self);
QTLIBC_API void QCamera_Connect_WhiteBalanceModeChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ColorTemperatureChanged(const QCamera* self);
QTLIBC_API void QCamera_Connect_ColorTemperatureChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_BrightnessChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_BrightnessChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_ContrastChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_ContrastChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_SaturationChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_SaturationChanged(QCamera* self, intptr_t slot);
QTLIBC_API void QCamera_HueChanged(QCamera* self);
QTLIBC_API void QCamera_Connect_HueChanged(QCamera* self, intptr_t slot);
