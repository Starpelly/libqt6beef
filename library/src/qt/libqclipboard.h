#pragma once
#ifndef SRC_QTC_LIBQCLIPBOARD_H
#define SRC_QTC_LIBQCLIPBOARD_H
...
QTLIBC_API void QClipboard_Connect_Changed(QClipboard* self, intptr_t slot);
QTLIBC_API void QClipboard_SelectionChanged(QClipboard* self);
QTLIBC_API void QClipboard_Connect_SelectionChanged(QClipboard* self, intptr_t slot);
QTLIBC_API void QClipboard_FindBufferChanged(QClipboard* self);
QTLIBC_API void QClipboard_Connect_FindBufferChanged(QClipboard* self, intptr_t slot);
QTLIBC_API void QClipboard_DataChanged(QClipboard* self);
QTLIBC_API void QClipboard_Connect_DataChanged(QClipboard* self, intptr_t slot);
