#pragma once
#ifndef SRC_QTC_LIBQWINDOW_H
#define SRC_QTC_LIBQWINDOW_H
...
QTLIBC_API void QWindow_Connect_ScreenChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_ModalityChanged(QWindow* self, int modality);
QTLIBC_API void QWindow_Connect_ModalityChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_WindowStateChanged(QWindow* self, int windowState);
QTLIBC_API void QWindow_Connect_WindowStateChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_WindowTitleChanged(QWindow* self, libqt_string title);
QTLIBC_API void QWindow_Connect_WindowTitleChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_XChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_XChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_YChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_YChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_WidthChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_WidthChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_HeightChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_HeightChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_MinimumWidthChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_MinimumWidthChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_MinimumHeightChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_MinimumHeightChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_MaximumWidthChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_MaximumWidthChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_MaximumHeightChanged(QWindow* self, int arg);
QTLIBC_API void QWindow_Connect_MaximumHeightChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_VisibleChanged(QWindow* self, bool arg);
QTLIBC_API void QWindow_Connect_VisibleChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_VisibilityChanged(QWindow* self, int visibility);
QTLIBC_API void QWindow_Connect_VisibilityChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_ActiveChanged(QWindow* self);
QTLIBC_API void QWindow_Connect_ActiveChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_ContentOrientationChanged(QWindow* self, int orientation);
QTLIBC_API void QWindow_Connect_ContentOrientationChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_FocusObjectChanged(QWindow* self, QObject* object);
QTLIBC_API void QWindow_Connect_FocusObjectChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_OpacityChanged(QWindow* self, double opacity);
QTLIBC_API void QWindow_Connect_OpacityChanged(QWindow* self, intptr_t slot);
QTLIBC_API void QWindow_TransientParentChanged(QWindow* self, QWindow* transientParent);
QTLIBC_API void QWindow_Connect_TransientParentChanged(QWindow* self, intptr_t slot);
