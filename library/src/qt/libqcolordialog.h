...
QTLIBC_API void QColorDialog_Connect_CurrentColorChanged(QColorDialog* self, intptr_t slot);
QTLIBC_API void QColorDialog_ColorSelected(QColorDialog* self, QColor* color);
QTLIBC_API void QColorDialog_Connect_ColorSelected(QColorDialog* self, intptr_t slot);
