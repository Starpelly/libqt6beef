...
QTLIBC_API void QSystemTrayIcon_Connect_Activated(QSystemTrayIcon* self, intptr_t slot);
QTLIBC_API void QSystemTrayIcon_MessageClicked(QSystemTrayIcon* self);
QTLIBC_API void QSystemTrayIcon_Connect_MessageClicked(QSystemTrayIcon* self, intptr_t slot);
