...
QTLIBC_API void QDockWidget_Connect_FeaturesChanged(QDockWidget* self, intptr_t slot);
QTLIBC_API void QDockWidget_TopLevelChanged(QDockWidget* self, bool topLevel);
QTLIBC_API void QDockWidget_Connect_TopLevelChanged(QDockWidget* self, intptr_t slot);
QTLIBC_API void QDockWidget_AllowedAreasChanged(QDockWidget* self, int allowedAreas);
QTLIBC_API void QDockWidget_Connect_AllowedAreasChanged(QDockWidget* self, intptr_t slot);
QTLIBC_API void QDockWidget_VisibilityChanged(QDockWidget* self, bool visible);
QTLIBC_API void QDockWidget_Connect_VisibilityChanged(QDockWidget* self, intptr_t slot);
QTLIBC_API void QDockWidget_DockLocationChanged(QDockWidget* self, int area);
QTLIBC_API void QDockWidget_Connect_DockLocationChanged(QDockWidget* self, intptr_t slot);
