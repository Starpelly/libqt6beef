...
QTLIBC_API void QDateTimeEdit_Connect_DateTimeChanged(QDateTimeEdit* self, intptr_t slot);
QTLIBC_API void QDateTimeEdit_TimeChanged(QDateTimeEdit* self, QTime* time);
QTLIBC_API void QDateTimeEdit_Connect_TimeChanged(QDateTimeEdit* self, intptr_t slot);
QTLIBC_API void QDateTimeEdit_DateChanged(QDateTimeEdit* self, QDate* date);
QTLIBC_API void QDateTimeEdit_Connect_DateChanged(QDateTimeEdit* self, intptr_t slot);
...
QTLIBC_API void QTimeEdit_Connect_UserTimeChanged(QTimeEdit* self, intptr_t slot);
...
QTLIBC_API void QDateEdit_Connect_UserDateChanged(QDateEdit* self, intptr_t slot);
