...
QTLIBC_API void QUndoGroup_Connect_ActiveStackChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_IndexChanged(QUndoGroup* self, int idx);
QTLIBC_API void QUndoGroup_Connect_IndexChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_CleanChanged(QUndoGroup* self, bool clean);
QTLIBC_API void QUndoGroup_Connect_CleanChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_CanUndoChanged(QUndoGroup* self, bool canUndo);
QTLIBC_API void QUndoGroup_Connect_CanUndoChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_CanRedoChanged(QUndoGroup* self, bool canRedo);
QTLIBC_API void QUndoGroup_Connect_CanRedoChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_UndoTextChanged(QUndoGroup* self, libqt_string undoText);
QTLIBC_API void QUndoGroup_Connect_UndoTextChanged(QUndoGroup* self, intptr_t slot);
QTLIBC_API void QUndoGroup_RedoTextChanged(QUndoGroup* self, libqt_string redoText);
QTLIBC_API void QUndoGroup_Connect_RedoTextChanged(QUndoGroup* self, intptr_t slot);
