#pragma once
#ifndef SRC_QTC_LIBQACTION_H
#define SRC_QTC_LIBQACTION_H
...
QTLIBC_API void QAction_Connect_Changed(QAction* self, intptr_t slot);
QTLIBC_API void QAction_EnabledChanged(QAction* self, bool enabled);
QTLIBC_API void QAction_Connect_EnabledChanged(QAction* self, intptr_t slot);
QTLIBC_API void QAction_CheckableChanged(QAction* self, bool checkable);
QTLIBC_API void QAction_Connect_CheckableChanged(QAction* self, intptr_t slot);
QTLIBC_API void QAction_VisibleChanged(QAction* self);
QTLIBC_API void QAction_Connect_VisibleChanged(QAction* self, intptr_t slot);
QTLIBC_API void QAction_Triggered(QAction* self);
QTLIBC_API void QAction_Connect_Triggered(QAction* self, intptr_t slot);
QTLIBC_API void QAction_Hovered(QAction* self);
QTLIBC_API void QAction_Connect_Hovered(QAction* self, intptr_t slot);
QTLIBC_API void QAction_Toggled(QAction* self, bool param1);
QTLIBC_API void QAction_Connect_Toggled(QAction* self, intptr_t slot);
...
QTLIBC_API void QAction_Connect_Triggered1(QAction* self, intptr_t slot);
