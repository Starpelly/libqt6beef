...
QTLIBC_API void QStackedWidget_Connect_CurrentChanged(QStackedWidget* self, intptr_t slot);
QTLIBC_API void QStackedWidget_WidgetRemoved(QStackedWidget* self, int index);
QTLIBC_API void QStackedWidget_Connect_WidgetRemoved(QStackedWidget* self, intptr_t slot);
