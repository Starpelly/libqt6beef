...
QTLIBC_API void QItemSelectionModel_Connect_SelectionChanged(QItemSelectionModel* self, intptr_t slot);
QTLIBC_API void QItemSelectionModel_CurrentChanged(QItemSelectionModel* self, QModelIndex* current, QModelIndex* previous);
QTLIBC_API void QItemSelectionModel_Connect_CurrentChanged(QItemSelectionModel* self, intptr_t slot);
QTLIBC_API void QItemSelectionModel_CurrentRowChanged(QItemSelectionModel* self, QModelIndex* current, QModelIndex* previous);
QTLIBC_API void QItemSelectionModel_Connect_CurrentRowChanged(QItemSelectionModel* self, intptr_t slot);
...
QTLIBC_API void QItemSelectionModel_Connect_CurrentColumnChanged(QItemSelectionModel* self, intptr_t slot);
QTLIBC_API void QItemSelectionModel_ModelChanged(QItemSelectionModel* self, QAbstractItemModel* model);
QTLIBC_API void QItemSelectionModel_Connect_ModelChanged(QItemSelectionModel* self, intptr_t slot);
