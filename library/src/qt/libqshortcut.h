#pragma once
#ifndef SRC_QTC_LIBQSHORTCUT_H
#define SRC_QTC_LIBQSHORTCUT_H
...
QTLIBC_API void QShortcut_Connect_Activated(QShortcut* self, intptr_t slot);
QTLIBC_API void QShortcut_ActivatedAmbiguously(QShortcut* self);
QTLIBC_API void QShortcut_Connect_ActivatedAmbiguously(QShortcut* self, intptr_t slot);
