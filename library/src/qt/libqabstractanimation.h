#pragma once
#ifndef SRC_QTC_LIBQABSTRACTANIMATION_H
#define SRC_QTC_LIBQABSTRACTANIMATION_H
...
QTLIBC_API void QAbstractAnimation_Connect_Finished(QAbstractAnimation* self, intptr_t slot);
QTLIBC_API void QAbstractAnimation_StateChanged(QAbstractAnimation* self, int newState, int oldState);
QTLIBC_API void QAbstractAnimation_Connect_StateChanged(QAbstractAnimation* self, intptr_t slot);
QTLIBC_API void QAbstractAnimation_CurrentLoopChanged(QAbstractAnimation* self, int currentLoop);
QTLIBC_API void QAbstractAnimation_Connect_CurrentLoopChanged(QAbstractAnimation* self, intptr_t slot);
QTLIBC_API void QAbstractAnimation_DirectionChanged(QAbstractAnimation* self, int param1);
QTLIBC_API void QAbstractAnimation_Connect_DirectionChanged(QAbstractAnimation* self, intptr_t slot);
...
QTLIBC_API void QAnimationDriver_Connect_Started(QAnimationDriver* self, intptr_t slot);
QTLIBC_API void QAnimationDriver_Stopped(QAnimationDriver* self);
QTLIBC_API void QAnimationDriver_Connect_Stopped(QAnimationDriver* self, intptr_t slot);
