...
QTLIBC_API void QActionGroup_Connect_Triggered(QActionGroup* self, intptr_t slot);
QTLIBC_API void QActionGroup_Hovered(QActionGroup* self, QAction* param1);
QTLIBC_API void QActionGroup_Connect_Hovered(QActionGroup* self, intptr_t slot);
