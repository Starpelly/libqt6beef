...
QTLIBC_API void QTabBar_Connect_CurrentChanged(QTabBar* self, intptr_t slot);
QTLIBC_API void QTabBar_TabCloseRequested(QTabBar* self, int index);
QTLIBC_API void QTabBar_Connect_TabCloseRequested(QTabBar* self, intptr_t slot);
QTLIBC_API void QTabBar_TabMoved(QTabBar* self, int from, int to);
QTLIBC_API void QTabBar_Connect_TabMoved(QTabBar* self, intptr_t slot);
QTLIBC_API void QTabBar_TabBarClicked(QTabBar* self, int index);
QTLIBC_API void QTabBar_Connect_TabBarClicked(QTabBar* self, intptr_t slot);
QTLIBC_API void QTabBar_TabBarDoubleClicked(QTabBar* self, int index);
QTLIBC_API void QTabBar_Connect_TabBarDoubleClicked(QTabBar* self, intptr_t slot);
