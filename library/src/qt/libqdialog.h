...
QTLIBC_API void QDialog_Connect_Finished(QDialog* self, intptr_t slot);
QTLIBC_API void QDialog_Accepted(QDialog* self);
QTLIBC_API void QDialog_Connect_Accepted(QDialog* self, intptr_t slot);
QTLIBC_API void QDialog_Rejected(QDialog* self);
QTLIBC_API void QDialog_Connect_Rejected(QDialog* self, intptr_t slot);
